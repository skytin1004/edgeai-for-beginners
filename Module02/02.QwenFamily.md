...
Selected Qwen family models are available through [Hugging Face](https://huggingface.co/models?search=qwen), providing access to some variants of these models. You can explore available variants, fine-tune them for your specific use cases, and deploy them through various frameworks.

### Local Development Tools
For local development and testing, you can use [Microsoft Foundry Local](https://github.com/microsoft/foundry-local) to run available Qwen models on your development machine with optimized performance.
