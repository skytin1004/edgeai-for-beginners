...
The Qwen family of models is available through the [Azure AI Foundry Model Catalog](https://ai.azure.com/explore/models?q=qwen), providing developers with easy access to these powerful models. You can explore different variants, fine-tune them for your specific use cases, and deploy them through Azure's infrastructure.

### Azure AI Studio
Deploy and experiment with Qwen models using [Azure AI Foundry](https://ai.azure.com), which offers an integrated environment for building, testing, and deploying AI solutions with these models.

### Foundry Local
For local development and testing, you can use [Microsoft Foundry Local](https://github.com/microsoft/foundry-local) to run Qwen models on your development machine with optimized performance.

### Documentation Resources
- [Microsoft Learn: Working with Qwen Models](https://learn.microsoft.com/azure/ai-studio/how-to/deployments/qwen)
-- [Optimizing Qwen Models for Edge Deployment](https://github.com/micrososft/olive)
...
- Recognize the benefits and limitations of different Qwen model variants
