...
**Medium Models:**
- `qwen2.5-7b-instruct`: Excellent reasoning and longer context
- `deepseek-r1-distill-qwen-7b`: Optimized for code generation

**Larger Models:**
- `llama-3.2`: Meta's latest open-source model
- `qwen2.5-14b-instruct`: Enterprise-grade reasoning
...
- Advanced: `qwen2.5-7b-instruct` (longer context)

**For Code Generation:**
- Recommended: `deepseek-r1-distill-qwen-7b`
- Alternative: `qwen2.5-7b-instruct` (also good for code)
