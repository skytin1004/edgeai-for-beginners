...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T01:45:26+00:00",
...
Тази сесия се фокусира върху практическо откриване и управление на модели с Foundry Local. Ще научите как да изброявате наличните модели, да тествате различни опции и да разбирате основните характеристики на производителността. Подходът акцентира върху практическо изследване с foundry CLI, за да ви помогне да изберете правилните модели за вашите случаи на употреба.

## Цели на обучението

- Усвояване на команди на foundry CLI за откриване и управление на модели
- Разбиране на кеша на модели и локалните модели за съхранение
- Научаване как бързо да тествате и сравнявате различни модели
- Създаване на практични работни процеси за избор и оценка на модели
...
- **[Foundry Local Документация](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Официална документация
...
✅ **Мониторинг на производителността**: Основно измерване на използването на ресурси и времето за отговор  
...
Сега разполагате с практически умения за откриване, тестване и избор на подходящи модели за вашите AI приложения, използвайки лесния CLI подход на Foundry Local.
...
- `phi-4-mini`: Бърз, ефективен, подходящ за общ чат
- `phi-4`: По-способна версия с по-добро разсъждение

**Средни модели:**
- `qwen2.5-7b-instruct`: Отлично разсъждение и по-дълъг контекст
- `deepseek-r1-distill-qwen-7b`: Оптимизиран за генериране на код

**Големи модели:**
- `llama-3.2`: Най-новият модел с отворен код на Meta
- `qwen2.5-14b-instruct`: Разсъждение на ниво предприятие

## Част 2: Бързо тестване и сравнение на модели

### Подход Пример 03: Прост списък и оценка
...
### Тестване на производителността на модела
...
- Обмислете компромис между размер на модела и способности
...
**За общ чат и въпроси и отговори:**
- Започнете с: `phi-4-mini` (бърз, ефективен)
- Надградете до: `phi-4` (по-добро разсъждение)
- Напреднали: `qwen2.5-7b-instruct` (по-дълъг контекст)

**За генериране на код:**
- Препоръчителен: `deepseek-r1-distill-qwen-7b`
- Алтернатива: `qwen2.5-7b-instruct` (също добър за код)

**За сложни разсъждения:**
- Най-добър: `qwen2.5-7b-instruct` или `qwen2.5-14b-instruct`
...
- Поддръжка на NPU (Windows 11 Copilot+ компютри) за ускорение
...
**Тестови подсказки:**
1. "Обяснете квантовите изчисления с прости думи."
...
**Критерии за оценка:**
- **Точност**: Дали информацията е вярна?
