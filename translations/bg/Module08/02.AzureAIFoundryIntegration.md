...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T01:16:10+00:00",
...
Въз основа на основите на Foundry Local, тази сесия се фокусира върху създаването на усъвършенствани AI решения чрез напреднало инженерство на подканите, безпроблемна интеграция на данни и автоматизация на задачи. Ще научите как да свържете локалната разработка с възможностите на Azure AI Foundry, създавайки приложения за предприятия, които използват най-доброто от двата свята.

## Цели на обучението

До края на тази сесия ще можете:
- Да овладеете напреднали техники за инженерство на подканите за последователни и надеждни AI отговори
- Да внедрите устойчиви модели за интеграция на данни за реални приложения
- Да създавате изпълними AI задачи, които добавят бизнес стойност
- Да установите безпроблемна връзка между Foundry Local и Azure AI Foundry
- Да изградите работни процеси за мониторинг и оптимизация на производителността
- Да внедрите AI решения, готови за производство, с подходящо управление на грешки и мащабиране

## Предварителни изисквания

- Завършена Сесия 1: Запознаване с Foundry Local
- Активна инсталация на Foundry Local с работещи модели
- Azure акаунт (безплатният план е достатъчен за обучение)
- Основни познания за REST API и JSON

## Част 1: Напреднало инженерство на подканите

### Разбиране на архитектурата на подканите

Ефективното инженерство на подканите е основата на надеждните AI приложения. Foundry Local предоставя разширени възможности за създаване на подканите:
...
### Внедряване на стратегии за подканите
...
### Практически примери за инженерство на подканите
...
## Част 2: Модели за интеграция на данни

### Конектори за данни на Foundry Local
...
### Пример за интеграция на данни в реалния свят
...
## Част 3: Изпълними AI задачи

### Рамка за автоматизация на задачи
...
### Примери за автоматизация на бизнес процеси
...
## Част 4: Интеграция с Azure AI Foundry
...
## Част 5: Мониторинг и оптимизация на производителността

### Цялостна система за мониторинг
...
### Упражнение 1: Напреднал бот за обслужване на клиенти
...
### Упражнение 2: Автоматизирано пазарно проучване
...
## Част 7: Следващи стъпки и преглед на Сесия 3

### Постижения от сесията

В тази сесия овладяхте:
- ✅ Напреднали техники за инженерство на подканите за последователно AI поведение
- ✅ Устойчиви модели за интеграция на данни за реални приложения
- ✅ Създаване на автоматизирани задачи за оптимизация на бизнес процеси
- ✅ Интеграция с Azure AI Foundry и хибридни стратегии за внедряване
- ✅ Цялостен мониторинг и оптимизация на производителността

### Подготовка за Сесия 3: Модели с отворен код

1. **Разгледайте Hugging Face**: Създайте акаунт и разгледайте каталога с модели
2. **Прегледайте Model Mondays**: Вижте последната серия [Model Mondays](https://aka.ms/model-mondays)
3. **Планирайте персонализирани модели**: Помислете кои специализирани модели биха били полезни за вашите случаи на употреба

### Допълнителни ресурси

- [Документация за Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [GitHub хранилище на Foundry Local](https://github.com/microsoft/Foundry-Local)
- [Ръководство за напреднало инженерство на подканите](https://platform.openai.com/docs/guides/prompt-engineering)
- [Най-добри практики за автоматизация на бизнес процеси](https://docs.microsoft.com/en-us/power-automate/)

Вече сте подготвени да създавате усъвършенствани AI решения, които комбинират силата на локалното изчисление с мащабируемостта на облака, поставяйки основата за AI приложения от корпоративен клас.
