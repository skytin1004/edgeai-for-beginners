...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T01:46:19+00:00",
  "source_file": "Module08/04.CuttingEdgeModels.md",
  "language_code": "bg"
}
-->
# Сесия 4: Създаване на производствени чат приложения с Chainlit

## Обзор

Тази сесия е посветена на изграждането на готови за производство чат приложения с помощта на Chainlit и Microsoft Foundry Local. Ще научите как да създавате модерни уеб интерфейси за AI разговори, да внедрявате стрийминг отговори и да разгръщате надеждни чат приложения с правилно управление на грешки и дизайн за потребителско изживяване.
...
- **Производствени модели**: Управление на грешки, мониторинг и стратегии за разгръщане

## Цели на обучението

- Създаване на готови за производство чат приложения с Chainlit
- Внедряване на стрийминг отговори за подобрено потребителско изживяване
- Овладяване на модели за интеграция с Foundry Local SDK
- Прилагане на правилно управление на грешки и плавна деградация
...
## Част 1: Разбиране на модерни чат приложения
...
## Част 2: Матрица за решение между локално и облачно

### Характеристики на производителността

| Аспект | Локално (Foundry) | Облачно (Azure OpenAI) |
|--------|-------------------|-----------------------|
| **Закъснение** | 🚀 50-200ms (без мрежа) | ⏱️ 200-2000ms (зависимо от мрежата) |
| **Поверителност** | 🔒 Данните никога не напускат устройството | ⚠️ Данните се изпращат в облака |
...
Приложението Пример 04 демонстрира готови за производство модели:
...
Пример 04 включва цялостен Jupyter notebook (`chainlit_app.ipynb`), който предоставя:
...
#### Упражнение 1: Тестване на конфигурация на клиента
...
#### Упражнение 2: Симулиране на стрийминг отговори
...
### Стъпка 2: Настройка на Docker (Препоръчително)
...
**Забележка:** `host.docker.internal` позволява на Docker контейнерите да достъпват хост машината на Windows.
...
2. **Моделите не се появяват:**
   ...
   - Рестартирайте контейнера на Open WebUI

## Част 7: Съображения за производствено разгръщане
...
Сесия 4 обхвана създаването на готови за производство Chainlit приложения за разговорен AI. Научихте за:
...
- ✅ **Производствени модели**: Управление на грешки, мониторинг и скалируемост

Приложението Пример 04 демонстрира най-добрите практики за създаване на надеждни чат интерфейси, които използват локални AI модели чрез Microsoft Foundry Local, като същевременно предоставят отлично потребителско изживяване.

## Референции

- **[Пример 04: Chainlit Application](samples/04/README.md)**: Пълно приложение с документация
