...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T19:44:01+00:00",
...
Решението на Microsoft Azure за EdgeAI се фокусира върху ефективното разгръщане на Small Language Models (SLMs) в хибридни среди облак-edge. Този подход преодолява разликата между AI услуги в облака и изискванията за edge разгръщане.
...
- Оптимизирано за разгръщане в мащаб на предприятието
- Поддръжка за непрекъснати актуализации и управление на модели

### Случаи на употреба
Azure EdgeAI реализацията е отлична за сценарии, изискващи AI разгръщане в мащаб на предприятието с възможности за управление в облака. Това включва интелигентна обработка на документи, анализи в реално време и хибридни AI работни потоци, които използват както облачни, така и edge изчислителни ресурси.
...
- Работи на всички Windows 11 PC устройства с версия 24H2 (build 26100) или по-нова
- Работи на всички x64 и ARM64 PC хардуери, дори на PC устройства без NPU или GPU
- Позволява на разработчиците да използват свои собствени модели и да ги разгръщат ефективно в екосистемата на силиконовите партньори, включително AMD, Intel, NVIDIA и Qualcomm, обхващащи CPU, GPU, NPU
...
За разработчици, които специално се насочват към платформата Windows, създадохме подробно ръководство, което обхваща цялата екосистема на Windows EdgeAI. Този ресурс предоставя подробна информация за Windows AI Foundry, включително API, инструменти и най-добри практики за EdgeAI разработка на Windows.
...
- Стратегии за хардуерна оптимизация за Windows устройства
- Практически примери за реализация и най-добри практики

### [AI Toolkit за Edge AI разработка](./aitoolkit.md)
...
**Ръководство за разработка**: [AI Toolkit за Edge AI разработка](./aitoolkit.md)
...
Всяка платформа предлага уникални предимства: Jetson Orin Nano за хардуерно ускорено edge изчисление, ONNX Runtime GenAI за кросплатформена мобилна разработка, Azure EdgeAI за интеграция облак-edge в предприятието, Windows ML за нативни Windows приложения и Foundry Local за реализации, фокусирани върху поверителността. Заедно те представляват цялостна екосистема за EdgeAI разработка.
