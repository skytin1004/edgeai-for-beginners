...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T21:03:40+00:00",
...
Добре дошли в **EdgeAI за начинаещи** – вашето пълно ръководство за трансформиращия свят на Edge изкуствения интелект. Този курс свързва мощните възможности на AI с практическото му приложение на edge устройства, позволявайки ви да използвате потенциала на AI директно там, където се генерират данни и трябва да се вземат решения.
...
### [Модул 01: Основи на EdgeAI и трансформация](./Module01/README.md)
**Тема**: Трансформиращата промяна на внедряването на Edge AI

#### Структура на главите:
- [**Секция 1: Основи на EdgeAI**](./Module01/01.EdgeAIFundamentals.md)  
  - Сравнение между традиционен облачен AI и Edge AI  
  - Предизвикателства и ограничения на edge изчисленията  
  - Ключови технологии: квантоване на модели, оптимизация на компресията, малки езикови модели (SLMs)  
...
- [**Секция 2: Казуси от реалния свят**](./Module01/02.RealWorldCaseStudies.md)  
...
- [**Секция 3: Практическо ръководство за внедряване**](./Module01/03.PracticalImplementationGuide.md)  
...
- [**Секция 4: Хардуерни платформи за внедряване на Edge AI**](./Module01/04.EdgeDeployment.md)  
...
**Тема**: Теоретични принципи, стратегии за внедряване и производствено приложение на SLM

#### Структура на главите:
- [**Секция 1: Основи на семейството модели Microsoft Phi**](./Module02/01.PhiFamily.md)  
  - Еволюция на философията на дизайна (Phi-1 до Phi-4)  
  - Дизайн, ориентиран към ефективността  
  - Специализирани възможности (разсъждение, мултимодалност, edge внедряване)  

- [**Секция 2: Основи на семейството модели Qwen**](./Module02/02.QwenFamily.md)  
...
- [**Секция 3: Основи на семейството модели Gemma**](./Module02/03.GemmaFamily.md)  
  - Иновации, водени от изследвания (Gemma 3 & 3n)  
  - Мултимодална изключителност  
  - Архитектура, ориентирана към мобилни устройства  

- [**Секция 4: Основи на семейството модели BitNET**](./Module02/04.BitNETFamily.md)  
  - Революционна технология за квантоване (1.58-битова)  
  - Специализирана рамка за инференция от https://github.com/microsoft/BitNet  
  - Устойчиво AI лидерство чрез изключителна ефективност  

- [**Секция 5: Основи на модела Microsoft Mu**](./Module02/05.mumodel.md)  
...
- [**Секция 6: Основи на Phi-Silica**](./Module02/06.phisilica.md)  
...
**Тема**: Пълният жизнен цикъл на SLM – от теория до производствена среда

#### Структура на главите:
- [**Секция 1: Разширено обучение за SLM**](./Module03/01.SLMAdvancedLearning.md)  
  - Рамка за класификация на параметри (Micro SLM 100M-1.4B, Medium SLM 14B-30B)  
  - Разширени техники за оптимизация (методи за квантоване, BitNET 1-битово квантоване)  
  - Стратегии за придобиване на модели (Azure AI Foundry за Phi модели, Hugging Face за избрани модели)  

- [**Секция 2: Внедряване в локална среда**](./Module03/02.DeployingSLMinLocalEnv.md)  
  - Универсално внедряване на платформа Ollama  
  - Локални решения за корпоративен клас на Microsoft Foundry  
  - Сравнителен анализ на рамки  

- [**Секция 3: Контейнеризирано внедряване в облака**](./Module03/03.DeployingSLMinCloud.md)  
  - Внедряване на високопроизводителна инференция с vLLM  
  - Оркестрация на контейнери Ollama  
...
#### Структура на главите:
- [**Секция 1: Основи на конвертиране на формат на модели и квантоване**](./Module04/01.Introduce.md)  
  ...
  - Сравнения на производителността и паметта  
- [**Секция 2: Ръководство за внедряване на Llama.cpp**](./Module04/02.Llamacpp.md)
  - Инсталация на различни платформи (Windows, macOS, Linux)
...
- [**Секция 3: Microsoft Olive Optimization Suite**](./Module04/03.MicrosoftOlive.md)
  ...
  - Интеграция в корпоративни работни потоци с Azure ML
  - Поддръжка на популярни модели (Llama, Phi, избрани Qwen модели, Gemma)

- [**Секция 4: OpenVINO Toolkit Optimization Suite**](./Module04/04.openvino.md)
  - Open-source инструмент на Intel за внедряване на AI на различни платформи
  - Framework за компресия на невронни мрежи (NNCF) за напреднала оптимизация
  - OpenVINO GenAI за внедряване на големи езикови модели
  - Хардуерно ускорение за CPU, GPU, VPU и AI ускорители

- [**Секция 5: Apple MLX Framework - Подробен анализ**](./Module04/05.AppleMLX.md)
  - Унифицирана паметна архитектура за Apple Silicon
  - Поддръжка на LLaMA, Mistral, Phi-3, избрани Qwen модели
  - LoRA фина настройка и персонализация на модели
  - Интеграция с Hugging Face с квантизация 4-бит/8-бит

- [**Секция 6: Синтез на работния процес за Edge AI разработка**](./Module04/06.workflow-synthesis.md)
  - Унифицирана архитектура на работния процес, интегрираща множество оптимизационни рамки
  - Дървета за вземане на решения при избор на рамка и анализ на компромиси в производителността
  - Валидиране на готовност за производство и стратегии за разгръщане
...
**Тема**: Пълен жизнен цикъл на SLM операции - от дистилация до внедряване в производство

#### Структура на главите:
- [**Секция 1: Въведение в SLMOps**](./Module05/01.IntroduceSLMOps.md)
...
- [**Секция 2: Дистилация на модели - от теория към практика**](./Module05/02.SLMOps-Distillation.md)
...
- [**Секция 3: Фина настройка - Персонализиране на модели за специфични задачи**](./Module05/03.SLMOps-Finetuing.md)
...
- [**Секция 4: Внедряване - Готовност за производство**](./Module05/04.SLMOps.Deployment.md)
...
**Тема**: Внедряване на SLM агентни системи - от основи до напреднало извикване на функции и интеграция с Model Context Protocol

#### Структура на главите:
- [**Секция 1: Основи на AI агенти и малки езикови модели**](./Module06/01.IntroduceAgent.md)
...
- [**Секция 2: Извикване на функции в малки езикови модели**](./Module06/02.FunctionCalling.md)
...
- [**Секция 3: Интеграция с Model Context Protocol (MCP)**](./Module06/03.IntroduceMCP.md)
...
**Тема**: Цялостни EdgeAI внедрения на различни платформи и рамки
...
- [**Ръководство за разработка на Windows EdgeAI**](./Module07/windowdeveloper.md)
...
- [**EdgeAI в мобилни приложения с .NET MAUI и ONNX Runtime GenAI**](./Module07/README.md#2-edgeai-in-mobile-applications-with-net-maui-and-onnx-runtime-genai)
  - Кросплатформен мобилен AI с единен C# код
...
- [**EdgeAI с Windows ML**](./Module07/README.md#4-edgeai-with-windows-ml)
  ...
  - Унифицирана рамка за разнообразна Windows хардуерна екосистема
...
- [**EdgeAI с приложения Foundry Local**](./Module07/README.md#5-edgeai-with-foundry-local-applications)
  ...
  - Интеграция на езиков модел Phi-3 със семантично търсене (само Phi модели)
...
С успешното завършване на този цялостен курс за EdgeAI, ще развиете експертиза за проектиране, внедряване и разгръщане на готови за производство EdgeAI решения. Нашият структуриран подход гарантира, че ще овладеете както теоретичните основи, така и практическите умения за внедряване.

### Технически компетенции

**Основни знания**
- Разбиране на фундаменталните разлики между облачни и edge AI архитектури
- Овладяване на принципите на квантизация, компресия и оптимизация за среди с ограничени ресурси
- Осъзнаване на опциите за хардуерно ускорение (NPUs, GPUs, CPUs) и техните внедрителни последици

**Умения за внедряване**
- Внедряване на малки езикови модели на различни edge платформи (мобилни, вградени, IoT, edge сървъри)
- Прилагане на оптимизационни рамки, включително Llama.cpp, Microsoft Olive, ONNX Runtime и Apple MLX
- Внедряване на системи за инференция в реално време с изисквания за отговор под секунда

**Експертиза в производството**
- Проектиране на мащабируеми EdgeAI архитектури за корпоративни приложения
- Внедряване на стратегии за мониторинг, поддръжка и актуализация на разгръщаните системи
...
- Преценка на компромисите между точност на модела, скорост на инференция, консумация на енергия и разходи за хардуер
...
- Планиране на хибридни edge-облачни архитектури за оптимална производителност и ефективност на разходите
- Внедряване на потоци за обработка на данни за AI приложения в реално време
...
- **Потребителска електроника**: Мобилни приложения с AI и интелигентни домашни устройства
...
- Дълбоко разбиране на различни философии за дизайн на SLM и техните внедрителни последици
...
- Разбиране на компромисите при внедрителна гъвкавост
- Придобиване на прозрения за бъдещето на ефективни AI архитектури

### Резултати от обучението за Модул 03:
- Стратегически способности за избор на модели
- Овладяване на техники за оптимизация
- Овладяване на гъвкавостта при внедряване
...
- Овладяване на оптимизацията на Intel хардуер с OpenVINO и NNCF
- Способности за избор на оптимизация, съобразена с хардуера, на различни платформи
- Умения за внедряване в производство за edge компютинг среди на различни платформи
- Стратегически избор на рамки и синтез на работни потоци за оптимални Edge AI решения

### Резултати от обучението за Модул 05:
- Овладяване на парадигмата и оперативните принципи на SLMOps
...
- Овладяване на внедряване на извикване на функции на различни платформи и рамки
- Интеграция с Model Context Protocol (MCP) за стандартизирано взаимодействие с външни инструменти
- Създаване на сложни агентни системи с минимални изисквания за човешка намеса

### Резултати от обучението за Модул 07:
- Овладяване на AI Toolkit за Visual Studio Code за цялостни работни потоци за разработка на Edge AI
- Придобиване на експертиза в платформата Windows AI Foundry и стратегии за оптимизация на NPU
- Придобиване на практически опит с различни EdgeAI платформи и стратегии за внедряване
- Овладяване на техники за оптимизация, специфични за хардуера, на NVIDIA, мобилни, Azure и Windows платформи
- Разбиране на компромисите при внедряване между производителност, разходи и изисквания за поверителност
- Развитие на практически умения за създаване на реални EdgeAI приложения в различни екосистеми

## Очаквани резултати от курса

След успешно завърш
Този курс ви поставя на предната линия на внедряването на AI технологии, където интелигентните възможности се интегрират безпроблемно в устройствата и системите, които задвижват съвременния живот.
...
- **Прогресивно обучение**: Постепенно преминаване от основни концепции към напреднало внедряване
...
- **Практическа работа**: Завършени конфигурационни файлове, процедури за тестване на API и скриптове за внедряване
- **Показатели за производителност**: Подробни сравнения на скоростта на извод, използването на паметта и изискванията за ресурси
- **Корпоративни съображения**: Практики за сигурност, рамки за съответствие и стратегии за защита на данни

## Първи стъпки

Препоръчителен учебен път:
1. Започнете с **Module01**, за да изградите основно разбиране за EdgeAI
2. Продължете с **Module02**, за да разберете задълбочено различните семейства модели SLM
...
5. Завършете **Module05**, за да овладеете SLMOps за готови за производство реализации
6. Изследвайте **Module06**, за да разберете агентните системи на SLM и възможностите за извикване на функции
7. Завършете с **Module07**, за да придобиете практически опит с AI Toolkit и разнообразни примери за внедряване на EdgeAI

Всеки модул е проектиран да бъде самостоятелно завършен, но последователното обучение ще предостави най-добри резултати.

## Учебно ръководство

Достъпно е цялостно [Учебно ръководство](STUDY_GUIDE.md), което да ви помогне да максимизирате учебния си опит. Учебното ръководство предоставя:

- **Структурирани учебни пътища**: Оптимизирани графици за завършване на курса за 20 часа
...
Учебното ръководство е проектирано да се адаптира както за интензивно обучение (1 седмица), така и за обучение на непълно работно време (3 седмици), с ясни насоки как да разпределите времето си ефективно, дори ако можете да отделите само 10 часа за курса.

---

**Бъдещето на EdgeAI се крие в непрекъснатото усъвършенстване на архитектурите на модели, техниките за квантизация и стратегиите за внедряване, които дават приоритет на ефективността и специализацията пред универсалните възможности. Организациите, които приемат тази промяна в парадигмата, ще бъдат добре позиционирани да използват трансформиращия потенциал на AI, като същевременно запазват контрол върху своите данни и операции.**
