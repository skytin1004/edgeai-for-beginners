...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T12:19:46+00:00",
...
Bienvenido a **EdgeAI para Principiantes**: tu guía completa hacia el mundo transformador de la Inteligencia Artificial en el Borde (Edge AI). Este curso conecta las capacidades avanzadas de la IA con implementaciones prácticas en dispositivos de borde, permitiéndote aprovechar el potencial de la IA directamente donde se generan los datos y se toman decisiones.

### Lo que Aprenderás

Este curso te llevará desde conceptos básicos hasta implementaciones listas para producción, cubriendo:
- **Modelos de Lenguaje Pequeños (SLMs)** optimizados para el borde
...
### Por Qué Importa EdgeAI

Edge AI representa un cambio de paradigma que aborda desafíos modernos clave:
...
- **Eficiencia de Costos**: Reduce el uso de ancho de banda y los costos de computación en la nube
...
Los SLMs como Phi-4, Mistral-7B y Gemma son versiones optimizadas de modelos de lenguaje más grandes, entrenados o destilados para:
- **Menor uso de memoria**: Uso eficiente de la memoria limitada de los dispositivos de borde
- **Menor demanda de cómputo**: Optimización para rendimiento en CPU y GPU de borde
- **Tiempos de inicio más rápidos**: Inicialización rápida para aplicaciones receptivas

Estos modelos desbloquean capacidades avanzadas de PLN mientras cumplen con las limitaciones de:
...
- **Computadoras personales**: Escenarios de implementación en desktops y laptops
...
- [**Sección 1: Fundamentos de EdgeAI**](./Module01/01.EdgeAIFundamentals.md)
  - Comparación entre IA en la nube tradicional y Edge AI
  - Desafíos y limitaciones del cómputo en el borde
  - Tecnologías clave: cuantización de modelos, optimización por compresión, Modelos de Lenguaje Pequeños (SLMs)
  - Aceleración de hardware: NPUs, optimización de GPU, optimización de CPU
  - Ventajas: seguridad de privacidad, baja latencia, capacidades offline, eficiencia de costos

- [**Sección 2: Casos de Estudio del Mundo Real**](./Module01/02.RealWorldCaseStudies.md)
  - Ecosistema de modelos Phi y Mu de Microsoft
  - Caso de estudio del sistema de informes de IA de Japan Airlines
...
- [**Sección 4: Plataformas de Hardware para Despliegue de Edge AI**](./Module01/04.EdgeDeployment.md)
  ...
  - Hardware de IA de borde de Intel y técnicas de optimización
  - Soluciones de IA de Qualcomm para sistemas móviles y embebidos
  - NVIDIA Jetson y plataformas de cómputo en el borde
  - Plataformas de PC con IA en Windows con aceleración NPU
  - Estrategias de optimización específicas de hardware
...
- [**Sección 1: Fundamentos de la Familia de Modelos Phi de Microsoft**](./Module02/01.PhiFamily.md)
  ...
  - Diseño arquitectónico enfocado en la eficiencia
...
- [**Sección 3: Fundamentos de la Familia Gemma**](./Module02/03.GemmaFamily.md)
  ...
  - Arquitectura enfocada en dispositivos móviles
...
- [**Sección 5: Fundamentos del Modelo Mu de Microsoft**](./Module02/05.mumodel.md)
  - Arquitectura orientada al dispositivo integrada en Windows 11
  - Integración con la Configuración de Windows 11
...
- [**Sección 1: Aprendizaje Avanzado de SLM**](./Module03/01.SLMAdvancedLearning.md)
  ...
  - Técnicas avanzadas de optimización (métodos de cuantización, cuantización de 1-bit de BitNET)
...
**Tema**: Kit de herramientas completo para la optimización de modelos para despliegue en el borde en diversas plataformas

#### Estructura del Capítulo:
- [**Sección 1: Fundamentos de Conversión de Formato y Cuantización de Modelos**](./Module04/01.Introduce.md)
...
- [**Sección 3: Suite de Optimización Microsoft Olive**](./Module04/03.MicrosoftOlive.md)
  ...
  - Soporte para modelos populares (Llama, Phi, modelos Qwen seleccionados, Gemma)
...
- [**Sección 4: Suite de Optimización OpenVINO Toolkit**](./Module04/04.openvino.md)
  ...
  - OpenVINO GenAI para despliegue de modelos de lenguaje de gran escala
  - Aceleración por hardware en CPU, GPU, VPU y aceleradores de IA

- [**Sección 5: Análisis Detallado del Marco Apple MLX**](./Module04/05.AppleMLX.md)
  - Arquitectura de memoria unificada para Apple Silicon
  - Soporte para LLaMA, Mistral, Phi-3, modelos Qwen seleccionados
...
- [**Sección 6: Síntesis del Flujo de Trabajo de Desarrollo de Edge AI**](./Module04/06.workflow-synthesis.md)
  ...
  - Estrategias de futuro para hardware emergente y arquitecturas de modelos

---

### [Módulo 05: SLMOps - Operaciones de Modelos de Lenguaje Pequeños](./Module05/README.md)
...
- [**Sección 4: Despliegue - Implementación Lista para Producción**](./Module05/04.SLMOps.Deployment.md)
  ...
  - Configuración de despliegue local con Foundry
  - Validación de calidad y evaluación de rendimiento
...
- [**Sección 1: Fundamentos de Agentes de IA y Modelos de Lenguaje Pequeños**](./Module06/01.IntroduceAgent.md)
  ...
  - Fundamentos de SLM y estrategias de optimización (GGUF, cuantización, marcos de edge)
  - Análisis de compensaciones entre SLM y LLM (reducción de costos de 10-30×, efectividad del 70-80% en tareas)
  - Despliegue práctico con Ollama, VLLM y soluciones edge de Microsoft
...
- [**Sección 3: Integración del Protocolo de Contexto del Modelo (MCP)**](./Module06/03.IntroduceMCP.md)
  - Arquitectura del protocolo y diseño de sistema en capas
...
**Tema**: Implementaciones completas de EdgeAI en diversas plataformas y marcos
...
- [**Herramienta de IA para Visual Studio Code**](./Module07/aitoolkit.md)
  ...
  - Catálogo de modelos y descubrimiento para despliegue en edge
  - Pruebas locales, optimización y flujos de trabajo de desarrollo de agentes
  - Monitoreo y evaluación de rendimiento para escenarios edge
...
- [**EdgeAI en NVIDIA Jetson Orin Nano**](./Module07/README.md#1-edgeai-in-nvidia-jetson-orin-nano)
  ...
  - Plataforma asequible de $249 para desarrollo democratizado de IA
...
- [**EdgeAI en Azure con Motor de Modelos de Lenguaje Pequeños**](./Module07/README.md#3-edgeai-in-azure-with-small-language-models-engine)
  - Arquitectura híbrida de despliegue en la nube y el edge
...
- [**EdgeAI con Aplicaciones Locales de Foundry**](./Module07/README.md#5-edgeai-with-foundry-local-applications)
  ...
  - Integración del modelo de lenguaje Phi-3 con búsqueda semántica (solo modelos Phi)
...
Al completar este curso integral de EdgeAI, desarrollarás la experiencia para diseñar, implementar y desplegar soluciones de EdgeAI listas para producción. Nuestro enfoque estructurado asegura que domines tanto los fundamentos teóricos como las habilidades prácticas de implementación.

### Competencias Técnicas

**Conocimientos Fundamentales**
- Comprender las diferencias fundamentales entre arquitecturas de IA basadas en la nube y en el edge
...
- Desplegar Modelos de Lenguaje Pequeños en diversas plataformas edge (móviles, embebidos, IoT, servidores edge)
...
- Planificar arquitecturas híbridas edge-nube para un rendimiento y eficiencia de costos óptimos
...
- **Electrónica de Consumo**: Aplicaciones móviles con IA y dispositivos inteligentes para el hogar

## Resumen de Resultados de Aprendizaje

### Resultados de Aprendizaje del Módulo 01:
- Comprender las diferencias fundamentales entre arquitecturas de IA en la nube y en el edge
- Dominar técnicas básicas de optimización para despliegues en edge
...
- Dominio de la optimización de hardware Intel con OpenVINO y NNCF
- Capacidades de selección de optimización basada en hardware en diversas plataformas
- Habilidades de despliegue en producción para entornos de computación edge multiplataforma
...
- Dominar el paradigma SLMOps y los principios operativos
...
- Obtener experiencia práctica con diversas plataformas y estrategias de implementación de EdgeAI
...
- **Gestión de Riesgos**: Identificar y mitigar riesgos técnicos y operativos en despliegues de EdgeAI
...
- Completar proyectos de EdgeAI de extremo a extremo que demuestren competencia práctica
- Desplegar soluciones listas para producción en múltiples plataformas de hardware
...
- Preparación para arquitecturas híbridas nube-edge
- Puerta de entrada a tecnologías y marcos de IA emergentes
Este curso te posiciona a la vanguardia del despliegue de tecnología de IA, donde las capacidades inteligentes se integran perfectamente en los dispositivos y sistemas que impulsan la vida moderna.
...
- **Aprendizaje Progresivo**: Avanza gradualmente desde conceptos básicos hasta despliegues avanzados
- **Integración de Teoría y Práctica**: Cada módulo contiene fundamentos teóricos y operaciones prácticas
- **Casos Reales**: Basados en casos reales de Microsoft, Alibaba, Google y otros
- **Práctica Práctica**: Archivos de configuración completos, procedimientos de prueba de API y scripts de despliegue
- **Comparativas de Rendimiento**: Comparaciones detalladas de velocidad de inferencia, uso de memoria y requisitos de recursos
- **Consideraciones de Nivel Empresarial**: Prácticas de seguridad, marcos de cumplimiento y estrategias de protección de datos

## Cómo Empezar

Ruta de aprendizaje recomendada:
1. Comienza con **Module01** para construir una comprensión fundamental de EdgeAI
2. Continúa con **Module02** para entender profundamente las diversas familias de modelos SLM
3. Aprende **Module03** para dominar habilidades prácticas de despliegue
4. Prosigue con **Module04** para optimización avanzada de modelos, conversión de formatos y síntesis de marcos
5. Completa **Module05** para dominar SLMOps para implementaciones listas para producción
6. Explora **Module06** para entender sistemas SLM agenticos y capacidades de llamadas a funciones
7. Finaliza con **Module07** para obtener experiencia práctica con AI Toolkit y diversos ejemplos de implementación de EdgeAI
...
Una [Guía de Estudio](STUDY_GUIDE.md) completa está disponible para ayudarte a maximizar tu experiencia de aprendizaje. La guía de estudio proporciona:
...
- **Ideas de Mini-Proyectos**: Aplicaciones prácticas para reforzar tu aprendizaje

La guía de estudio está diseñada para adaptarse tanto al aprendizaje intensivo (1 semana) como al estudio a tiempo parcial (3 semanas), con orientación clara sobre cómo asignar tu tiempo de manera efectiva incluso si solo puedes dedicar 10 horas al curso.

---

**El futuro de EdgeAI radica en la mejora continua de las arquitecturas de modelos, técnicas de cuantización y estrategias de despliegue que priorizan la eficiencia y la especialización sobre las capacidades de propósito general. Las organizaciones que adopten este cambio de paradigma estarán bien posicionadas para aprovechar el potencial transformador de la IA mientras mantienen el control sobre sus datos y operaciones.**
