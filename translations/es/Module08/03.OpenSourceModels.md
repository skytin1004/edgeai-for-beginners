...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T11:34:18+00:00",
...
Esta sesión se centra en el descubrimiento y gestión práctica de modelos con Foundry Local. Aprenderás a listar modelos disponibles, probar diferentes opciones y comprender características básicas de rendimiento. El enfoque destaca la exploración práctica con la CLI de Foundry para ayudarte a seleccionar los modelos adecuados para tus casos de uso.

## Objetivos de Aprendizaje

- Dominar los comandos de la CLI de Foundry para el descubrimiento y gestión de modelos
...
- Explorar el creciente ecosistema de modelos disponibles a través de Foundry Local
...
Ahora tienes las habilidades prácticas para descubrir, probar y seleccionar modelos apropiados para tus aplicaciones de IA utilizando el enfoque sencillo de la CLI de Foundry Local.
...
- Aplicar estrategias de selección de modelos según precisión, latencia y necesidades de recursos
...
La CLI de Foundry proporciona comandos sencillos para el descubrimiento y gestión de modelos:
...
**Modelos Medianos:**
- `qwen2.5-7b-instruct`: Excelente razonamiento y contexto más largo
- `deepseek-r1-distill-qwen-7b`: Optimizado para generación de código

**Modelos Grandes:**
- `llama-3.2`: El último modelo open-source de Meta
- `qwen2.5-14b-instruct`: Razonamiento de nivel empresarial
...
### Comprendiendo la Caché de Modelos
...
- Avanzado: `qwen2.5-7b-instruct` (contexto más largo)

**Para Generación de Código:**
- Recomendado: `deepseek-r1-distill-qwen-7b`
- Alternativa: `qwen2.5-7b-instruct` (también bueno para código)

**Para Razonamiento Complejo:**
- Mejor opción: `qwen2.5-7b-instruct` o `qwen2.5-14b-instruct`
...
Para cada modelo, prueba con prompts consistentes y evalúa manualmente:
