...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T11:35:21+00:00",
...
Objetivo: Implementar la selección inteligente de modelos con enrutamiento automático basado en el contenido de la consulta.
...
Paso 3) Implementar el enrutamiento inteligente y la ejecución (ver `samples/06/router.py`)  
```python
...
- [ ] Implementar el enrutador inteligente de modelos con selección basada en palabras clave (`samples/06/router.py`)
...
- [ ] Configurar la asignación de modelos basada en el entorno
...
- **Documentación de integración**: [Integrar con SDKs de inferencia](https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/how-to/how-to-integrate-with-inference-sdks)
