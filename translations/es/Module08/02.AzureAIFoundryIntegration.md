...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T12:57:21+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "es"
}
-->
# Sesión 2: Crear Soluciones de IA con Azure AI Foundry

## Descripción General

Basándote en los fundamentos de Foundry Local, esta sesión se centra en desarrollar soluciones avanzadas de IA mediante técnicas avanzadas de ingeniería de prompts, integración fluida de datos y automatización de tareas accionables. Aprenderás a conectar el desarrollo local con las capacidades de Azure AI Foundry, creando aplicaciones empresariales que aprovechan lo mejor de ambos mundos.

## Objetivos de Aprendizaje

Al finalizar esta sesión, podrás:
- Dominar técnicas avanzadas de ingeniería de prompts para obtener respuestas consistentes y confiables de la IA
- Implementar patrones sólidos de integración de datos para aplicaciones reales
- Crear tareas accionables de IA que generen valor para el negocio
- Establecer una conectividad fluida entre Foundry Local y Azure AI Foundry
- Construir flujos de trabajo para monitoreo y optimización del rendimiento
- Desplegar soluciones de IA listas para producción con manejo adecuado de errores y escalabilidad

## Requisitos Previos

- Haber completado la Sesión 1: Introducción a Foundry Local
- Instalación activa de Foundry Local con modelos en ejecución
- Cuenta de Azure (el nivel gratuito es suficiente para el aprendizaje)
- Comprensión básica de REST APIs y JSON

## Parte 1: Ingeniería Avanzada de Prompts

### Comprender la Arquitectura de Prompts

La ingeniería efectiva de prompts es la base de las aplicaciones confiables de IA. Foundry Local ofrece capacidades mejoradas para la creación de prompts:
...
### Implementación de Estrategias de Prompts
...
## Parte 2: Patrones de Integración de Datos

### Conectores de Datos de Foundry Local
...
### Ejemplo de Integración de Datos en el Mundo Real
...
## Parte 3: Tareas de IA Accionables

### Marco de Automatización de Tareas
...
## Parte 4: Integración con Azure AI Foundry

### Estableciendo la Conectividad
...
## Parte 5: Monitoreo y Optimización del Rendimiento
...
### Ejercicio 1: Bot Avanzado de Atención al Cliente
...
### Ejercicio 2: Investigación de Mercado Automatizada
...
## Parte 7: Próximos Pasos y Vista Previa de la Sesión 3

### Logros de la Sesión

En esta sesión, has dominado:
- ✅ Técnicas avanzadas de ingeniería de prompts para un comportamiento consistente de la IA
- ✅ Patrones sólidos de integración de datos para aplicaciones reales
- ✅ Creación de tareas automatizadas para la optimización de procesos empresariales
- ✅ Estrategias de integración con Azure AI Foundry y despliegue híbrido
- ✅ Monitoreo y optimización integral del rendimiento

### Preparación para la Sesión 3: Modelos de Código Abierto

1. **Explora Hugging Face**: Crea una cuenta y navega por el catálogo de modelos
2. **Revisa Model Mondays**: Consulta la última serie [Model Mondays](https://aka.ms/model-mondays)
3. **Planifica Modelos Personalizados**: Considera qué modelos especializados beneficiarían tus casos de uso

### Recursos Adicionales

- [Documentación de Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Repositorio de GitHub de Foundry Local](https://github.com/microsoft/Foundry-Local)
- [Guía Avanzada de Ingeniería de Prompts](https://platform.openai.com/docs/guides/prompt-engineering)
- [Mejores Prácticas de Automatización de Procesos Empresariales](https://docs.microsoft.com/en-us/power-automate/)

Ahora estás preparado para construir soluciones avanzadas de IA que combinan el poder de la inferencia local con capacidades a escala en la nube, estableciendo la base para aplicaciones empresariales de IA de alto nivel.
