...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T12:42:28+00:00",
...
Microsoft Olive es una herramienta de optimización de modelos de aprendizaje automático, fácil de usar y consciente del hardware, que simplifica el proceso de optimización para el despliegue en diferentes plataformas de hardware. Ya sea que estés trabajando con CPUs, GPUs o aceleradores de IA especializados, Olive te ayuda a lograr un rendimiento óptimo mientras mantiene la precisión del modelo.
...
- **Soporte para Modelos Populares**: Olive puede optimizar automáticamente arquitecturas de modelos populares como Llama, Phi, Qwen, Gemma, entre otros.
...
- **Despliegue Multiplataforma**: Los modelos optimizados funcionan en diferentes hardware y sistemas operativos.
...
Basado en el ejemplo proporcionado por Hugging Face en [lokinfey/Qwen3-8B-ONNX-INT4-CPU](https://huggingface.co/lokinfey/Qwen3-8B-ONNX-INT4-CPU), aquí te mostramos cómo optimizar un modelo Qwen3:
...
- Ajusta tu objetivo de optimización al hardware de despliegue.
...
- **Extensión de VS Code**: Descripción general del AI Toolkit para VS Code — https://learn.microsoft.com/azure/ai-toolkit/overview
