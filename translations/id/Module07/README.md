...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T22:23:11+00:00",
...
NVIDIA Jetson Orin Nano adalah terobosan dalam komputasi Edge AI yang terjangkau, memberikan performa AI hingga 67 TOPS dalam bentuk yang kecil seukuran kartu kredit. Platform Edge AI yang kuat ini mendemokratisasi pengembangan AI generatif untuk para hobiis, pelajar, dan pengembang profesional.
...
- Mendukung berbagai akselerator perangkat keras yang disesuaikan untuk perangkat mobile, termasuk CPU, GPU, dan prosesor AI khusus mobile
...
### Kasus Penggunaan
Implementasi Azure EdgeAI unggul dalam skenario yang membutuhkan penerapan AI tingkat perusahaan dengan kemampuan manajemen cloud. Ini termasuk pemrosesan dokumen cerdas, analitik waktu nyata, dan alur kerja AI hybrid yang memanfaatkan sumber daya komputasi cloud dan edge.
...
- [Windows EdgeAI Development Guide](../windowdeveloper.md) - Panduan lengkap untuk pengembangan Windows Edge AI

## 5. EdgeAI dengan Aplikasi Lokal Foundry
