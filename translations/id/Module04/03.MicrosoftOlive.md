...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T22:22:47+00:00",
...
Microsoft Olive adalah toolkit optimasi model yang kuat dan mudah digunakan, dirancang untuk perangkat keras tertentu. Olive mempermudah proses optimasi model pembelajaran mesin untuk diterapkan di berbagai platform perangkat keras. Baik Anda menargetkan CPU, GPU, atau akselerator AI khusus, Olive membantu Anda mencapai kinerja optimal sambil mempertahankan akurasi model.

## Apa itu Microsoft Olive?

Olive adalah alat optimasi model yang mudah digunakan dan dirancang untuk perangkat keras tertentu. Olive menggabungkan teknik-teknik terdepan di industri dalam kompresi model, optimasi, dan kompilasi. Olive bekerja dengan ONNX Runtime sebagai solusi optimasi inferensi E2E.
...
- **Dukungan Model Populer**: Olive dapat secara otomatis mengoptimalkan arsitektur model populer seperti Llama, Phi, Qwen, Gemma, dll.
...
- **Masalah GitHub**: [github.com/microsoft/Olive/issues](https://github.com/microsoft/Olive/issues)
...
- **Postingan Blog**: Blog Open Source Microsoft — https://opensource.microsoft.com/blog/
