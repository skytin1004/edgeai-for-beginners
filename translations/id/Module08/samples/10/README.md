...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T03:12:00+00:00",
...
Kerangka kerja komprehensif untuk mengintegrasikan Microsoft Foundry Local sebagai alat yang dapat dipanggil dalam aplikasi yang lebih besar, sesuai dengan pola resmi Microsoft untuk integrasi AI berbasis alat.

## Gambaran Umum

Contoh ini menunjukkan cara mengekspos model Foundry Local sebagai alat yang dapat digunakan kembali dan diintegrasikan ke dalam aplikasi, alur kerja, dan lingkungan pengembangan yang ada. Contoh ini menampilkan pola yang direkomendasikan Microsoft untuk integrasi alat dan pemanggilan fungsi.

## Konsep Utama

### 🔧 **Arsitektur Berbasis Alat**
- Model Foundry Local sebagai fungsi yang dapat dipanggil
- Antarmuka dan skema alat yang terstandarisasi
- Integrasi mulus dengan basis kode yang ada
- Definisi alat yang aman tipe dan validasi

### ⚡ **Pola Pemanggilan Fungsi**
- Implementasi pemanggilan fungsi Microsoft Foundry Local
- Definisi alat yang kompatibel dengan OpenAI
- Validasi dan konversi parameter otomatis
- Penanganan kesalahan dan pemformatan respons

### 🔌 **Kerangka Integrasi**
- **Integrasi LangChain**: Dukungan alat LangChain secara native
- **Semantic Kernel**: Fungsi Microsoft Semantic Kernel
- **REST API**: Endpoint alat berbasis HTTP
- **Alat CLI**: Integrasi antarmuka baris perintah
- **Jupyter Notebooks**: Alat pengembangan interaktif

### 🎯 **Pola Kasus Penggunaan**
- Alat analisis dan pembuatan kode
- Pemrosesan dan ringkasan konten
- Analisis dan visualisasi data
- Penelitian dan pengambilan informasi
...
- **Memori**: Direkomendasikan 12GB+
- **Penyimpanan**: 10GB+ untuk model dan alat
...
### Ketergantungan Khusus Kerangka
```bash
...
### Integrasi Antarmuka Baris Perintah
```python
import typer
...
1. **Pola Integrasi Alat**
   - Desain alat berbasis fungsi dan berbasis kelas
   - Pola integrasi Microsoft Foundry Local
   - Validasi skema dan keamanan tipe
   - Penanganan kesalahan dan pemulihan

2. **Integrasi Kerangka**
   - Pengembangan alat LangChain
   - Integrasi fungsi Semantic Kernel
   - Integrasi kerangka REST API
   - Pengembangan aplikasi CLI

3. **Pertimbangan Produksi**
   - Strategi optimasi performa
   - Caching dan pengelolaan sumber daya
   - Pemantauan dan observabilitas
   - Keamanan dan validasi

4. **Pola Alat Lanjutan**
   - Komposisi dan rantai alat
   - Pemrosesan yang sadar konteks
   - Operasi batch dan streaming
   - Pengembangan integrasi khusus

## Langkah Selanjutnya

- **Proyek Integrasi**: Bangun integrasi khusus dengan kerangka kerja pilihan Anda
- **Pengembangan Alat**: Buat alat khusus untuk domain Anda
- **Penyetelan Performa**: Optimalkan untuk kasus penggunaan spesifik Anda
- **Penerapan Produksi**: Skalakan alat untuk penggunaan di tingkat perusahaan
