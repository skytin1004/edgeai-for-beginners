...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T00:42:04+00:00",
...
Melanjutkan dasar Foundry Local Anda, sesi ini berfokus pada pola integrasi OpenAI SDK tingkat lanjut yang mendukung Microsoft Foundry Local dan Azure OpenAI secara mulus. Anda akan menguasai seni membangun aplikasi AI yang fleksibel, yang dapat berjalan secara lokal untuk privasi dan pengembangan, sambil menyediakan skalabilitas cloud melalui Azure OpenAI saat diperlukan.

## Tujuan Pembelajaran

Pada akhir sesi ini, Anda akan:
- Menguasai integrasi OpenAI SDK tingkat lanjut dengan Foundry Local dan Azure OpenAI
- Menerapkan respons streaming untuk pengalaman pengguna yang lebih baik
- Membuat pola client factory yang tangguh untuk mendukung multi-provider
- Membangun sistem manajemen percakapan dengan pelestarian konteks
- Menetapkan pengukuran kinerja dan pemantauan kesehatan
- Meluncurkan aplikasi siap produksi dengan penanganan kesalahan yang tepat

## Prasyarat

- Menyelesaikan Sesi 1: Memulai dengan Foundry Local
- Instalasi Foundry Local aktif dengan model yang berjalan
- Python 3.8 atau lebih baru dengan kemampuan virtual environment
- OpenAI Python SDK terinstal (`pip install openai foundry-local-sdk`)
- Akun Azure dengan layanan OpenAI (opsional, untuk skenario cloud)
- Pemahaman dasar tentang pola Python async/await

## Bagian 1: Pola Client Factory OpenAI SDK

### Memahami Arsitektur Multi-Provider

Membangun aplikasi yang bekerja dengan Foundry Local dan Azure OpenAI membutuhkan pola pembuatan client yang fleksibel:
...
## Bagian 2: Respons Streaming dan Interaksi Real-time

### Menerapkan Streaming Chat Completions

Streaming memberikan pengalaman pengguna yang lebih baik dengan menampilkan respons saat sedang dibuat:
...
### Manajemen Percakapan Multi-turn
...
## Bagian 3: Pengukuran Kinerja dan Analisis

### Pengukuran Waktu Respons

Mengukur dan membandingkan kinerja di berbagai konfigurasi:
...
### Pengujian Parameter dan Temperatur
...
## Bagian 4: Pemantauan Kesehatan Layanan dan Diagnostik

### Sistem Pemeriksaan Kesehatan Komprehensif
...
### Validator Konfigurasi Lingkungan
...
## Bagian 5: Variabel Lingkungan dan Manajemen Konfigurasi

### Referensi Variabel Lingkungan

Referensi lengkap untuk mengonfigurasi kedua provider:
...
**Pengaturan Windows Command Prompt:**
...
## Bagian 6: Latihan Praktis

### Latihan 1: Integrasi SDK Multi-Provider

Bangun aplikasi lengkap yang dapat beralih dengan mulus antara provider:
...
### Latihan 2: Manajemen Percakapan Tingkat Lanjut
...
### Latihan 3: Pemantauan Kesehatan Siap Produksi
...
## Bagian 7: Ringkasan dan Langkah Selanjutnya

### Pencapaian Sesi

Dalam sesi ini, Anda telah menguasai:
- ✅ **Integrasi OpenAI SDK**: Pola tingkat lanjut untuk Foundry Local dan Azure OpenAI
- ✅ **Respons Streaming**: Chat completions real-time untuk pengalaman pengguna yang lebih baik
- ✅ **Dukungan Multi-Provider**: Pergantian mulus antara layanan AI lokal dan cloud
- ✅ **Manajemen Percakapan**: Percakapan multi-turn yang sadar konteks
- ✅ **Pemantauan Kinerja**: Benchmarking dan pemeriksaan kesehatan untuk deployment produksi
- ✅ **Pola Produksi**: Penanganan kesalahan yang tangguh dan manajemen konfigurasi
...
1. **🔄 Selalu Terapkan Fallbacks**: Azure → Foundry Local → Penanganan kesalahan
2. **🌊 Gunakan Streaming untuk Respons Panjang**: Kinerja yang lebih baik secara persepsi
3. **🛡️ Terapkan Penanganan Kesalahan Komprehensif**: Pesan kesalahan yang ramah pengguna
4. **📈 Pantau Kinerja**: Lacak waktu respons dan tingkat keberhasilan
5. **⚙️ Konfigurasi Berbasis Lingkungan**: Pergantian mudah antara dev/staging/prod
6. **🔒 Manajemen Kredensial yang Aman**: Jangan pernah hardcode API key

### Panduan Pemilihan Provider

| Skenario | Provider yang Direkomendasikan | Alasan |
|----------|---------------------|----------|
| **Pengembangan** | Foundry Local | Iterasi cepat, tanpa biaya API |
| **Privasi-Kritis** | Foundry Local | Data tidak pernah meninggalkan perangkat |
| **Produksi Volume Tinggi** | Azure OpenAI | Skalabilitas lebih baik, SLA enterprise |
| **Model Terbaru** | Azure OpenAI | Akses ke rilis model terbaru |
| **Kebutuhan Offline** | Foundry Local | Tidak bergantung pada internet |
| **Sensitif Biaya** | Foundry Local | Tanpa biaya per-token |
...
### Persiapan untuk Sesi 3: Model Open-Source

1. **Jelajahi Katalog Model**: Tinjau model yang tersedia di Foundry Local
2. **Pahami Format Model**: Pelajari tentang ONNX, kuantisasi, dan optimasi
3. **Pertimbangkan Model Kustom**: Pikirkan tentang kebutuhan model spesifik domain
...
- **[Dokumentasi OpenAI Python SDK](https://github.com/openai/openai-python)**: Referensi SDK resmi
- **[Dokumentasi Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/)**: Panduan layanan Azure OpenAI
- **[Referensi SDK Foundry Local](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Dokumentasi inferensi lokal
- **[Panduan Streaming Completions](https://learn.microsoft.com/azure/ai-foundry/foundry-local/how-to/integrate-with-inference-sdks)**: Pola streaming tingkat lanjut
- **[Contoh 01: Chat Cepat via OpenAI SDK](samples/01/README.md)**: Pola integrasi dasar
- **[Contoh 02: Integrasi SDK Tingkat Lanjut](samples/02/README.md)**: Contoh praktis sesi ini
- **[Contoh 04: Aplikasi Chainlit](samples/04/README.md)**: Pengembangan UI web
- **[Contoh 05: Sistem Multi-Agent](samples/05/README.md)**: Pola orkestrasi tingkat lanjut

Anda sekarang siap untuk membangun aplikasi AI yang canggih yang mengintegrasikan kemampuan AI lokal dan cloud secara mulus, memberikan fleksibilitas untuk memilih provider yang tepat untuk setiap kasus penggunaan spesifik sambil mempertahankan pola pengembangan yang konsisten.
