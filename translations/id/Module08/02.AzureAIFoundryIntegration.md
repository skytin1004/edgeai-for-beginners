...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T22:40:22+00:00",
...
Melanjutkan dasar-dasar Foundry Local, sesi ini berfokus pada pembuatan solusi AI canggih melalui teknik rekayasa prompt yang lebih maju, integrasi data yang mulus, dan otomatisasi tugas yang dapat ditindaklanjuti. Anda akan belajar menghubungkan pengembangan lokal dengan kemampuan Azure AI Foundry, menciptakan aplikasi siap perusahaan yang memanfaatkan keunggulan dari kedua dunia.

## Tujuan Pembelajaran

Pada akhir sesi ini, Anda akan:
- Menguasai teknik rekayasa prompt tingkat lanjut untuk respons AI yang konsisten dan andal
- Menerapkan pola integrasi data yang kuat untuk aplikasi dunia nyata
- Membuat tugas AI yang dapat ditindaklanjuti untuk memberikan nilai bisnis
- Membangun konektivitas yang mulus antara Foundry Local dan Azure AI Foundry
- Membuat alur kerja pemantauan dan optimasi kinerja
- Meluncurkan solusi AI siap produksi dengan penanganan kesalahan dan skalabilitas yang tepat

## Prasyarat

- Menyelesaikan Sesi 1: Memulai dengan Foundry Local
- Instalasi Foundry Local aktif dengan model yang berjalan
- Akun Azure (tingkat gratis cukup untuk pembelajaran)
- Pemahaman dasar tentang REST API dan JSON

## Bagian 1: Rekayasa Prompt Tingkat Lanjut

### Memahami Arsitektur Prompt

Rekayasa prompt yang efektif adalah dasar dari aplikasi AI yang andal. Foundry Local menyediakan kemampuan prompting yang ditingkatkan:
...
### Contoh Praktis Rekayasa Prompt
...
## Bagian 2: Pola Integrasi Data

### Konektor Data Foundry Local
...
### Contoh Integrasi Data Dunia Nyata
...
## Bagian 3: Tugas AI yang Dapat Ditindaklanjuti

### Kerangka Otomatisasi Tugas
...
## Bagian 4: Integrasi Azure AI Foundry
...
## Bagian 5: Pemantauan dan Optimasi Kinerja
...
### Latihan 1: Bot Layanan Pelanggan Tingkat Lanjut
...
### Latihan 2: Riset Pasar Otomatis
...
## Bagian 7: Langkah Selanjutnya dan Pratinjau Sesi 3

### Pencapaian Sesi

Dalam sesi ini, Anda telah menguasai:
- ✅ Teknik rekayasa prompt tingkat lanjut untuk perilaku AI yang konsisten
- ✅ Pola integrasi data yang kuat untuk aplikasi dunia nyata
- ✅ Pembuatan tugas otomatis untuk optimasi proses bisnis
- ✅ Integrasi Azure AI Foundry dan strategi penerapan hybrid
- ✅ Pemantauan dan optimasi kinerja yang komprehensif

### Persiapan untuk Sesi 3: Model Open-Source

1. **Jelajahi Hugging Face**: Buat akun dan telusuri katalog model
2. **Tinjau Model Mondays**: Lihat seri terbaru [Model Mondays](https://aka.ms/model-mondays)
3. **Rencanakan Model Kustom**: Pertimbangkan model khusus apa yang akan menguntungkan kasus penggunaan Anda
...
- [Panduan Rekayasa Prompt Tingkat Lanjut](https://platform.openai.com/docs/guides/prompt-engineering)
- [Praktik Terbaik Otomatisasi Proses Bisnis](https://docs.microsoft.com/en-us/power-automate/)

Anda sekarang siap untuk membangun solusi AI canggih yang menggabungkan kekuatan inferensi lokal dengan kemampuan skala cloud, meletakkan dasar untuk aplikasi AI tingkat perusahaan.
