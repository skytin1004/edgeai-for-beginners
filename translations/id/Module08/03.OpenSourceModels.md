...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T00:40:59+00:00",
...
- Ruang penyimpanan yang cukup untuk mengunduh model (ukuran model dapat berkisar dari 1GB hingga 20GB+)
...
2. **Coba berbagai model**: Uji setidaknya 3 model berbeda
...
✅ **Penemuan Model**: Gunakan `foundry model list` untuk menjelajahi model yang tersedia  
...
- Mengkompilasi dan menjalankan model Hugging Face tertentu dalam Foundry Local
...
### Perintah Dasar Pengelolaan Model
...
- `phi-4-mini`: Cepat, efisien, bagus untuk obrolan umum
- `phi-4`: Versi yang lebih mampu dengan penalaran yang lebih baik

**Model Menengah:**
- `qwen2.5-7b-instruct`: Penalaran yang sangat baik dan konteks yang lebih panjang
- `deepseek-r1-distill-qwen-7b`: Dioptimalkan untuk pembuatan kode

**Model Besar:**
- `llama-3.2`: Model open-source terbaru dari Meta
- `qwen2.5-14b-instruct`: Penalaran tingkat perusahaan
...
- Pertimbangkan trade-off ukuran model vs kemampuan
...
- Direkomendasikan: `deepseek-r1-distill-qwen-7b`
- Alternatif: `qwen2.5-7b-instruct` (juga bagus untuk kode)
