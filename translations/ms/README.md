...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T00:45:48+00:00",
...
Selamat datang ke **EdgeAI untuk Pemula** – perjalanan komprehensif anda ke dunia transformasi Kecerdasan Buatan di Edge. Kursus ini menghubungkan keupayaan AI yang hebat dengan pelaksanaan praktikal di peranti edge, membolehkan anda memanfaatkan potensi AI secara langsung di tempat data dihasilkan dan keputusan perlu dibuat.
...
- **Inferens masa nyata** dengan keupayaan menjaga privasi
...
| [💻 07](../../Module07) | [Pelaksanaan Platform](./Module07/README.md) | Sampel merentas platform | Toolkit AI • Foundry Local • Pembangunan Windows | Lanjutan | 3-4 jam |
| [🏭 08](../../Module08) | [Toolkit Foundry Local](./Module08/README.md) | Sampel sedia pengeluaran | Aplikasi sampel (lihat butiran di bawah) | Pakar | 8-10 jam |
...
### 🎯 Kecekapan Teras
- **Seni Bina Edge AI**: Reka sistem AI yang berorientasikan tempatan dengan integrasi awan  
...
### 🏗️ Projek Praktikal
- **Aplikasi Chat Foundry Local**: Aplikasi asli Windows 11 dengan penukaran model  
...
2. **⚙️ Pengoptimuman** (Modul 03-04): Pelaksanaan + rangka kerja kuantisasi  
3. **🚀 Pengeluaran** (Modul 05-06): SLMOps + ejen AI + panggilan fungsi  
4. **💻 Pelaksanaan** (Modul 07-08): Sampel platform + toolkit Foundry Local  

Setiap modul termasuk teori, latihan praktikal, dan sampel kod sedia pengeluaran.

## Impak Kerjaya
**Peranan Teknikal**: EdgeAI Solutions Architect • ML Engineer (Edge) • IoT AI Developer • Mobile AI Developer

**Sektor Industri**: Pembuatan 4.0 • Teknologi Kesihatan • Sistem Autonomi • FinTech • Elektronik Pengguna

**Projek Portfolio**: Sistem multi-ejen • Aplikasi RAG pengeluaran • Penghantaran merentas platform • Pengoptimuman prestasi
...
✅ **Pembelajaran Progresif**: Teori → Praktikal → Penghantaran pengeluaran  
✅ **Kajian Kes Sebenar**: Microsoft, Japan Airlines, pelaksanaan perusahaan  
✅ **Contoh Praktikal**: 50+ contoh, 10 demo Foundry Local yang komprehensif  
✅ **Fokus Prestasi**: Peningkatan kelajuan 85%, pengurangan saiz 75%  
✅ **Pelbagai Platform**: Windows, mudah alih, tertanam, hibrid awan-tepi  
✅ **Sedia Pengeluaran**: Pemantauan, penskalaan, keselamatan, rangka kerja pematuhan

📖 **[Panduan Pembelajaran Tersedia](STUDY_GUIDE.md)**: Laluan pembelajaran berstruktur selama 20 jam dengan panduan peruntukan masa dan alat penilaian kendiri.

---

**EdgeAI mewakili masa depan penghantaran AI**: keutamaan tempatan, pemeliharaan privasi, dan cekap. Kuasai kemahiran ini untuk membangunkan aplikasi pintar generasi seterusnya.
