...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T13:30:37+00:00",
...
![Imej muka depan kursus](../../translated_images/cover.eb18d1b9605d754b30973f4e17c6e11ea4f8473d9686ee378d6e7b44e3c70ac7.ms.png)
...
Selamat datang ke **EdgeAI untuk Pemula** – perjalanan komprehensif anda ke dunia transformasi Kecerdasan Buatan (AI) di peranti tepi. Kursus ini merapatkan jurang antara keupayaan AI yang hebat dengan pelaksanaan praktikal di peranti tepi, membolehkan anda memanfaatkan potensi AI secara langsung di tempat data dihasilkan dan keputusan perlu dibuat.

### Apa yang Akan Anda Kuasai

Kursus ini membawa anda dari konsep asas hingga pelaksanaan sedia pengeluaran, meliputi:
- **Model Bahasa Kecil (SLM)** yang dioptimumkan untuk pelaksanaan di peranti tepi
- **Pengoptimuman perkakasan** merentasi pelbagai platform
- **Inferens masa nyata** dengan keupayaan pemeliharaan privasi
...
- **Prestasi Masa Nyata**: Menghapuskan latensi rangkaian untuk aplikasi kritikal masa
...
Edge AI merujuk kepada pelaksanaan algoritma AI dan model bahasa secara tempatan pada perkakasan—berhampiran dengan tempat data dihasilkan—tanpa bergantung pada sumber awan untuk inferens. Ia mengurangkan latensi, meningkatkan privasi, dan membolehkan pembuatan keputusan masa nyata.

### Prinsip Teras:
- **Inferens pada peranti**: Model AI dijalankan pada peranti tepi (telefon, penghala, mikrokontroler, PC industri)
...
- **Jejak memori yang dikurangkan**: Penggunaan memori peranti tepi yang terhad secara efisien
- **Permintaan pengiraan yang lebih rendah**: Dioptimumkan untuk prestasi CPU dan GPU tepi
...
- **Pelayan tepi**: Unit pemprosesan tempatan dengan sumber GPU terhad
- **Komputer Peribadi**: Senario pelaksanaan pada desktop dan komputer riba

## Seni Bina Kursus

### [Modul 01: Asas dan Transformasi EdgeAI](./Module01/README.md)
**Tema**: Peralihan transformasi pelaksanaan AI di peranti tepi

#### Struktur Bab:
- [**Bahagian 1: Asas EdgeAI**](./Module01/01.EdgeAIFundamentals.md)
  - Perbandingan AI awan tradisional vs AI tepi
  - Cabaran dan kekangan pengkomputeran tepi
  - Teknologi utama: kuantisasi model, pengoptimuman pemampatan, Model Bahasa Kecil (SLM)
  - Pecutan perkakasan: NPU, pengoptimuman GPU, pengoptimuman CPU
  - Kelebihan: keselamatan privasi, latensi rendah, keupayaan luar talian, kecekapan kos

- [**Bahagian 2: Kajian Kes Dunia Sebenar**](./Module01/02.RealWorldCaseStudies.md)
  - Ekosistem model Microsoft Phi & Mu
  - Kajian kes sistem pelaporan AI Japan Airlines
  - Kesan pasaran dan arah masa depan
...
- [**Bahagian 4: Platform Perkakasan Pelaksanaan Edge AI**](./Module01/04.EdgeDeployment.md)
  - Pertimbangan dan keperluan pelaksanaan AI tepi
  - Perkakasan AI tepi Intel dan teknik pengoptimuman
  - Penyelesaian AI Qualcomm untuk sistem mudah alih dan terbenam
  - NVIDIA Jetson dan platform pengkomputeran tepi
...
- [**Bahagian 1: Asas Keluarga Model Microsoft Phi**](./Module02/01.PhiFamily.md)
  ...
  - Reka bentuk seni bina berasaskan kecekapan
  - Keupayaan khusus (penaakulan, multimodal, pelaksanaan tepi)
...
- [**Bahagian 2: Asas Keluarga Qwen**](./Module02/02.QwenFamily.md)
  ...
  - Seni bina penaakulan lanjutan dengan keupayaan mod pemikiran
...
- [**Bahagian 3: Asas Keluarga Gemma**](./Module02/03.GemmaFamily.md)
  ...
  - Seni bina berorientasikan mudah alih
...
- [**Bahagian 4: Asas Keluarga BitNET**](./Module02/04.BitNETFamily.md)
  ...
  - Kepimpinan AI mampan melalui kecekapan melampau

- [**Bahagian 5: Asas Model Microsoft Mu**](./Module02/05.mumodel.md)
  - Seni bina berorientasikan peranti yang dibina dalam Windows 11
  - Integrasi sistem dengan Tetapan Windows 11
  - Operasi luar talian yang memelihara privasi

- [**Bahagian 6: Asas Phi-Silica**](./Module02/06.phisilica.md)
  - Seni bina dioptimumkan NPU yang dibina dalam PC Windows 11 Copilot+
...
**Tema**: Kitaran hayat lengkap pelaksanaan SLM, dari teori hingga persekitaran pengeluaran
...
- [**Bahagian 1: Pembelajaran Lanjutan SLM**](./Module03/01.SLMAdvancedLearning.md)
  ...
  - Teknik pengoptimuman lanjutan (kaedah kuantisasi, kuantisasi 1-bit BitNET)
  - Strategi pemerolehan model (Azure AI Foundry untuk model Phi, Hugging Face untuk model terpilih)

- [**Bahagian 2: Pelaksanaan Persekitaran Tempatan**](./Module03/02.DeployingSLMinLocalEnv.md)
  - Pelaksanaan platform universal Ollama
  - Penyelesaian perusahaan tempatan Microsoft Foundry
...
- [**Bahagian 3: Pelaksanaan Awan Berkontena**](./Module03/03.DeployingSLMinCloud.md)
  ...
  - Pelaksanaan dioptimumkan tepi ONNX Runtime

---

### [Modul 04: Penukaran Format Model dan Kuantisasi](./Module04/README.md)
**Tema**: Alat pengoptimuman model lengkap untuk pelaksanaan tepi merentasi platform
...
- [**Bahagian 2: Panduan Pelaksanaan Llama.cpp**](./Module04/02.Llamacpp.md)
  ...
  - Penukaran format GGUF dan tahap kuantisasi (Q2_K hingga Q8_0)
...
- [**Bahagian 3: Microsoft Olive Optimization Suite**](./Module04/03.MicrosoftOlive.md)
  - Pengoptimuman model yang peka perkakasan dengan lebih 40 komponen terbina
  - Pengoptimuman automatik dengan kuantisasi dinamik dan statik
...
- [**Bahagian 5: Apple MLX Framework Deep Dive**](./Module04/05.AppleMLX.md)
  ...
  - Sokongan untuk LLaMA, Mistral, Phi-3, model Qwen terpilih
...
- [**Bahagian 1: Pengenalan kepada SLMOps**](./Module05/01.IntroduceSLMOps.md)
  ...
  - Cabaran pelaksanaan dunia sebenar dan penyelesaian
...
- [**Bahagian 1: Asas Agen AI dan Model Bahasa Kecil**](./Module06/01.IntroduceAgent.md)
  ...
  - Asas SLM dan strategi pengoptimuman (GGUF, kuantisasi, rangka kerja edge)
...
**Tema**: Pelaksanaan EdgeAI yang komprehensif merentas platform dan rangka kerja yang pelbagai
...
- [**Panduan Pembangunan EdgeAI Windows**](./Module07/windowdeveloper.md)
  - Gambaran keseluruhan platform Windows AI Foundry
...
- [**EdgeAI dalam Aplikasi Mudah Alih dengan .NET MAUI dan ONNX Runtime GenAI**](./Module07/README.md#2-edgeai-in-mobile-applications-with-net-maui-and-onnx-runtime-genai)
  ...
  - Pelaksanaan gelung AI generatif lengkap
...
- [**EdgeAI dengan Aplikasi Foundry Local**](./Module07/README.md#5-edgeai-with-foundry-local-applications)
  ...
  - Integrasi model bahasa Phi-3 dengan carian semantik (model Phi sahaja)
...
Dengan melengkapkan kursus EdgeAI yang komprehensif ini, anda akan membangunkan kepakaran untuk mereka bentuk, melaksanakan, dan menyebarkan penyelesaian EdgeAI yang sedia pengeluaran. Pendekatan berstruktur kami memastikan anda menguasai asas teori dan kemahiran pelaksanaan praktikal.

### Kompetensi Teknikal

**Pengetahuan Asas**
- Memahami perbezaan asas antara seni bina AI berasaskan cloud dan berasaskan edge
- Menguasai prinsip kuantisasi model, pemampatan, dan pengoptimuman untuk persekitaran yang terhad sumber
...
- Mereka bentuk seni bina EdgeAI yang boleh diskalakan untuk aplikasi perusahaan
...
## Gambaran Keseluruhan Hasil Pembelajaran
...
- Memiliki pandangan masa depan yang bersedia untuk seni bina AI yang cekap
...
- Keupayaan pemilihan pengoptimuman peka perkakasan merentas platform yang pelbagai
- Kemahiran penyebaran pengeluaran untuk persekitaran pengkomputeran edge merentas platform
- Sintesis rangka kerja strategik dan aliran kerja untuk penyelesaian Edge AI yang optimum

### Hasil Pembelajaran Modul 05:
- Menguasai paradigma SLMOps dan prinsip operasi
...
- Memahami konsep asas seni bina agen AI dan Model Bahasa Kecil
...
- Menguasai Toolkit AI untuk Visual Studio Code untuk aliran kerja pembangunan Edge AI yang komprehensif
...
- Menguasai teknik pengoptimuman khusus perkakasan merentas platform NVIDIA, mudah alih, Azure, dan Windows
...
**Kepimpinan Teknikal**
- **Seni Bina Penyelesaian**: Mereka bentuk sistem EdgeAI yang komprehensif yang memenuhi keperluan perusahaan
...
- **Operasi Pengeluaran**: Menyenggara dan menskalakan sistem EdgeAI dengan kebolehpercayaan gred perusahaan
...
- **Pengurusan Risiko**: Mengenal pasti dan mengurangkan risiko teknikal dan operasi dalam penyebaran EdgeAI
- **Pengoptimuman ROI**: Menunjukkan nilai perniagaan yang boleh diukur daripada pelaksanaan EdgeAI

### Peluang Kemajuan Kerjaya

**Peranan Profesional**
- Arkitek Penyelesaian EdgeAI
- Jurutera Pembelajaran Mesin (Pengkhususan Edge)
- Pembangun AI IoT
...
- Teknologi Penjagaan Kesihatan dan Peranti Perubatan
...
- Menyelesaikan projek EdgeAI hujung ke hujung yang menunjukkan kecekapan praktikal
- Menyebarkan penyelesaian sedia pengeluaran merentas pelbagai platform perkakasan
- Mendokumentasikan strategi pengoptimuman dan penambahbaikan prestasi yang dicapai

**Laluan Pembelajaran Berterusan**
- Asas untuk pengkhususan AI lanjutan
- Persediaan untuk seni bina hibrid cloud-edge
- Pintu masuk kepada teknologi dan rangka kerja AI yang muncul
Kursus ini meletakkan anda di barisan hadapan dalam penerapan teknologi AI, di mana keupayaan pintar diintegrasikan dengan lancar ke dalam peranti dan sistem yang menggerakkan kehidupan moden.
...
- **Pembelajaran Berperingkat**: Maju secara beransur-ansur daripada konsep asas kepada penerapan yang lebih maju
- **Integrasi Teori dan Praktikal**: Setiap modul mengandungi asas teori dan operasi praktikal
- **Kajian Kes Sebenar**: Berdasarkan kes sebenar daripada Microsoft, Alibaba, Google, dan lain-lain
- **Latihan Praktikal**: Lengkapkan fail konfigurasi, prosedur ujian API, dan skrip penerapan
- **Penanda Aras Prestasi**: Perbandingan terperinci kelajuan inferens, penggunaan memori, dan keperluan sumber
- **Pertimbangan Tahap Perusahaan**: Amalan keselamatan, rangka kerja pematuhan, dan strategi perlindungan data
...
3. Pelajari **Module03** untuk menguasai kemahiran penerapan praktikal
4. Lanjutkan dengan **Module04** untuk pengoptimuman model lanjutan, penukaran format, dan sintesis rangka kerja
5. Lengkapkan **Module05** untuk menguasai SLMOps bagi penerapan yang sedia untuk pengeluaran
6. Terokai **Module06** untuk memahami sistem agen SLM dan keupayaan pemanggilan fungsi
7. Akhiri dengan **Module07** untuk mendapatkan pengalaman praktikal dengan AI Toolkit dan pelbagai contoh penerapan EdgeAI

Setiap modul direka untuk lengkap secara bebas, tetapi pembelajaran secara berurutan akan memberikan hasil terbaik.

## Panduan Pembelajaran

Panduan Pembelajaran [Study Guide](STUDY_GUIDE.md) yang komprehensif tersedia untuk membantu anda memaksimumkan pengalaman pembelajaran anda. Panduan pembelajaran ini menyediakan:
...
- **Fokus Konsep Utama**: Objektif pembelajaran yang diprioritaskan untuk setiap modul
- **Alat Penilaian Kendiri**: Soalan dan latihan untuk menguji pemahaman anda
- **Idea Mini-Projek**: Aplikasi praktikal untuk mengukuhkan pembelajaran anda

Panduan pembelajaran ini direka untuk menampung pembelajaran intensif (1 minggu) dan pembelajaran separuh masa (3 minggu), dengan panduan jelas tentang cara mengatur masa anda dengan berkesan walaupun anda hanya boleh meluangkan 10 jam untuk kursus ini.

---

**Masa depan EdgeAI terletak pada peningkatan berterusan seni bina model, teknik kuantisasi, dan strategi penerapan yang mengutamakan kecekapan dan pengkhususan berbanding keupayaan serba guna. Organisasi yang menerima perubahan paradigma ini akan berada dalam kedudukan yang baik untuk memanfaatkan potensi transformasi AI sambil mengekalkan kawalan ke atas data dan operasi mereka.**
