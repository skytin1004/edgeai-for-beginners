...
Contoh ini mempamerkan cara membina sistem ejen AI yang canggih menggunakan Foundry Local, dengan melaksanakan corak rasmi Microsoft untuk pemanggilan fungsi, orkestrasi ejen, dan aliran kerja AI kolaboratif.
...
### 🤖 **Koordinasi Ejen Pintar**
- Analisis tugas dinamik dan pemilihan ejen
- Pengagihan beban kerja secara automatik
- Penggabungan dan sintesis hasil
- Protokol komunikasi antara ejen

### 🔧 **Jenis Ejen Khusus**
- **Pakar Kod**: Pengaturcaraan, penyahpepijatan, semakan kod
- **Penganalisis Data**: Pemprosesan data, visualisasi, pandangan
- **Pembantu Penyelidikan**: Pengumpulan maklumat, ringkasan
- **Pakar Penulisan**: Penciptaan kandungan, penyuntingan, dokumentasi
- **Penyelesai Masalah**: Penaakulan kompleks, membuat keputusan

### ⚡ **Pemanggilan Fungsi Lanjutan**
- Corak pemanggilan fungsi Microsoft Foundry Local
- Definisi alat yang selamat jenis
- Pengesahan parameter automatik
- Pengendalian ralat dan pemulihan
- Rantaian dan komposisi alat

### 🎯 **Penghalaan Tugas Pintar**
- Pengelasan dan analisis niat
- Padanan keupayaan ejen
- Pengimbangan beban dan pengoptimuman
- Pengendalian sandaran dan redundansi

## Prasyarat

### Keperluan Sistem
- **Python**: 3.9+ dengan sokongan asyncio
- **Memori**: 16GB+ disyorkan untuk pelbagai ejen
- **Storan**: 15GB+ untuk pelbagai model
- **CPU/GPU**: Pemproses berbilang teras, GPU disyorkan
...
### 1. Aliran Kerja Multi-Ejen Asas
```python
...
## Penjelasan Mendalam Jenis Ejen
...
### Contoh 1: Aliran Kerja Pembangunan Perisian
```python
...
### Contoh 2: Penyelidikan dan Analisis
```python
...
### Contoh 3: Sesi Penyelesaian Masalah
```python
...
1. **Seni Bina Sistem Multi-Ejen**
   - Corak koordinasi ejen
   - Strategi pengagihan tugas
   - Teknik sintesis hasil
   - Pengurusan konteks antara ejen

2. **Integrasi Microsoft Foundry Local**
   - Pelaksanaan pemanggilan fungsi
   - Corak integrasi alat
   - Orkestrasi pelbagai model
   - Pengoptimuman prestasi

3. **Orkestrasi AI Lanjutan**
   - Reka bentuk dan pelaksanaan aliran kerja
   - Mekanisme jaminan kualiti
   - Pengendalian ralat dan pemulihan
   - Pertimbangan skalabiliti

4. **Reka Bentuk Sistem Pengeluaran**
   - Pemantauan dan analitik
...
- **Topik Lanjutan**: Pembangunan ejen tersuai
- **Skalabiliti**: Sistem ejen teragih
- **Integrasi**: Integrasi aliran kerja perusahaan
