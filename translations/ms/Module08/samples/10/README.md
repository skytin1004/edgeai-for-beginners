...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T03:12:12+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "ms"
}
-->
# Foundry Local sebagai Integrasi Alat

Kerangka kerja komprehensif untuk mengintegrasikan Microsoft Foundry Local sebagai alat yang boleh dipanggil dalam aplikasi yang lebih besar, mengikut pola rasmi Microsoft untuk integrasi AI berasaskan alat.

## Gambaran Keseluruhan

Contoh ini menunjukkan cara untuk mendedahkan model Foundry Local sebagai alat yang boleh digunakan semula dan diintegrasikan ke dalam aplikasi, aliran kerja, dan persekitaran pembangunan sedia ada. Ia mempamerkan pola yang disyorkan oleh Microsoft untuk integrasi alat dan pemanggilan fungsi.

## Konsep Utama

### 🔧 **Seni Bina Berasaskan Alat**
- Model Foundry Local sebagai fungsi yang boleh dipanggil
- Antara muka dan skema alat yang standard
- Integrasi lancar dengan pangkalan kod sedia ada
- Definisi alat yang selamat jenis dan pengesahan

### ⚡ **Pola Pemanggilan Fungsi**
- Pelaksanaan pemanggilan fungsi Microsoft Foundry Local
- Definisi alat yang serasi dengan OpenAI
- Pengesahan dan penukaran parameter secara automatik
- Pengendalian ralat dan pemformatan respons

### 🔌 **Kerangka Integrasi**
- **Integrasi LangChain**: Sokongan alat asli LangChain
- **Semantic Kernel**: Fungsi Microsoft Semantic Kernel
- **REST API**: Titik akhir alat berasaskan HTTP
- **Alat CLI**: Integrasi antara muka baris arahan
- **Jupyter Notebooks**: Alat pembangunan interaktif

### 🎯 **Pola Kes Penggunaan**
- Alat analisis dan penjanaan kod
- Pemprosesan kandungan dan ringkasan
- Analisis data dan visualisasi
- Penyelidikan dan pengambilan maklumat
...
### Keperluan Sistem
- **Python**: 3.9+ dengan sokongan asyncio
- **Node.js**: v18+ (untuk integrasi JavaScript)
- **Memori**: Disyorkan 12GB+
- **Storan**: 10GB+ untuk model dan alat
...
### Kebergantungan Khusus Kerangka
```bash
...
1. **Pola Integrasi Alat**
   - Reka bentuk alat berasaskan fungsi dan kelas
   - Pola integrasi Microsoft Foundry Local
   - Pengesahan skema dan keselamatan jenis
   - Pengendalian ralat dan pemulihan

2. **Integrasi Kerangka**
   - Pembangunan alat LangChain
   - Integrasi fungsi Semantic Kernel
   - Integrasi kerangka REST API
   - Pembangunan aplikasi CLI

3. **Pertimbangan Pengeluaran**
   - Strategi pengoptimuman prestasi
   - Pengurusan caching dan sumber
   - Pemantauan dan pemerhatian
   - Keselamatan dan pengesahan

4. **Pola Alat Lanjutan**
   - Komposisi dan rantaian alat
   - Pemprosesan sedar konteks
   - Operasi batch dan penstriman
   - Pembangunan integrasi tersuai

## Langkah Seterusnya

- **Projek Integrasi**: Bina integrasi tersuai dengan kerangka pilihan anda
- **Pembangunan Alat**: Cipta alat khusus untuk domain anda
- **Penalaan Prestasi**: Optimumkan untuk kes penggunaan spesifik anda
- **Pengeluaran**: Skala alat untuk penggunaan perusahaan

## Menyumbang

Lihat garis panduan repositori utama untuk arahan sumbangan.
