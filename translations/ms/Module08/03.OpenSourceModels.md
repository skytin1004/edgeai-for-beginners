...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-01T01:00:44+00:00",
...
Sesi ini memberi tumpuan kepada penemuan dan pengurusan model secara praktikal dengan Foundry Local. Anda akan belajar cara menyenaraikan model yang tersedia, menguji pilihan yang berbeza, dan memahami ciri prestasi asas. Pendekatan ini menekankan penerokaan secara langsung menggunakan CLI Foundry untuk membantu anda memilih model yang sesuai untuk kes penggunaan anda.
...
2. **Cuba model yang berbeza**: Uji sekurang-kurangnya 3 model yang berbeza
...
✅ **Pemantauan Prestasi**: Penggunaan sumber asas dan pengukuran masa respons  
✅ **Pemilihan Model**: Garis panduan praktikal untuk memilih model berdasarkan kes penggunaan  
...
Mulakan dengan model yang popular dan telah diuji untuk memahami ciri prestasi:
...
- `phi-4-mini`: Pantas, cekap, sesuai untuk perbualan umum
- `phi-4`: Versi yang lebih mampu dengan penaakulan yang lebih baik

**Model Sederhana:**
- `qwen2.5-7b`: Penaakulan yang sangat baik dan konteks yang lebih panjang
- `deepseek-r1-7b`: Dioptimumkan untuk penjanaan kod

**Model Lebih Besar:**
- `llama-3.2`: Model sumber terbuka terbaru dari Meta
- `qwen2.5-14b`: Penaakulan gred perusahaan
...
### Memilih Model Berdasarkan Kes Penggunaan

**Untuk Perbualan Umum dan Soal Jawab:**
...
**Untuk Penjanaan Kod:**
- Disyorkan: `deepseek-r1-7b`
- Alternatif: `qwen2.5-7b` (juga baik untuk kod)
