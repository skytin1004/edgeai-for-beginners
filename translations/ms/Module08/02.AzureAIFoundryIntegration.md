...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T22:40:31+00:00",
...
Berdasarkan asas Foundry Local anda, sesi ini memberi tumpuan kepada mencipta penyelesaian AI yang canggih melalui teknik kejuruteraan prompt yang maju, integrasi data yang lancar, dan automasi tugas yang boleh diambil tindakan. Anda akan belajar untuk menghubungkan pembangunan tempatan dengan keupayaan Azure AI Foundry, mencipta aplikasi bersedia untuk perusahaan yang memanfaatkan kelebihan kedua-dua dunia.

## Objektif Pembelajaran

Menjelang akhir sesi ini, anda akan:
- Menguasai teknik kejuruteraan prompt yang maju untuk respons AI yang konsisten dan boleh dipercayai
- Melaksanakan corak integrasi data yang kukuh untuk aplikasi dunia sebenar
- Mencipta tugas AI yang boleh diambil tindakan yang memacu nilai perniagaan
- Menjalin sambungan yang lancar antara Foundry Local dan Azure AI Foundry
- Membina aliran kerja pemantauan dan pengoptimuman prestasi
- Melancarkan penyelesaian AI bersedia untuk pengeluaran dengan pengendalian ralat dan penskalaan yang betul

## Prasyarat

- Telah melengkapkan Sesi 1: Memulakan dengan Foundry Local
- Pemasangan Foundry Local yang aktif dengan model yang berjalan
- Akaun Azure (tier percuma mencukupi untuk pembelajaran)
- Pemahaman asas tentang REST API dan JSON

## Bahagian 1: Kejuruteraan Prompt Lanjutan

### Memahami Seni Bina Prompt

Kejuruteraan prompt yang berkesan adalah asas kepada aplikasi AI yang boleh dipercayai. Foundry Local menyediakan keupayaan prompt yang dipertingkatkan:
...
### Contoh Kejuruteraan Prompt Praktikal
...
## Bahagian 2: Corak Integrasi Data

### Penyambung Data Foundry Local
...
### Contoh Integrasi Data Dunia Sebenar
...
## Bahagian 3: Tugas AI yang Boleh Diambil Tindakan

### Kerangka Automasi Tugas
...
### Contoh Automasi Proses Perniagaan
...
## Bahagian 4: Integrasi Azure AI Foundry
...
## Bahagian 5: Pemantauan dan Pengoptimuman Prestasi

### Sistem Pemantauan Komprehensif
...
### Latihan 1: Bot Khidmat Pelanggan Lanjutan
...
### Latihan 2: Penyelidikan Pasaran Automatik
...
## Bahagian 7: Langkah Seterusnya dan Pratonton Sesi 3

### Pencapaian Sesi

Dalam sesi ini, anda telah menguasai:
- ✅ Teknik kejuruteraan prompt lanjutan untuk tingkah laku AI yang konsisten
- ✅ Corak integrasi data yang kukuh untuk aplikasi dunia sebenar
- ✅ Penciptaan tugas automatik untuk pengoptimuman proses perniagaan
- ✅ Integrasi Azure AI Foundry dan strategi penghantaran hibrid
- ✅ Pemantauan dan pengoptimuman prestasi yang komprehensif

### Persediaan untuk Sesi 3: Model Sumber Terbuka

1. **Terokai Hugging Face**: Buat akaun dan semak katalog model
2. **Semak Model Mondays**: Lihat siri [Model Mondays terkini](https://aka.ms/model-mondays)
3. **Rancang Model Tersuai**: Pertimbangkan model khusus yang akan memberi manfaat kepada kes penggunaan anda

### Sumber Tambahan

- [Dokumentasi Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Repositori GitHub Foundry Local](https://github.com/microsoft/Foundry-Local)
- [Panduan Kejuruteraan Prompt Lanjutan](https://platform.openai.com/docs/guides/prompt-engineering)
- [Amalan Terbaik Automasi Proses Perniagaan](https://docs.microsoft.com/en-us/power-automate/)

Anda kini dilengkapi untuk membina penyelesaian AI yang canggih yang menggabungkan kuasa inferens tempatan dengan keupayaan skala awan, meletakkan asas untuk aplikasi AI gred perusahaan.
