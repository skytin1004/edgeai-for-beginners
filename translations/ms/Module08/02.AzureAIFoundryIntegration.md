...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T00:48:20+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "ms"
}
-->
# Sesi 2: Integrasi OpenAI SDK dengan Azure AI Foundry

## Gambaran Keseluruhan

Meneruskan asas Foundry Local anda, sesi ini memberi fokus kepada corak integrasi OpenAI SDK yang lebih maju, yang menyokong kedua-dua Microsoft Foundry Local dan Azure OpenAI secara lancar. Anda akan menguasai seni membina aplikasi AI yang fleksibel, yang boleh dijalankan secara tempatan untuk privasi dan pembangunan, sambil menyediakan skalabiliti awan melalui Azure OpenAI apabila diperlukan.

## Objektif Pembelajaran

Menjelang akhir sesi ini, anda akan:
- Menguasai integrasi OpenAI SDK yang maju dengan Foundry Local dan Azure OpenAI
- Melaksanakan respons penstriman untuk pengalaman pengguna yang lebih baik
- Mencipta corak kilang klien yang kukuh untuk sokongan pelbagai penyedia
- Membina sistem pengurusan perbualan dengan pemeliharaan konteks
- Menetapkan penanda aras prestasi dan pemantauan kesihatan
- Melancarkan aplikasi sedia produksi dengan pengendalian ralat yang betul

## Prasyarat

- Telah melengkapkan Sesi 1: Memulakan dengan Foundry Local
- Pemasangan Foundry Local yang aktif dengan model yang berjalan
- Python 3.8 atau lebih baru dengan keupayaan persekitaran maya
- OpenAI Python SDK dipasang (`pip install openai foundry-local-sdk`)
- Akaun Azure dengan perkhidmatan OpenAI (pilihan, untuk senario awan)
- Pemahaman asas tentang corak Python async/await

## Bahagian 1: Corak Kilang Klien OpenAI SDK

### Memahami Seni Bina Pelbagai Penyedia

Membina aplikasi yang berfungsi dengan Foundry Local dan Azure OpenAI memerlukan corak penciptaan klien yang fleksibel:
...
## Bahagian 2: Respons Penstriman dan Interaksi Masa Nyata

### Melaksanakan Penstriman Chat Completions

Penstriman menyediakan pengalaman pengguna yang lebih baik dengan menunjukkan respons semasa ia dihasilkan:
...
### Pengurusan Perbualan Pelbagai Pusingan
...
## Bahagian 3: Penanda Aras Prestasi dan Analisis

### Pengukuran Masa Respons

Ukur dan bandingkan prestasi merentasi konfigurasi yang berbeza:
...
## Bahagian 4: Pemantauan Kesihatan Perkhidmatan dan Diagnostik

### Sistem Pemeriksaan Kesihatan Komprehensif
...
### Validator Konfigurasi Persekitaran
...
## Bahagian 5: Pembolehubah Persekitaran dan Pengurusan Konfigurasi

### Rujukan Pembolehubah Persekitaran

Rujukan lengkap untuk konfigurasi kedua-dua penyedia:
...
**Persediaan Windows Command Prompt:**
...
### Latihan 1: Integrasi SDK Pelbagai Penyedia

Bina aplikasi lengkap yang beralih dengan lancar antara penyedia:
...
### Latihan 2: Pengurusan Perbualan Lanjutan
...
### Latihan 3: Pemantauan Kesihatan Sedia Produksi
...
## Bahagian 7: Ringkasan dan Langkah Seterusnya

### Pencapaian Sesi

Dalam sesi ini, anda telah menguasai:
- ✅ **Integrasi OpenAI SDK**: Corak lanjutan untuk Foundry Local dan Azure OpenAI
- ✅ **Respons Penstriman**: Chat completions masa nyata untuk pengalaman pengguna yang lebih baik
- ✅ **Sokongan Pelbagai Penyedia**: Peralihan lancar antara perkhidmatan AI tempatan dan awan
- ✅ **Pengurusan Perbualan**: Perbualan pelbagai pusingan yang sedar konteks
- ✅ **Pemantauan Prestasi**: Penanda aras dan pemeriksaan kesihatan untuk pelancaran produksi
- ✅ **Corak Produksi**: Pengendalian ralat yang kukuh dan pengurusan konfigurasi

### Corak Seni Bina Utama
...
1. **🔄 Sentiasa Laksanakan Fallbacks**: Azure → Foundry Local → Pengendalian ralat
2. **🌊 Gunakan Penstriman untuk Respons Panjang**: Prestasi yang lebih baik dirasakan
3. **🛡️ Laksanakan Pengendalian Ralat Komprehensif**: Mesej ralat mesra pengguna
4. **📈 Pantau Prestasi**: Jejak masa respons dan kadar kejayaan
5. **⚙️ Konfigurasi Berdasarkan Persekitaran**: Peralihan mudah antara dev/staging/prod
6. **🔒 Pengurusan Kredensial yang Selamat**: Jangan sekali-kali kodkan kunci API

### Garis Panduan Pemilihan Penyedia

| Senario | Penyedia Disyorkan | Sebab |
|---------|---------------------|-------|
| **Pembangunan** | Foundry Local | Iterasi pantas, tiada kos API |
| **Privasi Kritikal** | Foundry Local | Data tidak pernah meninggalkan peranti |
| **Produksi Volume Tinggi** | Azure OpenAI | Skalabiliti lebih baik, SLA perusahaan |
| **Model Terkini** | Azure OpenAI | Akses kepada keluaran model terbaru |
| **Keperluan Luar Talian** | Foundry Local | Tiada kebergantungan internet |
| **Sensitif Kos** | Foundry Local | Tiada caj per token |
...
### Persediaan untuk Sesi 3: Model Sumber Terbuka

1. **Terokai Katalog Model**: Semak model yang tersedia dalam Foundry Local
2. **Fahami Format Model**: Pelajari tentang ONNX, kuantisasi, dan pengoptimuman
3. **Pertimbangkan Model Tersuai**: Fikirkan tentang keperluan model khusus domain
...
- **[Dokumentasi OpenAI Python SDK](https://github.com/openai/openai-python)**: Rujukan SDK rasmi
- **[Dokumentasi Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/)**: Panduan perkhidmatan Azure OpenAI
- **[Rujukan SDK Foundry Local](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Dokumentasi inferens tempatan
- **[Panduan Penstriman Completions](https://learn.microsoft.com/azure/ai-foundry/foundry-local/how-to/integrate-with-inference-sdks)**: Corak penstriman lanjutan
- **[Contoh 01: Chat Cepat melalui OpenAI SDK](samples/01/README.md)**: Corak integrasi asas
- **[Contoh 02: Integrasi SDK Lanjutan](samples/02/README.md)**: Contoh latihan sesi ini
- **[Contoh 04: Aplikasi Chainlit](samples/04/README.md)**: Pembangunan UI web
- **[Contoh 05: Sistem Multi-Agent](samples/05/README.md)**: Corak orkestrasi lanjutan

Anda kini dilengkapi untuk membina aplikasi AI yang canggih yang mengintegrasikan keupayaan AI tempatan dan awan secara lancar, memberikan fleksibiliti untuk memilih penyedia yang sesuai bagi setiap kes penggunaan sambil mengekalkan corak pembangunan yang konsisten.
