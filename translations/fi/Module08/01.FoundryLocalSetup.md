...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T23:31:21+00:00",
...
Microsoft Foundry Local tuo Azure AI Foundryn ominaisuudet suoraan Windows 11 -kehitysympäristöösi, mahdollistaen yksityisyyttä suojaavan, matalan viiveen AI-kehityksen yritystason työkaluilla. Tässä istunnossa käsitellään täydellinen asennus, konfigurointi ja käytännön mallien, kuten phi, qwen, deepseek ja GPT-OSS-20B, käyttöönotto.
...
Luo tuotantovalmiin chat-sovelluksen OpenAI SDK:n ja Foundry Localin integroinnin avulla, noudattaen Sample 01:n malleja.
