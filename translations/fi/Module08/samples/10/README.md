...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T23:38:51+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "fi"
}
-->
# Foundry Local työkalujen integrointina

Kattava kehys Microsoft Foundry Local -mallien integroimiseksi kutsuttavina työkaluina suurempiin sovelluksiin, noudattaen Microsoftin virallisia malleja työkalupohjaiselle tekoälyn integroinnille.

## Yleiskatsaus

Tämä esimerkki näyttää, kuinka Foundry Local -mallit voidaan tarjota uudelleenkäytettävinä työkaluina, jotka voidaan integroida olemassa oleviin sovelluksiin, työnkulkuihin ja kehitysympäristöihin. Se esittelee Microsoftin suositellut mallit työkalujen integroinnille ja funktioiden kutsumiselle.

## Keskeiset käsitteet

### 🔧 **Työkalulähtöinen arkkitehtuuri**
- Foundry Local -mallit kutsuttavina funktioina
- Standardoidut työkaluliittymät ja skeemat
- Saumaton integrointi olemassa oleviin koodipohjiin
- Tyyppiturvalliset työkalumääritelmät ja validointi

### ⚡ **Funktiokutsumismallit**
- Microsoft Foundry Local -funktiokutsujen toteutus
- OpenAI-yhteensopivat työkalumääritelmät
- Automaattinen parametrien validointi ja muuntaminen
- Virheenkäsittely ja vastausten muotoilu

### 🔌 **Integrointikehykset**
- **LangChain-integraatio**: Natiivin LangChain-työkalutuki
- **Semantic Kernel**: Microsoft Semantic Kernel -funktiot
- **REST API**: HTTP-pohjaiset työkaluliittymät
- **CLI-työkalut**: Komentorivipohjainen integrointi
- **Jupyter Notebooks**: Interaktiiviset kehitystyökalut

### 🎯 **Käyttötapamallit**
- Koodin analysointi- ja generointityökalut
- Sisällön käsittely ja tiivistäminen
...
- **Python**: 3.9+ asyncio-tuella
- **Node.js**: v18+ (JavaScript-integraatioita varten)
- **Muisti**: Suositus vähintään 12GB
- **Tallennustila**: Vähintään 10GB malleille ja työkaluille
...
### Komentorivipohjainen integraatio
```python
import typer
...
### 2. Kontekstia huomioivat työkalut
```python
...
Kun olet käynyt läpi tämän esimerkin, ymmärrät:

1. **Työkalujen integrointimallit**
   - Funktiopohjainen ja luokkapohjainen työkalusuunnittelu
   - Microsoft Foundry Local -integraatiomallit
   - Skeemavalidointi ja tyyppiturvallisuus
   - Virheenkäsittely ja palautuminen

2. **Kehysintegraatio**
   - LangChain-työkalujen kehitys
   - Semantic Kernel -funktioiden integrointi
   - REST API -kehysintegraatio
   - CLI-sovellusten kehitys

3. **Tuotantokäytön näkökohdat**
   - Suorituskyvyn optimointistrategiat
   - Välimuisti ja resurssien hallinta
   - Seuranta ja havainnointi
   - Turvallisuus ja validointi

4. **Edistyneet työkalumallit**
   - Työkalujen koostaminen ja ketjuttaminen
   - Kontekstia huomioiva käsittely
   - Erä- ja striimaustoiminnot
   - Räätälöityjen integraatioiden kehitys

## Seuraavat askeleet

- **Integraatioprojektit**: Rakenna räätälöityjä integraatioita suosikkikehyksilläsi
- **Työkalujen kehitys**: Luo erikoistuneita työkaluja omaan toimialaasi
- **Suorituskyvyn hienosäätö**: Optimoi omia käyttötapauksiasi varten
- **Tuotantokäyttöön siirtyminen**: Skaalaa työkalut yrityskäyttöön

## Osallistuminen

Katso pääasiallisen arkiston ohjeet osallistumisohjeista.
