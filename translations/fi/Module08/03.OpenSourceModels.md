...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-01T00:43:56+00:00",
...
Tässä istunnossa tutkitaan, miten avoimen lähdekoodin mallit tuodaan Foundry Localiin.
...
**Hidas suorituskyky:**
- Varmista, että malli on täysin ladattu (tarkista yksityiskohtainen tuloste)
...
5. **Dokumentoi tulokset**: Kirjaa muistiin mallien suorituskyky käyttötarkoituksiasi varten
...
- **Esitiedot**: Mukavuus mallien vaihtamisessa ja perussuorituskyvyn testauksessa
...
Nyt sinulla on käytännön taidot löytää, testata ja valita sopivia malleja AI-sovelluksiisi Foundry Localin yksinkertaisen CLI-lähestymistavan avulla: yhteisömallien valinta, Hugging Face -sisällön integrointi ja "tuo oma malli" (BYOM) -strategioiden omaksuminen. Löydät myös Model Mondays -sarjan jatkuvaan oppimiseen ja mallien löytämiseen.
...
## Osa 1: Mallien löytäminen Foundry CLI:n avulla
...
- `qwen2.5-7b`: Erinomainen päättely ja pidempi konteksti
- `deepseek-r1-7b`: Optimoitu koodin generointiin

**Suuret mallit:**
- `llama-3.2`: Metan uusin avoimen lähdekoodin malli
- `qwen2.5-14b`: Yritystason päättely

## Osa 2: Nopea mallien testaus ja vertailu

### Sample 03 -lähestymistapa: Yksinkertainen lista ja vertailu

Sample 03 -mallin pohjalta tässä on yksinkertainen työnkulku:
...
## Osa 3: Mallien välimuistin ja tallennuksen hallinta

### Mallivälimuistin ymmärtäminen

Foundry Local hallitsee automaattisesti mallien lataukset ja välimuistin:
...
- Poista käyttämättömät mallit tilan vapauttamiseksi: `foundry cache clean`
...
- Tarkkaile muistin käyttöä (mallit pysyvät ladattuina RAM-muistiin)
...
- Edistynyt: `qwen2.5-7b` (pidempi konteksti)

**Koodin generointiin:**
- Suositeltu: `deepseek-r1-7b`
- Vaihtoehto: `qwen2.5-7b` (hyvä myös koodiin)

**Monimutkaiseen päättelyyn:**
- Paras: `qwen2.5-7b` tai `qwen2.5-14b`
...
- Valmistaudu Istuntoon 4: LLM vs SLM -vertailu, paikallinen vs pilvi-inferenssi ja käytännön demot
