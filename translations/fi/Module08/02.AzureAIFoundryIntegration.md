...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T23:30:58+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "fi"
}
-->
# Istunto 2: OpenAI SDK -integraatio Azure AI Foundryn kanssa

## Yleiskatsaus

Tässä istunnossa syvennytään edistyneisiin OpenAI SDK -integraatiomalleihin, jotka tukevat saumattomasti sekä Microsoft Foundry Localia että Azure OpenAI:ta. Opit rakentamaan joustavia tekoälysovelluksia, jotka toimivat paikallisesti yksityisyyden ja kehityksen vuoksi, mutta tarjoavat pilven skaalautuvuutta Azure OpenAI:n kautta tarvittaessa.

## Oppimistavoitteet

Istunnon lopussa osaat:
- Hallita edistyneitä OpenAI SDK -integraatioita Foundry Localin ja Azure OpenAI:n kanssa
- Toteuttaa suoratoistovastauksia käyttäjäkokemuksen parantamiseksi
- Luoda vankkoja asiakasrajapintojen tehtaan malleja monen palveluntarjoajan tukeen
- Rakentaa keskustelunhallintajärjestelmiä kontekstin säilyttämiseksi
- Määrittää suorituskyvyn vertailuja ja terveysseurantaa
- Ottaa käyttöön tuotantovalmiita sovelluksia asianmukaisella virheenkäsittelyllä

## Esivaatimukset

- Suoritettu istunto 1: Foundry Localin aloitus
- Aktiivinen Foundry Local -asennus toimivilla malleilla
- Python 3.8 tai uudempi virtuaaliympäristön tuella
- Asennettu OpenAI Python SDK (`pip install openai foundry-local-sdk`)
- Azure-tili OpenAI-palvelulla (valinnainen pilviskenaarioita varten)
- Perustiedot Pythonin async/await-malleista

## Osa 1: OpenAI SDK -asiakasrajapinnan tehtaan malli

### Monen palveluntarjoajan arkkitehtuurin ymmärtäminen

Sovellusten rakentaminen, jotka toimivat sekä Foundry Localin että Azure OpenAI:n kanssa, vaatii joustavan asiakasluontimallin:
...
## Osa 2: Suoratoistovastaukset ja reaaliaikainen vuorovaikutus

### Suoratoistochat-vastausten toteuttaminen

Suoratoisto tarjoaa paremman käyttäjäkokemuksen näyttämällä vastaukset niiden luomisen aikana:
...
### Monikierroksinen keskustelunhallinta
...
## Osa 3: Suorituskyvyn vertailu ja analyysi

### Vastausaikojen mittaus

Mittaa ja vertaa suorituskykyä eri kokoonpanojen välillä:
...
### Lämpötilan ja parametrien testaus
...
## Osa 4: Palvelun terveysseuranta ja diagnostiikka

### Kattava terveyden tarkistusjärjestelmä
...
### Ympäristön konfiguraation validointi
...
## Osa 5: Ympäristömuuttujat ja konfiguraation hallinta

### Ympäristömuuttujien viite

Täydellinen viite molempien palveluntarjoajien konfigurointiin:
...
**Windows-komentokehoteasetukset:**
...
### Harjoitus 1: Monen palveluntarjoajan SDK-integraatio

Rakenna täydellinen sovellus, joka vaihtaa saumattomasti palveluntarjoajien välillä:
...
### Harjoitus 2: Edistynyt keskustelunhallinta
...
### Harjoitus 3: Tuotantovalmiin terveysseurannan toteuttaminen
...
## Osa 7: Yhteenveto ja seuraavat askeleet

### Istunnon saavutukset

Tässä istunnossa opit:
- ✅ **OpenAI SDK -integraatio**: Edistyneet mallit Foundry Localille ja Azure OpenAI:lle
- ✅ **Suoratoistovastaukset**: Reaaliaikaiset chat-vastaukset käyttäjäkokemuksen parantamiseksi
- ✅ **Monen palveluntarjoajan tuki**: Saumaton vaihto paikallisten ja pilvipalveluiden välillä
- ✅ **Keskustelunhallinta**: Kontekstin huomioivat monikierroksiset keskustelut
- ✅ **Suorituskyvyn seuranta**: Vertailu ja terveyden tarkistus tuotantokäyttöön
- ✅ **Tuotantomallit**: Vankka virheenkäsittely ja konfiguraation hallinta

### Keskeiset arkkitehtuurimallit

**Asiakasrajapinnan tehtaan malli:**
```
...
1. **🔄 Toteuta aina varajärjestelmät**: Azure → Foundry Local → Virheenkäsittely
2. **🌊 Käytä suoratoistoa pitkissä vastauksissa**: Parempi koettu suorituskyky
3. **🛡️ Toteuta kattava virheenkäsittely**: Käyttäjäystävälliset virheilmoitukset
4. **📈 Seuraa suorituskykyä**: Vastausaikojen ja onnistumisprosenttien seuranta
5. **⚙️ Ympäristöperusteinen konfiguraatio**: Helppo vaihto kehitys-, testaus- ja tuotantoympäristöjen välillä
6. **🔒 Suojaa tunnistetiedot**: Älä koskaan kovakoodaa API-avaimia

### Palveluntarjoajan valintasuositukset

| Skenaario | Suositeltu palveluntarjoaja | Perustelu |
|----------|---------------------|----------|
| **Kehitys** | Foundry Local | Nopea iterointi, ei API-kustannuksia |
| **Yksityisyyskriittinen** | Foundry Local | Data ei koskaan poistu laitteesta |
| **Suuri tuotantomäärä** | Azure OpenAI | Parempi skaalautuvuus, yritystason SLA |
| **Uusimmat mallit** | Azure OpenAI | Pääsy uusimpiin mallijulkaisuihin |
| **Offline-vaatimukset** | Foundry Local | Ei internetriippuvuutta |
| **Kustannusherkkä** | Foundry Local | Ei per-token-maksuja |

### Ympäristömuuttujien pikaopas
...
### Valmistautuminen istuntoon 3: Avoimen lähdekoodin mallit

1. **Tutustu mallikatalogiin**: Tarkastele Foundry Localin saatavilla olevia malleja
2. **Ymmärrä malliformaatit**: Opi ONNX:stä, kvantisoinnista ja optimoinnista
3. **Harkitse mukautettuja malleja**: Mieti alakohtaisia mallivaatimuksia
...
- **[OpenAI Python SDK -dokumentaatio](https://github.com/openai/openai-python)**: Virallinen SDK-viite
- **[Azure OpenAI -dokumentaatio](https://learn.microsoft.com/azure/ai-services/openai/)**: Azure OpenAI -palvelun opas
- **[Foundry Local SDK -viite](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Paikallisen inferenssin dokumentaatio
- **[Suoratoistovastausten opas](https://learn.microsoft.com/azure/ai-foundry/foundry-local/how-to/integrate-with-inference-sdks)**: Edistyneet suoratoistomallit
- **[Esimerkki 01: Nopea chat OpenAI SDK:n kautta](samples/01/README.md)**: Perusintegraatiomallit
- **[Esimerkki 02: Edistynyt SDK-integraatio](samples/02/README.md)**: Tämän istunnon käytännön esimerkit
- **[Esimerkki 04: Chainlit-sovellus](samples/04/README.md)**: Web-käyttöliittymän kehitys
- **[Esimerkki 05: Moniagenttijärjestelmät](samples/05/README.md)**: Edistyneet orkestrointimallit

Olet nyt valmis rakentamaan kehittyneitä tekoälysovelluksia, jotka yhdistävät paikalliset ja pilvipohjaiset tekoälyominaisuudet saumattomasti, tarjoten joustavuutta valita oikea palveluntarjoaja kuhunkin käyttötapaukseen samalla säilyttäen yhtenäiset kehitysmallit.
