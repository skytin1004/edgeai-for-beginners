...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T20:25:35+00:00",
...
Rakentaen Foundry Local -perustasi päälle, tämä istunto keskittyy kehittyneiden tekoälyratkaisujen luomiseen edistyneen kehotetekniikan, saumattoman dataintegraation ja käytännön tehtäväautomaatioiden avulla. Opit yhdistämään paikallisen kehityksen Azure AI Foundryn ominaisuuksiin, luoden yrityskäyttöön valmiita sovelluksia, jotka hyödyntävät molempien maailmojen parhaat puolet.

## Oppimistavoitteet

Istunnon lopussa osaat:
- Hallita kehittyneitä kehotetekniikoita, jotka tuottavat johdonmukaisia ja luotettavia tekoälyvastauksia
- Toteuttaa vahvoja dataintegraatiomalleja tosielämän sovelluksiin
- Luoda käytännön tekoälytehtäviä, jotka tuottavat liiketoiminnallista arvoa
- Varmistaa saumattoman yhteyden Foundry Localin ja Azure AI Foundryn välillä
- Rakentaa suorituskyvyn seurantaan ja optimointiin liittyviä työnkulkuja
- Ottaa käyttöön tuotantovalmiita tekoälyratkaisuja, joissa on asianmukainen virheenkäsittely ja skaalautuvuus

## Esivaatimukset

- Suoritettu Istunto 1: Foundry Localin aloitus
- Aktiivinen Foundry Local -asennus, jossa mallit ovat käynnissä
- Azure-tili (ilmainen taso riittää oppimiseen)
- Perustiedot REST API:sta ja JSON:sta

## Osa 1: Kehittynyt kehotetekniikka

### Kehotearkkitehtuurin ymmärtäminen

Tehokas kehotetekniikka on luotettavien tekoälysovellusten perusta. Foundry Local tarjoaa parannettuja kehotusominaisuuksia:
...
### Kehotusstrategioiden toteuttaminen
...
### Käytännön kehotetekniikan esimerkkejä
...
## Osa 2: Dataintegraatiomallit

### Foundry Local -dataliittimet
...
### Tosielämän dataintegraation esimerkki
...
## Osa 3: Käytännön tekoälytehtävät

### Tehtäväautomaatiojärjestelmä
...
### Liiketoimintaprosessien automaation esimerkkejä
...
## Osa 4: Azure AI Foundryn integrointi
...
## Osa 5: Suorituskyvyn seuranta ja optimointi
...
### Harjoitus 1: Kehittynyt asiakaspalvelubotti
...
### Harjoitus 2: Automaattinen markkinatutkimus
...
## Osa 7: Seuraavat askeleet ja Istunto 3:n esikatselu

### Istunnon saavutukset

Tässä istunnossa olet oppinut:
- ✅ Kehittyneet kehotetekniikat tekoälyn johdonmukaisen käyttäytymisen varmistamiseksi
- ✅ Vahvat dataintegraatiomallit tosielämän sovelluksiin
- ✅ Automaattisten tehtävien luominen liiketoimintaprosessien optimointiin
- ✅ Azure AI Foundryn integrointi ja hybridikäyttöönoton strategiat
- ✅ Kattava suorituskyvyn seuranta ja optimointi

### Valmistautuminen Istuntoon 3: Avoimen lähdekoodin mallit

1. **Tutustu Hugging Faceen**: Luo tili ja selaa mallikatalogia
2. **Tarkista Model Mondays**: Katso uusin [Model Mondays -sarja](https://aka.ms/model-mondays)
3. **Suunnittele räätälöityjä malleja**: Mieti, mitkä erikoistuneet mallit hyödyttäisivät käyttötapauksiasi

### Lisäresurssit

- [Azure AI Foundryn dokumentaatio](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Foundry Local GitHub -arkisto](https://github.com/microsoft/Foundry-Local)
- [Kehittyneen kehotetekniikan opas](https://platform.openai.com/docs/guides/prompt-engineering)
- [Liiketoimintaprosessien automaation parhaat käytännöt](https://docs.microsoft.com/en-us/power-automate/)

Olet nyt valmis rakentamaan kehittyneitä tekoälyratkaisuja, jotka yhdistävät paikallisen laskennan voiman pilvipohjaiseen skaalautuvuuteen, luoden perustan yritystason tekoälysovelluksille.
