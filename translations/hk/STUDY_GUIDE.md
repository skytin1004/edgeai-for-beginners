...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T09:48:38+00:00",
...
| 第2週 | 模組3-4：部署與優化 | 6小時 |
| 第3週 | 模組5-6：SLMOps 與 AI Agents | 5小時 |
| 第4週 | 模組7：開發工具與整合 | 3小時 |
...
| 第7-8天 | 模組4：模型優化 | 4小時 |
| 第9-10天 | 模組5：SLMOps | 3小時 |
| 第11-12天 | 模組6：SLM Agentic 系統 | 2小時 |
...
歡迎使用 EdgeAI 初學者學習指南！本文件旨在幫助您有效地學習課程內容，並最大化學習效果。它提供結構化的學習路徑、建議的學習計劃、關鍵概念摘要以及補充資源，幫助您深入了解 EdgeAI 技術。

這是一門簡潔的20小時課程，專為忙碌的專業人士和學生設計，幫助他們快速掌握這一新興領域的實用技能。
...
4. **模型格式轉換與量化** - 使用6個框架進行高級優化，包括 OpenVINO
5. **SLMOps - 小型語言模型運營** - 生產生命周期管理與部署
6. **SLM Agentic 系統** - AI Agents、函數調用與模型上下文協議
...
- 掌握從1-bit到8-bit精度的高級量化技術
- 理解格式轉換策略（GGUF、ONNX）
- 在六個框架中實現優化（Llama.cpp、Olive、OpenVINO、MLX、工作流合成）
...
2. 解釋模型蒸餾對邊緣部署的好處。
3. 在資源受限的環境中微調 SLM 的主要考量是什麼？
4. 描述邊緣 AI 應用的完整生產部署管道。

### 實作練習

1. **基礎蒸餾**: 從較大的教師模型創建一個較小的模型（1 小時）
2. **微調實驗**: 為特定領域微調模型（1 小時）
3. **部署管道**: 設置一個基本的 CI/CD 管道以進行模型部署（1 小時）

## 第六模組：SLM Agentic Systems - AI 代理和函數調用
...
1. **簡單代理**: 構建一個帶有函數調用的基本 AI 代理（1 小時）
...
- 掌握 Visual Studio Code 的 AI 工具包，用於全面的 EdgeAI 開發工作流程
- 熟悉 Windows AI Foundry 平台和 NPU 優化策略
- 在多個硬體平台和部署場景中實施 EdgeAI
- 使用平台特定的優化構建生產就緒的 EdgeAI 應用
...
## 第八模組：Microsoft Foundry Local – 完整開發者工具包（現代化）

### 主要學習目標

- 安裝和配置 Foundry Local，集成現代 SDK
- 使用協調模式實施高級多代理系統
- 構建智能模型路由器，實現自動基於任務的選擇
- 部署生產就緒的 AI 解決方案，配備全面的監控功能
...
- **重點概念**: 
  - 全面的錯誤處理和回退機制
  - 請求監控和性能跟踪
  - 帶有基準測試的交互式 Jupyter notebook 示例
  - 與現有應用的集成模式
...
- [AI 工具包 for VS Code](https://code.visualstudio.com/docs/intelligentapps/overview) - 集成的 EdgeAI 開發環境
- [Windows AI Foundry](https://docs.microsoft.com/en-us/windows/ai/) - Windows 特定的 EdgeAI 開發平台
...
11. **MCP 整合系統**：使用 Model Context Protocol 構建一個代理系統進行工具交互
...
EdgeAI 代表了人工智能應用的前沿技術，將強大的能力直接帶到設備上，同時解決隱私、延遲和連接性等重要問題。本課程共 20 小時，提供了必要的知識和實用技能，讓您能立即開始使用 EdgeAI 技術。
