...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T11:48:18+00:00",
...
在 Foundry Local 的基礎上，本節課程將重點放在透過進階提示工程、無縫數據整合以及可執行的任務自動化來創建高級 AI 解決方案。您將學習如何將本地開發與 Azure AI Foundry 的功能相結合，打造能夠充分利用兩者優勢的企業級應用程式。

## 學習目標

完成本節課程後，您將能夠：
- 掌握進階提示工程技術，確保 AI 回應的一致性與可靠性
- 實現穩健的數據整合模式，應用於真實世界場景
- 創建能夠提升商業價值的可執行 AI 任務
- 建立 Foundry Local 與 Azure AI Foundry 的無縫連接
- 構建性能監控與優化工作流程
- 部署具備錯誤處理與擴展能力的生產級 AI 解決方案
...
- Azure 帳戶（免費層足以學習）
- 基本了解 REST APIs 和 JSON

## 第一部分：進階提示工程

### 理解提示架構

有效的提示工程是可靠 AI 應用的基礎。Foundry Local 提供了增強的提示功能：
...
在本節課程中，您已掌握：
- ✅ 進階提示工程技術，確保 AI 行為的一致性
- ✅ 真實世界應用的穩健數據整合模式
- ✅ 商業流程優化的自動化任務創建
- ✅ Azure AI Foundry 整合與混合部署策略
- ✅ 全面的性能監控與優化

### 為第三節課程做準備：開源模型

1. **探索 Hugging Face**：建立帳戶並瀏覽模型目錄
2. **檢視 Model Mondays**：查看最新的 [Model Mondays 系列](https://aka.ms/model-mondays)
3. **規劃自訂模型**：思考哪些專業化模型能夠提升您的使用案例

### 其他資源

- [Azure AI Foundry 文件](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Foundry Local GitHub 儲存庫](https://github.com/microsoft/Foundry-Local)
- [進階提示工程指南](https://platform.openai.com/docs/guides/prompt-engineering)
- [商業流程自動化最佳實踐](https://docs.microsoft.com/en-us/power-automate/)

您現在已具備建構高級 AI 解決方案的能力，能夠結合本地推理與雲端規模的優勢，為企業級 AI 應用奠定基礎。
