...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T11:44:05+00:00",
...
注意：Foundry Local 中的代理功能會不斷演進——在實施高級模式之前，請確認最新版本說明中的支持情況。

## 概述

使用 Foundry Local 快速原型化代理應用：系統提示、基礎設置和編排模式。當代理支持存在時，您可以標準化使用 OpenAI 兼容的函數調用，或者在混合設計中使用 Azure AI Agents 的雲端支持。
