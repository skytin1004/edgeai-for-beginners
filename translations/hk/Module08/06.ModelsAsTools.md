...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T11:46:53+00:00",
...
步驟 1）決定路由策略  
- 優先本地以保護隱私/降低延遲，遇到錯誤或大型提示時回退至 Azure  
...
- [ ] 為領域模板強制 JSON 輸出  
- [ ] 本地清理並記錄調用  
- [ ] 實現具有 Azure 回退功能的簡單混合路由器  

## 總結

Foundry Local 使得在設備上實現穩健的 AI 成為可能，模型可以組合成工具。通過清晰的介面、治理和混合擴展，團隊可以推出即時、安全的 AI 應用，既尊重用戶隱私，又符合企業需求。
