...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T09:47:37+00:00",
...
歡迎來到 **EdgeAI 初學者指南**——這是一個全面的旅程，帶您進入邊緣人工智能的變革世界。本課程將強大的 AI 能力與邊緣設備上的實際部署相結合，幫助您直接在數據生成和需要做出決策的地方發揮 AI 的潛力。
...
像 Phi-4、Mistral-7B 和 Gemma 這樣的 SLMs 是更大 LLMs 的優化版本——通過訓練或蒸餾來實現：
...
| [🤖 06](../../Module06) | [AI 代理與功能調用](./Module06/README.md) | 代理框架與 MCP | 代理介紹 • 功能調用 • 模型上下文協議 | 高級 | 4-5 小時 |
| [💻 07](../../Module07) | [平台實施](./Module07/README.md) | 跨平台示例 | AI 工具包 • Foundry Local • Windows 開發 | 高級 | 3-4 小時 |
| [🏭 08](../../Module08) | [Foundry Local 工具包](./Module08/README.md) | 生產就緒示例 | 示例應用（詳情見下文） | 專家 | 8-10 小時 |
...
### 📊 **學習路徑摘要**
- **總時長**：36-45 小時
- **初學者路徑**：模塊 01-02（7-9 小時）  
- **中級路徑**：模塊 03-04（9-11 小時）
- **高級路徑**：模塊 05-07（12-15 小時）
- **專家路徑**：模塊 08（8-10 小時）
...
- **多平台部署**：Windows、移動設備、嵌入式設備和雲邊緣混合系統
- **生產運營**：監控、擴展和維護生產中的邊緣 AI

### 🏗️ 實踐項目
- **Foundry Local 聊天應用**：Windows 11 原生應用，支持模型切換
- **多代理系統**：協調器與專家代理，處理複雜工作流程  
- **RAG 應用**：本地文檔處理與向量搜索
- **模型路由器**：根據任務分析智能選擇模型
- **API 框架**：支持流式和健康監控的生產就緒客戶端
...
1. **📚 基礎**（模塊 01-02）：邊緣 AI 概念 + SLM 模型家族
2. **⚙️ 優化**（模塊 03-04）：部署 + 量化框架  
3. **🚀 生產**（模塊 05-06）：SLMOps + AI 代理 + 功能調用
4. **💻 實施**（模塊 07-08）：平台示例 + Foundry Local 工具包

每個模塊都包括理論、實踐練習和生產就緒的代碼示例。

## 職業影響
**技術角色**: EdgeAI 解決方案架構師 • 機器學習工程師 (Edge) • 物聯網 AI 開發者 • 移動 AI 開發者

**行業領域**: 工業 4.0 • 醫療科技 • 自主系統 • 金融科技 • 消費電子
...
✅ **實操範例**: 超過 50 個例子，10 個全面的 Foundry Local 演示  
✅ **性能優化**: 提升速度 85%，減少大小 75%  
✅ **多平台支持**: Windows、移動端、嵌入式、雲端與邊緣混合  
✅ **生產就緒**: 監控、擴展、安全性、合規框架
...
**EdgeAI 代表 AI 部署的未來**: 本地優先、保護隱私、高效能。掌握這些技能，打造下一代智能應用。
