...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T07:43:13+00:00",
...
- **多代理系統**：協調器與專家代理，適用於複雜工作流程  
- **RAG 應用**：本地文檔處理，支持向量搜索
- **模型路由器**：根據任務分析智能選擇模型
- **API 框架**：支持流式傳輸和健康監控的生產就緒客戶端
...
3. **🚀 生產環境**（模組 05-06）：SLMOps + AI代理 + 函數調用  
4. **💻 實作**（模組 07-08）：平台範例 + Foundry Local 工具包  

每個模組均包含理論、實作練習及生產環境準備的程式碼範例。

## 職業影響

**技術職位**：EdgeAI 解決方案架構師 • 機器學習工程師（Edge） • IoT AI 開發者 • 移動 AI 開發者  

**行業領域**：工業4.0 • 醫療科技 • 自主系統 • 金融科技 • 消費電子  

**作品集項目**：多代理系統 • 生產環境 RAG 應用程式 • 跨平台部署 • 性能優化  
...
✅ **漸進式學習**：理論 → 實作 → 生產環境部署  
✅ **真實案例研究**：Microsoft、日本航空、企業實作  
✅ **實作範例**：超過50個範例，10個完整的 Foundry Local 演示  
✅ **性能專注**：提升速度85%，減少大小75%  
✅ **多平台支持**：Windows、移動端、嵌入式、雲端-邊緣混合  
✅ **生產環境準備**：監控、擴展、安全性、合規框架  
