...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-07-22T05:12:22+00:00",
...
Microsoft Olive 是一款功能強大且易於使用的硬件感知模型優化工具包，簡化了針對不同硬件平台部署機器學習模型的優化過程。不論目標是 CPU、GPU 或專用 AI 加速器，Olive 都能幫助您在保持模型準確性的同時實現最佳性能。
...
- [04: Apple MLX Framework 深入探討](./04.AppleMLX.md)
