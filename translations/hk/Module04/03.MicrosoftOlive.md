...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T11:38:35+00:00",
...
Olive 是一款易於使用的硬件感知模型優化工具，結合了行業領先的技術，包括模型壓縮、優化和編譯。它與 ONNX Runtime 配合使用，提供端到端的推理優化解決方案。
...
- 對於 Windows 機器的集成顯卡，考慮使用 DirectML
