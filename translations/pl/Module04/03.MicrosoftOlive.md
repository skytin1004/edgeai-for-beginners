...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T13:17:56+00:00",
...
Microsoft Olive to zaawansowane, łatwe w użyciu narzędzie do optymalizacji modeli, uwzględniające specyfikę sprzętu. Upraszcza proces optymalizacji modeli uczenia maszynowego do wdrożenia na różnych platformach sprzętowych. Niezależnie od tego, czy celem są procesory CPU, GPU czy specjalistyczne akceleratory AI, Olive pomaga osiągnąć optymalną wydajność przy zachowaniu dokładności modelu.

## Czym jest Microsoft Olive?

Olive to narzędzie do optymalizacji modeli uwzględniające specyfikę sprzętu, które łączy w sobie najlepsze techniki w zakresie kompresji, optymalizacji i kompilacji modeli. Współpracuje z ONNX Runtime jako kompleksowe rozwiązanie do optymalizacji wnioskowania.

### Kluczowe funkcje

- **Optymalizacja uwzględniająca sprzęt**: Automatyczny wybór najlepszych technik optymalizacji dla docelowego sprzętu
...
- **Wsparcie dla wielu frameworków**: Działa z PyTorch, modelami Hugging Face i ONNX
...
- **Zyski wydajnościowe**: Znaczące przyspieszenie działania (nawet do 6x w niektórych przypadkach)
- **Wieloplatformowe wdrożenie**: Modele zoptymalizowane działają na różnych sprzętach i systemach operacyjnych
- **Zachowana dokładność**: Optymalizacje poprawiają wydajność, jednocześnie zachowując jakość modelu
...
Dla bardziej złożonych przepływów pracy optymalizacji możesz użyć plików konfiguracyjnych JSON:
...
- Używaj mniejszych rozmiarów batch podczas optymalizacji
...
### Powiązane narzędzia
- **ONNX Runtime**: Silnik wnioskowania o wysokiej wydajności — https://onnxruntime.ai/
- **Hugging Face Transformers**: Źródło wielu kompatybilnych modeli — https://huggingface.co/docs/transformers/index
- **Azure Machine Learning**: Przepływy pracy optymalizacji w chmurze — https://learn.microsoft.com/azure/machine-learning/
