...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T12:31:30+00:00",
...
Traktuj modele AI jako modułowe, dostosowywalne narzędzia działające bezpośrednio na urządzeniu dzięki Foundry Local. Ta sesja kładzie nacisk na praktyczne przepływy pracy związane z ochroną prywatności, inferencją o niskim opóźnieniu oraz integracją tych narzędzi za pomocą SDK, API lub CLI. Dowiesz się również, jak skalować do Azure AI Foundry, gdy zajdzie taka potrzeba.
...
- **Monitorowanie stanu**: Walidacja usług i sprawdzanie dostępności modeli
...
Cel: Zaimplementowanie inteligentnego wyboru modeli z automatycznym routingiem na podstawie treści zapytania.
...
Krok 2) Skonfiguruj środowisko (opcjonalne - zobacz `samples/06/README.md`)  
```cmd
...
## Część 4: Tryb offline i bezpieczeństwo (krok po kroku)
...
- [ ] Zaimplementuj monitorowanie stanu usług i obsługę błędów
