...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T13:40:09+00:00",
...
Bazując na podstawach Foundry Local, ta sesja koncentruje się na tworzeniu zaawansowanych rozwiązań AI poprzez zaawansowaną inżynierię promptów, płynną integrację danych oraz automatyzację zadań. Nauczysz się łączyć lokalny rozwój z możliwościami Azure AI Foundry, tworząc aplikacje gotowe do wdrożenia w przedsiębiorstwach, które wykorzystują najlepsze cechy obu środowisk.

## Cele nauki

Po zakończeniu tej sesji będziesz:
- Opanowywać zaawansowane techniki inżynierii promptów dla spójnych i niezawodnych odpowiedzi AI
- Wdrażać solidne wzorce integracji danych dla aplikacji w rzeczywistych scenariuszach
- Tworzyć zadania AI, które przynoszą wartość biznesową
- Ustanawiać płynną łączność między Foundry Local a Azure AI Foundry
- Budować przepływy pracy monitorowania wydajności i optymalizacji
- Wdrażać rozwiązania AI gotowe do produkcji z odpowiednim zarządzaniem błędami i skalowaniem

## Wymagania wstępne

- Ukończona Sesja 1: Wprowadzenie do Foundry Local
- Aktywna instalacja Foundry Local z działającymi modelami
- Konto Azure (darmowy poziom wystarczający do nauki)
- Podstawowa znajomość REST API i JSON

## Część 1: Zaawansowana inżynieria promptów

### Zrozumienie architektury promptów

Efektywna inżynieria promptów jest podstawą niezawodnych aplikacji AI. Foundry Local oferuje rozszerzone możliwości tworzenia promptów:
...
### Praktyczne przykłady inżynierii promptów
...
## Część 2: Wzorce integracji danych

### Złącza danych Foundry Local
...
### Przykład integracji danych w rzeczywistych scenariuszach
...
## Część 3: Zadania AI przynoszące wartość

### Ramy automatyzacji zadań
...
## Część 4: Integracja z Azure AI Foundry
...
## Część 5: Monitorowanie wydajności i optymalizacja

### Kompleksowy system monitorowania
...
### Ćwiczenie 1: Zaawansowany bot obsługi klienta
...
### Ćwiczenie 2: Zautomatyzowane badania rynku
...
## Część 7: Kolejne kroki i zapowiedź Sesji 3

### Osiągnięcia sesji

W tej sesji opanowałeś:
- ✅ Zaawansowane techniki inżynierii promptów dla spójnego zachowania AI
- ✅ Solidne wzorce integracji danych dla aplikacji w rzeczywistych scenariuszach
- ✅ Tworzenie zautomatyzowanych zadań dla optymalizacji procesów biznesowych
- ✅ Integrację z Azure AI Foundry i strategie wdrożeń hybrydowych
- ✅ Kompleksowe monitorowanie wydajności i optymalizację

### Przygotowanie do Sesji 3: Modele open-source

1. **Poznaj Hugging Face**: Załóż konto i przeglądaj katalog modeli
2. **Przejrzyj Model Mondays**: Sprawdź najnowszą serię [Model Mondays](https://aka.ms/model-mondays)
3. **Planuj modele niestandardowe**: Zastanów się, jakie specjalistyczne modele mogą być korzystne dla Twoich przypadków użycia

### Dodatkowe zasoby

- [Dokumentacja Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Repozytorium Foundry Local na GitHub](https://github.com/microsoft/Foundry-Local)
- [Przewodnik zaawansowanej inżynierii promptów](https://platform.openai.com/docs/guides/prompt-engineering)
- [Najlepsze praktyki automatyzacji procesów biznesowych](https://docs.microsoft.com/en-us/power-automate/)

Jesteś teraz wyposażony w wiedzę, aby tworzyć zaawansowane rozwiązania AI, które łączą moc lokalnego przetwarzania z możliwościami chmury, tworząc fundament dla aplikacji AI na poziomie przedsiębiorstwa.
