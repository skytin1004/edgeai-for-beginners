...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T12:31:52+00:00",
...
- Zastosowanie odpowiedniej obsługi błędów i łagodnej degradacji
...
**Lokalne najpierw z awaryjnym przełączeniem:**
```python
...
| `BASE_URL` | Endpoint Foundry Local | Automatycznie wykryty | `http://localhost:51211` |
...
3. Wybierz kernel "Foundry Local", gdy zostaniesz o to poproszony
4. Zacznij dodawać komórki z zawartością
...
### Krok 1: Sprawdzenie wsparcia dla WebGPU

**Wymagania przeglądarki:**
- Chrome/Edge 113+ z włączonym WebGPU
- Sprawdź: `chrome://gpu` → potwierdź status "WebGPU"
- Programatyczne sprawdzenie: `if (!('gpu' in navigator)) { /* brak WebGPU */ }`
...
Open WebUI oferuje profesjonalny interfejs podobny do ChatGPT, który łączy się z kompatybilnym z OpenAI API Foundry Local.
...
3. **Konfiguracja modelu:**
   - Ustawienia → Modele → OpenAI API  
   - Base URL: `http://host.docker.internal:51211/v1`
   - API Key: `foundry-local-key` (dowolna wartość działa)
...
- ✅ **Framework Chainlit**: Nowoczesny UI i wsparcie dla strumieniowania w aplikacjach czatowych
...
- **[Przykład 04: Aplikacja Chainlit](samples/04/README.md)**: Kompletny przykład z dokumentacją
- **[Edukacyjny notebook Chainlit](samples/04/chainlit_app.ipynb)**: Interaktywne materiały edukacyjne
- **[Dokumentacja Foundry Local](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Kompletny opis platformy
