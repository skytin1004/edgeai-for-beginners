...
Ten przykład pokazuje, jak udostępniać modele Foundry Local jako wielokrotnego użytku narzędzia, które można zintegrować z istniejącymi aplikacjami, przepływami pracy i środowiskami programistycznymi. Prezentuje zalecane przez Microsoft wzorce integracji narzędzi i wywoływania funkcji.

## Kluczowe koncepcje

### 🔧 **Architektura oparta na narzędziach**
- Modele Foundry Local jako wywoływalne funkcje
- Standaryzowane interfejsy i schematy narzędzi
- Bezproblemowa integracja z istniejącymi bazami kodu
- Definicje narzędzi z kontrolą typów i walidacją

### ⚡ **Wzorce wywoływania funkcji**
- Implementacja wywoływania funkcji Microsoft Foundry Local
- Definicje narzędzi kompatybilne z OpenAI
- Automatyczna walidacja i konwersja parametrów
- Obsługa błędów i formatowanie odpowiedzi

### 🔌 **Ramy integracji**
- **Integracja z LangChain**: Natywne wsparcie narzędzi LangChain
- **Semantic Kernel**: Funkcje Microsoft Semantic Kernel
- **REST API**: Punkty końcowe oparte na HTTP
- **Narzędzia CLI**: Integracja z interfejsem wiersza poleceń
- **Jupyter Notebooks**: Interaktywne narzędzia programistyczne

### 🎯 **Wzorce zastosowań**
- Narzędzia do analizy i generowania kodu
- Przetwarzanie treści i podsumowywanie
- Analiza danych i wizualizacja
- Badania i wyszukiwanie informacji
...
### Wymagania systemowe
- **Python**: 3.9+ z obsługą asyncio
- **Node.js**: v18+ (dla integracji z JavaScript)
- **Pamięć**: Zalecane 12GB+
- **Przechowywanie**: 10GB+ na modele i narzędzia
...
### Zależności specyficzne dla ram
```bash
...
### 1. Tworzenie podstawowego narzędzia
```python
...
## Podstawowe wzorce narzędzi

### 1. Narzędzia oparte na funkcjach
```python
...
### 2. Narzędzia świadome kontekstu
```python
...
1. **Wzorce integracji narzędzi**
   - Projektowanie narzędzi opartych na funkcjach i klasach
   - Wzorce integracji Microsoft Foundry Local
   - Walidacja schematów i bezpieczeństwo typów
   - Obsługa błędów i odzyskiwanie

2. **Integracja z ramami**
   - Tworzenie narzędzi LangChain
   - Integracja funkcji Semantic Kernel
   - Integracja z ramami REST API
   - Tworzenie aplikacji CLI
...
4. **Zaawansowane wzorce narzędzi**
   - Kompozycja i łączenie narzędzi
   - Przetwarzanie świadome kontekstu
   - Operacje wsadowe i strumieniowe
   - Tworzenie niestandardowych integracji

## Kolejne kroki

- **Projekty integracyjne**: Twórz niestandardowe integracje z preferowanymi ramami
- **Rozwój narzędzi**: Twórz wyspecjalizowane narzędzia dla swojej dziedziny
- **Dostrajanie wydajności**: Optymalizuj pod kątem swoich specyficznych przypadków użycia
- **Wdrożenie produkcyjne**: Skaluj narzędzia do zastosowań korporacyjnych

## Wkład

Zapoznaj się z wytycznymi głównego repozytorium dotyczącymi instrukcji dotyczących wkładu.
