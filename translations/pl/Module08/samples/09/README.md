...
Zaawansowany system wieloagentowy opracowany przez Microsoft Foundry Local, który demonstruje koordynację inteligentnych agentów, delegowanie wyspecjalizowanych zadań oraz wzorce współpracy w rozwiązywaniu problemów.

## Przegląd

Ten przykład pokazuje, jak budować zaawansowane systemy AI agentów za pomocą Foundry Local, implementując oficjalne wzorce Microsoftu dotyczące wywoływania funkcji, orkiestracji agentów i współpracy w ramach AI.
...
### 🤖 **Inteligentna Koordynacja Agentów**
- Dynamiczna analiza zadań i wybór agentów
- Automatyczna dystrybucja obciążenia
- Agregacja i synteza wyników
- Protokoły komunikacji między agentami

### 🔧 **Wyspecjalizowane Typy Agentów**
- **Ekspert Kodowania**: Programowanie, debugowanie, przegląd kodu
- **Analityk Danych**: Przetwarzanie danych, wizualizacja, wnioski
- **Asystent Badawczy**: Zbieranie informacji, podsumowania
- **Specjalista ds. Pisania**: Tworzenie treści, edycja, dokumentacja
- **Rozwiązywacz Problemów**: Złożone rozumowanie, podejmowanie decyzji

### ⚡ **Zaawansowane Wywoływanie Funkcji**
- Wzorce wywoływania funkcji Microsoft Foundry Local
- Bezpieczne typowo definicje narzędzi
- Automatyczna walidacja parametrów
- Obsługa błędów i odzyskiwanie
- Łączenie i kompozycja narzędzi

### 🎯 **Inteligentne Kierowanie Zadaniami**
- Klasyfikacja i analiza intencji
- Dopasowanie zdolności agentów
- Równoważenie obciążenia i optymalizacja
- Obsługa awaryjna i redundancja

## Wymagania wstępne

### Wymagania systemowe
- **Python**: 3.9+ z obsługą asyncio
- **Pamięć**: Zalecane 16GB+ dla wielu agentów
...
### 1. Podstawowy Przepływ Wieloagentowy
```python
...
### 3. Integracja Wywoływania Funkcji
```python
...
### 1. Równoważenie Obciążenia Modelu
```python
...
### 2. Pamięć Podręczna i Zarządzanie Pamięcią
```python
...
### Przykład 1: Przepływ Pracy w Rozwoju Oprogramowania
```python
...
### Przykład 3: Sesja Rozwiązywania Problemów
```python
...
1. **Architekturę Systemu Wieloagentowego**
   - Wzorce koordynacji agentów
   - Strategie dystrybucji zadań
   - Techniki syntezy wyników
   - Zarządzanie kontekstem między agentami

2. **Integrację Microsoft Foundry Local**
   - Implementację wywoływania funkcji
   - Wzorce integracji narzędzi
   - Orkiestrację wielu modeli
   - Optymalizację wydajności

3. **Zaawansowaną Orkiestrację AI**
   - Projektowanie i wykonanie przepływów pracy
   - Mechanizmy zapewnienia jakości
   - Obsługę błędów i odzyskiwanie
...
- **Zaawansowane tematy**: Tworzenie własnych agentów
- **Skalowanie**: Rozproszone systemy agentów
- **Integracja**: Integracja przepływów pracy w przedsiębiorstwie

## Wkład

Zapoznaj się z wytycznymi głównego repozytorium dotyczącymi instrukcji wkładu.
