...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-01T00:15:46+00:00",
...
Ta sesja skupia się na praktycznym odkrywaniu i zarządzaniu modelami za pomocą Foundry Local. Nauczysz się, jak wyświetlać dostępne modele, testować różne opcje i rozumieć podstawowe charakterystyki wydajności. Podejście kładzie nacisk na praktyczną eksplorację za pomocą foundry CLI, aby pomóc Ci wybrać odpowiednie modele dla Twoich zastosowań.
...
- Ustanowienie praktycznych przepływów pracy dla wyboru i benchmarkingu modeli
- Eksploracja rozwijającego się ekosystemu modeli dostępnych przez Foundry Local
...
Ta sesja bada, jak wprowadzać modele open-source do Foundry Local.
...
- Zwiększ ilość RAM, jeśli często napotykasz ograniczenia
...
- **[Referencja CLI](https://learn.microsoft.com/azure/ai-foundry/foundry-local/reference/reference-cli)**: Kompletny zestaw poleceń
...
- Usuń nieużywane modele, aby zwolnić miejsce: `foundry cache clean`
...
- Zaawansowane: `qwen2.5-7b` (dłuższy kontekst)

**Do generowania kodu:**
- Zalecane: `deepseek-r1-7b`
- Alternatywa: `qwen2.5-7b` (również dobry do kodu)

**Do złożonego rozumowania:**
- Najlepsze: `qwen2.5-7b` lub `qwen2.5-14b`
...
- Przechowywanie SSD dla szybszego ładowania modeli
...
## Część 5: Proste benchmarki modeli
...
- Przekaż wyniki swojemu zespołowi do pliku `models.json`
- Przygotuj się do Sesji 4: porównanie LLM vs SLM, lokalne vs chmurowe wnioskowanie oraz praktyczne demonstracje
