...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:18:50+00:00",
...
مرحبًا بك في **EdgeAI للمبتدئين** – رحلتك الشاملة إلى عالم الذكاء الاصطناعي على الحافة. هذه الدورة تربط بين قدرات الذكاء الاصطناعي القوية والتطبيق العملي في العالم الحقيقي على الأجهزة الطرفية، مما يتيح لك الاستفادة من إمكانيات الذكاء الاصطناعي مباشرة حيث يتم إنشاء البيانات واتخاذ القرارات.
...
نماذج مثل Phi-4، Mistral-7B، وGemma هي نسخ محسنة من نماذج اللغة الكبيرة – تم تدريبها أو تقليل حجمها لتحقيق:
...
| [📚 01](../../Module01) | [أساسيات EdgeAI](./Module01/README.md) | مقارنة بين السحابة وEdge AI | أساسيات EdgeAI • دراسات حالة واقعية • دليل التنفيذ • النشر على الحافة | مبتدئ | 3-4 ساعات |
...
| [🔧 05](../../Module05) | [SLMOps للإنتاج](./Module05/README.md) | عمليات الإنتاج | مقدمة إلى SLMOps • تقليل حجم النماذج • التخصيص • النشر الإنتاجي | متقدم | 5-6 ساعات |
...
- **أدلة الجلسات** - أدلة تفصيلية لكل جلسة ورشة عمل
- **أدوات التحقق** - نصوص للتحقق من جودة الكود وتشغيل اختبارات الدخان
...
- **النشر متعدد المنصات**: Windows، الأجهزة المحمولة، الأنظمة المدمجة، وأنظمة السحابة والحافة الهجينة
...
- **تطبيقات RAG**: معالجة المستندات المحلية باستخدام البحث المتجهي
...
**قطاعات الصناعة**: التصنيع 4.0 • تكنولوجيا الرعاية الصحية • الأنظمة الذاتية • التكنولوجيا المالية • الإلكترونيات الاستهلاكية
