...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T07:38:54+00:00",
...
[![طلبات السحب في GitHub](https://img.shields.io/github/issues-pr/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/pulls)
...
تتيح هذه النماذج إمكانيات معالجة اللغة الطبيعية القوية مع تلبية قيود:
...
| [📚 01](../../Module01) | [أساسيات EdgeAI](./Module01/README.md) | مقارنة بين السحابة وEdge AI | أساسيات EdgeAI • دراسات حالة واقعية • دليل التنفيذ • نشر الحافة | مبتدئ | 3-4 ساعات |
...
| [🔧 05](../../Module05) | [SLMOps الإنتاجي](./Module05/README.md) | عمليات الإنتاج | مقدمة إلى SLMOps • تقليل النماذج • التخصيص • النشر الإنتاجي | متقدم | 5-6 ساعات |
...
- **عمليات الإنتاج**: مراقبة وتوسيع وصيانة الذكاء الاصطناعي على الحافة في الإنتاج
...
✅ **متعدد المنصات**: ويندوز، الهواتف المحمولة، الأجهزة المدمجة، السحابة-الحافة الهجينة  
