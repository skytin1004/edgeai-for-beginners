...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T13:59:29+00:00",
...
مرحبًا بك في **EdgeAI للمبتدئين** – رحلتك الشاملة إلى عالم الذكاء الاصطناعي على الحافة. هذه الدورة تربط بين قدرات الذكاء الاصطناعي القوية والتطبيق العملي في العالم الحقيقي على الأجهزة الطرفية، مما يمكّنك من استغلال إمكانيات الذكاء الاصطناعي مباشرةً حيث يتم إنشاء البيانات واتخاذ القرارات.
...
- **الاستدلال في الوقت الحقيقي** مع ميزات الحفاظ على الخصوصية
- **استراتيجيات النشر الإنتاجي** لتطبيقات المؤسسات

### لماذا يهم EdgeAI

يمثل Edge AI تحولًا جذريًا يعالج تحديات العصر الحديث:
...
نماذج مثل Phi-4، Mistral-7B، وGemma هي نسخ محسّنة من نماذج اللغة الكبيرة – تم تدريبها أو تقليلها لتناسب:
...
**الموضوع**: التحول الجذري لنشر الذكاء الاصطناعي على الحافة

#### هيكل الفصول:
- [**القسم 1: أساسيات EdgeAI**](./Module01/01.EdgeAIFundamentals.md)
  - مقارنة بين الذكاء الاصطناعي السحابي التقليدي وEdgeAI
  - تحديات وقيود الحوسبة الطرفية
  - التقنيات الرئيسية: تقليل حجم النموذج، تحسين الضغط، نماذج اللغة الصغيرة (SLMs)
...
- [**القسم 2: دراسات حالة واقعية**](./Module01/02.RealWorldCaseStudies.md)
  - نظام نماذج Phi & Mu من Microsoft
...
- [**القسم 3: دليل التنفيذ العملي**](./Module01/03.PracticalImplementationGuide.md)
  ...
  - أدوات تقليل الحجم والتحسين (Llama.cpp، Microsoft Olive، Apple MLX)
  - قائمة التقييم والتحقق

- [**القسم 4: منصات الأجهزة لنشر Edge AI**](./Module01/04.EdgeDeployment.md)
  - اعتبارات ومتطلبات نشر Edge AI
  - أجهزة Intel Edge AI وتقنيات التحسين
  - حلول Qualcomm AI للأجهزة المحمولة والأنظمة المدمجة
...
- [**القسم 1: التعلم المتقدم لنماذج اللغة الصغيرة**](./Module03/01.SLMAdvancedLearning.md)
  ...
  - تقنيات تحسين متقدمة (طرق تقليل الحجم، تقليل الحجم إلى 1-bit باستخدام BitNET)
...
- [**القسم 3: نشر السحابة المعبأة في حاويات**](./Module03/03.DeployingSLMinCloud.md)
  - نشر استدلال عالي الأداء باستخدام vLLM
  - تنظيم الحاويات باستخدام Ollama
  - تنفيذ محسن للحافة باستخدام ONNX Runtime

---

### [الوحدة 04: تحويل تنسيق النموذج وتقليل الحجم](./Module04/README.md)
**الموضوع**: مجموعة أدوات كاملة لتحسين النموذج للنشر على الحافة عبر المنصات

#### هيكل الفصول:
- [**القسم 1: أساسيات تحويل تنسيق النموذج وتقليل الحجم**](./Module04/01.Introduce.md)
  - إطار تصنيف الدقة (دقة منخفضة جدًا، منخفضة، متوسطة)
  - مزايا واستخدامات تنسيقات GGUF وONNX
  - فوائد تقليل الحجم للكفاءة التشغيلية
  - معايير الأداء ومقارنات استهلاك الذاكرة
- [**القسم 2: دليل تنفيذ Llama.cpp**](./Module04/02.Llamacpp.md)
  - التثبيت عبر الأنظمة الأساسية (ويندوز، macOS، لينكس)
  - تحويل التنسيق GGUF ومستويات التكميم (Q2_K إلى Q8_0)
  - تسريع الأجهزة (CUDA، Metal، OpenCL، Vulkan)
  - تكامل Python ونشر REST API
...
- [**القسم 3: مجموعة تحسين Microsoft Olive**](./Module04/03.MicrosoftOlive.md)
  ...
  - تحسين تلقائي باستخدام التكميم الديناميكي والثابت
  - تكامل المؤسسات مع تدفقات عمل Azure ML
...
- [**القسم 4: مجموعة تحسين OpenVINO Toolkit**](./Module04/04.openvino.md)
  ...
  - إطار ضغط الشبكات العصبية (NNCF) لتحسين متقدم
...
- [**القسم 5: استكشاف عميق لإطار Apple MLX**](./Module04/05.AppleMLX.md)
  ...
  - دعم LLaMA، Mistral، Phi، نماذج Qwen المختارة
  - ضبط LoRA وتخصيص النماذج
  - تكامل Hugging Face مع تكميم 4 بت/8 بت
...
- [**القسم 6: توليف سير عمل تطوير Edge AI**](./Module04/06.workflow-synthesis.md)
  ...
  - استراتيجيات المستقبل للأجهزة الناشئة وهياكل النماذج
...
- [**القسم 3: ضبط النماذج - تخصيص النماذج لمهام محددة**](./Module05/03.SLMOps-Finetuing.md)
  - تقنيات ضبط المعلمات بكفاءة (PEFT)
...
### [الوحدة 06: أنظمة SLM Agentic - وكلاء الذكاء الاصطناعي واستدعاء الوظائف](./Module06/README.md)
**الموضوع**: تنفيذ أنظمة SLM Agentic من الأساس إلى استدعاء الوظائف المتقدم وتكامل بروتوكول سياق النموذج

#### هيكل الفصول:
- [**القسم 1: وكلاء الذكاء الاصطناعي وأساسيات نماذج اللغة الصغيرة**](./Module06/01.IntroduceAgent.md)
  ...
  - النشر العملي باستخدام Ollama، VLLM، وحلول Microsoft للحافة
...
- [**القسم 3: تكامل بروتوكول سياق النموذج (MCP)**](./Module06/03.IntroduceMCP.md)
  ...
  - تطبيقات واقعية (أتمتة الويب، معالجة البيانات، تكامل API)
...
- [**أداة الذكاء الاصطناعي لـ Visual Studio Code**](./Module07/aitoolkit.md)
  ...
  - اختبارات محلية، تحسين، وتدفقات عمل تطوير الوكلاء
...
- [**دليل تطوير EdgeAI على ويندوز**](./Module07/windowdeveloper.md)
  ...
  - واجهة برمجة تطبيقات Phi Silica للاستدلال الفعال على NPU
...
- [**EdgeAI في NVIDIA Jetson Orin Nano**](./Module07/README.md#1-edgeai-in-nvidia-jetson-orin-nano)
  ...
  - تطبيقات في الروبوتات، الطائرات بدون طيار، الكاميرات الذكية، الأجهزة الذاتية
...
- [**EdgeAI في التطبيقات المحمولة باستخدام .NET MAUI وONNX Runtime GenAI**](./Module07/README.md#2-edgeai-in-mobile-applications-with-net-maui-and-onnx-runtime-genai)
  - ذكاء اصطناعي محمول عبر الأنظمة الأساسية مع قاعدة كود C# واحدة
  - دعم تسريع الأجهزة (CPU، GPU، معالجات الذكاء الاصطناعي المحمولة)
  - تحسينات خاصة بالمنصة (CoreML لـ iOS، NNAPI لـ Android)
...
- [**EdgeAI في Azure مع محرك نماذج اللغة الصغيرة**](./Module07/README.md#3-edgeai-in-azure-with-small-language-models-engine)
  ...
  - نشر على نطاق المؤسسة وإدارة النماذج المستمرة
  - تدفقات عمل ذكاء اصطناعي هجينة لمعالجة المستندات الذكية

- [**EdgeAI مع Windows ML**](./Module07/README.md#4-edgeai-with-windows-ml)
  - أساس Windows AI Foundry للاستدلال الفعال على الجهاز
  - دعم الأجهزة العالمية (AMD، Intel، NVIDIA، Qualcomm silicon)
  - تجريد الأجهزة التلقائي والتحسين
  - إطار موحد لنظام الأجهزة المتنوع لـ Windows
...
- [**EdgeAI مع تطبيقات Foundry Local**](./Module07/README.md#5-edgeai-with-foundry-local-applications)
  ...
  - تكامل نموذج اللغة Phi-4 مع البحث الدلالي (نماذج Phi فقط)
  - دعم قواعد البيانات المحلية المتجهة (SQLite، Qdrant)
  - سيادة البيانات وقدرات التشغيل دون اتصال

### [الوحدة 08: Microsoft Foundry Local – مجموعة أدوات المطور الكاملة](./Module08/README.md)
**الموضوع**: بناء وتشغيل وتكامل الذكاء الاصطناعي محليًا باستخدام Foundry Local؛ التوسع والهجين مع Azure AI Foundry

#### هيكل الفصول:
- [**1: البدء مع Foundry Local**](./Module08/01.FoundryLocalSetup.md)
- [**2: بناء حلول الذكاء الاصطناعي مع Azure AI Foundry**](./Module08/02.AzureAIFoundryIntegration.md)
- [**3: نماذج مفتوحة المصدر لـ Foundry Local**](./Module08/03.OpenSourceModels.md)
- [**4: نماذج متقدمة واستدلال على الجهاز**](./Module08/04.CuttingEdgeModels.md)
- [**5: وكلاء مدعومون بالذكاء الاصطناعي مع Foundry Local**](./Module08/05.AIPoweredAgents.md)
- [**6: النماذج كأدوات**](./Module08/06.ModelsAsTools.md)

## أهداف تعلم الدورة

من خلال إكمال هذه الدورة الشاملة لـ EdgeAI، ستطور الخبرة اللازمة لتصميم وتنفيذ ونشر حلول EdgeAI الجاهزة للإنتاج. يضمن نهجنا المنظم إتقانك للأسس النظرية ومهارات التنفيذ العملية.

### الكفاءات التقنية

**المعرفة الأساسية**
- فهم الفروقات الأساسية بين بنى الذكاء الاصطناعي القائمة على السحابة والحافة
...
- تنفيذ أنظمة الاستدلال في الوقت الفعلي بمتطلبات استجابة دون الثانية
...
- تنفيذ تدفقات البيانات وخطوط المعالجة لتطبيقات الذكاء الاصطناعي في الوقت الفعلي
...
- **الإلكترونيات الاستهلاكية**: تطبيقات محمولة مدعومة بالذكاء الاصطناعي وأجهزة المنازل الذكية

## نظرة عامة على نتائج التعلم

### نتائج تعلم الوحدة 01:
- فهم الفروقات الأساسية بين بنى الذكاء الاصطناعي السحابية والحافة
...
- امتلاك رؤى مستقبلية جاهزة حول بنى الذكاء الاصطناعي الفعالة

### نتائج تعلم الوحدة 03:
- قدرات اختيار النماذج الاستراتيجية
- إتقان تقنيات التحسين
- إتقان مرونة النشر
- قدرات تكوين جاهزة للإنتاج

### نتائج تعلم الوحدة 04:
- فهم عميق لحدود التكميم والتطبيقات العملية
- خبرة عملية مع أطر تحسين متعددة (Llama.cpp، Olive، OpenVINO، MLX)
...
- اختيار استراتيجي للأطر وتوليف سير العمل لحلول Edge AI المثلى

### نتائج تعلم الوحدة 05:
- إتقان نموذج SLMOps ومبادئه التشغيلية
- تنفيذ تقطير النماذج لنقل المعرفة وتحسين الكفاءة
- تطبيق تقنيات الضبط لتخصيص النماذج الخاصة بالمجال
- نشر حلول SLM جاهزة للإنتاج مع استراتيجيات المراقبة والصيانة

### نتائج تعلم الوحدة 06:
...
- تكامل برو
- **إدارة المخاطر**: تحديد وتخفيف المخاطر التقنية والتشغيلية في عمليات نشر EdgeAI  
- **تحسين العائد على الاستثمار (ROI)**: إثبات القيمة التجارية القابلة للقياس من تطبيقات EdgeAI  

### فرص التقدم المهني  

**الأدوار المهنية**  
- مهندس حلول EdgeAI  
- مهندس تعلم الآلة (تخصص Edge)  
- مطور ذكاء اصطناعي لإنترنت الأشياء  
- مطور تطبيقات ذكاء اصطناعي للهواتف المحمولة  
- مستشار ذكاء اصطناعي للمؤسسات  

**قطاعات الصناعة**  
- التصنيع الذكي وصناعة 4.0  
- المركبات ذاتية القيادة والنقل  
- تكنولوجيا الرعاية الصحية والأجهزة الطبية  
- التكنولوجيا المالية والأمن  
- الإلكترونيات الاستهلاكية وتطبيقات الهواتف المحمولة  

### الشهادات والتحقق  

**تطوير الحافظة المهنية**  
- إكمال مشاريع EdgeAI شاملة لإثبات الكفاءة العملية  
- نشر حلول جاهزة للإنتاج عبر منصات أجهزة متعددة  
- توثيق استراتيجيات التحسين والتحسينات في الأداء التي تم تحقيقها  

**مسار التعلم المستمر**  
- أساس لتخصصات الذكاء الاصطناعي المتقدمة  
- إعداد للهياكل السحابية-الحافة الهجينة  
- بوابة للتقنيات والأطر الناشئة في الذكاء الاصطناعي  

هذا المساق يضعك في مقدمة نشر تقنيات الذكاء الاصطناعي، حيث يتم دمج القدرات الذكية بسلاسة في الأجهزة والأنظمة التي تدعم الحياة الحديثة.  
...
- **دراسات حالة حقيقية**: مستندة إلى حالات فعلية من Microsoft، Alibaba، Google، وغيرها  
- **ممارسة عملية**: إكمال ملفات التكوين، إجراءات اختبار API، ونصوص النشر  
- **معايير الأداء**: مقارنات تفصيلية لسرعة الاستدلال، استخدام الذاكرة، ومتطلبات الموارد  
...
4. استمر مع **Module04** لتحسين النماذج المتقدمة، تحويل الصيغ، وتركيب الأطر  
5. أكمل **Module05** لإتقان SLMOps لتطبيقات جاهزة للإنتاج  
6. استكشف **Module06** لفهم أنظمة SLM الوكيلية وقدرات استدعاء الوظائف  
7. أنهي بـ **Module07** لاكتساب خبرة عملية مع أدوات الذكاء الاصطناعي وعينات متنوعة لتطبيقات EdgeAI  
8. استكشف **Module08** للحصول على مجموعة أدوات Foundry Local كاملة (تطوير محلي أول مع تكامل Azure الهجين)  

كل وحدة مصممة لتكون مكتملة بشكل مستقل، ولكن التعلم المتسلسل سيحقق أفضل النتائج.  

## دليل الدراسة  

يتوفر [دليل الدراسة](STUDY_GUIDE.md) لمساعدتك على تحقيق أقصى استفادة من تجربة التعلم. يوفر دليل الدراسة:  

- **مسارات تعلم منظمة**: جداول زمنية محسّنة لإكمال الدورة في 20 ساعة  
...
- **أفكار مشاريع صغيرة**: تطبيقات عملية لتعزيز تعلمك  

تم تصميم دليل الدراسة ليتناسب مع التعلم المكثف (أسبوع واحد) والدراسة الجزئية (3 أسابيع)، مع إرشادات واضحة حول كيفية تخصيص وقتك بفعالية حتى إذا كان بإمكانك تخصيص 10 ساعات فقط للدورة.  
