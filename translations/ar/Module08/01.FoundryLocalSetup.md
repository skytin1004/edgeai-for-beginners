...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T13:25:00+00:00",
...
قم بإنشاء تطبيق دردشة جاهز للإنتاج باستخدام OpenAI SDK مع تكامل Foundry Local، باتباع الأنماط من Sample 01.
...
- **استخدام OpenAI SDK**: يفضل استخدام OpenAI SDK بدلاً من طلبات HTTP الخام لتحسين قابلية الصيانة
...
- **ابدأ صغيرًا**: ابدأ بالنماذج الصغيرة (Phi mini، Qwen 7B) وقم بالتوسع تدريجيًا
...
### التمرين الأول: اختبار سريع متعدد النماذج
...
### التمرين الثاني: اختبار تكامل OpenAI SDK
...
### التمرين الثالث: فحص شامل لصحة الخدمة
