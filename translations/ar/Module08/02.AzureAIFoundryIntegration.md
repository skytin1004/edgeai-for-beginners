...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T14:25:06+00:00",
...
بناءً على أساسيات Foundry Local، تركز هذه الجلسة على إنشاء حلول ذكاء اصطناعي متقدمة من خلال هندسة متقدمة للتوجيهات، تكامل سلس للبيانات، وأتمتة المهام القابلة للتنفيذ. ستتعلم كيفية الربط بين التطوير المحلي وقدرات Azure AI Foundry لإنشاء تطبيقات جاهزة للمؤسسات تستفيد من أفضل ما في العالمين.

## أهداف التعلم

بنهاية هذه الجلسة، ستتمكن من:
- إتقان تقنيات هندسة التوجيهات المتقدمة للحصول على استجابات ذكاء اصطناعي موثوقة ومتسقة
- تنفيذ أنماط تكامل بيانات قوية لتطبيقات العالم الحقيقي
- إنشاء مهام ذكاء اصطناعي قابلة للتنفيذ تضيف قيمة للأعمال
- تأسيس اتصال سلس بين Foundry Local وAzure AI Foundry
- بناء تدفقات عمل لمراقبة الأداء وتحسينه
- نشر حلول ذكاء اصطناعي جاهزة للإنتاج مع معالجة الأخطاء والتوسع بشكل صحيح

## المتطلبات الأساسية

- إكمال الجلسة الأولى: البدء مع Foundry Local
- تثبيت نشط لـ Foundry Local مع نماذج قيد التشغيل
- حساب Azure (الطبقة المجانية كافية للتعلم)
- فهم أساسي لـ REST APIs وJSON

## الجزء الأول: هندسة التوجيهات المتقدمة

### فهم بنية التوجيهات

هندسة التوجيهات الفعالة هي أساس تطبيقات الذكاء الاصطناعي الموثوقة. يوفر Foundry Local قدرات محسّنة للتوجيهات:
...
## الجزء الثاني: أنماط تكامل البيانات

### موصلات بيانات Foundry Local
...
### مثال على تكامل البيانات في العالم الحقيقي
...
## الجزء الثالث: مهام الذكاء الاصطناعي القابلة للتنفيذ

### إطار عمل أتمتة المهام
...
### أمثلة على أتمتة العمليات التجارية
...
## الجزء الرابع: تكامل Azure AI Foundry
...
## الجزء الخامس: مراقبة الأداء وتحسينه
...
## الجزء السادس: تمارين عملية

### التمرين الأول: روبوت خدمة العملاء المتقدم
...
### التمرين الثاني: أبحاث السوق المؤتمتة
...
## الجزء السابع: الخطوات التالية ومعاينة الجلسة الثالثة

### إنجازات الجلسة

في هذه الجلسة، أتقنت:
- ✅ تقنيات هندسة التوجيهات المتقدمة لسلوك ذكاء اصطناعي متسق
- ✅ أنماط تكامل بيانات قوية لتطبيقات العالم الحقيقي
- ✅ إنشاء مهام مؤتمتة لتحسين العمليات التجارية
- ✅ تكامل Azure AI Foundry واستراتيجيات النشر الهجينة
- ✅ مراقبة الأداء وتحسينه بشكل شامل

### التحضير للجلسة الثالثة: النماذج مفتوحة المصدر

1. **استكشاف Hugging Face**: قم بإنشاء حساب واستعرض كتالوج النماذج
2. **مراجعة Model Mondays**: تحقق من أحدث [سلسلة Model Mondays](https://aka.ms/model-mondays)
3. **تخطيط النماذج المخصصة**: فكر في النماذج المتخصصة التي ستفيد حالات الاستخدام الخاصة بك

### موارد إضافية

- [وثائق Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [مستودع GitHub الخاص بـ Foundry Local](https://github.com/microsoft/Foundry-Local)
- [دليل هندسة التوجيهات المتقدمة](https://platform.openai.com/docs/guides/prompt-engineering)
- [أفضل الممارسات لأتمتة العمليات التجارية](https://docs.microsoft.com/en-us/power-automate/)

أنت الآن مجهز لبناء حلول ذكاء اصطناعي متقدمة تجمع بين قوة الاستدلال المحلي وقدرات السحابة، مما يضع الأساس لتطبيقات ذكاء اصطناعي على مستوى المؤسسات.
