...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T17:03:10+00:00",
...
للتطوير والاختبار المحلي، يمكنك استخدام [Microsoft Foundry Local](https://github.com/microsoft/foundry-local) لتشغيل نماذج Qwen المتاحة على جهاز التطوير الخاص بك بأداء محسن.
...
في هذا الدليل، سنستكشف عائلة نماذج Qwen من Alibaba ومفاهيمها الأساسية. سنغطي تطور عائلة Qwen، منهجيات التدريب المبتكرة التي تجعل نماذج Qwen فعالة، المتغيرات الرئيسية في العائلة، والتطبيقات العملية عبر سيناريوهات مختلفة.
...
- التعرف على فوائد وحدود المتغيرات المختلفة لنماذج Qwen
- تطبيق المعرفة بنماذج Qwen لاختيار المتغيرات المناسبة للسيناريوهات الواقعية

## فهم مشهد نماذج الذكاء الاصطناعي الحديثة

لقد تطور مشهد الذكاء الاصطناعي بشكل كبير، حيث تتبع المنظمات المختلفة نهجًا متنوعًا لتطوير نماذج اللغة. بينما يركز البعض على النماذج المغلقة المصدر، يركز آخرون على إمكانية الوصول المفتوح والشفافية. النهج التقليدي يتضمن إما نماذج ضخمة مغلقة المصدر يمكن الوصول إليها فقط عبر واجهات برمجية أو نماذج مفتوحة المصدر قد تتأخر في القدرات.

هذا النموذج يخلق تحديات للمنظمات التي تسعى للحصول على قدرات ذكاء اصطناعي قوية مع الحفاظ على التحكم في بياناتها، تكاليفها، وخيارات النشر. غالبًا ما يتطلب النهج التقليدي الاختيار بين الأداء المتقدم واعتبارات النشر العملية.

## تحدي التميز في الذكاء الاصطناعي القابل للوصول

أصبحت الحاجة إلى ذكاء اصطناعي عالي الجودة وقابل للوصول أكثر أهمية عبر سيناريوهات متنوعة. ضع في اعتبارك التطبيقات التي تتطلب خيارات نشر مرنة لتلبية احتياجات المنظمات المختلفة، تنفيذات فعالة من حيث التكلفة حيث يمكن أن تصبح تكاليف واجهات البرمجية كبيرة، قدرات متعددة اللغات للتطبيقات العالمية، أو خبرة متخصصة في مجالات مثل البرمجة والرياضيات.

### متطلبات النشر الرئيسية

تواجه عمليات نشر الذكاء الاصطناعي الحديثة عدة متطلبات أساسية تحد من التطبيق العملي:

- **إمكانية الوصول**: توفر مفتوح المصدر للشفافية والتخصيص
...
- **التخصص**: متغيرات خاصة بالمجال لاستخدامات معينة

## فلسفة نماذج Qwen

تمثل عائلة نماذج Qwen نهجًا شاملاً لتطوير نماذج الذكاء الاصطناعي، حيث تعطي الأولوية لإمكانية الوصول المفتوح، القدرات متعددة اللغات، والنشر العملي مع الحفاظ على خصائص الأداء التنافسية. تحقق نماذج Qwen ذلك من خلال أحجام نماذج متنوعة، منهجيات تدريب عالية الجودة، ومتغيرات متخصصة لمجالات مختلفة.

تشمل عائلة Qwen نهجًا متنوعًا مصممًا لتوفير خيارات عبر طيف الأداء والكفاءة، مما يمكن النشر من الأجهزة المحمولة إلى خوادم المؤسسات مع توفير قدرات ذكاء اصطناعي ذات معنى. الهدف هو ديمقراطية الوصول إلى ذكاء اصطناعي عالي الجودة مع توفير المرونة في خيارات النشر.

### مبادئ تصميم Qwen الأساسية

تم بناء نماذج Qwen على عدة مبادئ أساسية تميزها عن عائلات نماذج اللغة الأخرى:

- **الأولوية للمصدر المفتوح**: شفافية كاملة وإمكانية الوصول للاستخدام البحثي والتجاري
...
- **تميز متخصص**: متغيرات خاصة بالمجال محسنة لمهام معينة

## التقنيات الرئيسية التي تمكن عائلة Qwen

### تدريب واسع النطاق

أحد الجوانب المميزة لعائلة Qwen هو النطاق الواسع لبيانات التدريب والموارد الحسابية المستثمرة في تطوير النماذج. تستفيد نماذج Qwen من مجموعات بيانات متعددة اللغات تم اختيارها بعناية تمتد عبر تريليونات من الرموز، مصممة لتوفير معرفة شاملة وقدرات استدلال.

### التفكير والاستدلال المتقدم

تتضمن نماذج Qwen الحديثة قدرات استدلال متطورة تمكن من حل المشكلات المعقدة متعددة الخطوات:

**وضع التفكير (Qwen3)**: يمكن للنماذج الانخراط في استدلال تفصيلي خطوة بخطوة قبل تقديم الإجابات النهائية، مشابهة لنهج حل المشكلات البشري.

**عملية ثنائية الوضع**: القدرة على التبديل بين وضع الاستجابة السريعة للاستفسارات البسيطة ووضع التفكير العميق للمشكلات المعقدة.

**دمج سلسلة التفكير**: دمج طبيعي لخطوات الاستدلال التي تحسن الشفافية والدقة في المهام المعقدة.

### ابتكارات هيكلية

تتضمن عائلة Qwen العديد من التحسينات الهيكلية المصممة للأداء والكفاءة:

**تصميم قابل للتوسع**: هيكلية متسقة عبر أحجام النماذج مما يسهل التوسع والمقارنة.

**تكامل متعدد الوسائط**: تكامل سلس لمعالجة النصوص، الرؤية، والصوت ضمن هيكلية موحدة.

**تحسين النشر**: خيارات متعددة للتكميم وتنسيقات النشر لتناسب تكوينات الأجهزة المختلفة.
...
النماذج متوسطة الحجم تقدم قدرات محسنة للتطبيقات المهنية، مما يوفر توازنًا ممتازًا بين الأداء ومتطلبات الحساب.

### نماذج كبيرة (72B+)

النماذج واسعة النطاق تقدم أداءً متقدمًا للتطبيقات المتطلبة، البحث، ونشر المؤسسات التي تتطلب أقصى قدر من القدرات.

## فوائد عائلة نماذج Qwen

### إمكانية الوصول المفتوح

توفر نماذج Qwen شفافية كاملة وقدرات تخصيص، مما يمكن المنظمات من فهم، تعديل، وتكييف النماذج لتلبية احتياجاتها الخاصة دون قيود الموردين.
...
تتفوق نماذج Qwen في الفهم والتوليد متعدد اللغات، مما يدعم عشرات اللغات مع قوة خاصة في الإنجليزية والصينية، مما يجعلها مناسبة للتطبيقات العالمية.
...
المتغيرات الخاصة بالمجال مثل Qwen-Coder و Qwen-Math توفر خبرة متخصصة مع الحفاظ على قدرات الفهم اللغوي العامة.
...
تظهر نماذج Qwen قدرات قوية متعددة اللغات عبر لغات مختلفة:
...
يتفوق Qwen-Coder في توليد وشرح الأكواد عبر لغات برمجة متعددة:
...
### مثال على النشر على الحافة

يمكن نشر نماذج Qwen على أجهزة الحافة المختلفة بتكوينات محسنة:
...
### Qwen 1.0 و 1.5: نماذج الأساس

النماذج الأولى من Qwen وضعت المبادئ الأساسية للتدريب الشامل وإمكانية الوصول المفتوح:

- **Qwen-7B (7B معلمات)**: الإصدار الأول يركز على فهم اللغة الصينية والإنجليزية
- **Qwen-14B (14B معلمات)**: قدرات محسنة مع تحسين الاستدلال والمعرفة
- **Qwen-72B (72B معلمات)**: نموذج واسع النطاق يقدم أداءً متقدمًا
- **سلسلة Qwen1.5**: توسعت إلى أحجام متعددة (0.5B إلى 110B) مع تحسين معالجة السياقات الطويلة

### عائلة Qwen2: توسع متعدد الوسائط

سلسلة Qwen2 حققت تقدمًا كبيرًا في القدرات اللغوية ومتعددة الوسائط:

- **Qwen2-0.5B إلى 72B**: مجموعة شاملة من نماذج اللغة لتلبية احتياجات النشر المختلفة
- **Qwen2-57B-A14B (MoE)**: هيكلية خليط الخبراء لاستخدام فعال للمعلمات
- **Qwen2-VL**: قدرات متقدمة لفهم النصوص والصور
- **Qwen2-Audio**: معالجة وفهم الصوت
- **Qwen2-Math**: استدلال رياضي متخصص وحل المشكلات

### عائلة Qwen2.5: أداء محسّن

سلسلة Qwen2.5 جلبت تحسينات كبيرة عبر جميع الأبعاد:

- **تدريب موسع**: 18 تريليون رمز من بيانات التدريب لتحسين القدرات
- **سياق ممتد**: طول سياق يصل إلى 128K رمز، مع متغير Turbo يدعم 1M رمز
- **تخصص محسّن**: تحسين متغيرات Qwen2.5-Coder و Qwen2.5-Math
- **دعم متعدد اللغات أفضل**: أداء محسّن عبر أكثر من 27 لغة

### عائلة Qwen3: استدلال متقدم

الجيل الأحدث يدفع حدود القدرات الاستدلالية والتفكيرية:
...
- **وضع التفكير**: نهج استدلال هجين يدعم الاستجابات السريعة والتفكير العميق
- **تميز متعدد اللغات**: دعم لـ 119 لغة ولهجة
- **تدريب محسّن**: 36 تريليون رمز من بيانات التدريب المتنوعة وعالية الجودة
...
تستخدم المنصات التعليمية نماذج Qwen للتدريس الشخصي، توليد المحتوى التلقائي، مساعدة تعلم اللغات، وتجارب تعليمية تفاعلية. النماذج المتخصصة مثل Qwen-Math توفر خبرة خاصة بالمجال.
...
بينما تؤدي نماذج Qwen بشكل جيد عبر المجالات العامة، قد تستفيد التطبيقات المتخصصة للغاية من ضبط دقيق أو نماذج متخصصة.

### تعقيد اختيار النموذج

النطاق الواسع للنماذج والمتغيرات المتاحة قد يجعل الاختيار تحديًا للمستخدمين الجدد في النظام.
...
تمثل عائلة نماذج Qwen التطور المستمر نحو ذكاء اصطناعي ديمقراطي وعالي الجودة. تشمل التطورات المستقبلية تحسينات الكفاءة، توسع القدرات متعددة الوسائط، آليات استدلال محسّنة، وتكامل أفضل عبر سيناريوهات نشر مختلفة.

مع استمرار تطور التكنولوجيا، يمكننا توقع أن تصبح نماذج Qwen أكثر قدرة مع الحفاظ على إمكانية الوصول المفتوح، مما يمكن نشر الذكاء الاصطناعي عبر سيناريوهات واستخدامات متنوعة.
...
### 📱 النشر على الأجهزة المحمولة والحواف
...
حققت عائلة نماذج Qwen أداءً مذهلاً عبر العديد من المعايير مع الحفاظ على إمكانية الوصول المفتوح المصدر:

### أبرز نقاط الأداء

**التفوق في التفكير:**
- حقق Qwen3-235B-A22B نتائج تنافسية في تقييمات المعايير الخاصة بالبرمجة، الرياضيات، والقدرات العامة مقارنةً بنماذج أخرى مثل DeepSeek-R1، o1، o3-mini، Grok-3، وGemini-2.5-Pro
- يتفوق Qwen3-30B-A3B على QwQ-32B مع 10 أضعاف عدد المعاملات النشطة
- يمكن لـ Qwen3-4B منافسة أداء Qwen2.5-72B-Instruct

**إنجازات الكفاءة:**
- تحقق نماذج Qwen3-MoE الأساسية أداءً مشابهًا لنماذج Qwen2.5 الأساسية الكثيفة مع استخدام 10% فقط من المعاملات النشطة
- توفير كبير في التكلفة أثناء التدريب والاستخدام مقارنةً بالنماذج الكثيفة
...
**مقياس التدريب:**
- تستخدم Qwen3 ما يقرب من ضعف كمية البيانات، مع حوالي 36 تريليون رمز تغطي 119 لغة ولهجة مقارنةً بـ Qwen2.5 التي تستخدم 18 تريليون رمز
...
| **Qwen2.5-VL** | متنوع | متغير | فهم اللغة والرؤية | التطبيقات متعددة الوسائط، تحليل الصور |
...
- **Qwen2.5-Math**: حل المسائل الرياضية وتعليم العلوم والتكنولوجيا
...
- **مزودو السحابة المختلفون**: دعم عبر منصات التعلم الآلي القياسية
...
- **استخدم قوالب الدردشة**: تطبيق التنسيق المناسب للحصول على أفضل النتائج
- **راقب الموارد**: تتبع استخدام الذاكرة وسرعة الاستدلال
- **فكر في التخصص**: اختر المتغيرات الخاصة بالمجال عند الحاجة
...
تمثل عائلة نماذج Qwen نهجًا شاملاً لتعميم تكنولوجيا الذكاء الاصطناعي مع الحفاظ على أداء تنافسي عبر تطبيقات متنوعة. من خلال التزامها بالوصول المفتوح المصدر، القدرات متعددة اللغات، وخيارات النشر المرنة، تمكن Qwen المؤسسات والمطورين من الاستفادة من قدرات الذكاء الاصطناعي القوية بغض النظر عن مواردهم أو متطلباتهم الخاصة.
...
**بنية قابلة للتوسع**: النطاق من 0.5B إلى 235B من المعاملات يتيح النشر عبر جميع البيئات الحاسوبية، من الأجهزة المحمولة إلى مجموعات المؤسسات.

**قدرات متخصصة**: المتغيرات الخاصة بالمجال مثل Qwen-Coder، Qwen-Math، وQwen-VL توفر خبرة متخصصة مع الحفاظ على فهم اللغة العامة.
...
- **كفاءة محسنة**: تحسين مستمر لنسب الأداء لكل معاملة
...
- **نمو المجتمع**: توسيع نظام الأدوات، التطبيقات، ومساهمات المجتمع
...
- **المجتمع**: [مناقشات ومشاكل GitHub](https://github.com/QwenLM/)
...
2. اختيار المتغير المناسب من Qwen بناءً على متطلبات التطبيق وقيود الموارد
