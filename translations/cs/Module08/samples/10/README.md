...
Tento příklad ukazuje, jak zpřístupnit modely Foundry Local jako opakovaně použitelné nástroje, které lze integrovat do stávajících aplikací, pracovních postupů a vývojových prostředí. Představuje doporučené vzory Microsoftu pro integraci nástrojů a volání funkcí.

## Klíčové koncepty

### 🔧 **Architektura zaměřená na nástroje**
- Modely Foundry Local jako volatelné funkce
- Standardizované rozhraní a schémata nástrojů
- Bezproblémová integrace do stávajících kódových základen
- Typově bezpečné definice nástrojů a validace

### ⚡ **Vzory volání funkcí**
- Implementace volání funkcí Microsoft Foundry Local
- Definice nástrojů kompatibilní s OpenAI
- Automatická validace a konverze parametrů
- Zpracování chyb a formátování odpovědí

### 🔌 **Rámce pro integraci**
- **Integrace LangChain**: Nativní podpora nástrojů LangChain
- **Semantic Kernel**: Funkce Microsoft Semantic Kernel
- **REST API**: Koncové body založené na HTTP
- **CLI nástroje**: Integrace příkazového řádku
- **Jupyter Notebooks**: Interaktivní vývojové nástroje

### 🎯 **Vzory použití**
- Nástroje pro analýzu a generování kódu
- Zpracování obsahu a sumarizace
- Analýza dat a vizualizace
- Výzkum a vyhledávání informací
...
- **Node.js**: v18+ (pro integrace v JavaScriptu)
- **Paměť**: Doporučeno 12 GB+
- **Úložiště**: 10 GB+ pro modely a nástroje
...
### Závislosti specifické pro rámce
```bash
...
## Základní vzory nástrojů

### 1. Nástroje založené na funkcích
```python
...
### 2. Nástroje založené na třídách
```python
...
### 2. Nástroje s kontextovým povědomím
```python
...
1. **Vzory integrace nástrojů**
   - Návrh nástrojů založených na funkcích a třídách
   - Vzory integrace Microsoft Foundry Local
   - Validace schémat a typová bezpečnost
   - Zpracování chyb a zotavení

2. **Integrace rámců**
   - Vývoj nástrojů LangChain
   - Integrace funkcí Semantic Kernel
   - Integrace rámce REST API
   - Vývoj aplikací CLI

3. **Úvahy o produkci**
   - Strategie optimalizace výkonu
   - Správa mezipaměti a zdrojů
   - Monitoring a pozorovatelnost
   - Bezpečnost a validace

4. **Pokročilé vzory nástrojů**
   - Kompozice a řetězení nástrojů
   - Zpracování s kontextovým povědomím
   - Operace v dávkách a streamování
   - Vývoj vlastních integrací

## Další kroky

- **Projekty integrace**: Vytvořte vlastní integrace s preferovanými rámci
- **Vývoj nástrojů**: Vytvořte specializované nástroje pro váš obor
- **Ladění výkonu**: Optimalizujte pro vaše specifické případy použití
- **Nasazení do produkce**: Škálujte nástroje pro podnikové využití

## Přispívání

Podívejte se na pokyny hlavního repozitáře pro instrukce k přispívání.

## Licence

Tento příklad se řídí stejnou licencí jako projekt Microsoft Foundry Local.
