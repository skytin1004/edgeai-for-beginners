...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T01:20:29+00:00",
...
Microsoft Foundry Local přináší schopnosti Azure AI Foundry přímo do vašeho vývojového prostředí na Windows 11, umožňující vývoj AI s nízkou latencí a ochranou soukromí pomocí nástrojů na podnikové úrovni. Tato lekce zahrnuje kompletní instalaci, konfiguraci a praktické nasazení populárních modelů, včetně phi, qwen, deepseek a GPT-OSS-20B.
...
- **Začněte s menšími modely**: Začněte s menšími modely (Phi mini, Qwen 7B) a postupně přecházejte na větší
- **Monitorování prostředků**: Sledujte CPU/GPU/paměť při ladění promptů a nastavení
