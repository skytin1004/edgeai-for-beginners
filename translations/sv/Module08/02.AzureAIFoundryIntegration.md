...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T19:22:39+00:00",
...
Med utgångspunkt i din Foundry Local-grund fokuserar denna session på att skapa avancerade AI-lösningar genom avancerad promptdesign, sömlös dataintegration och automatisering av uppgifter. Du kommer att lära dig att koppla lokal utveckling med Azure AI Foundry-funktioner och skapa företagsklara applikationer som utnyttjar det bästa från båda världarna.

## Lärandemål

Efter denna session kommer du att:
- Behärska avancerade tekniker för promptdesign för konsekventa och pålitliga AI-svar
- Implementera robusta dataintegrationsmönster för verkliga applikationer
- Skapa handlingsbara AI-uppgifter som genererar affärsvärde
- Etablera sömlös anslutning mellan Foundry Local och Azure AI Foundry
- Bygga arbetsflöden för prestandaövervakning och optimering
- Distribuera produktionsklara AI-lösningar med korrekt felhantering och skalning

## Förkunskaper

- Genomfört Session 1: Kom igång med Foundry Local
- Aktiv Foundry Local-installation med fungerande modeller
- Azure-konto (gratisnivå räcker för lärande)
- Grundläggande förståelse för REST API:er och JSON

## Del 1: Avancerad promptdesign

### Förstå promptarkitektur

Effektiv promptdesign är grunden för pålitliga AI-applikationer. Foundry Local erbjuder förbättrade möjligheter för promptdesign:
...
### Praktiska exempel på promptdesign
...
## Del 2: Dataintegrationsmönster

### Foundry Local datakopplingar
...
### Exempel på verklig dataintegration
...
## Del 3: Handlingsbara AI-uppgifter

### Ramverk för uppgiftsautomatisering
...
### Exempel på automatisering av affärsprocesser
...
## Del 5: Prestandaövervakning och optimering
...
### Övning 1: Avancerad kundtjänstbot
...
### Övning 2: Automatiserad marknadsundersökning
...
## Del 7: Nästa steg och förhandsvisning av Session 3

### Sessionens prestationer

Under denna session har du bemästrat:
- ✅ Avancerade tekniker för promptdesign för konsekvent AI-beteende
- ✅ Robusta dataintegrationsmönster för verkliga applikationer
- ✅ Automatiserad uppgiftsdesign för optimering av affärsprocesser
- ✅ Integration med Azure AI Foundry och hybriddistributionsstrategier
- ✅ Omfattande prestandaövervakning och optimering

### Förberedelse inför Session 3: Öppen källkod-modeller

1. **Utforska Hugging Face**: Skapa ett konto och bläddra i modellkatalogen
2. **Granska Model Mondays**: Kolla in den senaste [Model Mondays-serien](https://aka.ms/model-mondays)
3. **Planera anpassade modeller**: Fundera på vilka specialiserade modeller som skulle gynna dina användningsområden
...
- [Avancerad guide för promptdesign](https://platform.openai.com/docs/guides/prompt-engineering)
- [Bästa praxis för automatisering av affärsprocesser](https://docs.microsoft.com/en-us/power-automate/)

Du är nu rustad att bygga avancerade AI-lösningar som kombinerar kraften i lokal inferens med molnskaliga funktioner, och lägger grunden för AI-applikationer i företagsklass.
