...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T22:48:27+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "sv"
}
-->
# Session 2: OpenAI SDK-integration med Azure AI Foundry

## Översikt

Med utgångspunkt i din Foundry Local-grund fokuserar denna session på avancerade integrationsmönster för OpenAI SDK som smidigt stödjer både Microsoft Foundry Local och Azure OpenAI. Du kommer att bemästra konsten att bygga flexibla AI-applikationer som kan köras lokalt för integritet och utveckling, samtidigt som du erbjuder skalbarhet i molnet via Azure OpenAI när det behövs.

## Lärandemål

Efter denna session kommer du att:
- Bemästra avancerad OpenAI SDK-integration med både Foundry Local och Azure OpenAI
- Implementera strömmande svar för förbättrad användarupplevelse
- Skapa robusta klientfabriksmönster för stöd av flera leverantörer
- Bygga konversationshanteringssystem med kontextbevarande
- Etablera prestandamätning och hälsokontroll
- Distribuera produktionsklara applikationer med korrekt felhantering

## Förkunskaper

- Slutfört Session 1: Kom igång med Foundry Local
- Aktiv Foundry Local-installation med fungerande modeller
- Python 3.8 eller senare med stöd för virtuella miljöer
- OpenAI Python SDK installerad (`pip install openai foundry-local-sdk`)
- Azure-konto med OpenAI-tjänst (valfritt, för molnscenarier)
- Grundläggande förståelse för Python async/await-mönster

## Del 1: OpenAI SDK-klientfabriksmönster

### Förstå arkitekturen för flera leverantörer

Att bygga applikationer som fungerar med både Foundry Local och Azure OpenAI kräver ett flexibelt klientskapandemönster:
...
## Del 2: Strömmande svar och interaktion i realtid

### Implementera strömmande chattkompletteringar

Strömning ger en bättre användarupplevelse genom att visa svar medan de genereras:
...
### Hantering av flervändskonversationer
...
## Del 3: Prestandamätning och analys

### Mätning av svarstid

Mät och jämför prestanda över olika konfigurationer:
...
### Testning av temperatur och parametrar
...
## Del 4: Hälsokontroll och diagnostik för tjänster

### Omfattande hälsokontrollsystem
...
### Validator för miljökonfiguration
...
## Del 5: Miljövariabler och konfigurationshantering

### Referens för miljövariabler

Fullständig referens för konfiguration av båda leverantörerna:
...
**Windows Command Prompt-inställning:**
...
## Del 6: Praktiska övningar

### Övning 1: SDK-integration med flera leverantörer

Bygg en komplett applikation som smidigt växlar mellan leverantörer:
...
### Övning 2: Avancerad konversationshantering
...
### Övning 3: Produktionsklar hälsokontroll
...
## Del 7: Sammanfattning och nästa steg

### Sessionens prestationer

Under denna session har du bemästrat:
- ✅ **OpenAI SDK-integration**: Avancerade mönster för både Foundry Local och Azure OpenAI
- ✅ **Strömmande svar**: Realtidschattkompletteringar för förbättrad användarupplevelse
- ✅ **Stöd för flera leverantörer**: Smidig växling mellan lokala och molnbaserade AI-tjänster
- ✅ **Konversationshantering**: Kontextmedvetna flervändskonversationer
- ✅ **Prestandaövervakning**: Benchmarking och hälsokontroll för produktionsdistributioner
- ✅ **Produktionsmönster**: Robust felhantering och konfigurationshantering

### Viktiga arkitekturmönster
...
1. **🔄 Implementera alltid fallback-alternativ**: Azure → Foundry Local → Felhantering
2. **🌊 Använd strömning för långa svar**: Förbättrad upplevd prestanda
3. **🛡️ Implementera omfattande felhantering**: Användarvänliga felmeddelanden
4. **📈 Övervaka prestanda**: Spåra svarstider och framgångsfrekvenser
5. **⚙️ Konfiguration baserad på miljö**: Enkel växling mellan utveckling/test/produktion
6. **🔒 Säker hantering av autentiseringsuppgifter**: Hårdkoda aldrig API-nycklar

### Riktlinjer för leverantörsval

| Scenario | Rekommenderad leverantör | Motivering |
|----------|--------------------------|------------|
| **Utveckling** | Foundry Local | Snabb iteration, inga API-kostnader |
| **Integritetskritiskt** | Foundry Local | Data lämnar aldrig enheten |
| **Högvolymsproduktion** | Azure OpenAI | Bättre skalning, företags-SLA |
| **Senaste modeller** | Azure OpenAI | Tillgång till de senaste modellversionerna |
| **Offlinekrav** | Foundry Local | Ingen internetberoende |
| **Kostnadskänsligt** | Foundry Local | Inga kostnader per token |

### Snabbreferens för miljövariabler
...
### Förberedelse inför Session 3: Öppen källkod-modeller

1. **Utforska modellkatalogen**: Granska tillgängliga modeller i Foundry Local
2. **Förstå modelformater**: Lär dig om ONNX, kvantisering och optimering
3. **Överväg anpassade modeller**: Fundera på domänspecifika modellbehov
...
- **[OpenAI Python SDK-dokumentation](https://github.com/openai/openai-python)**: Officiell SDK-referens
- **[Azure OpenAI-dokumentation](https://learn.microsoft.com/azure/ai-services/openai/)**: Guide för Azure OpenAI-tjänsten
- **[Foundry Local SDK-referens](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Dokumentation för lokal inferens
- **[Guide för strömmande kompletteringar](https://learn.microsoft.com/azure/ai-foundry/foundry-local/how-to/integrate-with-inference-sdks)**: Avancerade strömningsmönster
- **[Exempel 01: Snabb chatt via OpenAI SDK](samples/01/README.md)**: Grundläggande integrationsmönster
- **[Exempel 02: Avancerad SDK-integration](samples/02/README.md)**: Praktiska övningar från denna session
- **[Exempel 04: Chainlit-applikation](samples/04/README.md)**: Utveckling av webbgränssnitt
- **[Exempel 05: Multi-agent-system](samples/05/README.md)**: Avancerade orkestreringsmönster

Du är nu utrustad för att bygga sofistikerade AI-applikationer som smidigt integrerar lokala och molnbaserade AI-funktioner, vilket ger flexibiliteten att välja rätt leverantör för varje specifikt användningsfall samtidigt som du upprätthåller konsekventa utvecklingsmönster.
