...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-01T01:35:47+00:00",
...
4. **Документујте налазе**: Направите једноставан графикон поређења
...
1. **Почните са мањим моделима**: Почните са `phi-4-mini` да бисте потврдили подешавање
...
5. **Документујте резултате**: Водите белешке о перформансама модела за своје случајеве употребе
...
- **Предуслови**: Удобност са пребацивањем модела и основним тестирањем перформанси
...
✅ **Управљање кешом**: Разумевање складиштења и процедура чишћења  

Сада имате практичне вештине за откривање, тестирање и избор одговарајућих модела за своје AI апликације користећи једноставан CLI приступ Foundry Local-а.

## Циљеви учења

- Откријте и процените моделе отвореног кода за локалну инференцију
- Компилирајте и покрените одабране Hugging Face моделе у Foundry Local-у
...
### Алтернатива за тестирање у PowerShell-у
...
- Држите 2-3 модела кеширана за брзо пребацивање
- Уклоните неупотребљиве моделе да ослободите простор: `foundry cache clean`
- Пратите употребу диска, посебно на мањим SSD-овима
- Размотрите компромис између величине модела и способности
...
- Проверите I/O диска током почетног учитавања модела
...
- Напредно: `qwen2.5-7b` (дужи контекст)
...
- 32GB+ RAM за удобно пребацивање између модела
- SSD складиштење за брже учитавање модела
- Модеран CPU са добрим перформансама по једном језгру
- Подршка за NPU (Windows 11 Copilot+ рачунари) за убрзање

### Радни ток за пребацивање модела
