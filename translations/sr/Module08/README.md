...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T19:01:01+00:00",
...
[Microsoft Foundry Local](https://learn.microsoft.com/azure/ai-foundry/foundry-local/) представља нову генерацију развоја Edge AI технологије, пружајући програмерима моћне алате за креирање, имплементацију и скалирање AI апликација локално, уз беспрекорну интеграцију са Azure AI Foundry. Овај модул нуди свеобухватан преглед Foundry Local-а, од инсталације до развоја напредних агената.
...
- **Креирање производних решења**: Развој AI апликација уз напредно инжењерство промпта и интеграцију података
- **Искористите отворени екосистем**: Интеграција Hugging Face модела и доприноси заједнице
...
**Фокус**: Напредно инжењерство промпта, интеграција података и повезивање са облаком

**Кључне теме**: Инжењерство промпта • Интеграција података • Azure радни токови • Оптимизација перформанси • Надгледање
...
**Фокус**: Архитектуре агената, системски промптови, приземљење и оркестрација

**Кључне теме**: Шаблони дизајна агената • Инжењерство системских промптова • Технике приземљења • Системи са више агената • Имплементација у производњи
...
**Фокус**: Модуларна AI решења, корпоративно скалирање и шаблони за производњу

**Кључне теме**: Модели као алати • Имплементација на уређају • SDK/API интеграција • Корпоративне архитектуре • Стратегије скалирања
...
**Кључне теме**: Имплементација HTTP клијента • Прилагођена аутентификација • Надгледање здравља модела • Стриминг одговора • Руковање грешкама у производњи
...
**Кључне теме**: Развој са Electron-ом • Fluent Design System • Нативна интеграција са Windows-ом • Стриминг у реалном времену • Дизајн интерфејса за ћаскање
...
**Фокус**: Координација агената, специјализована делегација задатака и колаборативни AI радни токови

**Кључне теме**: Интелигентна координација агената • Шаблони за позивање функција • Комуникација између агената • Оркестрација радних токова • Механизми за осигурање квалитета
...
- Концепти REST API-а
- Основно знање о промптовању и инференцији модела
...
|  3 | Отворени модели | 05 | 2-3 сата | Средњи |
...
- [Azure AI Foundry документација](https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/) - Комплетан водич за подешавање и употребу
...
- **Одлуке о архитектури**: Донети информисане одлуке између локалне и облачне имплементације
- **Оптимизација перформанси**: Оптимизовати перформансе инференције на различитим хардверским конфигурацијама
- **Корпоративно скалирање**: Дизајнирати апликације које се скалирају од локалних прототипова до корпоративних имплементација
- **Приватност и безбедност**: Имплементирати решења која чувају приватност уз локалну инференцију

### Иновативне способности
- **Брзо прототипирање**: Брзо креирање и тестирање концепата AI апликација кроз свих 10 шаблона примера
- **Интеграција заједнице**: Искористити моделе отвореног кода и допринети екосистему
- **Напредни шаблони**: Имплементирати најсавременије AI шаблоне укључујући RAG, агенте и интеграцију алата
- **Овладавање оквирима**: Експертска интеграција са LangChain-ом, Semantic Kernel-ом, Chainlit-ом и Electron-ом
- **Имплементација у производњи**: Скалирање AI решења од локалних прототипова до корпоративних система
- **Развој за будућност**: Креирање апликација спремних за нове AI технологије и шаблоне

## Почетак рада

1. **Подешавање окружења**: Осигурајте Windows 11 са препорученим хардвером (види Предуслове)
...
- [ ] Направите систем за оркестрацију са више агената (Пример 05)
