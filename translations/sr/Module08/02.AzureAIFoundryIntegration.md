...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T01:16:23+00:00",
...
Надовезујући се на основе Foundry Local, ова сесија је усмерена на креирање напредних AI решења кроз напредно инжењерство упита, беспрекорну интеграцију података и аутоматизацију задатака који доносе резултате. Научићете како да повежете локални развој са могућностима Azure AI Foundry, креирајући апликације спремне за предузећа које користе најбоље од оба света.

## Циљеви учења

До краја ове сесије, моћи ћете:
- Савладати напредне технике инжењерства упита за доследне и поуздане AI одговоре
- Применити робусне шаблоне интеграције података за апликације у стварном свету
- Креирати AI задатке који доносе пословну вредност
- Успоставити беспрекорну повезаност између Foundry Local и Azure AI Foundry
- Изградити радне токове за праћење перформанси и оптимизацију
- Деплојовати AI решења спремна за производњу уз правилно руковање грешкама и скалирање

## Предуслови

- Завршена Сесија 1: Увод у Foundry Local
- Активна инсталација Foundry Local са покренутим моделима
- Azure налог (бесплатан ниво довољан за учење)
- Основно разумевање REST API-ја и JSON-а

## Део 1: Напредно инжењерство упита

### Разумевање архитектуре упита

Ефективно инжењерство упита је основа поузданих AI апликација. Foundry Local пружа побољшане могућности за креирање упита:
...
### Практични примери инжењерства упита
...
## Део 2: Шаблони интеграције података

### Конектори података у Foundry Local
...
### Пример интеграције података у стварном свету
...
## Део 3: Активни AI задаци

### Оквир за аутоматизацију задатака
...
### Примери аутоматизације пословних процеса
...
## Део 4: Интеграција Azure AI Foundry

### Успостављање повезаности
...
## Део 5: Праћење перформанси и оптимизација

### Свеобухватни систем за праћење
...
### Вежба 1: Напредни бот за корисничку подршку
...
### Вежба 2: Аутоматизовано истраживање тржишта
...
## Део 7: Следећи кораци и преглед Сесије 3

### Постигнућа из сесије

У овој сесији сте савладали:
- ✅ Напредне технике инжењерства упита за доследно AI понашање
- ✅ Робусне шаблоне интеграције података за апликације у стварном свету
- ✅ Креирање аутоматизованих задатака за оптимизацију пословних процеса
- ✅ Интеграцију Azure AI Foundry и стратегије хибридног деплојмента
- ✅ Свеобухватно праћење перформанси и оптимизацију

### Припрема за Сесију 3: Модели отвореног кода

1. **Истражите Hugging Face**: Направите налог и прегледајте каталог модела
2. **Прегледајте Model Mondays**: Погледајте најновију [Model Mondays серију](https://aka.ms/model-mondays)
3. **Планирајте прилагођене моделе**: Размислите који специјализовани модели би били корисни за ваше случајеве употребе
...
- [Водич за напредно инжењерство упита](https://platform.openai.com/docs/guides/prompt-engineering)
- [Најбоље праксе за аутоматизацију пословних процеса](https://docs.microsoft.com/en-us/power-automate/)

Сада сте опремљени за изградњу напредних AI решења која комбинују моћ локалног инференса са могућностима облака, постављајући темеље за AI апликације спремне за предузећа.
