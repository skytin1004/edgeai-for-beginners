...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T00:02:52+00:00",
...
Ово решење показује како интегрисати генеративну AI и моделе великог језика (LLMs) у мобилне апликације које раде на више платформи користећи .NET MAUI (Multi-platform App UI) и ONNX Runtime GenAI. Овај приступ омогућава .NET програмерима да креирају софистициране AI апликације које раде нативно на Android и iOS уређајима.

### Кључне карактеристике
- Изграђено на .NET MAUI оквиру, пружајући једну базу кода за Android и iOS апликације
- ONNX Runtime GenAI интеграција омогућава покретање генеративних AI модела директно на мобилним уређајима
- Подржава различите хардверске акцелераторе прилагођене мобилним уређајима, укључујући CPU, GPU и специјализоване AI процесоре
- Платформске оптимизације као што су CoreML за iOS и NNAPI за Android кроз ONNX Runtime
- Имплементира комплетан генеративни AI циклус укључујући предобраду и постобраду, инференцију, обраду логита, претрагу и узорковање, и управљање KV кешом

### Предности развоја
.NET MAUI приступ омогућава програмерима да искористе своје постојеће C# и .NET вештине док граде AI апликације за више платформи. ONNX Runtime GenAI оквир подржава више архитектура модела, укључујући Llama, Mistral, Phi, Gemma и многе друге. Оптимизовани ARM64 кернели убрзавају INT4 квантизовану матричну множење, обезбеђујући ефикасне перформансе на мобилном хардверу уз задржавање познатог .NET искуства развоја.

### Случајеви употребе
Ово решење је идеално за програмере који желе да креирају AI апликације за мобилне уређаје користећи .NET технологије, укључујући интелигентне chatbot-ове, апликације за препознавање слика, алате за превођење језика и персонализоване системе препорука који раде искључиво на уређају ради побољшане приватности и могућности рада ван мреже.
...
Microsoft-ово Azure EdgeAI решење се фокусира на ефикасно распоређивање малих језичких модела (SLMs) у cloud-edge хибридним окружењима. Овај приступ премошћује јаз између cloud AI услуга и захтева за edge распоређивање.
...
### Случајеви употребе
Azure EdgeAI имплементација је изузетна у сценаријима који захтевају AI распоређивање на нивоу предузећа уз могућности управљања cloud-ом. Ово укључује интелигентну обраду докумената, анализу у реалном времену и хибридне AI токове рада који користе ресурсе cloud-а и edge-а.
...
- Омогућава програмерима да донесу своје моделе и ефикасно их распоређују преко екосистема партнера за силицијум, укључујући AMD, Intel, NVIDIA и Qualcomm, који обухватају CPU, GPU, NPU
- Захваљујући инфраструктурним API-јевима, програмери више не морају да креирају више верзија своје апликације за различите типове силицијума
...
Foundry Local омогућава програмерима да креирају апликације за Retrieval Augmented Generation (RAG) користећи локалне ресурсе у .NET-у, комбинујући локалне језичке моделе са могућностима семантичке претраге. Овај приступ пружа решења за AI која су фокусирана на приватност и раде искључиво на локалној инфраструктури.

### Техничка архитектура
- Комбинује Phi језички модел, локалне ембеддинге и Semantic Kernel за креирање RAG сценарија
...
RAG, или Retrieval Augmented Generation, је само сложен начин да се каже "потражите нешто и укључите то у упит". Ова локална имплементација обезбеђује приватност података док пружа интелигентне одговоре засноване на прилагођеним базама знања. Приступ је посебно вредан за сценарије у предузећима који захтевају суверенитет података и могућности рада ван мреже.
...
Windows AI Foundry платформа пружа свеобухватан сет алата и API-ја специјално дизајнираних за Edge AI развој на Windows уређајима. Ово укључује специјализовану подршку за NPU-акцелераторе, интеграцију Windows ML-а и платформске технике оптимизације.
...
- Интеграцију и оптимизацију Windows ML runtime-а
...
- Локално тестирање и оптимизационе токове рада
