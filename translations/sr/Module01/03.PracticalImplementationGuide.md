...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T23:57:55+00:00",
...
Овај свеобухватни водич ће вам помоћи да се припремите за EdgeAI курс, који се фокусира на изградњу практичних AI решења која ефикасно раде на уређајима на ивици. Курс наглашава практични развој користећи савремене оквире и најсавременије моделе оптимизоване за имплементацију на ивици.
...
- Jupyter Notebooks за интерактивни развој и прототипизацију
...
**Cloud GPU ресурси (опционо)**
- **Azure Machine Learning**: За интензивну обуку и експериментацију
- **Google Colab**: Бесплатан ниво доступан за образовне сврхе
- **Kaggle Notebooks**: Алтернативна платформа за рачунарство у облаку
...
- **Ресурс**: [Phi-4 Collection on Hugging Face](https://huggingface.co/collections/microsoft/phi-4-677e9380e514feb5577a40e4)
...
- **Ресурс**: [Qwen-3 Collection on Hugging Face](https://huggingface.co/collections/Qwen/qwen3-67dd247413f0e2e4f653967f)
- **Примена**: Мултијезичке апликације, решења за AI у различитим културама
...
- **Ресурс**: [Gemma-3n Collection on Hugging Face](https://huggingface.co/collections/google/gemma-3n-685065323f5984ef315c93f4)
...
- **Оптимизација специфична за задатке**: Усклађивање модела са специфичним случајевима употребе
- **Ограничења имплементације**: Меморија, кашњење и потрошња енергије

## 4. Алатке за квантовање и оптимизацију

### Llama.cpp оквир
- **Репозиторијум**: [Llama.cpp on GitHub](https://github.com/ggml-org/llama.cpp)
- **Намена**: Мотор за инференцију високих перформанси за LLM-ове
...
### Microsoft Olive
- **Репозиторијум**: [Microsoft Olive on GitHub](https://github.com/microsoft/olive)
...
- **Инсталација и основна употреба**:
  ...
  # Дефинисање модела и конфигурације оптимизације
  ...
  # Покретање радног тока оптимизације
  result = run_workflow(config)
  optimized_model = result.optimized_model
  
  # Чување оптимизованог модела
...
- **Installation and Basic Usage**:
  ...
  # Пример Python скрипте за учитавање и оптимизацију модела
  ```python
...
### ONNX Runtime
- **Репозиторијум**: [ONNX Runtime on GitHub](https://github.com/microsoft/onnxruntime)
...
- **Edge AI шаблони дизајна**: Најбоље праксе за имплементацију на ивици
...
- [ ] Python 3.10+ инсталиран и проверен
- [ ] .NET 8+ инсталиран и проверен
- [ ] Развојно окружење конфигурисано
- [ ] Hugging Face налог креиран
- [ ] Основно познавање циљних породица модела
- [ ] Алатке за квантовање инсталиране и тестиране
- [ ] Испуњени хардверски захтеви
- [ ] Налози за рачунарство у облаку постављени (ако је потребно)
...
4. Разумете кључна разматрања за имплементацију AI модела на уређајима на ивици
...
- **Microsoft .NET документација**: Званични ресурси за развој у .NET окружењу
...
- **Jupyter Notebooks**: Интерактивно окружење за експериментацију у ML-у
...
Након завршетка овог припремног водича, бићете:
...
3. Бити упознати са кључним оквирима и алатима који се користе током курса
4. Моћи да изаберете одговарајуће моделе на основу ограничења уређаја и захтева
