...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T00:02:27+00:00",
...
Olive је једноставан алат за оптимизацију модела који је свестан хардвера и комбинује водеће технике у индустрији за компресију, оптимизацију и компилацију модела. Ради са ONNX Runtime као E2E решењем за оптимизацију инференције.

### Кључне карактеристике

- **Оптимизација свесна хардвера**: Аутоматски бира најбоље технике оптимизације за ваш циљани хардвер
- **40+ уграђених компоненти за оптимизацију**: Обухвата компресију модела, квантовање, оптимизацију графа и још много тога
...
- **Подршка за популарне моделе**: Olive може аутоматски оптимизовати популарне архитектуре модела као што су Llama, Phi, Qwen, Gemma и други
...
Процес оптимизације укључује: преузимање модела из локалне кеш меморије, хватање ONNX графа и чување тежина у ONNX датотеци, оптимизацију ONNX графа и квантовање модела на int4 користећи RTN метод.
...
- `--precision`: Прецизност квантовања (int4, int8, fp16)
...
- Пробајте квантовање са већом прецизношћу (int8 уместо int4)
...
- **Jupyter бележнице**: Доступно у Olive GitHub репозиторијуму — https://github.com/microsoft/Olive/tree/main/examples
- **VS Code екстензија**: Pregled AI Toolkit за VS Code — https://learn.microsoft.com/azure/ai-toolkit/overview
- **Блог постови**: Microsoft Open Source Blog — https://opensource.microsoft.com/blog/

### Повезани алати
- **ONNX Runtime**: Мотор за инференцију високих перформанси — https://onnxruntime.ai/
- **Hugging Face Transformers**: Извор многих компатибилних модела — https://huggingface.co/docs/transformers/index
- **Azure Machine Learning**: Радни токови оптимизације засновани на облаку — https://learn.microsoft.com/azure/machine-learning/
