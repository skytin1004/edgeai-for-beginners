...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T21:06:54+00:00",
...
Добродошли у **EdgeAI за почетнике** – ваш свеобухватни пут у трансформативни свет Edge вештачке интелигенције. Овај курс повезује моћне могућности вештачке интелигенције са практичном применом у стварном свету на уређајима на ивици, омогућавајући вам да искористите потенцијал вештачке интелигенције директно тамо где се подаци генеришу и где се одлуке доносе.
...
- **Мобилни уређаји**: Смартфони и таблети са офлајн могућностима
...
**Тема**: Трансформативна промена у примени EdgeAI  

#### Структура поглавља:
- [**Секција 1: Основе EdgeAI**](./Module01/01.EdgeAIFundamentals.md)  
  - Поређење традиционалног cloud AI-а и EdgeAI-а  
  ...
  - Предности: приватност, безбедност, ниско кашњење, офлајн могућности, ефикасност трошкова  
...
- [**Секција 3: Практични водич за имплементацију**](./Module01/03.PracticalImplementationGuide.md)  
  ...
  - Ресурси породице основних модела  
  - Алатке за квантовање и оптимизацију (Llama.cpp, Microsoft Olive, Apple MLX)  
  - Контролна листа за процену и верификацију  

- [**Секција 4: Хардверске платформе за EdgeAI примену**](./Module01/04.EdgeDeployment.md)  
  - Разматрања и захтеви за EdgeAI примену  
  - Intel хардвер за EdgeAI и технике оптимизације  
  - Qualcomm AI решења за мобилне и уграђене системе  
  - NVIDIA Jetson и платформе за Edge рачунарство  
...
- [**Секција 1: Основе породице Microsoft Phi модела**](./Module02/01.PhiFamily.md)  
  ...
  - Специјализоване могућности (расуђивање, мултимодалност, примена на ивици)  
...
- [**Секција 5: Основе Microsoft Mu модела**](./Module02/05.mumodel.md)  
  - Архитектура оријентисана на уређаје уграђена у Windows 11  
  - Интеграција система са Windows 11 подешавањима  
  - Офлајн рад уз очување приватности  

- [**Секција 6: Основе Phi-Silica модела**](./Module02/06.phisilica.md)  
  - Архитектура оптимизована за NPU уграђена у Windows 11 Copilot+ рачунаре  
...
**Тема**: Комплетан животни циклус примене SLM-а, од теорије до производног окружења  
...
- [**Секција 1: Напредно учење SLM-а**](./Module03/01.SLMAdvancedLearning.md)  
  ...
  - Стратегије набавке модела (Azure AI Foundry за Phi моделе, Hugging Face за одабране моделе)  
...
- [**Секција 3: Примена у облаку уз контејнеризацију**](./Module03/03.DeployingSLMinCloud.md)  
  - vLLM примена за инференцију високих перформанси  
  - Оркестрација контејнера Ollama  
  - ONNX Runtime оптимизована имплементација за ивицу  
...
#### Структура поглавља:
- [**Секција 1: Основе конверзије формата модела и квант
...
- [**Секција 3: Microsoft Olive Suite за оптимизацију**](./Module04/03.MicrosoftOlive.md)
  ...
  - Интеграција у Azure ML радне токове
  - Подршка за популарне моделе (Llama, Phi, одабрани Qwen модели, Gemma)

- [**Секција 4: OpenVINO Toolkit Suite за оптимизацију**](./Module04/04.openvino.md)
...
- [**Секција 5: Дубинска анализа Apple MLX Framework-а**](./Module04/05.AppleMLX.md)
  - Јединствена меморијска архитектура за Apple Silicon
  - Подршка за LLaMA, Mistral, Phi-3, одабране Qwen моделе
...
- [**Секција 6: Синтеза радног тока за Edge AI развој**](./Module04/06.workflow-synthesis.md)
  ...
  - Одлуке о избору оквира и анализа компромиса у перформансама
...
- [**Секција 2: Дистилација модела - од теорије до праксе**](./Module05/02.SLMOps-Distillation.md)
  - Пренос знања са учитељских на студентске моделе
...
### [Модул 06: SLM агентски системи - AI агенти и позивање функција](./Module06/README.md)
...
#### Структура поглавља:
- [**Секција 1: Основе AI агената и малих језичких модела**](./Module06/01.IntroduceAgent.md)
...
### [Модул 07: Примери имплементације EdgeAI-а](./Module07/README.md)
**Тема**: Свеобухватне имплементације EdgeAI-а на различитим платформама и оквирима
...
- [**Водич за развој EdgeAI-а на Windows-у**](./Module07/windowdeveloper.md)
  - Комплетан преглед Windows AI Foundry платформе
...
- [**EdgeAI у мобилним апликацијама уз .NET MAUI и ONNX Runtime GenAI**](./Module07/README.md#2-edgeai-in-mobile-applications-with-net-maui-and-onnx-runtime-genai)
  - Мобилни AI на више платформи са јединственом C# базом кода
...
- [**EdgeAI у Azure-у са мотором за мале језичке моделе**](./Module07/README.md#3-edgeai-in-azure-with-small-language-models-engine)
  - Хибридна архитектура за имплементацију на облаку и edge-у
  - Интеграција Azure AI услуга са ONNX Runtime-ом
...
- [**EdgeAI уз Foundry Local апликације**](./Module07/README.md#5-edgeai-with-foundry-local-applications)
  ...
  - Интеграција Phi-3 језичког модела са семантичком претрагом (само Phi модели)
  - Подршка за локалне векторске базе података (SQLite, Qdrant)
  - Способности за суверенитет података и офлајн рад
...
**Основно знање**
- Разумевање основних разлика између AI архитектура заснованих на облаку и edge-у
- Савладавање принципа квантовања модела, компресије и оптимизације за окружења са ограниченим ресурсима
- Разумевање опција за убрзање хардвера (NPUs, GPUs, CPUs) и њихових импликација на имплементацију

**Вештине имплементације**
- Постављање малих језичких модела на различите edge платформе (мобилне, уграђене, IoT, edge сервере)
- Примена оквира за оптимизацију, укључујући Llama.cpp, Microsoft Olive, ONNX Runtime и Apple MLX
- Имплементација система за инференцију у реалном времену са захтевима за одговор испод секунде
...
- Примена најбољих пракси за безбедност у EdgeAI имплементацијама које чувају приватност

### Стратешке способности

**Оквир за доношење одлука**
- Процена EdgeAI могућности и идентификација погодних случајева употребе за пословне апликације
- Процена компромиса између тачности модела, брзине инференције, потрошње енергије и трошкова хардвера
...
- Разумевање основних разлика између облака и edge AI архитектура
- Савладавање основних техника оптимизације за edge имплементацију
- Препознавање примена у стварном свету и успешних прича
...
- Савладавање стратешких способности доношења одлука на основу рачунарских ограничења и захтева за перформансама
...
- Савладавање Intel оптимизације хардвера уз OpenVINO и NNCF
- Способности за избор оптимизације прилагођене хардверу на различитим платформама
- Вештине за имплементацију у производњи на више платформи за edge рачунарство
- Стратешки избор оквира и синтеза радних токова за оптимална Edge AI решења

### Исходи учења за Модул 05:
- Савладавање парадигме SLMOps и оперативних принципа
- Имплементација дистилације модела за пренос знања и оптимизацију ефикасности
- Примена техника фино подешавања за прилагођавање модела специфичним доменима
- Постављање SLM решења спремних за производњу уз стратегије за праћење и одржавање

### Исходи учења за Модул 06:
- Разумевање основних концепата AI агената и архитектуре малих језичких модела
- Савладавање имплементације позивања функција на више платформи и оквира
- Интеграција Model Context Protocol-а (MCP) за стандардизовану интеракцију са екстерним алатима
- Изградња софистицираних агентских система са минималним захтевима за људску интервенцију

### Исходи учења за Модул 07:
- Савладавање AI Toolkit-а за Visual Studio Code за свеобухватне Edge AI радне токове
Овај курс вас позиционира на челу примене AI технологије, где се интелигентне могућности беспрекорно интегришу у уређаје и системе који покрећу савремени живот.
...
- **Прогресивно учење**: Постепено напредовање од основних концепата до напредне примене
...
- **Практична примена**: Завршени конфигурациони фајлови, процедуре тестирања API-ја и скрипте за примену
- **Перформанс бенчмаркови**: Детаљна поређења брзине извршавања, употребе меморије и захтева за ресурсима
- **Разматрања на нивоу предузећа**: Практике безбедности, оквири за усаглашеност и стратегије заштите података

## Почетак

Препоручени пут учења:
1. Почните са **Module01** да изградите основно разумевање EdgeAI-а
2. Наставите са **Module02** за дубље разумевање различитих породица SLM модела
3. Научите **Module03** да савладате практичне вештине примене
...
7. Завршите са **Module07** да стекнете практично искуство са AI Toolkit-ом и разноврсним примерима EdgeAI имплементације

Сваки модул је дизајниран да буде независно комплетан, али секвенцијално учење ће пружити најбоље резултате.

## Водич за учење

Детаљан [Водич за учење](STUDY_GUIDE.md) је доступан да вам помогне да максимално искористите своје искуство учења. Водич за учење пружа:
...
- **Идеје за мини-пројекте**: Практичне примене за учвршћивање вашег знања

Водич за учење је дизајниран да одговара и интензивном учењу (1 недеља) и учењу са скраћеним радним временом (3 недеље), са јасним смерницама како да ефикасно распоредите време чак и ако можете да посветите само 10 сати курсу.

---

**Будућност EdgeAI-а лежи у континуираном унапређењу архитектура модела, техника квантовања и стратегија примене које приоритет дају ефикасности и специјализацији у односу на опште могућности. Организације које прихвате ову промену парадигме биће добро позициониране да искористе трансформативни потенцијал AI-а, истовремено задржавајући контролу над својим подацима и операцијама.**
