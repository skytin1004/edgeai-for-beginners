...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T09:57:29+00:00",
...
Добродошли у **EdgeAI за почетнике** – ваш свеобухватни пут у трансформативни свет Edge вештачке интелигенције. Овај курс повезује моћне AI могућности са практичном применом у стварном свету на уређајима на ивици, омогућавајући вам да искористите потенцијал AI директно тамо где се подаци генеришу и где се одлуке доносе.
...
- **Стратегије за производну примену** за пословне апликације
...
- **Усклађеност са регулативама**: Испуњавање захтева за суверенитет података
...
| [💻 07](../../Module07) | [Примена на платформама](./Module07/README.md) | Примери за различите платформе | AI алатке • Foundry Local • Развој за Windows | Напредни | 3-4 сата |
...
- [07: Директни API клијент](./Module08/samples/07/README.md)
...
- **Архитектура Edge AI**: Дизајнирање локалних AI система са интеграцијом облака
...
- **Foundry Local Chat апликације**: Windows 11 апликација са могућношћу промене модела
...
**Препоручени пут учења** (20-30 сати укупно):
...
**Пројекти за портфолио**: Системи са више агената • RAG апликације за продукцију • Мултиплатформска имплементација • Оптимизација перформанси  
...
✅ **Прогресивно учење**: Теорија → Практика → Имплементација у продукцији  
...
✅ **Спремно за продукцију**: Надзор, скалабилност, безбедност, оквири за усаглашеност  

📖 **[Доступан водич за учење](STUDY_GUIDE.md)**: Структурисан план учења од 20 сати са смерницама за расподелу времена и алатима за самооцењивање.
