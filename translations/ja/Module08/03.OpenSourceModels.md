...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T10:29:59+00:00",
  "source_file": "Module08/03.OpenSourceModels.md",
  "language_code": "ja"
}
-->
# セッション 3: オープンソースモデルの発見と管理

## 概要

このセッションでは、Foundry Localを使用した実践的なモデルの発見と管理に焦点を当てます。利用可能なモデルをリスト化し、さまざまなオプションをテストし、基本的な性能特性を理解する方法を学びます。このアプローチは、Foundry CLIを使った実践的な探索を強調しており、ユースケースに適したモデルを選択するのに役立ちます。

## 学習目標

- モデルの発見と管理のためのFoundry CLIコマンドを習得する
...
2. **1つのモデルを同時に使用**: 新しいモデルを開始する前に以前のモデルを停止する
...
- **[CLIリファレンス](https://learn.microsoft.com/azure/ai-foundry/foundry-local/reference/reference-cli)**: 完全なコマンドリファレンス
...
- **[Sample 03: Model Discovery](samples/03/README.md)**: 実践的な例スクリプト

### 重要なポイント

✅ **モデルの発見**: `foundry model list`を使用して利用可能なモデルを探索  
✅ **迅速なテスト**: `list_and_bench.cmd`パターンで迅速な評価  
✅ **性能モニタリング**: 基本的なリソース使用量と応答時間の測定  
✅ **モデル選択**: ユースケースに基づいたモデル選択の実践的なガイドライン  
✅ **キャッシュ管理**: ストレージとクリーンアップ手順の理解  

これで、Foundry LocalのシンプルなCLIアプローチを使用して、AIアプリケーションに適したモデルを発見、テスト、選択するための実践的なスキルを習得しました。
...
## パート 1: Foundry CLIを使用したモデルの発見

### 基本的なモデル管理コマンド

Foundry CLIは、モデルの発見と管理のための簡単なコマンドを提供します:
...
人気があり、十分にテストされたモデルから始めて性能特性を理解します:
...
**注意:** `--verbose`フラグは詳細な起動情報を提供します。以下を含む:
- 初回実行時のモデルダウンロード進捗
- メモリ割り当ての詳細
- サービスバインディング情報
- 性能初期化メトリクス
...
**中型モデル:**
- `qwen2.5-7b-instruct`: 優れた推論能力と長いコンテキスト
- `deepseek-r1-distill-qwen-7b`: コード生成に最適化

**大型モデル:**
- `llama-3.2`: Metaの最新オープンソースモデル
- `qwen2.5-14b-instruct`: エンタープライズ向けの高度な推論能力
...
**典型的なモデルサイズ:**
- `phi-4-mini`: 約2.5 GB
- `qwen2.5-7b-instruct`: 約4.1 GB  
- `deepseek-r1-distill-qwen-7b`: 約4.3 GB
- `llama-3.2`: 約4.9 GB
- `qwen2.5-14b-instruct`: 約8.2 GB
...
- 高度な選択肢: `qwen2.5-7b-instruct`（長いコンテキスト）

**コード生成の場合:**
- 推奨: `deepseek-r1-distill-qwen-7b`
- 代替: `qwen2.5-7b-instruct`（コードにも適している）

**複雑な推論の場合:**
- 最適: `qwen2.5-7b-instruct`または`qwen2.5-14b-instruct`
- 予算オプション: `phi-4`
...
各モデルについて、一貫したプロンプトでテストし、手動で評価します:
...
## パート 6: 次のステップ
- 新しいモデルとヒントのためにModel Mondaysに登録: https://aka.ms/model-mondays
- チームの`models.json`に発見内容を共有
- セッション 4の準備: LLMとSLMの比較、ローカルとクラウド推論、実践デモ
