...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T00:04:50+00:00",
...
1. **Fork Repository**: Nhấn vào [![GitHub forks](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)  
...
| [💻 07](../../Module07) | [Triển khai nền tảng](./Module07/README.md) | Các mẫu đa nền tảng | Bộ công cụ AI • Foundry Local • Phát triển Windows | Nâng cao | 3-4 giờ |
| [🏭 08](../../Module08) | [Bộ công cụ Foundry Local](./Module08/README.md) | Các mẫu sẵn sàng sản xuất | Ứng dụng mẫu (xem chi tiết bên dưới) | Chuyên gia | 8-10 giờ |
...
- **Tối ưu hóa mô hình**: Lượng hóa và nén mô hình cho triển khai edge (tăng tốc 85%, giảm kích thước 75%)  
...
### 🏗️ Dự án thực tế
- **Ứng dụng Chat Foundry Local**: Ứng dụng Windows 11 bản địa với khả năng chuyển đổi mô hình  
...
- **Khung API**: Các client sẵn sàng sản xuất với streaming và giám sát sức khỏe  
- **Công cụ đa nền tảng**: Các mẫu tích hợp LangChain/Semantic Kernel  
...
1. **📚 Nền tảng** (Module 01-02): Các khái niệm EdgeAI + Các họ mô hình SLM  
2. **⚙️ Tối ưu hóa** (Module 03-04): Triển khai + các khung lượng hóa  
3. **🚀 Sản xuất** (Module 05-06): SLMOps + Tác nhân AI + Gọi hàm  
4. **💻 Triển khai** (Module 07-08): Các mẫu nền tảng + Bộ công cụ Foundry Local  

Mỗi module bao gồm lý thuyết, bài tập thực hành, và các mẫu mã sẵn sàng sản xuất.
...
**Lĩnh vực ngành**: Sản xuất 4.0 • Công nghệ y tế • Hệ thống tự động • FinTech • Điện tử tiêu dùng  
