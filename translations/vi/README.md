...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T11:38:49+00:00",
...
- **Tối ưu hóa dựa trên phần cứng** trên nhiều nền tảng  
...
- **Quyền riêng tư & Bảo mật**: Xử lý dữ liệu nhạy cảm tại chỗ mà không cần gửi lên đám mây  
...
Edge AI là việc chạy các thuật toán AI và mô hình ngôn ngữ trực tiếp trên phần cứng—gần nơi dữ liệu được tạo ra—mà không cần dựa vào tài nguyên đám mây để suy luận. Điều này giảm độ trễ, tăng cường quyền riêng tư và cho phép ra quyết định thời gian thực.
...
- [**Phần 1: Các Nguyên Tắc Cơ Bản của EdgeAI**](./Module01/01.EdgeAIFundamentals.md)  
  ...
  - Các công nghệ chính: lượng hóa mô hình, tối ưu hóa nén, Small Language Models (SLMs)  
...
- [**Phần 3: Hướng Dẫn Triển Khai Thực Tế**](./Module01/03.PracticalImplementationGuide.md)  
  ...
  - Yêu cầu phần cứng và cấu hình được khuyến nghị  
  - Tài nguyên gia đình mô hình cốt lõi  
  - Công cụ lượng hóa và tối ưu hóa (Llama.cpp, Microsoft Olive, Apple MLX)  
  - Danh sách kiểm tra đánh giá và xác minh  

- [**Phần 4: Các Nền Tảng Phần Cứng Triển Khai Edge AI**](./Module01/04.EdgeDeployment.md)  
  ...
  - Nền tảng Jetson của NVIDIA và điện toán edge  
  - Nền tảng PC AI Windows với tăng tốc NPU  
  - Chiến lược tối ưu hóa cụ thể cho phần cứng  

---

### [Module 02: Nền Tảng Small Language Models](./Module02/README.md)  
...
- [**Phần 1: Các Nguyên Tắc Cơ Bản của Gia Đình Mô Hình Microsoft Phi**](./Module02/01.PhiFamily.md)  
  ...
  - Các khả năng chuyên biệt (lý luận, đa phương thức, triển khai edge)  
...
- [**Phần 4: Các Nguyên Tắc Cơ Bản của Gia Đình BitNET**](./Module02/04.BitNETFamily.md)  
  - Công nghệ lượng hóa cách mạng (1.58-bit)  
...
### [Module 03: Triển Khai Small Language Models](./Module03/README.md)  
...
- [**Phần 1: Học Nâng Cao về SLM**](./Module03/01.SLMAdvancedLearning.md)  
  ...
  - Các kỹ thuật tối ưu hóa nâng cao (phương pháp lượng hóa, lượng hóa 1-bit BitNET)  
  - Chiến lược thu nhận mô hình (Azure AI Foundry cho mô hình Phi, Hugging Face cho các mô hình được chọn)  

- [**Phần 2: Triển Khai Môi Trường Cục Bộ**](./Module03/02.DeployingSLMinLocalEnv.md)  
  - Triển khai nền tảng phổ quát Ollama  
  - Giải pháp doanh nghiệp cấp cao của Microsoft Foundry  
...
### [Module 04: Chuyển Đổi Định Dạng Mô Hình và Lượng Hóa](./Module04/README.md)  
**Chủ đề**: Bộ công cụ tối ưu hóa mô hình hoàn chỉnh cho triển khai edge trên nhiều nền tảng  

#### Cấu trúc chương:  
- [**Phần 1: Nền Tảng Chuyển Đổi Định Dạng Mô Hình và Lượng Hóa**](./Module04/01.Introduce.md)  
  - Khung phân loại độ chính xác (siêu thấp, thấp, trung bình)  
  - Lợi ích và trường hợp sử dụng định dạng GGUF và ONNX  
  - Lợi ích của lượng hóa đối với hiệu quả hoạt động  
  - So sánh hiệu suất và dung lượng bộ nhớ  
...
- [**Phần 3: Bộ công cụ tối ưu hóa Microsoft Olive**](./Module04/03.MicrosoftOlive.md)
  - Tối ưu hóa mô hình dựa trên phần cứng với hơn 40 thành phần tích hợp sẵn
...
- [**Phần 4: Bộ công cụ tối ưu hóa OpenVINO Toolkit**](./Module04/04.openvino.md)
  - Bộ công cụ mã nguồn mở của Intel dành cho triển khai AI đa nền tảng
  - Khung nén mạng thần kinh (NNCF) cho tối ưu hóa nâng cao
  - OpenVINO GenAI dành cho triển khai mô hình ngôn ngữ lớn
  - Tăng tốc phần cứng trên CPU, GPU, VPU và các bộ tăng tốc AI

- [**Phần 5: Khám phá sâu Framework Apple MLX**](./Module04/05.AppleMLX.md)
  - Kiến trúc bộ nhớ hợp nhất cho Apple Silicon
  - Hỗ trợ LLaMA, Mistral, Phi-3, một số mô hình Qwen
...
### [Module 05: SLMOps - Vận hành mô hình ngôn ngữ nhỏ](./Module05/README.md)
...
- [**Phần 3: Tinh chỉnh - Tùy chỉnh mô hình cho các nhiệm vụ cụ thể**](./Module05/03.SLMOps-Finetuing.md)
  ...
  - Triển khai tinh chỉnh Microsoft Olive
...
### [Module 06: Hệ thống SLM Agentic - Tác nhân AI và gọi hàm](./Module06/README.md)
**Chủ đề**: Triển khai hệ thống SLM agentic từ nền tảng đến gọi hàm nâng cao và tích hợp giao thức ngữ cảnh mô hình (MCP)

#### Cấu trúc chương:
- [**Phần 1: Tác nhân AI và nền tảng mô hình ngôn ngữ nhỏ**](./Module06/01.IntroduceAgent.md)
  - Khung phân loại tác nhân (phản xạ, dựa trên mô hình, dựa trên mục tiêu, tác nhân học tập)
  - Các nguyên tắc cơ bản của SLM và chiến lược tối ưu hóa (GGUF, lượng tử hóa, khung edge)
...
- [**Phần 2: Gọi hàm trong mô hình ngôn ngữ nhỏ**](./Module06/02.FunctionCalling.md)
  ...
  - Triển khai cụ thể theo nền tảng (Phi-4-mini, một số mô hình Qwen, Microsoft Foundry Local)
  - Các ví dụ nâng cao (hợp tác đa tác nhân, lựa chọn công cụ động)
  - Các cân nhắc sản xuất (giới hạn tốc độ, ghi nhật ký kiểm toán, biện pháp bảo mật)

- [**Phần 3: Tích hợp giao thức ngữ cảnh mô hình (MCP)**](./Module06/03.IntroduceMCP.md)
  - Kiến trúc giao thức và thiết kế hệ thống phân lớp
  - Hỗ trợ đa backend (Ollama cho phát triển, vLLM cho sản xuất)
  - Các giao thức kết nối (chế độ STDIO và SSE)
...
- [**Bộ công cụ AI cho Visual Studio Code**](./Module07/aitoolkit.md)
  ...
  - Quy trình thử nghiệm, tối ưu hóa và phát triển tác nhân tại chỗ
...
- [**EdgeAI trên NVIDIA Jetson Orin Nano**](./Module07/README.md#1-edgeai-in-nvidia-jetson-orin-nano)
  - Hiệu suất AI 67 TOPS trong kích thước bằng thẻ tín dụng
  - Hỗ trợ các mô hình AI tạo sinh (transformer thị giác, LLM, mô hình thị giác-ngôn ngữ)
...
- [**EdgeAI trên Azure với Small Language Models Engine**](./Module07/README.md#3-edgeai-in-azure-with-small-language-models-engine)
  ...
  - Tích hợp dịch vụ AI Azure với ONNX Runtime
...
- [**EdgeAI với Windows ML**](./Module07/README.md#4-edgeai-with-windows-ml)
  - Nền tảng Windows AI Foundry cho suy luận tại chỗ hiệu quả
...
- [**EdgeAI với ứng dụng Foundry Local**](./Module07/README.md#5-edgeai-with-foundry-local-applications)
  ...
  - Tích hợp mô hình ngôn ngữ Phi-3 với tìm kiếm ngữ nghĩa (chỉ mô hình Phi)
  - Hỗ trợ cơ sở dữ liệu vector tại chỗ (SQLite, Qdrant)
  - Khả năng hoạt động ngoại tuyến và chủ quyền dữ liệu

## Mục tiêu học tập của khóa học

Bằng cách hoàn thành khóa học EdgeAI toàn diện này, bạn sẽ phát triển chuyên môn để thiết kế, triển khai và triển khai các giải pháp EdgeAI sẵn sàng sản xuất. Cách tiếp cận có cấu trúc của chúng tôi đảm bảo bạn nắm vững cả nền tảng lý thuyết và kỹ năng triển khai thực tế.
...
- Hiểu các tùy chọn tăng tốc phần cứng (NPUs, GPUs, CPUs) và các tác động triển khai của chúng
...
**Khung ra quyết định**
- Đánh giá cơ hội EdgeAI và xác định các trường hợp sử dụng phù hợp cho ứng dụng doanh nghiệp
...
- Lập kế hoạch kiến trúc lai giữa edge và cloud để đạt hiệu suất tối ưu và hiệu quả chi phí
- Triển khai các luồng dữ liệu và quy trình xử lý cho các ứng dụng AI thời gian thực

### Ứng dụng ngành

**Kịch bản triển khai thực tế**
- **Sản xuất**: Hệ thống kiểm soát chất lượng, bảo trì dự đoán và tối ưu hóa quy trình
- **Chăm sóc sức khỏe**: Công cụ chẩn đoán bảo vệ quyền riêng tư và hệ thống giám sát bệnh nhân
- **Giao thông vận tải**: Ra quyết định cho phương tiện tự động và quản lý giao thông
...
- Có được kỹ năng thực tế để triển khai các giải pháp EdgeAI

### Kết quả học tập của Module 02:
- Hiểu sâu về các triết lý thiết kế SLM khác nhau và các tác động triển khai của chúng
...
- Hiểu sâu về các ranh giới lượng tử hóa và ứng dụng thực tế
...
- Lựa chọn khung chiến lược và tổng hợp quy trình làm việc cho các giải pháp Edge AI tối ưu

### Kết quả học tập của Module 05:
- Nắm vững mô hình SLMOps và các nguyên tắc vận hành
- Triển khai chưng cất mô hình để chuyển giao kiến thức và tối ưu hóa hiệu quả
- Áp dụng các kỹ thuật tinh chỉnh cho tùy chỉnh mô hình theo lĩnh vực
- Triển khai các giải pháp SLM sẵn sàng sản xuất với chiến lược giám sát và bảo trì

### Kết quả học tập của Module 06:
- Hiểu các khái niệm cơ bản về tác nhân AI và kiến trúc mô hình ngôn ngữ nhỏ
- Nắm vững triển khai gọi hàm trên nhiều nền tảng và khung
- Tích hợp giao thức ngữ cảnh mô hình (MCP) để tương tác công cụ bên ngoài được chuẩn hóa
- Xây dựng các hệ thống agentic tinh vi với yêu cầu can thiệp tối thiểu từ con người

### Kết quả học tập của Module 07:
- Nắm vững Bộ công cụ AI cho Visual Studio Code để quy trình phát triển Edge AI toàn diện
- Có được chuyên môn về nền tảng Windows AI Foundry và các chiến lược tối ưu hóa NPU
- Trải nghiệm thực hành với các nền tảng EdgeAI đa dạng và chiến lược triển khai
- Nắm vững các kỹ thuật tối ưu hóa cụ thể theo phần cứng trên các nền tảng NVIDIA, di động, Azure và Windows
- Hiểu các đánh đổi triển khai giữa hiệu suất, chi phí và yêu cầu quyền riêng tư
- Phát triển kỹ năng thực tế để xây dựng các ứng dụng EdgeAI thực tế trên các hệ sinh thái khác nhau

## Kết quả kỳ vọng của khóa học
...
- **Triển khai đa nền tảng**: Triển khai các giải pháp trên Windows, Linux, di động và nền tảng nhúng
...
- **Quản lý rủi ro**: Xác định và giảm thiểu các rủi ro kỹ thuật và vận hành trong triển khai EdgeAI
- **Tối ưu hóa ROI**: Chứng minh giá trị kinh doanh có thể đo lường từ các triển khai EdgeAI
...
- Nhà phát triển AI IoT
- Nhà phát triển ứng dụng AI di động
- Tư vấn AI doanh nghiệp

**Các ngành công nghiệp**
- Sản xuất thông minh và Công nghiệp 4.0
- Phương tiện tự động và giao thông vận tải
- Công nghệ chăm sóc sức khỏe và thiết bị y tế
- Công nghệ tài chính và bảo mật
- Điện tử tiêu dùng và ứng dụng di động

### Chứng nhận
Khóa học này đặt bạn ở vị trí tiên phong trong việc triển khai công nghệ AI, nơi các khả năng thông minh được tích hợp một cách liền mạch vào các thiết bị và hệ thống thúc đẩy cuộc sống hiện đại.
...
- **Thực hành trực tiếp**: Hoàn thành các tệp cấu hình, quy trình kiểm tra API và kịch bản triển khai  
- **Đánh giá hiệu suất**: So sánh chi tiết về tốc độ suy luận, sử dụng bộ nhớ và yêu cầu tài nguyên  
...
3. Học **Module03** để nắm vững kỹ năng triển khai thực tế  
4. Tiếp tục với **Module04** để tối ưu hóa mô hình nâng cao, chuyển đổi định dạng và tổng hợp khung làm việc  
5. Hoàn thành **Module05** để làm chủ SLMOps cho các triển khai sẵn sàng sản xuất  
6. Khám phá **Module06** để hiểu các hệ thống SLM có tính đại diện và khả năng gọi hàm  
...
Một [Hướng dẫn học tập](STUDY_GUIDE.md) toàn diện có sẵn để giúp bạn tối ưu hóa trải nghiệm học tập. Hướng dẫn học tập cung cấp:  
