...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T00:14:15+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "vi"
}
-->
# Foundry Local như Công cụ Tích hợp

Một khung toàn diện để tích hợp Microsoft Foundry Local như các công cụ có thể gọi trong các ứng dụng lớn hơn, tuân theo các mẫu chính thức của Microsoft về tích hợp AI dựa trên công cụ.

## Tổng quan

Ví dụ này minh họa cách đưa các mô hình Foundry Local thành các công cụ có thể tái sử dụng, tích hợp vào các ứng dụng, quy trình làm việc và môi trường phát triển hiện có. Nó trình bày các mẫu tích hợp công cụ và gọi hàm được Microsoft khuyến nghị.

## Các khái niệm chính

### 🔧 **Kiến trúc Ưu tiên Công cụ**
- Mô hình Foundry Local như các hàm có thể gọi
- Giao diện và lược đồ công cụ được chuẩn hóa
- Tích hợp mượt mà với các cơ sở mã hiện có
- Định nghĩa công cụ an toàn kiểu và xác thực

### ⚡ **Mẫu Gọi Hàm**
- Triển khai gọi hàm Microsoft Foundry Local
- Định nghĩa công cụ tương thích với OpenAI
- Xác thực và chuyển đổi tham số tự động
- Xử lý lỗi và định dạng phản hồi

### 🔌 **Khung Tích hợp**
- **Tích hợp LangChain**: Hỗ trợ công cụ LangChain gốc
- **Semantic Kernel**: Các hàm Microsoft Semantic Kernel
- **REST API**: Các điểm cuối công cụ dựa trên HTTP
- **Công cụ CLI**: Tích hợp giao diện dòng lệnh
- **Jupyter Notebooks**: Công cụ phát triển tương tác

### 🎯 **Mẫu Trường Hợp Sử Dụng**
- Công cụ phân tích và tạo mã
- Xử lý nội dung và tóm tắt
- Phân tích và trực quan hóa dữ liệu
- Nghiên cứu và truy xuất thông tin
...
- **Node.js**: v18+ (cho tích hợp JavaScript)
- **Bộ nhớ**: Khuyến nghị 12GB+
- **Lưu trữ**: 10GB+ cho mô hình và công cụ
...
Sau khi hoàn thành ví dụ này, bạn sẽ hiểu:

1. **Mẫu Tích hợp Công cụ**
   - Thiết kế công cụ dựa trên hàm và lớp
   - Mẫu tích hợp Microsoft Foundry Local
   - Xác thực lược đồ và an toàn kiểu
   - Xử lý lỗi và phục hồi

2. **Tích hợp Khung**
   - Phát triển công cụ LangChain
   - Tích hợp hàm Semantic Kernel
   - Tích hợp khung REST API
   - Phát triển ứng dụng CLI

3. **Cân nhắc Sản xuất**
   - Chiến lược tối ưu hóa hiệu suất
   - Quản lý bộ nhớ đệm và tài nguyên
   - Giám sát và quan sát
   - Bảo mật và xác thực

4. **Mẫu Công cụ Nâng cao**
   - Thành phần và chuỗi công cụ
   - Xử lý nhận thức ngữ cảnh
   - Hoạt động theo lô và streaming
   - Phát triển tích hợp tùy chỉnh

## Bước tiếp theo

- **Dự án Tích hợp**: Xây dựng tích hợp tùy chỉnh với các khung yêu thích của bạn
- **Phát triển Công cụ**: Tạo công cụ chuyên biệt cho lĩnh vực của bạn
- **Tối ưu hóa Hiệu suất**: Tối ưu hóa cho các trường hợp sử dụng cụ thể của bạn
- **Triển khai Sản xuất**: Mở rộng công cụ cho sử dụng doanh nghiệp

## Đóng góp

Xem hướng dẫn kho chính để biết hướng dẫn đóng góp.

## Giấy phép

Ví dụ này tuân theo cùng giấy phép với dự án Microsoft Foundry Local.
