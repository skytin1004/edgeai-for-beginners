...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-01T00:55:30+00:00",
...
Xem các mô hình AI như những công cụ mô-đun, tùy chỉnh chạy trực tiếp trên thiết bị với Foundry Local. Phiên này nhấn mạnh các quy trình thực tế để suy luận bảo vệ quyền riêng tư, độ trễ thấp và cách tích hợp các công cụ này thông qua SDK, API hoặc CLI. Bạn cũng sẽ học cách mở rộng quy mô lên Azure AI Foundry khi cần.

> **🔄 Cập nhật cho SDK hiện đại**: Module này đã được điều chỉnh theo các mẫu kho lưu trữ mới nhất của Microsoft Foundry-Local và phù hợp với triển khai định tuyến thông minh trong `samples/06/`. Các ví dụ hiện sử dụng `foundry-local-sdk` hiện đại và các chiến lược chọn mô hình nâng cao.
...
- **Cấu hình môi trường**: Gán mô hình linh hoạt thông qua biến môi trường
...
- Tích hợp thông qua API REST tương thích OpenAI hoặc SDK
...
## Phần 4: Hoạt động ngoại tuyến và bảo mật (Từng bước)
