...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T00:07:03+00:00",
...
Buổi học này tập trung vào việc xây dựng các ứng dụng chat sẵn sàng cho sản xuất bằng Chainlit và Microsoft Foundry Local. Bạn sẽ học cách tạo giao diện web hiện đại cho các cuộc hội thoại AI, triển khai phản hồi theo luồng, và triển khai các ứng dụng chat mạnh mẽ với xử lý lỗi và thiết kế trải nghiệm người dùng phù hợp.

**Những gì bạn sẽ xây dựng:**
- **Ứng dụng Chat Chainlit**: Giao diện web hiện đại với phản hồi theo luồng
- **Demo WebGPU**: Suy luận trực tiếp trên trình duyệt cho các ứng dụng ưu tiên quyền riêng tư  
...
- Triển khai phản hồi theo luồng để nâng cao trải nghiệm người dùng
- Làm chủ các mẫu tích hợp SDK Foundry Local
- Áp dụng xử lý lỗi phù hợp và giảm thiểu tác động một cách linh hoạt
...
- **Docker**: Dành cho tích hợp Open WebUI (tùy chọn)
...
- Tự động tạo giao diện UI và quản lý WebSocket
...
| **Chi phí** | 💰 Miễn phí sau khi có phần cứng | 💸 Tính phí theo token |
| **Offline** | ✅ Hoạt động không cần internet | ❌ Yêu cầu internet |
| **Kích thước mô hình** | ⚠️ Giới hạn bởi phần cứng | ✅ Truy cập các mô hình lớn nhất |
| **Khả năng mở rộng** | ⚠️ Phụ thuộc phần cứng | ✅ Mở rộng không giới hạn |

### Mẫu chiến lược kết hợp
...
- **🛠️ Công cụ phát triển**: Khả năng kiểm tra và gỡ lỗi
...
### Thực hành cấu trúc notebook tốt nhất
...
**Lưu ý:** `host.docker.internal` cho phép các container Docker truy cập vào máy chủ trên Windows.
...
Buổi 4 đã bao quát việc xây dựng các ứng dụng Chainlit sẵn sàng cho sản xuất dành cho AI hội thoại. Bạn đã học về:

- ✅ **Framework Chainlit**: Giao diện hiện đại và hỗ trợ theo luồng cho ứng dụng chat
...
Ứng dụng Mẫu 04 minh họa các thực hành tốt nhất để xây dựng giao diện chat mạnh mẽ, tận dụng các mô hình AI local thông qua Microsoft Foundry Local, đồng thời mang lại trải nghiệm người dùng xuất sắc.
