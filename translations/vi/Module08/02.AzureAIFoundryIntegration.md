...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T21:53:16+00:00",
...
Dựa trên nền tảng Foundry Local, buổi học này tập trung vào việc tạo ra các giải pháp AI tiên tiến thông qua kỹ thuật xây dựng prompt nâng cao, tích hợp dữ liệu liền mạch và tự động hóa các nhiệm vụ có thể hành động. Bạn sẽ học cách kết nối phát triển cục bộ với các khả năng của Azure AI Foundry, tạo ra các ứng dụng sẵn sàng cho doanh nghiệp, tận dụng tối đa cả hai nền tảng.

## Mục tiêu học tập

Sau buổi học này, bạn sẽ:
- Thành thạo các kỹ thuật xây dựng prompt nâng cao để đảm bảo phản hồi AI nhất quán và đáng tin cậy
- Triển khai các mẫu tích hợp dữ liệu mạnh mẽ cho các ứng dụng thực tế
- Tạo các nhiệm vụ AI có thể hành động để mang lại giá trị kinh doanh
- Thiết lập kết nối liền mạch giữa Foundry Local và Azure AI Foundry
- Xây dựng quy trình giám sát hiệu suất và tối ưu hóa
- Triển khai các giải pháp AI sẵn sàng cho sản xuất với xử lý lỗi và khả năng mở rộng phù hợp

## Điều kiện tiên quyết

- Hoàn thành Buổi 1: Bắt đầu với Foundry Local
- Cài đặt Foundry Local đang hoạt động với các mô hình đã chạy
- Tài khoản Azure (cấp miễn phí đủ để học)
- Hiểu cơ bản về REST APIs và JSON

## Phần 1: Kỹ thuật xây dựng Prompt nâng cao

### Hiểu về Kiến trúc Prompt

Kỹ thuật xây dựng prompt hiệu quả là nền tảng của các ứng dụng AI đáng tin cậy. Foundry Local cung cấp các khả năng xây dựng prompt nâng cao:
...
### Ví dụ Thực tế về Kỹ thuật Prompt
...
## Phần 2: Mẫu Tích hợp Dữ liệu

### Kết nối Dữ liệu Foundry Local
...
### Ví dụ Tích hợp Dữ liệu Thực tế
...
## Phần 3: Nhiệm vụ AI Có thể Hành động

### Khung Tự động hóa Nhiệm vụ
...
### Ví dụ Tự động hóa Quy trình Kinh doanh
...
## Phần 4: Tích hợp Azure AI Foundry
...
## Phần 5: Giám sát Hiệu suất và Tối ưu hóa
...
### Bài tập 1: Bot Dịch vụ Khách hàng Nâng cao
...
### Bài tập 2: Nghiên cứu Thị trường Tự động
...
## Phần 7: Bước Tiếp theo và Xem trước Buổi 3

### Thành tựu Buổi học

Trong buổi học này, bạn đã thành thạo:
- ✅ Kỹ thuật xây dựng prompt nâng cao để đảm bảo hành vi AI nhất quán
- ✅ Mẫu tích hợp dữ liệu mạnh mẽ cho các ứng dụng thực tế
- ✅ Tạo nhiệm vụ tự động hóa để tối ưu hóa quy trình kinh doanh
- ✅ Tích hợp Azure AI Foundry và chiến lược triển khai kết hợp
- ✅ Giám sát hiệu suất toàn diện và tối ưu hóa

### Chuẩn bị cho Buổi 3: Mô hình Mã nguồn Mở

1. **Khám phá Hugging Face**: Tạo tài khoản và duyệt qua danh mục mô hình
2. **Xem Model Mondays**: Kiểm tra loạt bài [Model Mondays](https://aka.ms/model-mondays) mới nhất
3. **Lên kế hoạch cho Mô hình Tùy chỉnh**: Xem xét các mô hình chuyên biệt nào sẽ mang lại lợi ích cho trường hợp sử dụng của bạn

### Tài nguyên bổ sung

- [Tài liệu Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Kho GitHub Foundry Local](https://github.com/microsoft/Foundry-Local)
- [Hướng dẫn Kỹ thuật Prompt Nâng cao](https://platform.openai.com/docs/guides/prompt-engineering)
- [Thực hành Tốt nhất về Tự động hóa Quy trình Kinh doanh](https://docs.microsoft.com/en-us/power-automate/)

Bạn đã sẵn sàng để xây dựng các giải pháp AI tiên tiến kết hợp sức mạnh của suy luận cục bộ với khả năng mở rộng trên đám mây, đặt nền tảng cho các ứng dụng AI cấp doanh nghiệp.
