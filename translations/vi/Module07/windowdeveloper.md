...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T21:45:49+00:00",
...
Windows ML cung cấp khả năng tối ưu hóa phần cứng tự động trên toàn bộ hệ sinh thái Windows, đảm bảo các ứng dụng AI của bạn hoạt động tối ưu bất kể kiến trúc chip bên dưới.

**Runtime AI Tích Hợp**  
Công cụ suy luận Windows ML tích hợp sẵn loại bỏ các yêu cầu thiết lập phức tạp, cho phép nhà phát triển tập trung vào logic ứng dụng thay vì các vấn đề hạ tầng.

**Tối Ưu PC Với Copilot+**  
Các API được thiết kế đặc biệt cho các thiết bị Windows thế hệ mới với Neural Processing Units (NPUs) chuyên dụng, mang lại hiệu suất vượt trội trên mỗi watt.
...
Khi hoàn thành hướng dẫn phát triển AI Edge trên Windows này, bạn sẽ nắm vững các kỹ năng cần thiết để xây dựng các ứng dụng AI sẵn sàng cho sản xuất trên nền tảng Windows.
...
- Triển khai suy luận thời gian thực với việc sử dụng tài nguyên tối ưu  
...
- Tích hợp các khả năng AI vào Win32, UWP và Progressive Web Applications  
- Triển khai thiết kế giao diện người dùng đáp ứng, thích ứng với trạng thái xử lý AI  
...
- Áp dụng quản lý bộ nhớ hiệu quả cho các mô hình ngôn ngữ lớn  
- Thiết kế ứng dụng giảm thiểu gracefully dựa trên khả năng phần cứng hiện có  
- Áp dụng các chiến lược lưu trữ tạm thời cho các hoạt động AI thường xuyên  
...
- Triển khai các giải pháp AI hiệu quả về chi phí, mở rộng theo nhu cầu người dùng  
...
Windows AI APIs cung cấp các khả năng AI sẵn sàng sử dụng được hỗ trợ bởi các mô hình trên thiết bị, được tối ưu hóa cho hiệu quả và hiệu suất trên các thiết bị Copilot+ PC với yêu cầu thiết lập tối thiểu.
...
**Triển Khai Cục Bộ**  
- Hoạt động hoàn toàn ngoại tuyến mà không phụ thuộc vào đám mây  
...
**Hỗ Trợ Phần Cứng Toàn Diện**  
- Tối ưu hóa tự động cho chip của AMD, Intel, NVIDIA và Qualcomm  
- Hỗ trợ thực thi trên CPU, GPU và NPU với chuyển đổi minh bạch  
- Trừu tượng hóa phần cứng loại bỏ công việc tối ưu hóa cụ thể theo nền tảng  
...
1. Cài đặt Visual Studio với phần mở rộng AI Toolkit  
2. Cấu hình các công cụ CLI của Windows AI Foundry  
3. Thiết lập môi trường thử nghiệm mô hình cục bộ  
4. Thiết lập các công cụ phân tích hiệu suất và giám sát  
...
**Phân Tích Yêu Cầu**  
- Xác định các yêu cầu chức năng cho các khả năng AI  
...
- Thiết kế giao diện người dùng thích ứng với quy trình xử lý AI  
- Áp dụng các chiến lược lưu trữ tạm thời và tối ưu hóa cho suy luận mô hình  
- Thêm giám sát và đo lường hiệu suất hoạt động AI  
...
- Thực hiện kiểm tra trải nghiệm người dùng với các tính năng tích hợp AI  
...
Tạo hệ thống quản lý hàng tồn kho tích hợp AI cho các ứng dụng bán lẻ:

**Công Nghệ Sử Dụng:**  
- Phân Đoạn Hình Ảnh để nhận diện sản phẩm  
- Các mô hình thị giác tùy chỉnh để phân loại thương hiệu và danh mục  
- Triển khai Foundry Local các mô hình ngôn ngữ chuyên biệt cho bán lẻ  
...
- Thêm truy vấn ngôn ngữ tự nhiên cho hàng tồn kho bằng các mô hình ngôn ngữ cục bộ  
...
**Tối Ưu NPU**  
- Thiết kế ứng dụng tận dụng khả năng NPU trên các PC Copilot+  
- Triển khai dự phòng linh hoạt sang GPU/CPU trên các thiết bị không có NPU  
- Tối ưu hóa định dạng mô hình cho tăng tốc cụ thể NPU  
- Giám sát việc sử dụng NPU và đặc điểm nhiệt  

**Quản Lý Bộ Nhớ**  
- Triển khai các chiến lược tải và lưu trữ mô hình hiệu quả  
- Sử dụng ánh xạ bộ nhớ cho các mô hình lớn để giảm thời gian khởi động  
- Thiết kế ứng dụng nhận thức bộ nhớ cho các thiết bị hạn chế tài nguyên  
...
- Lên kế hoạch cho kích thước mô hình lớn hơn và độ phức tạp cao hơn
- Triển khai kiến trúc thích ứng với phần cứng đang phát triển
- Cân nhắc các thuật toán sẵn sàng cho công nghệ lượng tử để đảm bảo tương thích trong tương lai
...
- Thiết kế cho khả năng học liên kết (federated learning)
...
- Triển khai cờ tính năng (feature flags) để triển khai khả năng dần dần
...
Sự kết hợp giữa Windows AI APIs, Foundry Local và Windows ML cung cấp nền tảng vượt trội để xây dựng thế hệ tiếp theo của các ứng dụng Windows thông minh. Khi AI tiếp tục phát triển, nền tảng Windows đảm bảo rằng ứng dụng của bạn sẽ mở rộng với các công nghệ mới nổi đồng thời duy trì khả năng tương thích và hiệu suất trên hệ sinh thái phần cứng đa dạng của Windows.

Dù bạn đang xây dựng ứng dụng tiêu dùng, giải pháp doanh nghiệp hay công cụ chuyên ngành, phát triển Windows Edge AI trao quyền cho bạn tạo ra các trải nghiệm thông minh, phản hồi nhanh và tích hợp sâu, tận dụng tối đa tiềm năng của các thiết bị Windows hiện đại.

## Tài Nguyên Bổ Sung

Để xem hướng dẫn từng bước về Foundry Local (cài đặt, CLI, điểm cuối động, sử dụng SDK), hãy xem hướng dẫn repo: [foundrylocal.md](./foundrylocal.md).

### Tài Liệu và Học Tập
- [Tài Liệu Windows AI Foundry](https://learn.microsoft.com/windows/ai/)
- [Tham Khảo Windows AI APIs](https://learn.microsoft.com/windows/ai/apis/)
- [Bắt Đầu Với Foundry Local](https://learn.microsoft.com/windows/ai/foundry-local/get-started/)
- [Tổng Quan Windows ML](https://learn.microsoft.com/windows/ai/new-windows-ml/overview/)

### Công Cụ Phát Triển
- [AI Toolkit cho Visual Studio Code](https://learn.microsoft.com/windows/ai/toolkit/)
