...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T19:39:04+00:00",
...
NVIDIA Jetson Orin Nano là một bước đột phá trong điện toán AI biên, cung cấp hiệu suất AI lên đến 67 TOPS trong một thiết bị nhỏ gọn, kích thước bằng thẻ tín dụng. Nền tảng AI biên mạnh mẽ này mang lại khả năng phát triển AI tạo sinh cho các nhà sáng tạo, sinh viên và nhà phát triển chuyên nghiệp.
...
- Giá chỉ $249, mang lại nền tảng dễ tiếp cận và tiết kiệm cho các nhà phát triển, sinh viên và nhà sáng tạo

### Ứng Dụng
Jetson Orin Nano vượt trội trong việc chạy các mô hình AI tạo sinh hiện đại bao gồm vision transformers, các mô hình ngôn ngữ lớn, và các mô hình kết hợp hình ảnh-ngôn ngữ. Nó được thiết kế đặc biệt cho các trường hợp sử dụng GenAI và giờ đây bạn có thể chạy nhiều LLM trên một thiết bị nhỏ gọn. Các trường hợp sử dụng phổ biến bao gồm robot thông minh, máy bay không người lái, camera thông minh, và các thiết bị biên tự động.
...
Giải pháp này minh họa cách tích hợp AI tạo sinh và các mô hình ngôn ngữ lớn (LLMs) vào các ứng dụng di động đa nền tảng bằng cách sử dụng .NET MAUI (Multi-platform App UI) và ONNX Runtime GenAI. Phương pháp này cho phép các nhà phát triển .NET xây dựng các ứng dụng di động AI mạnh mẽ chạy natively trên thiết bị Android và iOS.
...
- Thực hiện toàn bộ vòng lặp AI tạo sinh bao gồm tiền xử lý, hậu xử lý, suy luận, xử lý logits, tìm kiếm và lấy mẫu, và quản lý bộ nhớ đệm KV

### Lợi Ích Phát Triển
Phương pháp .NET MAUI cho phép các nhà phát triển tận dụng kỹ năng C# và .NET hiện có của họ trong khi xây dựng các ứng dụng AI đa nền tảng. Framework ONNX Runtime GenAI hỗ trợ nhiều kiến trúc mô hình bao gồm Llama, Mistral, Phi, Gemma, và nhiều mô hình khác. Các kernel ARM64 được tối ưu hóa tăng tốc nhân ma trận INT4, đảm bảo hiệu suất hiệu quả trên phần cứng di động trong khi vẫn duy trì trải nghiệm phát triển quen thuộc với .NET.
...
Giải pháp EdgeAI dựa trên Azure của Microsoft tập trung vào việc triển khai các mô hình ngôn ngữ nhỏ (SLMs) một cách hiệu quả trong môi trường kết hợp giữa đám mây và biên. Phương pháp này kết nối các dịch vụ AI quy mô đám mây với các yêu cầu triển khai tại biên.
...
### Các Trường Hợp Sử Dụng
Triển khai EdgeAI trên Azure vượt trội trong các kịch bản yêu cầu triển khai AI cấp doanh nghiệp với khả năng quản lý đám mây. Điều này bao gồm xử lý tài liệu thông minh, phân tích thời gian thực, và các quy trình AI kết hợp tận dụng cả tài nguyên đám mây và biên.
...
Windows ML là runtime tiên tiến của Microsoft được tối ưu hóa cho suy luận mô hình trên thiết bị và triển khai đơn giản, đóng vai trò là nền tảng của Windows AI Foundry. Nền tảng này cho phép các nhà phát triển tạo ứng dụng Windows tích hợp AI tận dụng toàn bộ khả năng của phần cứng PC.
...
- Nhờ các API hạ tầng, các nhà phát triển không cần tạo nhiều bản dựng ứng dụng để nhắm đến các loại silicon khác nhau
...
Foundry Local cho phép các nhà phát triển Windows và Mac xây dựng các ứng dụng Retrieval Augmented Generation (RAG) sử dụng tài nguyên cục bộ trong .NET, kết hợp các mô hình ngôn ngữ cục bộ với khả năng tìm kiếm ngữ nghĩa. Phương pháp này cung cấp các giải pháp AI tập trung vào quyền riêng tư hoạt động hoàn toàn trên hạ tầng cục bộ.
...
### Lợi Ích Triển Khai
RAG, hay Retrieval Augmented Generation, chỉ đơn giản là "tìm kiếm một số thông tin và đưa vào prompt". Triển khai cục bộ này đảm bảo quyền riêng tư dữ liệu trong khi cung cấp các phản hồi thông minh dựa trên các cơ sở kiến thức tùy chỉnh. Phương pháp này đặc biệt có giá trị trong các kịch bản doanh nghiệp yêu cầu chủ quyền dữ liệu và khả năng hoạt động offline.
...
- Tham chiếu CLI: https://learn.microsoft.com/azure/ai-foundry/foundry-local/reference/reference-cli
...
## Tài Nguyên Phát Triển EdgeAI trên Windows

Đối với các nhà phát triển nhắm đến nền tảng Windows, chúng tôi đã tạo một hướng dẫn toàn diện bao gồm toàn bộ hệ sinh thái EdgeAI trên Windows. Tài nguyên này cung cấp thông tin chi tiết về Windows AI Foundry, bao gồm các API, công cụ, và các thực tiễn tốt nhất cho phát triển EdgeAI trên Windows.
...
- Các ví dụ triển khai thực tế và các thực tiễn tốt nhất

### [AI Toolkit cho Phát Triển Edge AI](./aitoolkit.md)
Đối với các nhà phát triển sử dụng Visual Studio Code, tiện ích mở rộng AI Toolkit cung cấp một môi trường phát triển toàn diện được thiết kế đặc biệt để xây dựng, thử nghiệm, và triển khai các ứng dụng Edge AI. Bộ công cụ này hợp lý hóa toàn bộ quy trình phát triển Edge AI trong VS Code.
