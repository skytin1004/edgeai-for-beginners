...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T21:44:05+00:00",
  "source_file": "Module04/03.MicrosoftOlive.md",
  "language_code": "vi"
}
-->
# Phần 3: Bộ Công Cụ Tối Ưu Microsoft Olive
...
- **Hỗ trợ đa khung framework**: Hoạt động với PyTorch, các mô hình Hugging Face và ONNX
...
- **Triển khai đa nền tảng**: Các mô hình được tối ưu hóa hoạt động trên nhiều phần cứng và hệ điều hành khác nhau
...
Quá trình tối ưu hóa bao gồm: lấy mô hình từ bộ nhớ cache cục bộ, thu thập đồ thị ONNX và lưu trọng số vào tệp dữ liệu ONNX, tối ưu hóa đồ thị ONNX, và lượng tử hóa mô hình sang int4 bằng phương pháp RTN.
...
- `--log_level`: Mức độ chi tiết của nhật ký (0=ít nhất, 1=chi tiết)

## Ví dụ: Chuyển đổi Qwen3 sang ONNX INT4

Dựa trên ví dụ Hugging Face tại [lokinfey/Qwen3-8B-ONNX-INT4-CPU](https://huggingface.co/lokinfey/Qwen3-8B-ONNX-INT4-CPU), đây là cách tối ưu hóa mô hình Qwen3:
...
- Sử dụng tệp cấu hình để kiểm soát chi tiết hơn
...
- Đảm bảo đủ dung lượng đĩa để lưu trữ mô hình
...
### Ví dụ từ cộng đồng
- **Jupyter Notebooks**: Có sẵn trong kho GitHub của Olive — https://github.com/microsoft/Olive/tree/main/examples
- **Tiện ích mở rộng VS Code**: Tổng quan về AI Toolkit cho VS Code — https://learn.microsoft.com/azure/ai-toolkit/overview
- **Bài viết blog**: Blog Microsoft Open Source — https://opensource.microsoft.com/blog/
...
- [04: Bộ Công Cụ Tối Ưu OpenVINO Toolkit](./04.openvino.md)
