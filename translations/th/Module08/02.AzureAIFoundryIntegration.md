...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T19:22:25+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "th"
}
-->
# Session 2: สร้างโซลูชัน AI ด้วย Azure AI Foundry

## ภาพรวม

ต่อยอดจากพื้นฐาน Foundry Local ของคุณ เซสชันนี้มุ่งเน้นการสร้างโซลูชัน AI ที่ซับซ้อนผ่านการออกแบบคำสั่งขั้นสูง การผสานข้อมูลอย่างไร้รอยต่อ และการทำงานอัตโนมัติที่นำไปใช้ได้จริง คุณจะได้เรียนรู้วิธีเชื่อมโยงการพัฒนาระบบในพื้นที่กับความสามารถของ Azure AI Foundry เพื่อสร้างแอปพลิเคชันระดับองค์กรที่ใช้ประโยชน์จากทั้งสองด้านได้อย่างเต็มที่

## วัตถุประสงค์การเรียนรู้

เมื่อจบเซสชันนี้ คุณจะสามารถ:
- เชี่ยวชาญเทคนิคการออกแบบคำสั่งขั้นสูงเพื่อให้ได้ผลลัพธ์ AI ที่สม่ำเสมอและเชื่อถือได้
- ใช้รูปแบบการผสานข้อมูลที่แข็งแกร่งสำหรับการใช้งานในโลกจริง
- สร้างงาน AI ที่นำไปใช้ได้จริงเพื่อเพิ่มมูลค่าทางธุรกิจ
- เชื่อมต่อ Foundry Local กับ Azure AI Foundry ได้อย่างไร้รอยต่อ
- สร้างเวิร์กโฟลว์สำหรับการตรวจสอบและปรับปรุงประสิทธิภาพ
- ปรับใช้โซลูชัน AI ที่พร้อมใช้งานในระบบจริงด้วยการจัดการข้อผิดพลาดและการปรับขนาดที่เหมาะสม

## ข้อกำหนดเบื้องต้น

- ผ่านการเรียน Session 1: เริ่มต้นใช้งาน Foundry Local
- ติดตั้ง Foundry Local พร้อมโมเดลที่ทำงานอยู่
- บัญชี Azure (บัญชีฟรีเพียงพอสำหรับการเรียนรู้)
- ความเข้าใจพื้นฐานเกี่ยวกับ REST APIs และ JSON

## ส่วนที่ 1: การออกแบบคำสั่งขั้นสูง

### ความเข้าใจเกี่ยวกับโครงสร้างคำสั่ง

การออกแบบคำสั่งที่มีประสิทธิภาพเป็นพื้นฐานของแอปพลิเคชัน AI ที่เชื่อถือได้ Foundry Local มีความสามารถในการออกแบบคำสั่งที่เพิ่มขึ้น:
...
### ตัวอย่างการออกแบบคำสั่งในทางปฏิบัติ
...
## ส่วนที่ 2: รูปแบบการผสานข้อมูล

### ตัวเชื่อมต่อข้อมูลของ Foundry Local
...
### ตัวอย่างการผสานข้อมูลในโลกจริง
...
## ส่วนที่ 3: งาน AI ที่นำไปใช้ได้จริง

### กรอบการทำงานอัตโนมัติของงาน
...
### ตัวอย่างการทำงานอัตโนมัติในกระบวนการทางธุรกิจ
...
## ส่วนที่ 4: การผสาน Azure AI Foundry
...
## ส่วนที่ 5: การตรวจสอบและปรับปรุงประสิทธิภาพ
...
### การฝึกปฏิบัติที่ 1: บอทบริการลูกค้าขั้นสูง
...
### การฝึกปฏิบัติที่ 2: การวิจัยตลาดอัตโนมัติ
...
## ส่วนที่ 7: ขั้นตอนถัดไปและตัวอย่าง Session 3

### ความสำเร็จในเซสชันนี้

ในเซสชันนี้ คุณได้เรียนรู้:
- ✅ เทคนิคการออกแบบคำสั่งขั้นสูงเพื่อให้ AI มีพฤติกรรมที่สม่ำเสมอ
- ✅ รูปแบบการผสานข้อมูลที่แข็งแกร่งสำหรับการใช้งานในโลกจริง
- ✅ การสร้างงานอัตโนมัติเพื่อเพิ่มประสิทธิภาพกระบวนการทางธุรกิจ
- ✅ การผสาน Azure AI Foundry และกลยุทธ์การปรับใช้แบบไฮบริด
- ✅ ระบบการตรวจสอบและปรับปรุงประสิทธิภาพที่ครอบคลุม

### การเตรียมตัวสำหรับ Session 3: โมเดลโอเพ่นซอร์ส

1. **สำรวจ Hugging Face**: สร้างบัญชีและดูแคตตาล็อกโมเดล
2. **ตรวจสอบ Model Mondays**: ดูซีรีส์ [Model Mondays](https://aka.ms/model-mondays) ล่าสุด
3. **วางแผนโมเดลเฉพาะทาง**: พิจารณาว่าโมเดลเฉพาะทางใดจะเป็นประโยชน์ต่อกรณีการใช้งานของคุณ

### แหล่งข้อมูลเพิ่มเติม

- [เอกสาร Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [ที่เก็บ GitHub ของ Foundry Local](https://github.com/microsoft/Foundry-Local)
- [คู่มือการออกแบบคำสั่งขั้นสูง](https://platform.openai.com/docs/guides/prompt-engineering)
- [แนวปฏิบัติที่ดีที่สุดสำหรับการทำงานอัตโนมัติในกระบวนการทางธุรกิจ](https://docs.microsoft.com/en-us/power-automate/)

ตอนนี้คุณพร้อมที่จะสร้างโซลูชัน AI ที่ซับซ้อนซึ่งรวมพลังของการประมวลผลในพื้นที่เข้ากับความสามารถในระดับคลาวด์ วางรากฐานสำหรับแอปพลิเคชัน AI ระดับองค์กรแล้ว!
