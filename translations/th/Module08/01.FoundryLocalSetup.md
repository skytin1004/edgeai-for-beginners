...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T22:40:55+00:00",
...
Microsoft Foundry Local นำความสามารถของ Azure AI Foundry มาสู่สภาพแวดล้อมการพัฒนาบน Windows 11 ของคุณ ช่วยให้การพัฒนา AI มีความเป็นส่วนตัวและมีความหน่วงต่ำ พร้อมเครื่องมือระดับองค์กร เซสชันนี้ครอบคลุมการติดตั้ง การตั้งค่า และการใช้งานจริงของโมเดลยอดนิยม เช่น phi, qwen, deepseek และ GPT-OSS-20B
...
สร้างแอปพลิเคชันแชทที่พร้อมใช้งานในระดับการผลิตโดยใช้ OpenAI SDK พร้อมการผสานรวม Foundry Local ตามรูปแบบจากตัวอย่างที่ 01
...
- **อัปเกรดเป็นประจำ**: อัปเดต Foundry Local เพื่อเข้าถึงโมเดลและการแก้ไขใหม่ๆ
- **เริ่มต้นเล็กๆ**: เริ่มต้นด้วยโมเดลขนาดเล็ก (Phi mini, Qwen 7B) แล้วค่อยขยาย
- **ตรวจสอบทรัพยากร**: ติดตาม CPU/GPU/หน่วยความจำขณะปรับแต่งคำสั่งและการตั้งค่า

## ส่วนที่ 7: การฝึกปฏิบัติ

### การฝึกที่ 1: ทดสอบโมเดลหลายตัวอย่างรวดเร็ว
...
### การฝึกที่ 2: ทดสอบการผสานรวม OpenAI SDK
...
### การฝึกที่ 3: ตรวจสอบสุขภาพบริการอย่างครอบคลุม
...
- **ตัวอย่างที่ 01: แชทอย่างรวดเร็วผ่าน OpenAI SDK**: samples/01/README.md
- **ตัวอย่างที่ 02: การผสานรวม SDK ขั้นสูง**: samples/02/README.md
