...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-01T00:32:01+00:00",
...
| **งานวิจัย** | ☁️ Cloud (Azure OpenAI) | ต้องการฐานความรู้กว้าง |
...
- 🐳 **การใช้งาน Docker**: การตั้งค่าที่พร้อมใช้งานจริงแบบคอนเทนเนอร์
...
**Chainlit:**
- ใช้การสตรีมเพื่อปรับปรุงประสิทธิภาพที่รับรู้
...
- ตั้งค่าพร็อกซีแบบย้อนกลับสำหรับการยกเลิก SSL
...
- **API Keys**: ใช้ตัวแปรสภาพแวดล้อม ห้ามเขียนคีย์ลงในโค้ด
...
- **การตรวจสอบสุขภาพ**: ใช้การตรวจสอบจุดเชื่อมต่อ
...
- [เอกสาร Chainlit](https://docs.chainlit.io/) - คู่มือเฟรมเวิร์กครบถ้วน
- [เอกสาร Foundry Local](https://learn.microsoft.com/azure/ai-foundry/foundry-local/) - เอกสาร Microsoft อย่างเป็นทางการ
- [ONNX Runtime Web](https://onnxruntime.ai/docs/get-started/with-javascript/web.html) - การรวม WebGPU
- [เอกสาร Open WebUI](https://docs.openwebui.com/) - การตั้งค่าขั้นสูง
...
- [เอกสาร Session 4](../../04.CuttingEdgeModels.md) - คู่มือ Session ครบถ้วน
- [ตัวอย่าง Foundry Local](https://github.com/microsoft/foundry-local/tree/main/samples) - ตัวอย่างอย่างเป็นทางการ
