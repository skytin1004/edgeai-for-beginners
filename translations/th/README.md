...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T08:56:20+00:00",
...
ยินดีต้อนรับสู่ **EdgeAI สำหรับผู้เริ่มต้น** – การเดินทางที่ครอบคลุมสู่โลกแห่ง Edge Artificial Intelligence ที่เปลี่ยนแปลงวงการ คอร์สนี้จะช่วยให้คุณเข้าใจความสามารถของ AI ที่ทรงพลังและการนำไปใช้จริงในอุปกรณ์ Edge เพื่อให้คุณสามารถใช้ศักยภาพของ AI ได้โดยตรงในที่ที่ข้อมูลถูกสร้างขึ้นและการตัดสินใจต้องเกิดขึ้น

### สิ่งที่คุณจะได้เรียนรู้

คอร์สนี้จะพาคุณจากแนวคิดพื้นฐานไปจนถึงการนำไปใช้ในระดับการผลิต โดยครอบคลุม:
- **Small Language Models (SLMs)** ที่ปรับแต่งสำหรับการใช้งานในอุปกรณ์ Edge  
- **การปรับแต่งที่คำนึงถึงฮาร์ดแวร์** สำหรับแพลตฟอร์มที่หลากหลาย  
- **การวิเคราะห์แบบเรียลไทม์** พร้อมความสามารถในการรักษาความเป็นส่วนตัว  
- **กลยุทธ์การนำไปใช้ในระดับการผลิต** สำหรับแอปพลิเคชันในองค์กร  
...
Edge AI หมายถึงการรันอัลกอริทึม AI และโมเดลภาษาบนฮาร์ดแวร์ในพื้นที่ใกล้กับที่ข้อมูลถูกสร้างขึ้น โดยไม่ต้องพึ่งพาทรัพยากรคลาวด์สำหรับการวิเคราะห์ ซึ่งช่วยลดความล่าช้า เพิ่มความเป็นส่วนตัว และช่วยให้การตัดสินใจเกิดขึ้นแบบเรียลไทม์
...
- **อธิปไตยของข้อมูล**: เก็บข้อมูลที่สำคัญไว้ในพื้นที่ เพิ่มความปลอดภัยและการปฏิบัติตามกฎระเบียบ  

### Small Language Models (SLMs)

SLMs เช่น Phi-4, Mistral-7B และ Gemma เป็นเวอร์ชันที่ปรับแต่งของ LLMs ขนาดใหญ่ ซึ่งถูกฝึกหรือปรับแต่งเพื่อ:
...
| [📚 01](../../Module01) | [พื้นฐาน EdgeAI](./Module01/README.md) | เปรียบเทียบ Cloud กับ Edge AI | พื้นฐาน EdgeAI • กรณีศึกษาในโลกจริง • คู่มือการใช้งาน • การนำไปใช้ใน Edge | ผู้เริ่มต้น | 3-4 ชม. |
...
| [🚀 03](../../Module03) | [การปฏิบัติการใช้งาน SLM](./Module03/README.md) | การใช้งานในพื้นที่และคลาวด์ | การเรียนรู้ขั้นสูง • สภาพแวดล้อมในพื้นที่ • การใช้งานในคลาวด์ | ระดับกลาง | 4-5 ชม. |
...
| [🔧 05](../../Module05) | [SLMOps ในการผลิต](./Module05/README.md) | การดำเนินงานในระดับการผลิต | บทนำ SLMOps • การกลั่นโมเดล • การปรับแต่ง • การนำไปใช้ในระดับการผลิต | ระดับสูง | 5-6 ชม. |
...
| [🏭 08](../../Module08) | [เครื่องมือ Foundry Local](./Module08/README.md) | ตัวอย่างพร้อมใช้งานในระดับการผลิต | แอปพลิเคชันตัวอย่าง (ดูรายละเอียดด้านล่าง) | ระดับผู้เชี่ยวชาญ | 8-10 ชม. |
...
- **การปรับแต่งโมเดล**: การลดขนาดและการบีบอัดโมเดลสำหรับการใช้งานใน Edge (เพิ่มความเร็ว 85%, ลดขนาด 75%)  
- **การใช้งานข้ามแพลตฟอร์ม**: Windows, มือถือ, ระบบฝังตัว และระบบไฮบริดคลาวด์-Edge  
- **การดำเนินงานในระดับการผลิต**: การตรวจสอบ, การปรับขนาด, และการดูแลรักษา Edge AI ในการผลิต  

### 🏗️ โครงการปฏิบัติ
- **แอปแชท Foundry Local**: แอปพลิเคชัน Windows 11 พร้อมการสลับโมเดล  
- **ระบบ Multi-Agent**: ผู้ประสานงานที่มี Agent เฉพาะทางสำหรับ Workflow ที่ซับซ้อน  
...
- **เฟรมเวิร์ก API**: ลูกค้าพร้อมใช้งานในระดับการผลิตพร้อมการสตรีมและการตรวจสอบสุขภาพ  
...
2. **⚙️ การปรับแต่ง** (โมดูล 03-04): การใช้งาน + เฟรมเวิร์กการลดขนาดโมเดล  
3. **🚀 การใช้งานในระบบจริง** (Modules 05-06): SLMOps + AI agents + function calling  
4. **💻 การนำไปใช้** (Modules 07-08): ตัวอย่างแพลตฟอร์ม + Foundry Local toolkit  

แต่ละโมดูลประกอบด้วยทฤษฎี, การฝึกปฏิบัติ, และตัวอย่างโค้ดที่พร้อมใช้งานในระบบจริง  
...
**โปรเจกต์ในพอร์ตโฟลิโอ**: ระบบหลายตัวแทน • แอป RAG ในระบบจริง • การปรับใช้ข้ามแพลตฟอร์ม • การปรับปรุงประสิทธิภาพ  
...
✅ **การเรียนรู้แบบก้าวหน้า**: ทฤษฎี → การปฏิบัติ → การปรับใช้ในระบบจริง  
...
✅ **พร้อมใช้งานในระบบจริง**: การตรวจสอบ, การขยายระบบ, ความปลอดภัย, กรอบการปฏิบัติตามข้อกำหนด  

📖 **[คู่มือการเรียน](STUDY_GUIDE.md)**: เส้นทางการเรียนรู้ที่มีโครงสร้าง 20 ชั่วโมง พร้อมคำแนะนำการจัดสรรเวลาและเครื่องมือประเมินตนเอง  
