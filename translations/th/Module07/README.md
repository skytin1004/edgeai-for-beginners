...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T19:05:45+00:00",
...
Windows ML เป็นรันไทม์ล้ำสมัยของ Microsoft ที่ปรับแต่งสำหรับการอนุมานโมเดลบนอุปกรณ์และการปรับใช้ที่ง่ายดาย โดยเป็นพื้นฐานของ Windows AI Foundry แพลตฟอร์มนี้ช่วยให้นักพัฒนาสร้างแอปพลิเคชัน Windows ที่ขับเคลื่อนด้วย AI ซึ่งใช้ประโยชน์จากฮาร์ดแวร์ PC ได้อย่างเต็มที่
...
Foundry Local ช่วยให้นักพัฒนาสร้างแอปพลิเคชัน Retrieval Augmented Generation (RAG) โดยใช้ทรัพยากรในเครื่องใน .NET โดยผสานโมเดลภาษาในเครื่องเข้ากับความสามารถในการค้นหาเชิงความหมาย วิธีนี้ให้โซลูชัน AI ที่เน้นความเป็นส่วนตัวซึ่งทำงานได้ทั้งหมดบนโครงสร้างพื้นฐานในเครื่อง

### สถาปัตยกรรมทางเทคนิค
- ผสานโมเดลภาษา Phi, Local Embeddings และ Semantic Kernel เพื่อสร้างสถานการณ์ RAG
- ใช้ embeddings เป็นเวกเตอร์ (อาร์เรย์) ของค่าลอยตัวที่แสดงถึงเนื้อหาและความหมายเชิงความหมาย
- Semantic Kernel ทำหน้าที่เป็นตัวประสานหลัก โดยผสาน Phi และ Smart Components เพื่อสร้างท่อส่ง RAG ที่ไร้รอยต่อ
- รองรับฐานข้อมูลเวกเตอร์ในเครื่อง เช่น SQLite และ Qdrant

### ประโยชน์ในการใช้งาน
RAG หรือ Retrieval Augmented Generation เป็นวิธีการที่ช่วยให้สามารถค้นหาข้อมูลและนำมาใช้ใน prompt ได้ การใช้งานในเครื่องนี้ช่วยให้มั่นใจในความเป็นส่วนตัวของข้อมูล พร้อมกับการตอบสนองที่ชาญฉลาดซึ่งอ้างอิงจากฐานข้อมูลความรู้เฉพาะ วิธีนี้มีคุณค่าอย่างยิ่งสำหรับสถานการณ์ในองค์กรที่ต้องการอธิปไตยของข้อมูลและความสามารถในการทำงานแบบออฟไลน์

**เรียนรู้เพิ่มเติม**: [Foundry Local RAG Samples](https://github.com/microsoft/Foundry-Local/tree/main/samples/dotNET/rag)

### Windows Foundry Local

Microsoft Foundry Local ให้บริการ REST server ที่เข้ากันได้กับ OpenAI ซึ่งขับเคลื่อนโดย ONNX Runtime สำหรับการรันโมเดลในเครื่องบน Windows ด้านล่างนี้คือสรุปที่ผ่านการตรวจสอบแล้ว ดูเอกสารอย่างเป็นทางการสำหรับรายละเอียดเพิ่มเติม
...
รันโมเดลและค้นพบ dynamic endpoint:
```cmd
foundry model run gpt-oss-20b
foundry service status
```

ตรวจสอบ REST อย่างรวดเร็วเพื่อแสดงรายการโมเดล (แทนที่ PORT จาก status):
```cmd
...
สำหรับนักพัฒนาที่มุ่งเป้าหมายไปที่แพลตฟอร์ม Windows เราได้สร้างคู่มือฉบับสมบูรณ์ที่ครอบคลุมระบบนิเวศ Windows EdgeAI ทั้งหมด ทรัพยากรนี้ให้ข้อมูลรายละเอียดเกี่ยวกับ Windows AI Foundry รวมถึง API เครื่องมือ และแนวทางปฏิบัติที่ดีที่สุดสำหรับการพัฒนา EdgeAI บน Windows

### แพลตฟอร์ม Windows AI Foundry
แพลตฟอร์ม Windows AI Foundry ให้ชุดเครื่องมือและ API ที่ครอบคลุมซึ่งออกแบบมาโดยเฉพาะสำหรับการพัฒนา Edge AI บนอุปกรณ์ Windows ซึ่งรวมถึงการสนับสนุนเฉพาะสำหรับฮาร์ดแวร์ที่เร่งด้วย NPU การผสาน Windows ML และเทคนิคการปรับแต่งเฉพาะแพลตฟอร์ม
...
- การพัฒนา Agent สำหรับสถานการณ์ที่ขอบเครือข่าย
...
จุดร่วมของแพลตฟอร์มเหล่านี้คือการทำให้ความสามารถของ AI เป็นเรื่องง่ายสำหรับนักพัฒนาทุกระดับทักษะและการใช้งาน ไม่ว่าจะเป็นการสร้างแอปพลิเคชันมือถือ ซอฟต์แวร์เดสก์ท็อป หรือระบบฝังตัว โซลูชัน EdgeAI เหล่านี้ให้รากฐานสำหรับแอปพลิเคชันอัจฉริยะรุ่นต่อไปที่ทำงานได้อย่างมีประสิทธิภาพและเป็นส่วนตัวที่ขอบเครือข่าย

แต่ละแพลตฟอร์มมีข้อดีเฉพาะตัว: Jetson Orin Nano สำหรับการประมวลผล Edge ที่เร่งด้วยฮาร์ดแวร์ ONNX Runtime GenAI สำหรับการพัฒนามือถือข้ามแพลตฟอร์ม Azure EdgeAI สำหรับการผสานคลาวด์และขอบเครือข่ายในระดับองค์กร Windows ML สำหรับแอปพลิเคชันที่เน้น Windows และ Foundry Local สำหรับการใช้งาน RAG ที่เน้นความเป็นส่วนตัว ทั้งหมดนี้รวมกันเป็นระบบนิเวศที่ครอบคลุมสำหรับการพัฒนา EdgeAI
