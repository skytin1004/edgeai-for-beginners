...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T01:04:02+00:00",
...
Foundry Local inatumia cache ya akili ya mifano ili kuboresha utendaji na hifadhi:
...
Unda programu ya gumzo inayofaa kwa uzalishaji kwa kutumia OpenAI SDK na muunganisho wa Foundry Local, ukifuata mifumo kutoka kwa Sampuli 01.
...
| `API_KEY` | API key (kwa kawaida haitajiki kwa local) | `""` | Hapana |
...
- **Utunzaji wa Makosa**: Tekeleza mikakati ya kurudi nyuma kwa programu za uzalishaji
...
- **Fuatilia Rasilimali**: Fuata CPU/GPU/memory wakati wa kurekebisha maelekezo na mipangilio

## Sehemu ya 7: Mazoezi ya Vitendo

### Zoezi la 1: Jaribio la Haraka la Multi-Model
...
### Zoezi la 2: Jaribio la Muunganisho wa OpenAI SDK
...
- **Muhtasari wa amri za CLI**: https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/reference/reference-cli
- **Muunganisho wa OpenAI SDK**: https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/how-to/how-to-integrate-with-inference-sdks
...
- **Sampuli 02: Muunganisho wa SDK wa Juu**: samples/02/README.md
