...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T01:03:13+00:00",
...
- **Mifumo ya Uzalishaji**: Kushughulikia makosa, ufuatiliaji, na mikakati ya kupeleka
...
- Kutumia kushughulikia makosa ipasavyo na kupunguza athari kwa neema
...
- **Python**: 3.10 au zaidi na uwezo wa mazingira halisi
- **Modeli**: Angalau moja imepakizwa (`foundry model run phi-4-mini`)
...
## Sehemu ya 2: Uamuzi wa Kutumia Local au Cloud
...
|--------|---------|--------------|-------|
| `MODEL` | Alias ya modeli ya kutumia | `phi-4-mini` | `qwen2.5-7b-instruct` |
...
- **📚 Maudhui ya Kielimu**: Vifaa vya kujifunza hatua kwa hatua
- **🔬 Uchunguzi wa Kimaingiliano**: Endesha na jaribu seli za msimbo
- **📊 Maonyesho ya Visual**: Chati, michoro, na maonyesho ya matokeo
- **🛠️ Zana za Maendeleo**: Ujaribu na urekebishaji wa makosa

### Kuunda Notebook Yako
...
### Mifano ya Kimaingiliano na Mazoezi
...
4. **Jaribu Muunganisho:** Modeli zinapaswa kuonekana kwenye menyu ya kushuka
...
2. **Modeli Hazionekani:**
   - Thibitisha modeli imepakizwa: `foundry model list`
   - Angalia majibu ya API: `curl http://localhost:51211/v1/models`
   - Washa tena kontena la Open WebUI

## Sehemu ya 7: Mazingatio ya Upelekaji wa Uzalishaji
...
- ✅ **Usanidi wa Open WebUI**: Upelekaji wa kiolesura cha kitaalamu cha gumzo
- ✅ **Mifumo ya Uzalishaji**: Kushughulikia makosa, ufuatiliaji, na scaling
...
- **[Notebook ya Kielimu ya Chainlit](samples/04/chainlit_app.ipynb)**: Vifaa vya kujifunza vya kimaingiliano
