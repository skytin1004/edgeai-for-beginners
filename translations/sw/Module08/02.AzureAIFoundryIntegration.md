...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T01:03:41+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "sw"
}
-->
# Kipindi cha 2: Ujumuishaji wa OpenAI SDK na Azure AI Foundry

## Muhtasari

Kwa kuendeleza msingi wako wa Foundry Local, kipindi hiki kinazingatia mifumo ya hali ya juu ya ujumuishaji wa OpenAI SDK inayosaidia kwa urahisi Foundry Local ya Microsoft na Azure OpenAI. Utajifunza jinsi ya kujenga programu za AI zinazobadilika ambazo zinaweza kuendeshwa kwa ndani kwa faragha na maendeleo, huku zikitoa uwezo wa kupanuka kupitia Azure OpenAI inapohitajika.

## Malengo ya Kujifunza

Mwisho wa kipindi hiki, utaweza:
- Kumiliki ujumuishaji wa hali ya juu wa OpenAI SDK na Foundry Local na Azure OpenAI
- Kutekeleza majibu ya mtiririko kwa uzoefu bora wa mtumiaji
- Kuunda mifumo thabiti ya kiwanda cha wateja kwa msaada wa watoa huduma wengi
- Kujenga mifumo ya usimamizi wa mazungumzo yenye uhifadhi wa muktadha
- Kuanzisha upimaji wa utendaji na ufuatiliaji wa afya
- Kuweka programu tayari kwa uzalishaji kwa kushughulikia makosa ipasavyo

## Mahitaji ya Awali

- Kukamilisha Kipindi cha 1: Kuanza na Foundry Local
- Usakinishaji wa Foundry Local unaofanya kazi na mifano inayotumika
- Python 3.8 au zaidi yenye uwezo wa mazingira ya kawaida
- OpenAI Python SDK imewekwa (`pip install openai foundry-local-sdk`)
- Akaunti ya Azure yenye huduma ya OpenAI (hiari, kwa hali za wingu)
- Uelewa wa msingi wa mifumo ya Python async/await

## Sehemu ya 1: Muundo wa Kiwanda cha Wateja wa OpenAI SDK

### Kuelewa Usanifu wa Watoa Huduma Wengi

Kujenga programu zinazofanya kazi na Foundry Local na Azure OpenAI kunahitaji muundo wa kubadilika wa uundaji wa wateja:
...
## Sehemu ya 2: Majibu ya Mtiririko na Mwingiliano wa Wakati Halisi

### Kutekeleza Majibu ya Mazungumzo ya Mtiririko

Mtiririko hutoa uzoefu bora wa mtumiaji kwa kuonyesha majibu yanapozalishwa:
...
### Usimamizi wa Mazungumzo ya Mizunguko Mingi
...
## Sehemu ya 3: Upimaji wa Utendaji na Uchambuzi

### Kipimo cha Muda wa Majibu

Pima na linganisha utendaji katika usanidi tofauti:
...
## Sehemu ya 4: Ufuatiliaji wa Afya ya Huduma na Utambuzi

### Mfumo wa Ukaguzi wa Afya wa Kina
...
### Kithibitishaji cha Usanidi wa Mazingira
...
## Sehemu ya 5: Vigezo vya Mazingira na Usimamizi wa Usanidi

### Rejeleo la Vigezo vya Mazingira

Rejeleo kamili la kusanidi watoa huduma wote:
...
**Usanidi wa Windows Command Prompt:**
...
## Sehemu ya 6: Mazoezi ya Vitendo

### Zoezi la 1: Ujumuishaji wa SDK ya Watoa Huduma Wengi

Jenga programu kamili inayobadilika kati ya watoa huduma:
...
### Zoezi la 2: Usimamizi wa Mazungumzo ya Hali ya Juu
...
### Zoezi la 3: Ufuatiliaji wa Afya Tayari kwa Uzalishaji
...
## Sehemu ya 7: Muhtasari na Hatua Zifuatazo

### Mafanikio ya Kipindi

Katika kipindi hiki, umejifunza:
- ✅ **Ujumuishaji wa OpenAI SDK**: Mifumo ya hali ya juu kwa Foundry Local na Azure OpenAI
- ✅ **Majibu ya Mtiririko**: Majibu ya mazungumzo ya wakati halisi kwa uzoefu bora wa mtumiaji
- ✅ **Msaada wa Watoa Huduma Wengi**: Kubadilika kati ya huduma za AI za ndani na wingu
- ✅ **Usimamizi wa Mazungumzo**: Mazungumzo ya mizunguko mingi yenye muktadha
- ✅ **Ufuatiliaji wa Utendaji**: Upimaji na ukaguzi wa afya kwa matumizi ya uzalishaji
- ✅ **Mifumo ya Uzalishaji**: Kushughulikia makosa kwa njia thabiti na usimamizi wa usanidi

### Mifumo Muhimu ya Usanifu
...
1. **🔄 Daima Tekeleza Njia za Akiba**: Azure → Foundry Local → Kushughulikia makosa
2. **🌊 Tumia Mtiririko kwa Majibu Marefu**: Utendaji bora unaoonekana
3. **🛡️ Tekeleza Kushughulikia Makosa kwa Kina**: Ujumbe wa makosa rafiki kwa mtumiaji
4. **📈 Fuatilia Utendaji**: Fuata muda wa majibu na viwango vya mafanikio
5. **⚙️ Usanidi wa Kulingana na Mazingira**: Kubadilika kwa urahisi kati ya maendeleo/staging/uzalishaji
6. **🔒 Usimamizi Salama wa Hati za Kuthibitisha**: Kamwe usiweke funguo za API moja kwa moja

### Miongozo ya Uchaguzi wa Watoa Huduma

| Hali | Mtoa Huduma Anayependekezwa | Sababu |
|------|-----------------------------|--------|
| **Maendeleo** | Foundry Local | Kurudia haraka, hakuna gharama za API |
| **Faragha Muhimu** | Foundry Local | Data haiondoki kwenye kifaa |
| **Uzalishaji wa Kiasi Kikubwa** | Azure OpenAI | Uwezo bora wa kupanuka, SLA ya biashara |
| **Mifano ya Kisasa** | Azure OpenAI | Ufikiaji wa matoleo mapya ya mifano |
| **Mahitaji ya Nje ya Mtandao** | Foundry Local | Hakuna utegemezi wa mtandao |
| **Gharama Ndogo** | Foundry Local | Hakuna gharama za tokeni |
...
### Kujiandaa kwa Kipindi cha 3: Mifano ya Chanzo Huria

1. **Chunguza Katalogi ya Mifano**: Angalia mifano inayopatikana katika Foundry Local
2. **Elewa Miundo ya Mifano**: Jifunze kuhusu ONNX, upunguzaji, na uboreshaji
3. **Fikiria Mifano Maalum**: Fikiria kuhusu mahitaji ya mifano maalum ya kikoa

### Mwongozo wa Haraka wa Utatuzi
...
- **[OpenAI Python SDK Documentation](https://github.com/openai/openai-python)**: Rejeleo rasmi la SDK
- **[Azure OpenAI Documentation](https://learn.microsoft.com/azure/ai-services/openai/)**: Mwongozo wa huduma ya Azure OpenAI
- **[Foundry Local SDK Reference](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Nyaraka za utabiri wa ndani
- **[Streaming Completions Guide](https://learn.microsoft.com/azure/ai-foundry/foundry-local/how-to/integrate-with-inference-sdks)**: Mifumo ya hali ya juu ya mtiririko
- **[Sample 01: Quick Chat via OpenAI SDK](samples/01/README.md)**: Mifumo ya ujumuishaji wa msingi
- **[Sample 02: Advanced SDK Integration](samples/02/README.md)**: Mifano ya vitendo ya kipindi hiki
- **[Sample 04: Chainlit Application](samples/04/README.md)**: Maendeleo ya UI ya wavuti
- **[Sample 05: Multi-Agent Systems](samples/05/README.md)**: Mifumo ya hali ya juu ya uratibu

Sasa umejiandaa kujenga programu za AI za kisasa zinazojumuisha uwezo wa AI wa ndani na wingu, zikitoa kubadilika kuchagua mtoa huduma sahihi kwa kila hali maalum huku ukidumisha mifumo thabiti ya maendeleo.
