...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T01:15:10+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "sw"
}
-->
# Kipindi cha 2: Kujenga Suluhisho za AI na Azure AI Foundry

## Muhtasari

Kwa msingi wa Foundry Local uliyojifunza, kipindi hiki kinazingatia kuunda suluhisho za AI za hali ya juu kupitia mbinu za juu za uhandisi wa maelekezo, ujumuishaji wa data bila matatizo, na uundaji wa kazi zinazoweza kutekelezwa. Utajifunza jinsi ya kuunganisha maendeleo ya ndani na uwezo wa Azure AI Foundry, ukitengeneza programu za biashara zinazotumia faida za pande zote mbili.

## Malengo ya Kujifunza

Mwisho wa kipindi hiki, utaweza:
- Kumudu mbinu za juu za uhandisi wa maelekezo kwa majibu ya AI yanayoaminika na thabiti
- Kutekeleza mifumo imara ya ujumuishaji wa data kwa matumizi halisi
- Kuunda kazi za AI zinazoweza kutekelezwa ambazo zinaongeza thamani ya biashara
- Kuanzisha muunganisho bila matatizo kati ya Foundry Local na Azure AI Foundry
- Kujenga mifumo ya ufuatiliaji wa utendaji na uboreshaji
- Kuweka suluhisho za AI tayari kwa uzalishaji zikiwa na utunzaji sahihi wa makosa na uwezo wa kupanuka

## Mahitaji ya Awali

- Kukamilisha Kipindi cha 1: Kuanza na Foundry Local
- Ufungaji wa Foundry Local unaofanya kazi na mifano inayotumika
- Akaunti ya Azure (kiwango cha bure kinatosha kwa kujifunza)
- Uelewa wa msingi wa REST APIs na JSON

## Sehemu ya 1: Uhandisi wa Maelekezo wa Juu

### Kuelewa Muundo wa Maelekezo

Uhandisi mzuri wa maelekezo ni msingi wa programu za AI zinazoaminika. Foundry Local inatoa uwezo wa hali ya juu wa maelekezo:
...
### Kutekeleza Mikakati ya Maelekezo
...
### Mifano ya Vitendo ya Uhandisi wa Maelekezo
...
## Sehemu ya 2: Mifumo ya Ujumuishaji wa Data

### Viunganishi vya Data vya Foundry Local
...
### Mfano Halisi wa Ujumuishaji wa Data
...
## Sehemu ya 3: Kazi za AI Zinazoweza Kutekelezwa

### Mfumo wa Uundaji wa Kazi
...
### Mifano ya Uendeshaji wa Mchakato wa Biashara
...
## Sehemu ya 4: Ujumuishaji wa Azure AI Foundry
...
## Sehemu ya 5: Ufuatiliaji wa Utendaji na Uboreshaji
...
### Zoezi la 1: Bot ya Huduma kwa Wateja ya Juu
...
### Zoezi la 2: Utafiti wa Soko Uliojiendesha
...
## Sehemu ya 7: Hatua Zifuatazo na Muhtasari wa Kipindi cha 3

### Mafanikio ya Kipindi

Katika kipindi hiki, umejifunza:
- ✅ Mbinu za juu za uhandisi wa maelekezo kwa tabia thabiti ya AI
- ✅ Mifumo imara ya ujumuishaji wa data kwa matumizi halisi
- ✅ Uundaji wa kazi za kiotomatiki kwa uboreshaji wa mchakato wa biashara
- ✅ Ujumuishaji wa Azure AI Foundry na mikakati ya uwekaji mseto
- ✅ Ufuatiliaji wa utendaji wa kina na uboreshaji

### Kujiandaa kwa Kipindi cha 3: Mifano ya Chanzo Huria

1. **Chunguza Hugging Face**: Unda akaunti na angalia orodha ya mifano
2. **Pitia Model Mondays**: Angalia mfululizo wa hivi karibuni wa [Model Mondays](https://aka.ms/model-mondays)
3. **Panga Mifano Maalum**: Fikiria ni mifano gani maalum itakayonufaisha matumizi yako

### Rasilimali za Ziada

- [Nyaraka za Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Hifadhi ya GitHub ya Foundry Local](https://github.com/microsoft/Foundry-Local)
- [Mwongozo wa Juu wa Uhandisi wa Maelekezo](https://platform.openai.com/docs/guides/prompt-engineering)
- [Mbinu Bora za Uendeshaji wa Mchakato wa Biashara](https://docs.microsoft.com/en-us/power-automate/)

Sasa umejiandaa kuunda suluhisho za AI za hali ya juu zinazochanganya nguvu ya uchambuzi wa ndani na uwezo wa wingu, ukiweka msingi wa programu za AI za kiwango cha biashara.
