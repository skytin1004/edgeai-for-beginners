...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T01:04:36+00:00",
...
Tumia mifano ya AI kama zana za modular zinazoweza kubadilishwa ambazo zinafanya kazi moja kwa moja kwenye kifaa kwa kutumia Foundry Local. Kipindi hiki kinazingatia mchakato wa vitendo wa utabiri unaohifadhi faragha, wenye ucheleweshaji mdogo, na jinsi ya kuunganisha zana hizi kupitia SDKs, APIs, au CLI. Pia utajifunza jinsi ya kupanua hadi Azure AI Foundry inapohitajika.

> **🔄 Imesasishwa kwa SDK ya Kisasa**: Moduli hii imebadilishwa ili kuendana na mifumo ya hivi karibuni ya hifadhi ya Microsoft Foundry-Local na inalingana na utekelezaji wa usambazaji wa akili katika `samples/06/`. Mifano sasa inatumia `foundry-local-sdk` ya kisasa na mikakati ya hali ya juu ya kuchagua mifano.
...
- **Usanidi wa Mazingira**: Utoaji wa mifano unaobadilika kupitia vigezo vya mazingira
...
- Panga upanuzi wa mseto hadi Azure AI Foundry

## Sehemu ya 1: Usambazaji wa Akili wa Mfano (Utekelezaji wa Kisasa)

Lengo: Tekeleza uchaguzi wa akili wa mifano na usambazaji wa kiotomatiki kulingana na maudhui ya swali.
...
Hatua ya 1) Fafanua router ya kisasa ya mfano na FoundryLocalManager  
```python
...
Hatua ya 2) Anzisha mteja na SDK ya kisasa na ugunduzi wa huduma  
```python
...
Lengo: Tumia Foundry Local SDK na OpenAI Python SDK kwa ujumuishaji usio na mshono.
...
## Sehemu ya 3: Ubadilishaji wa Kikoa (Hatua kwa Hatua)
...
## Sehemu ya 4: Uendeshaji wa Nje ya Mtandao na Msimamo wa Usalama (Hatua kwa Hatua)

Lengo: Hakikisha faragha na uimara wakati wa kuendesha mifano kama zana za ndani.

Hatua ya 1) Anzisha mapema na uthibitishe endpoint ya ndani  
```cmd
...
- [ ] Tekeleza router ya akili ya mfano kwa uteuzi wa msingi wa maneno (`samples/06/router.py`)  
...
Foundry Local inawezesha AI thabiti kwenye kifaa ambapo mifano inakuwa zana za akili na maalum. Kwa uteuzi wa kiotomatiki wa mifano, ufuatiliaji wa kina, na mifumo ya uzalishaji tayari, timu zinaweza kuunda programu za AI za kisasa zinazobadilika kwa aina tofauti za kazi huku zikidumisha faragha na utendaji. Mfano wa router ya akili ulioonyeshwa hapa unatoa msingi wa kujenga mifumo changamano ya AI inayoweza kupanuka kutoka maendeleo ya ndani hadi utekelezaji wa uzalishaji.
