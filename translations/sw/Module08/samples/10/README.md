...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T03:12:41+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "sw"
}
-->
# Foundry Local kama Ujumuishaji wa Zana

Mfumo wa kina wa kuunganisha Microsoft Foundry Local kama zana zinazoweza kuitwa ndani ya programu kubwa, kufuata mifumo rasmi ya Microsoft kwa ujumuishaji wa AI unaotegemea zana.

## Muhtasari

Mfano huu unaonyesha jinsi ya kufichua mifano ya Foundry Local kama zana zinazoweza kutumika tena ambazo zinaweza kuunganishwa katika programu zilizopo, mtiririko wa kazi, na mazingira ya maendeleo. Unatoa mifumo inayopendekezwa na Microsoft kwa ujumuishaji wa zana na kupiga kazi.

## Dhana Muhimu

### 🔧 **Muundo wa Zana Kwanza**
- Mifano ya Foundry Local kama kazi zinazoweza kuitwa
- Viunganishi vya zana vilivyowekwa viwango na schemas
- Ujumuishaji usio na mshono na misimbo iliyopo
- Ufafanuzi wa zana salama kwa aina na uthibitishaji

### ⚡ **Mifumo ya Kupiga Kazi**
- Utekelezaji wa kupiga kazi wa Microsoft Foundry Local
- Ufafanuzi wa zana zinazolingana na OpenAI
- Uthibitishaji wa vigezo kiotomatiki na ubadilishaji
- Kushughulikia makosa na muundo wa majibu

### 🔌 **Mifumo ya Ujumuishaji**
- **Ujumuishaji wa LangChain**: Msaada wa zana asilia wa LangChain
- **Semantic Kernel**: Kazi za Microsoft Semantic Kernel
- **REST API**: Viunganishi vya zana vinavyotegemea HTTP
- **Zana za CLI**: Ujumuishaji wa kiolesura cha mstari wa amri
- **Jupyter Notebooks**: Zana za maendeleo shirikishi

### 🎯 **Mifumo ya Matumizi**
- Zana za uchambuzi wa misimbo na kizazi
- Usindikaji wa maudhui na muhtasari
- Uchambuzi wa data na uwasilishaji
- Utafiti na upatikanaji wa taarifa
...
### Mahitaji ya Mfumo
- **Python**: 3.9+ na msaada wa asyncio
- **Node.js**: v18+ (kwa ujumuishaji wa JavaScript)
- **Kumbukumbu**: 12GB+ inapendekezwa
- **Hifadhi**: 10GB+ kwa mifano na zana
...
### 1. Utengenezaji wa Zana za Msingi
```python
...
## Mifumo ya Zana Muhimu

### 1. Zana Zinazotegemea Kazi
```python
...
### Ujumuishaji wa Semantic Kernel
```python
...
### 2. Usimamizi wa Bwawa la Mifano
```python
...
1. **Mifumo ya Ujumuishaji wa Zana**
   - Muundo wa zana zinazotegemea kazi na darasa
   - Mifumo ya ujumuishaji wa Microsoft Foundry Local
   - Uthibitishaji wa schema na usalama wa aina
   - Kushughulikia makosa na urejeshaji

2. **Ujumuishaji wa Mfumo**
   - Maendeleo ya zana za LangChain
   - Ujumuishaji wa kazi za Semantic Kernel
   - Ujumuishaji wa mfumo wa REST API
   - Maendeleo ya programu za CLI

3. **Masuala ya Uzalishaji**
   - Mikakati ya uboreshaji wa utendaji
   - Usimamizi wa hifadhi na rasilimali
   - Ufuatiliaji na uangalizi
   - Usalama na uthibitishaji

4. **Mifumo ya Juu ya Zana**
   - Muundo wa zana na mnyororo
   - Usindikaji unaojua muktadha
   - Operesheni za kundi na kutiririsha
   - Maendeleo ya ujumuishaji maalum

## Hatua Zifuatazo

- **Miradi ya Ujumuishaji**: Tengeneza ujumuishaji maalum na mifumo unayopendelea
- **Maendeleo ya Zana**: Unda zana maalum kwa uwanja wako
- **Urekebishaji wa Utendaji**: Boresha kwa matumizi yako maalum
- **Utekelezaji wa Uzalishaji**: Pima zana kwa matumizi ya biashara

## Kuchangia

Tazama miongozo ya hazina kuu kwa maelekezo ya kuchangia.
