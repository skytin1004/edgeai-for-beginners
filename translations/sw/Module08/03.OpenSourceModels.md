...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T01:02:25+00:00",
  "source_file": "Module08/03.OpenSourceModels.md",
  "language_code": "sw"
}
-->
# Kipindi cha 3: Ugunduzi na Usimamizi wa Miundo ya Chanzo Huria

## Muhtasari

Kipindi hiki kinazingatia ugunduzi wa miundo na usimamizi kwa vitendo ukitumia Foundry Local. Utajifunza jinsi ya kuorodhesha miundo inayopatikana, kujaribu chaguo tofauti, na kuelewa sifa za utendaji wa msingi. Mbinu hii inasisitiza uchunguzi wa vitendo ukitumia foundry CLI ili kukusaidia kuchagua miundo sahihi kwa matumizi yako.

## Malengo ya Kujifunza

- Kuwa na ujuzi wa amri za foundry CLI kwa ugunduzi na usimamizi wa miundo
- Kuelewa muundo wa hifadhi ya muda ya miundo na uhifadhi wa ndani
- Kujifunza jinsi ya kujaribu na kulinganisha miundo tofauti kwa haraka
...
- Kukamilisha Kipindi cha 1: Kuanzisha Foundry Local
...
Kipindi hiki kinachunguza jinsi ya kuleta miundo ya chanzo huria kwenye Foundry Local.

## Sehemu ya 6: Zoezi la Vitendo

### Zoezi: Ugunduzi na Ulinganishaji wa Miundo

Unda script yako ya tathmini ya miundo ukitumia Mfano 03:
...
1. **Run script ya Mfano 03**: `samples\03\list_and_bench.cmd`
...
4. **Andika matokeo**: Unda chati rahisi ya kulinganisha

### Mfano wa Muundo wa Kulinganisha
...
## Sehemu ya 7: Utatuzi wa Shida na Mazoea Bora
...
5. **Andika Matokeo**: Weka maelezo ya utendaji wa miundo kwa matumizi yako

## Sehemu ya 8: Hatua Zifuatazo na Marejeleo

### Kujiandaa kwa Kipindi cha 4

- **Mwelekeo wa Kipindi cha 4**: Zana na mbinu za uboreshaji
- **Mahitaji ya Awali**: Uwe na ujuzi wa kubadilisha miundo na upimaji wa utendaji wa msingi
- **Inapendekezwa**: Kuwa na miundo 2-3 unayoipenda kutoka kipindi hiki

### Rasilimali za Ziada

- **[Foundry Local Documentation](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Nyaraka rasmi
- **[CLI Reference](https://learn.microsoft.com/azure/ai-foundry/foundry-local/reference/reference-cli)**: Marejeleo kamili ya amri
...
- **[Sample 03: Model Discovery](samples/03/README.md)**: Mfano wa script ya vitendo

### Mambo Muhimu ya Kujifunza

✅ **Ugunduzi wa Miundo**: Tumia `foundry model list` kuchunguza miundo inayopatikana  
✅ **Jaribio la Haraka**: Muundo wa `list_and_bench.cmd` kwa tathmini ya haraka  
...
Sasa una ujuzi wa vitendo wa kugundua, kujaribu, na kuchagua miundo sahihi kwa programu zako za AI ukitumia mbinu rahisi ya CLI ya Foundry Local.

## Malengo ya Kujifunza

- Kugundua na kutathmini miundo ya chanzo huria kwa inference ya ndani
- Kukusanya na kuendesha miundo teule ya Hugging Face ndani ya Foundry Local
- Kutumia mikakati ya uteuzi wa miundo kwa usahihi, kasi, na mahitaji ya rasilimali
- Kusimamia miundo kwa ndani ukitumia cache na toleo

## Sehemu ya 1: Ugunduzi wa Miundo ukitumia Foundry CLI
...
Anza na miundo maarufu na iliyojaribiwa vizuri ili kuelewa sifa za utendaji:
...
**Miundo ya Kati:**
- `qwen2.5-7b-instruct`: Uelewa bora na muktadha mrefu
- `deepseek-r1-distill-qwen-7b`: Imeboreshwa kwa kizazi cha msimbo

**Miundo Mikubwa:**
- `llama-3.2`: Muundo wa hivi karibuni wa chanzo huria kutoka Meta
- `qwen2.5-14b-instruct`: Uelewa wa daraja la biashara

## Sehemu ya 2: Jaribio la Haraka la Miundo na Ulinganishaji

### Mbinu ya Mfano 03: Orodha Rahisi na Upimaji

Kulingana na muundo wa Mfano 03, hapa kuna mtiririko wa kazi wa msingi:
...
### Njia Mbadala ya Upimaji wa PowerShell
...
### Kuchagua Miundo kulingana na Matumizi

**Kwa Mazungumzo ya Jumla na Maswali na Majibu:**
- Anza na: `phi-4-mini` (haraka, yenye ufanisi)
- Sasisha hadi: `phi-4` (uelewa bora)
- Advanced: `qwen2.5-7b-instruct` (muktadha mrefu)

**Kwa Kizazi cha Msimbo:**
- Inapendekezwa: `deepseek-r1-distill-qwen-7b`
- Njia mbadala: `qwen2.5-7b-instruct` (pia nzuri kwa msimbo)

**Kwa Uelewa wa Kina:**
- Bora: `qwen2.5-7b-instruct` au `qwen2.5-14b-instruct`
- Chaguo la bajeti: `phi-4`

### Mwongozo wa Mahitaji ya Vifaa

**Mahitaji ya Mfumo wa Kiwango cha Chini:**
```
...
- Msaada wa NPU (Windows 11 Copilot+ PCs) kwa kasi zaidi
...
- **Kasi**: Je, yanajibu haraka kiasi gani?
...
- Jiandae kwa Kipindi cha 4: kulinganisha LLMs dhidi ya SLMs, inference ya ndani dhidi ya wingu, na maonyesho ya vitendo
