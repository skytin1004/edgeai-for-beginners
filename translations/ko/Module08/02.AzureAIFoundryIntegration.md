...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T12:27:36+00:00",
...
Foundry Local의 기초를 바탕으로, 이번 세션에서는 고급 프롬프트 엔지니어링, 원활한 데이터 통합, 실행 가능한 작업 자동화를 통해 정교한 AI 솔루션을 만드는 방법에 대해 다룹니다. 로컬 개발과 Azure AI Foundry 기능을 연결하여 두 세계의 장점을 활용한 엔터프라이즈급 애플리케이션을 구축하는 방법을 배우게 됩니다.

## 학습 목표

이 세션이 끝날 때까지 여러분은:
- 일관되고 신뢰할 수 있는 AI 응답을 위한 고급 프롬프트 엔지니어링 기술을 숙달합니다.
- 실제 애플리케이션을 위한 견고한 데이터 통합 패턴을 구현합니다.
- 비즈니스 가치를 창출하는 실행 가능한 AI 작업을 만듭니다.
- Foundry Local과 Azure AI Foundry 간의 원활한 연결을 설정합니다.
- 성능 모니터링 및 최적화 워크플로를 구축합니다.
- 적절한 오류 처리 및 확장을 통해 프로덕션 준비된 AI 솔루션을 배포합니다.

## 사전 준비 사항

- 세션 1: Foundry Local 시작하기 완료
- 실행 중인 모델이 있는 활성 Foundry Local 설치
- Azure 계정 (학습에는 무료 계정으로 충분)
- REST API와 JSON에 대한 기본 이해

## Part 1: 고급 프롬프트 엔지니어링

### 프롬프트 아키텍처 이해하기

효과적인 프롬프트 엔지니어링은 신뢰할 수 있는 AI 애플리케이션의 기초입니다. Foundry Local은 향상된 프롬프트 기능을 제공합니다:
...
## Part 7: 다음 단계 및 세션 3 미리보기

### 세션 성과

이번 세션에서 여러분은 다음을 마스터했습니다:
- ✅ 일관된 AI 동작을 위한 고급 프롬프트 엔지니어링 기술
- ✅ 실제 애플리케이션을 위한 견고한 데이터 통합 패턴
- ✅ 비즈니스 프로세스 최적화를 위한 자동화된 작업 생성
- ✅ Azure AI Foundry 통합 및 하이브리드 배포 전략
- ✅ 종합적인 성능 모니터링 및 최적화

### 세션 3 준비: 오픈소스 모델

1. **Hugging Face 탐색**: 계정을 생성하고 모델 카탈로그를 둘러보세요.
2. **Model Mondays 검토**: 최신 [Model Mondays 시리즈](https://aka.ms/model-mondays)를 확인하세요.
3. **맞춤형 모델 계획**: 여러분의 사용 사례에 도움이 될 특화된 모델을 고려해보세요.
...
- [고급 프롬프트 엔지니어링 가이드](https://platform.openai.com/docs/guides/prompt-engineering)
- [비즈니스 프로세스 자동화 모범 사례](https://docs.microsoft.com/en-us/power-automate/)

이제 로컬 추론의 강점과 클라우드 규모의 기능을 결합하여 엔터프라이즈급 AI 애플리케이션을 구축할 준비가 되었습니다.
