...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T10:40:24+00:00",
  "source_file": "Module08/04.CuttingEdgeModels.md",
  "language_code": "ko"
}
-->
# Session 4: Chainlit을 활용한 프로덕션 채팅 애플리케이션 구축
...
- Chainlit을 활용하여 프로덕션 수준의 채팅 애플리케이션 구축
...
| **개인정보 보호** | 🔒 데이터가 기기를 벗어나지 않음 | ⚠️ 데이터가 클라우드로 전송됨 |
...
WebGPU는 AI 모델을 브라우저에서 직접 실행하여 최대 개인정보 보호와 설치 없는 경험을 제공합니다. 이 샘플은 ONNX Runtime Web과 WebGPU 실행을 시연합니다.
...
Session 4에서는 대화형 AI를 위한 프로덕션 수준의 Chainlit 애플리케이션 구축 방법을 다루었습니다. 주요 내용은 다음과 같습니다:

- ✅ **Chainlit 프레임워크**: 채팅 애플리케이션을 위한 현대적인 UI와 스트리밍 지원
