...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T12:17:44+00:00",
...
Microsoft Olive는 하드웨어를 고려한 강력하고 사용하기 쉬운 모델 최적화 도구로, 다양한 하드웨어 플랫폼에서 머신 러닝 모델을 배포하기 위한 최적화 과정을 간소화합니다. CPU, GPU, 또는 AI 가속기와 같은 특수 하드웨어를 대상으로 하든, Olive는 모델의 정확성을 유지하면서 최적의 성능을 달성할 수 있도록 도와줍니다.

## Microsoft Olive란 무엇인가?

Olive는 하드웨어를 고려한 모델 최적화 도구로, 모델 압축, 최적화, 컴파일과 같은 업계 최고 기술을 통합합니다. ONNX Runtime과 함께 E2E 추론 최적화 솔루션으로 작동합니다.

### 주요 기능

- **하드웨어를 고려한 최적화**: 대상 하드웨어에 가장 적합한 최적화 기술을 자동으로 선택
...
- **성능 향상**: 최대 6배의 속도 개선 (일부 사례에서)
- **크로스 플랫폼 배포**: 최적화된 모델이 다양한 하드웨어 및 운영 체제에서 작동
- **정확성 유지**: 성능을 개선하면서 모델 품질을 유지
...
성공적으로 설치되었다면 Olive CLI 도움말 메시지가 표시됩니다.
...
Hugging Face의 [lokinfey/Qwen3-8B-ONNX-INT4-CPU](https://huggingface.co/lokinfey/Qwen3-8B-ONNX-INT4-CPU) 예제를 기반으로 Qwen3 모델을 최적화하는 방법을 소개합니다:

### 1단계: 모델 다운로드 (선택 사항)

다운로드 시간을 최소화하려면 필수 파일만 캐시합니다:
...
- **VS Code 확장**: VS Code용 AI Toolkit 개요 — https://learn.microsoft.com/azure/ai-toolkit/overview
- **블로그 게시물**: Microsoft 오픈 소스 블로그 — https://opensource.microsoft.com/blog/
