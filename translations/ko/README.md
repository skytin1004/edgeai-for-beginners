...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T08:04:02+00:00",
...
**추가 번역 언어를 원하시면 [여기](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)에서 지원 언어를 확인하세요.**

## 소개

**EdgeAI for Beginners**에 오신 것을 환영합니다. 이 과정은 Edge 인공지능의 혁신적인 세계로 여러분을 안내하며, 강력한 AI 기능과 실제적인 엣지 디바이스 배포 간의 격차를 연결합니다. 데이터를 생성하고 결정을 내려야 하는 곳에서 AI의 잠재력을 활용할 수 있도록 돕습니다.
...
- **실시간 추론**과 프라이버시 보호 기능
- 기업 애플리케이션을 위한 **생산 배포 전략**

### EdgeAI의 중요성

Edge AI는 현대의 주요 과제를 해결하는 패러다임 전환을 제공합니다:
- **프라이버시 및 보안**: 민감한 데이터를 클라우드에 노출하지 않고 로컬에서 처리
...
SLM은 다음과 같은 제약 조건을 충족하면서 강력한 NLP 기능을 제공합니다:
...
|--------|-------|------------|-------------|--------|----------|
| [📖 00 ](./introduction.md) | [EdgeAI 소개](./introduction.md) | 기초 및 맥락 | EdgeAI 개요 • 산업 응용 • SLM 소개 • 학습 목표 | 초급 | 1-2시간 |
...
| [🏭 08](../../Module08) | [Foundry Local Toolkit](./Module08/README.md) | 생산 준비 샘플 | 샘플 애플리케이션 (아래 세부 정보 참조) | 전문가 | 8-10시간 |
...
### 🎯 핵심 역량
- **Edge AI 아키텍처**: 클라우드 통합 로컬 우선 AI 시스템 설계
- **모델 최적화**: 엣지 배포를 위한 모델 양자화 및 압축 (85% 속도 향상, 75% 크기 감소)
...
- **API 프레임워크**: 스트리밍 및 상태 모니터링이 가능한 생산 준비 클라이언트
...
**EdgeAI는 AI 배포의 미래를 대표합니다**: 로컬 우선, 프라이버시 보호, 효율적. 이러한 기술을 마스터하여 차세대 지능형 애플리케이션을 구축하세요.
