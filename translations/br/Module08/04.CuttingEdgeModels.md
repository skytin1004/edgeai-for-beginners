...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T21:18:32+00:00",
...
Esta sessão aborda a construção de aplicativos de chat prontos para produção usando Chainlit e Microsoft Foundry Local. Você aprenderá a criar interfaces web modernas para conversas com IA, implementar respostas em streaming e implantar aplicativos de chat robustos com tratamento adequado de erros e design de experiência do usuário.

**O que você vai construir:**
- **Aplicativo de Chat Chainlit**: Interface web moderna com respostas em streaming
- **Demonstração WebGPU**: Inferência no navegador para aplicações com foco em privacidade  
...
- **Navegador**: Navegador moderno com suporte a WebGPU (Chrome/Edge)
...
**Framework Chainlit:**
- `@cl.on_chat_start`: Inicializa sessões de chat
- `@cl.on_message`: Lida com mensagens recebidas do usuário  
...
O aplicativo do Exemplo 04 demonstra padrões prontos para produção:
...
## Parte 5: Demonstração de Inferência no Navegador com WebGPU

### Visão Geral

O WebGPU permite executar modelos de IA diretamente no navegador para máxima privacidade e experiências sem necessidade de instalação. Este exemplo demonstra o ONNX Runtime Web com execução WebGPU.

### Passo 1: Verificar Suporte ao WebGPU

**Requisitos do Navegador:**
- Chrome/Edge 113+ com WebGPU habilitado
- Verifique: `chrome://gpu` → confirme o status "WebGPU"
- Verificação programática: `if (!('gpu' in navigator)) { /* sem WebGPU */ }`

### Passo 2: Criar Demonstração WebGPU

Crie o diretório: `samples/04/webgpu-demo/`
...
1. **Abrir Navegador:** Acesse `http://localhost:3000`
...
2. **Modelos Não Aparecem:**
   ...
   - Verifique a resposta da API: `curl http://localhost:51211/v1/models`
   - Reinicie o contêiner do Open WebUI
...
O aplicativo do Exemplo 04 demonstra as melhores práticas para construir interfaces de chat robustas que utilizam modelos de IA locais por meio do Microsoft Foundry Local, proporcionando excelentes experiências ao usuário.
