...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T21:35:55+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "br"
}
-->
# Integração do Foundry Local como Ferramentas

Um framework abrangente para integrar o Microsoft Foundry Local como ferramentas chamáveis dentro de aplicações maiores, seguindo os padrões oficiais da Microsoft para integração de IA baseada em ferramentas.

## Visão Geral

Este exemplo demonstra como expor modelos do Foundry Local como ferramentas reutilizáveis que podem ser integradas em aplicações, fluxos de trabalho e ambientes de desenvolvimento existentes. Ele apresenta os padrões recomendados pela Microsoft para integração de ferramentas e chamadas de funções.

## Conceitos Principais

### 🔧 **Arquitetura Baseada em Ferramentas**
- Modelos do Foundry Local como funções chamáveis
...
- **REST API**: Endpoints de ferramentas baseados em HTTP
- **Ferramentas CLI**: Integração com interface de linha de comando
- **Jupyter Notebooks**: Ferramentas interativas de desenvolvimento

### 🎯 **Padrões de Casos de Uso**
- Ferramentas de análise e geração de código
- Processamento e sumarização de conteúdo
...
### Dependências Específicas de Frameworks
```bash
...
## Padrões Centrais de Ferramentas
...
### 2. Ferramentas Sensíveis ao Contexto
```python
...
### 2. Gerenciamento de Pool de Modelos
```python
...
- **Projetos de Integração**: Construa integrações personalizadas com seus frameworks preferidos
- **Desenvolvimento de Ferramentas**: Crie ferramentas especializadas para o seu domínio
- **Ajuste de Desempenho**: Otimize para seus casos de uso específicos
- **Implantação em Produção**: Escale ferramentas para uso corporativo
