...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T21:37:01+00:00",
...
Um sistema avançado de multi-agentes desenvolvido pela Microsoft Foundry Local que demonstra coordenação inteligente de agentes, delegação de tarefas especializadas e padrões de resolução colaborativa de problemas.

## Visão Geral

Este exemplo mostra como construir sistemas sofisticados de agentes de IA usando Foundry Local, implementando os padrões oficiais da Microsoft para chamadas de função, orquestração de agentes e fluxos de trabalho colaborativos de IA.
...
- **Assistente de Pesquisa**: Coleta de informações, sumarização
- **Especialista em Escrita**: Criação de conteúdo, edição, documentação
- **Solucionador de Problemas**: Raciocínio complexo, tomada de decisão

### ⚡ **Chamadas de Função Avançadas**
- Padrões de chamadas de função do Microsoft Foundry Local
...
- Gerenciamento de redundância e fallback
...
### 3. Integração de Chamadas de Função
```python
...
## Detalhamento dos Tipos de Agentes
...
## Integração de Chamadas de Função
...
4. **Design de Sistemas em Produção**
   - Monitoramento e análise
