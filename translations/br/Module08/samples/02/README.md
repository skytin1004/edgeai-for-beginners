...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T21:20:33+00:00",
...
Demonstra integração avançada com o SDK OpenAI em Python, suportando tanto o Microsoft Foundry Local quanto o Azure OpenAI, com respostas em streaming e tratamento adequado de erros.

## Visão Geral

Este exemplo demonstra:
- Alternância fluida entre Foundry Local e Azure OpenAI
- Respostas em streaming para melhorar a experiência do usuário
...
- **Azure OpenAI**: Endpoint válido e chave de API (para inferência na nuvem)
...
**Opção 1: Usando FoundryLocalManager (Recomendado)**
```cmd
...
|----------|-------------|---------|----------|
| `MODEL` | Alias do modelo a ser usado | `phi-4-mini` | Não |
| `BASE_URL` | Endpoint do Foundry Local | `http://localhost:8000` | Não |
| `API_KEY` | Chave de API (opcional para local) | `""` | Não |
...
| `MODEL` | Nome da implantação no Azure | `your-deployment-name` | Sim |

## Recursos Avançados

### Descoberta Automática de Serviços

O exemplo detecta automaticamente o serviço apropriado com base nas variáveis de ambiente:
...
### Trade-offs entre Local e Nuvem

**Vantagens do Foundry Local:**
- ✅ Sem custos de API
- ✅ Privacidade de dados (nenhum dado sai do dispositivo)
...
- **Exemplo 04**: Construindo um aplicativo RAG com Chainlit
- **Exemplo 05**: Orquestração de múltiplos agentes
