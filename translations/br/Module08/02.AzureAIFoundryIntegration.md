...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T18:33:29+00:00",
...
Com base na sua experiência com o Foundry Local, esta sessão foca na criação de soluções avançadas de IA por meio de técnicas avançadas de engenharia de prompts, integração de dados sem complicações e automação de tarefas acionáveis. Você aprenderá a conectar o desenvolvimento local às capacidades do Azure AI Foundry, criando aplicações empresariais que aproveitam o melhor dos dois mundos.

## Objetivos de Aprendizagem

Ao final desta sessão, você será capaz de:
- Dominar técnicas avançadas de engenharia de prompts para respostas de IA consistentes e confiáveis
- Implementar padrões robustos de integração de dados para aplicações reais
- Criar tarefas acionáveis de IA que gerem valor para os negócios
- Estabelecer conectividade perfeita entre Foundry Local e Azure AI Foundry
- Construir fluxos de trabalho para monitoramento e otimização de desempenho
- Implantar soluções de IA prontas para produção com tratamento adequado de erros e escalabilidade

## Pré-requisitos

- Conclusão da Sessão 1: Introdução ao Foundry Local
- Instalação ativa do Foundry Local com modelos em execução
- Conta no Azure (o plano gratuito é suficiente para aprendizado)
- Compreensão básica de APIs REST e JSON

## Parte 1: Engenharia Avançada de Prompts

### Compreendendo a Arquitetura de Prompts

A engenharia eficaz de prompts é a base de aplicações confiáveis de IA. O Foundry Local oferece capacidades aprimoradas de criação de prompts:
...
### Implementando Estratégias de Prompts
...
### Framework de Automação de Tarefas
...
### Padrões de Implantação Híbrida
...
## Parte 5: Monitoramento e Otimização de Desempenho
...
- ✅ Criação de tarefas automatizadas para otimização de processos de negócios
- ✅ Integração com Azure AI Foundry e estratégias de implantação híbrida
- ✅ Monitoramento e otimização de desempenho abrangentes

### Preparando-se para a Sessão 3: Modelos Open-Source

1. **Explore o Hugging Face**: Crie uma conta e navegue pelo catálogo de modelos
2. **Revise o Model Mondays**: Confira a última série [Model Mondays](https://aka.ms/model-mondays)
3. **Planeje Modelos Personalizados**: Considere quais modelos especializados seriam benéficos para seus casos de uso
...
- [Melhores Práticas de Automação de Processos de Negócios](https://docs.microsoft.com/en-us/power-automate/)

Agora você está preparado para construir soluções sofisticadas de IA que combinam o poder da inferência local com capacidades em escala na nuvem, estabelecendo a base para aplicações de IA de nível empresarial.
