...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T21:19:07+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "br"
}
-->
# Sessão 2: Integração do SDK OpenAI com Azure AI Foundry

## Visão Geral

Com base na sua fundação do Foundry Local, esta sessão foca em padrões avançados de integração do SDK OpenAI que suportam de forma integrada tanto o Microsoft Foundry Local quanto o Azure OpenAI. Você aprenderá a criar aplicações de IA flexíveis que podem ser executadas localmente para privacidade e desenvolvimento, enquanto oferecem escalabilidade na nuvem através do Azure OpenAI quando necessário.

## Objetivos de Aprendizagem

Ao final desta sessão, você será capaz de:
- Dominar a integração avançada do SDK OpenAI com Foundry Local e Azure OpenAI
- Implementar respostas em streaming para melhorar a experiência do usuário
- Criar padrões robustos de fábrica de clientes para suporte a múltiplos provedores
- Construir sistemas de gerenciamento de conversas com preservação de contexto
- Estabelecer benchmarking de desempenho e monitoramento de saúde
- Implantar aplicações prontas para produção com tratamento adequado de erros
...
- SDK Python OpenAI instalado (`pip install openai foundry-local-sdk`)
- Conta Azure com serviço OpenAI (opcional, para cenários na nuvem)
- Compreensão básica de padrões Python async/await

## Parte 1: Padrão de Fábrica de Clientes do SDK OpenAI

### Entendendo a Arquitetura Multi-Provedor

Construir aplicações que funcionem tanto com Foundry Local quanto com Azure OpenAI exige um padrão flexível de criação de clientes:
...
### Implementando Completações de Chat em Streaming

O streaming oferece uma melhor experiência ao usuário ao exibir respostas conforme são geradas:
...
### Gerenciamento de Conversas Multi-turno
...
Meça e compare o desempenho entre diferentes configurações:
...
## Parte 4: Monitoramento de Saúde e Diagnósticos do Serviço
...
## Parte 5: Variáveis de Ambiente e Gerenciamento de Configuração

### Referência de Variáveis de Ambiente

Referência completa para configurar ambos os provedores:
...
### Exercício 1: Integração Multi-Provedor do SDK

Construa uma aplicação completa que alterna entre provedores de forma integrada:
...
### Exercício 2: Gerenciamento Avançado de Conversas
...
### Exercício 3: Monitoramento de Saúde Pronto para Produção
...
Nesta sessão, você dominou:
- ✅ **Integração do SDK OpenAI**: Padrões avançados para Foundry Local e Azure OpenAI
- ✅ **Respostas em Streaming**: Completações de chat em tempo real para melhorar a experiência do usuário
- ✅ **Suporte Multi-Provedor**: Alternância integrada entre serviços de IA locais e na nuvem
- ✅ **Gerenciamento de Conversas**: Conversas multi-turno com preservação de contexto
- ✅ **Monitoramento de Desempenho**: Benchmarking e verificação de saúde para implantações em produção
- ✅ **Padrões de Produção**: Tratamento robusto de erros e gerenciamento de configuração
...
1. **🔄 Sempre Implemente Alternativas**: Azure → Foundry Local → Tratamento de erros
2. **🌊 Use Streaming para Respostas Longas**: Melhor percepção de desempenho
3. **🛡️ Implemente Tratamento Abrangente de Erros**: Mensagens de erro amigáveis ao usuário
4. **📈 Monitore o Desempenho**: Acompanhe tempos de resposta e taxas de sucesso
5. **⚙️ Configuração Baseada em Ambiente**: Alternância fácil entre dev/staging/prod
6. **🔒 Gerenciamento Seguro de Credenciais**: Nunca codifique chaves de API

### Diretrizes de Seleção de Provedores

| Cenário              | Provedor Recomendado | Justificativa                |
|----------------------|----------------------|-----------------------------|
...
| **Produção em Alta Escala** | Azure OpenAI        | Melhor escalabilidade, SLA empresarial |
| **Modelos Mais Recentes** | Azure OpenAI        | Acesso às versões mais novas de modelos |
| **Requisitos Offline** | Foundry Local        | Sem dependência de internet |
| **Sensibilidade a Custos** | Foundry Local        | Sem cobranças por token |
...
1. **Explore o Catálogo de Modelos**: Revise os modelos disponíveis no Foundry Local
2. **Entenda os Formatos de Modelos**: Aprenda sobre ONNX, quantização e otimização
3. **Considere Modelos Personalizados**: Pense em requisitos específicos de domínio
...
- **[Documentação do SDK Python OpenAI](https://github.com/openai/openai-python)**: Referência oficial do SDK
- **[Documentação do Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/)**: Guia do serviço Azure OpenAI
- **[Referência do SDK Foundry Local](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Documentação de inferência local
...
- **[Exemplo 01: Chat Rápido via SDK OpenAI](samples/01/README.md)**: Padrões básicos de integração
...
Agora você está preparado para construir aplicações de IA sofisticadas que integram de forma integrada capacidades de IA locais e na nuvem, oferecendo a flexibilidade de escolher o provedor certo para cada caso específico, enquanto mantém padrões consistentes de desenvolvimento.
