...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T22:03:09+00:00",
...
- [**Seção 1: Fundamentos do EdgeAI**](./Module01/01.EdgeAIFundamentals.md)
  - Comparação entre IA tradicional na nuvem e IA na borda
  - Desafios e restrições da computação na borda
  - Tecnologias-chave: quantização de modelos, otimização de compressão, Modelos de Linguagem Pequenos (SLMs)
...
- [**Seção 4: Plataformas de Hardware para Implantação de Edge AI**](./Module01/04.EdgeDeployment.md)
  ...
  - Plataformas de PC com Windows AI com aceleração NPU
  - Estratégias de otimização específicas para hardware

---

### [Módulo 02: Fundamentos de Modelos de Linguagem Pequenos](./Module02/README.md)
...
- [**Seção 3: Fundamentos da Família Gemma**](./Module02/03.GemmaFamily.md)
  - Inovação orientada por pesquisa (Gemma 3 & 3n)
...
- [**Seção 5: Fundamentos do Modelo Microsoft Mu**](./Module02/05.mumodel.md)
  - Arquitetura com foco em dispositivos integrada ao Windows 11
...
- [**Seção 1: Aprendizado Avançado de SLMs**](./Module03/01.SLMAdvancedLearning.md)
  ...
  - Técnicas avançadas de otimização (métodos de quantização, quantização BitNET 1-bit)
  - Estratégias de aquisição de modelos (Azure AI Foundry para modelos Phi, Hugging Face para modelos selecionados)

- [**Seção 2: Implantação em Ambiente Local**](./Module03/02.DeployingSLMinLocalEnv.md)
...
- [**Seção 3: Microsoft Olive Optimization Suite**](./Module04/03.MicrosoftOlive.md)
  - Otimização de modelos orientada por hardware com mais de 40 componentes integrados
...
- [**Seção 4: OpenVINO Toolkit Optimization Suite**](./Module04/04.openvino.md)
  ...
  - OpenVINO GenAI para implantação de modelos de linguagem extensivos
  - Aceleração de hardware em CPU, GPU, VPU e aceleradores de IA

- [**Seção 5: Apple MLX Framework - Análise Detalhada**](./Module04/05.AppleMLX.md)
  - Arquitetura de memória unificada para Apple Silicon
  - Suporte para LLaMA, Mistral, Phi-3, modelos Qwen selecionados
  - Ajuste fino com LoRA e personalização de modelos
  - Integração com Hugging Face e quantização de 4 bits/8 bits

- [**Seção 6: Síntese de Fluxo de Trabalho para Desenvolvimento de Edge AI**](./Module04/06.workflow-synthesis.md)
  ...
  - Estratégias para garantir compatibilidade com hardware e arquiteturas de modelos emergentes
...
- [**Seção 3: Ajuste Fino - Personalizando Modelos para Tarefas Específicas**](./Module05/03.SLMOps-Finetuing.md)
  - Técnicas de ajuste fino eficientes em parâmetros (PEFT)
  - Métodos avançados como LoRA e QLoRA
  - Implementação de ajuste fino com Microsoft Olive
...
**Tema**: Implementação de sistemas agentes SLM desde os fundamentos até chamadas de função avançadas e integração com o Protocolo de Contexto de Modelo
...
- [**Seção 2: Chamadas de Função em Modelos de Linguagem Pequenos**](./Module06/02.FunctionCalling.md)
  - Implementação sistemática de fluxo de trabalho (detecção de intenção, saída JSON, execução externa)
...
- [**Seção 3: Integração do Protocolo de Contexto de Modelo (MCP)**](./Module06/03.IntroduceMCP.md)
  ...
  - Aplicações no mundo real (automação web, processamento de dados, integração com APIs)
...
- [**EdgeAI no Azure com Motor de Modelos de Linguagem Pequenos**](./Module07/README.md#3-edgeai-in-azure-with-small-language-models-engine)
  ...
  - Integração com serviços de IA do Azure e ONNX Runtime
...
- [**EdgeAI com Aplicações Foundry Local**](./Module07/README.md#5-edgeai-with-foundry-local-applications)
  ...
  - Integração com modelo de linguagem Phi-3 e busca semântica (somente modelos Phi)
...
Ao concluir este curso abrangente de EdgeAI, você desenvolverá a expertise necessária para projetar, implementar e implantar soluções de EdgeAI prontas para produção. Nossa abordagem estruturada garante que você domine tanto os fundamentos teóricos quanto as habilidades práticas de implementação.
...
- Entender as opções de aceleração de hardware (NPUs, GPUs, CPUs) e suas implicações de implantação
...
- Aplicar práticas de segurança para implementações de EdgeAI com preservação de privacidade
...
- Projetar soluções completas de EdgeAI que integrem-se à infraestrutura existente
...
- Dominar técnicas de otimização essenciais para implantação em borda
...
- Entender trade-offs de flexibilidade de implantação
...
- Capacidades de seleção de otimização orientada por hardware em diversas plataformas
- Habilidades de implantação em produção para ambientes de computação de borda multiplataforma
- Síntese estratégica de frameworks e fluxos de trabalho para soluções de Edge AI ideais

### Resultados de Aprendizado do Módulo 05:
- Dominar o paradigma SLMOps e princípios operacionais
- Implementar destilação de modelos para transferência de conhecimento e otimização de eficiência
- Aplicar técnicas de ajuste fino para personalização de modelos específicos de domínio
...
### Resultados de Aprendizado do Módulo 07:
- Dominar o Toolkit de IA para Visual Studio Code para fluxos de trabalho completos de desenvolvimento de Edge AI
- Adquirir expertise na plataforma Windows AI Foundry e estratégias de otimização de NPU
- Obter experiência prática com diversas plataformas de EdgeAI e estratégias de implementação
- Dominar técnicas de otimização específicas de hardware em plataformas NVIDIA, móveis, Azure e Windows
- Entender trade-offs de implantação entre desempenho, custo e requisitos de privacidade
...
Após a conclusão bem-sucedida deste curso, você estará equipado com o conhecimento, habilidades e confiança para liderar iniciativas de EdgeAI em ambientes profissionais.

### Prontidão Profissional

**Liderança Técnica**
- **Arquitetura de Soluções**: Projetar sistemas completos de EdgeAI que atendam aos requisitos empresariais
- **Otimização de Desempenho**: Alcançar equilíbrio ideal entre precisão, velocidade e consumo de recursos
- **Implantação Multiplataforma**: Implementar soluções em Windows, Linux, dispositivos móveis e embarcados
...
- Engenheiro de Aprendizado de Máquina (Especialização em Borda)
- Desenvolvedor de IA para IoT
...
- Concluir projetos completos de EdgeAI demonstrando competência prática
- Implantar soluções prontas para produção em múltiplas plataformas de hardware
...
- Preparação para arquiteturas híbridas de borda-nuvem
- Porta de entrada para tecnologias e frameworks emergentes de IA
Este curso posiciona você na vanguarda da implantação de tecnologia de IA, onde capacidades inteligentes são integradas de forma contínua aos dispositivos e sistemas que impulsionam a vida moderna.
...
- **Considerações de Nível Empresarial**: Práticas de segurança, estruturas de conformidade e estratégias de proteção de dados

## Primeiros Passos

Caminho de Aprendizado Recomendado:
1. Comece com **Module01** para construir uma compreensão fundamental do EdgeAI
2. Prossiga para **Module02** para entender profundamente as diversas famílias de modelos SLM
...
Um [Guia de Estudos](STUDY_GUIDE.md) abrangente está disponível para ajudar você a maximizar sua experiência de aprendizado. O guia de estudos oferece:

- **Caminhos de Aprendizado Estruturados**: Cronogramas otimizados para concluir o curso em 20 horas
...
**O futuro do EdgeAI está na melhoria contínua das arquiteturas de modelos, técnicas de quantização e estratégias de implantação que priorizam eficiência e especialização em vez de capacidades de propósito geral. Organizações que adotarem essa mudança de paradigma estarão bem posicionadas para aproveitar o potencial transformador da IA enquanto mantêm controle sobre seus dados e operações.**
