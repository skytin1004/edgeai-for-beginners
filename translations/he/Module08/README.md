...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T23:58:57+00:00",
...
**נושאים מרכזיים**: התקנה מלאה • פקודות CLI • שמירת מודלים • האצת חומרה • פריסת מודלים מרובים

**דוגמה**: [מדריך מהיר ל-REST Chat](./samples/01/README.md) • [אינטגרציה עם OpenAI SDK](./samples/02/README.md) • [גילוי מודלים וביצועי Benchmark](./samples/03/README.md)
...
**מיקוד**: תיאום סוכנים מתוחכם, הקצאת משימות מיוחדות וזרימות עבודה שיתופיות של AI
...
**קהילה ותמיכה:**
- [דיונים על Foundry Local](https://github.com/microsoft/Foundry-Local/discussions) - שאלות ותשובות בקהילה ובקשות תכונות
- [קהילת מפתחי AI של Microsoft](https://techcommunity.microsoft.com/category/artificialintelligence) - חדשות אחרונות ושיטות עבודה מומלצות

## תוצאות למידה

לאחר השלמת מודול זה, תהיו מצוידים ל:
...
1. **הגדרת סביבה**: ודאו Windows 11 עם החומרה המומלצת (ראו דרישות מקדימות)
2. **התקנת Foundry Local**: עקבו אחר מפגש 1 להשלמת ההתקנה וההגדרה
...
- [ ] פריסה של 2+ דוגמאות בסביבות דמויות ייצור
...
## סיכום
מודול זה מייצג את חוד החנית של פיתוח AI בקצה, ומשלב את הכלים ברמת הארגון של מיקרוסופט עם הגמישות והחדשנות של עולם הקוד הפתוח. על ידי שליטה ב-Foundry Local דרך כל 10 הדוגמאות המקיפות, תמצאו את עצמכם בחזית פיתוח יישומי ה-AI.
