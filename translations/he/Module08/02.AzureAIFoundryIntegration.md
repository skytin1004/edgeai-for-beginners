...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T21:53:04+00:00",
...
בהמשך לבסיס Foundry Local, מפגש זה מתמקד ביצירת פתרונות AI מתקדמים באמצעות הנדסת פרומפטים מתקדמת, שילוב נתונים חלק ואוטומציה של משימות מעשיות. תלמדו כיצד לגשר בין פיתוח מקומי לבין יכולות Azure AI Foundry, וליצור אפליקציות מוכנות לארגונים שמנצלות את הטוב משני העולמות.

## מטרות למידה

בסיום המפגש, תוכלו:
- לשלוט בטכניקות הנדסת פרומפטים מתקדמות לתגובות AI עקביות ואמינות
- ליישם דפוסי שילוב נתונים חזקים ליישומים בעולם האמיתי
- ליצור משימות AI מעשיות שמניעות ערך עסקי
- להקים חיבור חלק בין Foundry Local ל-Azure AI Foundry
- לבנות תהליכי ניטור וביצוע אופטימיזציה
- לפרוס פתרונות AI מוכנים לייצור עם טיפול נכון בשגיאות ויכולת הרחבה

## דרישות מוקדמות

- סיום מפגש 1: התחלה עם Foundry Local
- התקנה פעילה של Foundry Local עם מודלים פועלים
- חשבון Azure (מספיק חשבון חינמי ללמידה)
- הבנה בסיסית של REST APIs ו-JSON

## חלק 1: הנדסת פרומפטים מתקדמת

### הבנת ארכיטקטורת פרומפטים

הנדסת פרומפטים יעילה היא הבסיס ליישומי AI אמינים. Foundry Local מספק יכולות פרומפטים משופרות:
...
### דוגמאות מעשיות להנדסת פרומפטים
...
## חלק 2: דפוסי שילוב נתונים

### מחברי נתונים של Foundry Local
...
### דוגמה לשילוב נתונים בעולם האמיתי
...
## חלק 3: משימות AI מעשיות

### מסגרת אוטומציה של משימות
...
### דוגמאות לאוטומציה של תהליכים עסקיים
...
## חלק 5: ניטור ביצועים ואופטימיזציה
...
### תרגיל 1: בוט שירות לקוחות מתקדם
...
## חלק 7: צעדים הבאים ותצוגה מקדימה של מפגש 3

### הישגי המפגש

במפגש זה, שלטתם ב:
- ✅ טכניקות הנדסת פרומפטים מתקדמות להתנהגות AI עקבית
- ✅ דפוסי שילוב נתונים חזקים ליישומים בעולם האמיתי
- ✅ יצירת משימות אוטומטיות לאופטימיזציה של תהליכים עסקיים
- ✅ שילוב Azure AI Foundry ואסטרטגיות פריסה היברידיות
- ✅ ניטור ביצועים מקיף ואופטימיזציה

### הכנה למפגש 3: מודלים בקוד פתוח

1. **חקור את Hugging Face**: צור חשבון ועיין בקטלוג המודלים
2. **סקור את Model Mondays**: בדוק את סדרת [Model Mondays](https://aka.ms/model-mondays) העדכנית
3. **תכנן מודלים מותאמים אישית**: שקול אילו מודלים מיוחדים יועילו לשימושים שלך

### משאבים נוספים

- [תיעוד Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [מאגר GitHub של Foundry Local](https://github.com/microsoft/Foundry-Local)
- [מדריך הנדסת פרומפטים מתקדמת](https://platform.openai.com/docs/guides/prompt-engineering)
- [שיטות עבודה מומלצות לאוטומציה של תהליכים עסקיים](https://docs.microsoft.com/en-us/power-automate/)

כעת אתם מצוידים לבנות פתרונות AI מתקדמים שמשלבים את כוח ההסקה המקומית עם יכולות ענן בקנה מידה רחב, ומניחים את הבסיס ליישומי AI ברמה ארגונית.
