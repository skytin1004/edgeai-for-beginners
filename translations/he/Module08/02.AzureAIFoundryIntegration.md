...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T00:00:52+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "he"
}
-->
# מפגש 2: שילוב OpenAI SDK עם Azure AI Foundry

## סקירה כללית

בהמשך לבסיס Foundry Local שלך, מפגש זה מתמקד בתבניות שילוב מתקדמות של OpenAI SDK שתומכות בצורה חלקה גם ב-Microsoft Foundry Local וגם ב-Azure OpenAI. תלמד כיצד לבנות יישומי AI גמישים שיכולים לפעול באופן מקומי לצורך פרטיות ופיתוח, תוך מתן יכולת הרחבה בענן באמצעות Azure OpenAI בעת הצורך.

## מטרות למידה

בסיום המפגש, תוכל:
- לשלוט בשילוב מתקדם של OpenAI SDK עם Foundry Local ו-Azure OpenAI
- ליישם תגובות זורמות לשיפור חוויית המשתמש
- ליצור תבניות מפעל לקוח חזקות לתמיכה בריבוי ספקים
- לבנות מערכות ניהול שיחה עם שימור הקשר
- להקים מערכות לבדיקת ביצועים וניטור בריאות
- לפרוס יישומים מוכנים לייצור עם טיפול נכון בשגיאות

## דרישות מקדימות

- סיום מפגש 1: התחלה עם Foundry Local
- התקנה פעילה של Foundry Local עם מודלים פועלים
- Python 3.8 או גרסה מאוחרת יותר עם יכולת סביבת עבודה וירטואלית
- OpenAI Python SDK מותקן (`pip install openai foundry-local-sdk`)
- חשבון Azure עם שירות OpenAI (אופציונלי, לתרחישי ענן)
- הבנה בסיסית של תבניות Python async/await

## חלק 1: תבנית מפעל לקוח של OpenAI SDK

### הבנת ארכיטקטורת ריבוי ספקים

בניית יישומים שעובדים עם Foundry Local ו-Azure OpenAI דורשת תבנית יצירת לקוח גמישה:
...
## חלק 2: תגובות זורמות ואינטראקציה בזמן אמת

### יישום השלמות שיחה זורמות

תגובות זורמות מספקות חוויית משתמש טובה יותר על ידי הצגת תגובות בזמן יצירתן:
...
## חלק 3: בדיקת ביצועים וניתוח

### מדידת זמן תגובה

מדוד והשווה ביצועים בין תצורות שונות:
...
## חלק 4: ניטור בריאות השירות ואבחון

### מערכת בדיקת בריאות מקיפה
...
## חלק 5: משתני סביבה וניהול תצורה

### התייחסות למשתני סביבה

התייחסות מלאה לתצורת שני הספקים:
...
## חלק 6: תרגילים מעשיים

### תרגיל 1: שילוב SDK רב-ספקי

בנה יישום מלא שמחליף בצורה חלקה בין ספקים:
...
### תרגיל 3: ניטור בריאות מוכן לייצור
...
## חלק 7: סיכום והשלבים הבאים

### הישגי המפגש

במפגש זה, שלטת ב:
- ✅ **שילוב OpenAI SDK**: תבניות מתקדמות עבור Foundry Local ו-Azure OpenAI
- ✅ **תגובות זורמות**: השלמות שיחה בזמן אמת לשיפור חוויית המשתמש
- ✅ **תמיכה בריבוי ספקים**: מעבר חלק בין שירותי AI מקומיים וענניים
- ✅ **ניהול שיחה**: שיחות רב-סיבוביות עם מודעות להקשר
- ✅ **ניטור ביצועים**: בדיקת ביצועים ובדיקת בריאות לפריסות ייצור
- ✅ **תבניות ייצור**: טיפול בשגיאות וניהול תצורה בצורה חזקה

### תבניות ארכיטקטורה מרכזיות
...
1. **🔄 תמיד יישם חלופות**: Azure → Foundry Local → טיפול בשגיאות
2. **🌊 השתמש בתגובות זורמות לתגובות ארוכות**: ביצועים נתפסים טובים יותר
3. **🛡️ יישם טיפול שגיאות מקיף**: הודעות שגיאה ידידותיות למשתמש
4. **📈 עקוב אחר ביצועים**: מדוד זמני תגובה ושיעורי הצלחה
5. **⚙️ תצורה מבוססת סביבה**: מעבר קל בין dev/staging/prod
6. **🔒 ניהול אישורים מאובטח**: לעולם אל תכתוב מפתחות API בקוד

### הנחיות לבחירת ספק

| תרחיש | ספק מומלץ | נימוק |
|----------|---------------------|----------|
| **פיתוח** | Foundry Local | איטרציה מהירה, ללא עלויות API |
| **קריטי לפרטיות** | Foundry Local | נתונים לא עוזבים את המכשיר |
| **ייצור בנפח גבוה** | Azure OpenAI | יכולת הרחבה טובה יותר, SLA ארגוני |
| **מודלים חדשים** | Azure OpenAI | גישה לשחרורי מודלים חדשים |
| **דרישות לא מקוונות** | Foundry Local | ללא תלות באינטרנט |
| **רגישות לעלויות** | Foundry Local | ללא חיובים לפי טוקן |

### התייחסות מהירה למשתני סביבה
...
### הכנה למפגש 3: מודלים בקוד פתוח

1. **חקור קטלוג מודלים**: סקור מודלים זמינים ב-Foundry Local
2. **הבנת פורמטי מודלים**: למד על ONNX, כימות ואופטימיזציה
3. **שקול מודלים מותאמים אישית**: חשוב על דרישות מודלים ספציפיות לתחום
...
- **[תיעוד OpenAI Python SDK](https://github.com/openai/openai-python)**: התייחסות רשמית ל-SDK
- **[תיעוד Azure OpenAI](https://learn.microsoft.com/azure/ai-services/openai/)**: מדריך שירות Azure OpenAI
- **[התייחסות Foundry Local SDK](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: תיעוד הסקה מקומי
- **[מדריך השלמות זורמות](https://learn.microsoft.com/azure/ai-foundry/foundry-local/how-to/integrate-with-inference-sdks)**: תבניות זרימה מתקדמות
- **[דוגמה 01: שיחה מהירה באמצעות OpenAI SDK](samples/01/README.md)**: תבניות שילוב בסיסיות
- **[דוגמה 02: שילוב SDK מתקדם](samples/02/README.md)**: דוגמאות מעשיות למפגש זה
- **[דוגמה 04: יישום Chainlit](samples/04/README.md)**: פיתוח ממשק משתמש אינטרנטי
- **[דוגמה 05: מערכות רב-סוכנים](samples/05/README.md)**: תבניות תזמור מתקדמות

כעת אתה מצויד לבנות יישומי AI מתוחכמים שמשלבים בצורה חלקה יכולות AI מקומיות וענניות, ומספקים את הגמישות לבחור את הספק המתאים לכל מקרה שימוש ספציפי תוך שמירה על תבניות פיתוח עקביות.
