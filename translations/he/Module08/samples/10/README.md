...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T00:13:58+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "he"
}
-->
# Foundry Local ככלי אינטגרציה

מסגרת מקיפה לשילוב Microsoft Foundry Local ככלים שניתן לקרוא להם בתוך יישומים גדולים יותר, בהתאם לדפוסים הרשמיים של מיקרוסופט לשילוב AI מבוסס כלים.

## סקירה כללית

דוגמה זו מדגימה כיצד לחשוף מודלים של Foundry Local ככלים שניתן להשתמש בהם מחדש ולשלב אותם ביישומים קיימים, תהליכי עבודה וסביבות פיתוח. היא מציגה את הדפוסים המומלצים של מיקרוסופט לשילוב כלים וקריאה לפונקציות.

## מושגים מרכזיים

### 🔧 **ארכיטקטורה מבוססת כלים**
- מודלים של Foundry Local כפונקציות שניתן לקרוא להן
- ממשקים וסכמות כלים סטנדרטיים
- שילוב חלק עם בסיסי קוד קיימים
- הגדרות כלים בטוחות מסוג ואימות

### ⚡ **דפוסי קריאה לפונקציות**
- יישום קריאה לפונקציות של Microsoft Foundry Local
- הגדרות כלים תואמות OpenAI
- אימות והמרה אוטומטיים של פרמטרים
- טיפול בשגיאות ועיצוב תגובות

### 🔌 **מסגרות אינטגרציה**
- **שילוב LangChain**: תמיכה בכלים מקוריים של LangChain
- **Semantic Kernel**: פונקציות של Microsoft Semantic Kernel
- **REST API**: נקודות קצה מבוססות HTTP
- **כלי CLI**: שילוב ממשק שורת פקודה
- **Jupyter Notebooks**: כלי פיתוח אינטראקטיביים

### 🎯 **דפוסי שימוש**
- כלים לניתוח קוד ויצירת קוד
- עיבוד תוכן וסיכום
- ניתוח נתונים והמחשה
- מחקר ואחזור מידע
...
- **Node.js**: גרסה v18+ (לשילובים ב-JavaScript)
- **זיכרון**: מומלץ 12GB+
- **אחסון**: 10GB+ עבור מודלים וכלים
...
1. **דפוסי שילוב כלים**
   - עיצוב כלים מבוססי פונקציות ומחלקות
   - דפוסי שילוב Microsoft Foundry Local
   - אימות סכמות ובטיחות סוגים
   - טיפול בשגיאות והתאוששות

2. **שילוב מסגרות**
   - פיתוח כלים ב-LangChain
   - שילוב פונקציות Semantic Kernel
   - שילוב מסגרת REST API
   - פיתוח יישומי CLI

3. **שיקולים לפרודקשן**
   - אסטרטגיות אופטימיזציה ביצועית
   - ניהול מטמון ומשאבים
   - ניטור ותצפית
   - אבטחה ואימות

4. **דפוסי כלים מתקדמים**
   - הרכבת כלים ושרשור
   - עיבוד מודע להקשר
   - פעולות בקבוצות ובסטרימינג
   - פיתוח אינטגרציות מותאמות אישית

## צעדים הבאים

- **פרויקטי אינטגרציה**: בנו אינטגרציות מותאמות אישית עם המסגרות המועדפות עליכם
- **פיתוח כלים**: צרו כלים מיוחדים לתחום שלכם
- **כיוונון ביצועים**: בצעו אופטימיזציה לשימושים הספציפיים שלכם
- **פריסה לפרודקשן**: סקיילינג כלים לשימוש ארגוני
