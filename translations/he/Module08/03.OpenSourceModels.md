...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T23:59:40+00:00",
...
המפגש הזה מתמקד בגילוי וניהול מודלים באופן מעשי עם Foundry Local. תלמדו כיצד לרשום מודלים זמינים, לבדוק אפשרויות שונות ולהבין מאפייני ביצועים בסיסיים. הגישה מדגישה חקר מעשי באמצעות CLI של Foundry כדי לעזור לכם לבחור את המודלים המתאימים לשימושים שלכם.
...
- להקים תהליכי עבודה מעשיים לבחירת מודלים וביצוע בדיקות ביצועים
...
- שטח אחסון מספיק להורדת מודלים (גודל המודלים יכול לנוע בין 1GB ל-20GB+)
...
4. **בדקו באופן עקבי**: השתמשו באותם הנחיות להשוואות הוגנות
...
- **מיקוד מפגש 4**: כלי וטכניקות אופטימיזציה
- **דרישות מוקדמות**: נוחות עם מעבר בין מודלים ובדיקות ביצועים בסיסיות
- **מומלץ**: זיהוי 2-3 מודלים מועדפים מהמפגש הזה
...
- **[Model Mondays](https://aka.ms/model-mondays)**: דגשים שבועיים על מודלים
- **[Foundry Local GitHub](https://github.com/microsoft/Foundry-Local)**: קהילה ונושאים
...
כעת יש לכם את הכישורים המעשיים לגילוי, בדיקה ובחירת מודלים מתאימים ליישומי AI שלכם באמצעות הגישה הפשוטה של CLI של Foundry Local.
...
CLI של Foundry מספק פקודות פשוטות לגילוי וניהול מודלים:
...
**מודלים קטנים (SLMs):**
- `phi-4-mini`: מהיר, יעיל, מצוין לצ'אט כללי
- `phi-4`: גרסה מתקדמת יותר עם יכולת הסקה טובה יותר

**מודלים בינוניים:**
- `qwen2.5-7b-instruct`: הסקה מצוינת והקשר ארוך יותר
- `deepseek-r1-distill-qwen-7b`: מותאם ליצירת קוד

**מודלים גדולים:**
- `llama-3.2`: המודל האחרון בקוד פתוח של Meta
- `qwen2.5-14b-instruct`: הסקה ברמה ארגונית

## חלק 2: בדיקה והשוואה מהירה של מודלים

### גישת דוגמה 03: רשימה ובדיקה פשוטה

בהתבסס על דפוס דוגמה 03, הנה תהליך העבודה המינימלי:
...
לאחר שמודל פועל, בדקו אותו עם הנחיות עקביות:
...
- עקבו אחרי שימוש בדיסק, במיוחד ב-SSD קטן
- שקלו את גודל המודל מול יכולותיו

### מעקב ביצועי מודלים

בזמן שמודלים פועלים, עקבו אחרי משאבי מערכת:
...
**לצ'אט כללי ושאלות ותשובות:**
- התחילו עם: `phi-4-mini` (מהיר, יעיל)
- שדרגו ל: `phi-4` (הסקה טובה יותר)
- מתקדם: `qwen2.5-7b-instruct` (הקשר ארוך יותר)

**ליצירת קוד:**
- מומלץ: `deepseek-r1-distill-qwen-7b`
- אלטרנטיבה: `qwen2.5-7b-instruct` (גם טוב לקוד)

**להסקה מורכבת:**
- הטוב ביותר: `qwen2.5-7b-instruct` או `qwen2.5-14b-instruct`
- אפשרות תקציבית: `phi-4`
...
## חלק 5: בדיקות ביצועים פשוטות של מודלים
...
לכל מודל, בדקו עם הנחיות עקביות והעריכו ידנית:
