...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T00:01:33+00:00",
...
התייחסו למודלים של AI ככלים מודולריים הניתנים להתאמה אישית שפועלים ישירות על המכשיר באמצעות Foundry Local. מפגש זה מדגיש תהליכי עבודה מעשיים עבור הסקת מסקנות עם שמירה על פרטיות וביצועים מהירים, וכיצד לשלב את הכלים הללו באמצעות SDKs, APIs או CLI. בנוסף, תלמדו כיצד להתרחב ל-Azure AI Foundry בעת הצורך.

> **🔄 מעודכן ל-SDK מודרני**: מודול זה הותאם לדפוסי המאגר העדכניים ביותר של Microsoft Foundry-Local ומתאים ליישום ניתוב חכם ב-`samples/06/`. הדוגמאות כעת משתמשות ב-`foundry-local-sdk` המודרני ובאסטרטגיות מתקדמות לבחירת מודלים.
...
**📁 יישום מקומי:**
- `samples/06/router.py` - ניתוב מודלים חכם עם בחירה מבוססת מילות מפתח
- `samples/06/model_router.ipynb` - דוגמאות אינטראקטיביות ומבחנים
...
- שילוב עם SDKs להסקת מסקנות: https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/how-to/how-to-integrate-with-inference-sdks
...
שלב 1) הגדרת ניתוב מודלים מודרני עם FoundryLocalManager  
```python
...
מטרה: שימוש ב-SDK של Foundry Local עם SDK של OpenAI Python לשילוב חלק.
...
מטרה: פריסת ניתוב חכם עם מעקב ושילוב Azure AI Foundry.

> **📋 הערה**: היישום המקומי ב-`samples/06/model_router.ipynb` כולל דוגמאות מקיפות לדפוסי פריסה לייצור.

שלב 1) ניתוב לייצור עם מעקב (ראו `samples/06/router.py`)  
```python
...
## רשימת בדיקות מעשית
- [ ] יישום ניתוב מודלים חכם עם בחירה מבוססת מילות מפתח (`samples/06/router.py`)
...
- [ ] פריסת ניתוב לייצור עם רישום מקיף
...
- **יישום מקומי**: `samples/06/` - ניתוב חכם מלא עם תמיכה במספר מודלים
- **דוגמאות Microsoft**: [Hello Foundry Local](https://github.com/microsoft/Foundry-Local/tree/main/samples/python/hello-foundry-local)
- **תיעוד שילוב**: [שילוב עם SDKs להסקת מסקנות](https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/how-to/how-to-integrate-with-inference-sdks)
- **דפוסים מתקדמים**: חקר קריאת פונקציות ותזמור רב-סוכנים במודול 5

## סיכום

Foundry Local מאפשר AI חזק על המכשיר שבו מודלים הופכים לכלים חכמים ומתמחים. עם בחירה אוטומטית של מודלים, מעקב מקיף ודפוסים מוכנים לייצור, צוותים יכולים להשיק יישומי AI מתקדמים שמתאימים לסוגי משימות שונים תוך שמירה על פרטיות וביצועים. דפוס ניתוב חכם שהוצג כאן מספק בסיס לבניית מערכות AI מורכבות שיכולות להתרחב מפיתוח מקומי לפריסה בייצור.
