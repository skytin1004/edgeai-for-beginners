...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T08:02:56+00:00",
...
- **השיהיה נמוכה**: תגובות מיידיות המתאימות למערכות בזמן אמת
...
| [⚙️ 04](../../Module04) | [ערכת כלי אופטימיזציית מודלים](./Module04/README.md) | אופטימיזציה חוצת פלטפורמות | מבוא • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • סינתזת תהליכים | בינוני | 5-6 שעות |
...
| [🤖 06](../../Module06) | [סוכני AI וקריאת פונקציות](./Module06/README.md) | מסגרות סוכנים ו-MCP | מבוא לסוכנים • קריאת פונקציות • פרוטוקול הקשר מודלים | מתקדם | 4-5 שעות |
...
**פרויקטים לתיק עבודות**: מערכות רב-סוכנים • אפליקציות RAG לייצור • פריסה חוצת פלטפורמות • אופטימיזציית ביצועים  
...
**EdgeAI מייצג את העתיד של פריסת AI**: מקומי תחילה, שומר על פרטיות ויעיל. שלוט במיומנויות אלו כדי לבנות את הדור הבא של אפליקציות חכמות.
...
- [הרפתקאות Copilot לבחירתך](https://github.com/microsoft/CopilotAdventures?WT.mc_id=academic-105485-koreyst)  
