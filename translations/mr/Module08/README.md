...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T15:13:45+00:00",
...
Microsoft Foundry Local ही एज AI विकासाची पुढील पिढी आहे, जी डेव्हलपरना स्थानिक स्तरावर AI अॅप्लिकेशन्स तयार, तैनात आणि स्केल करण्यासाठी शक्तिशाली साधने प्रदान करते, Azure AI Foundry सह अखंड एकत्रीकरण राखून. या मॉड्यूलमध्ये Foundry Local च्या स्थापनेपासून ते प्रगत एजंट विकासापर्यंत सर्वसमावेशक कव्हरेज आहे.
...
- **उत्पादन सोल्यूशन्स तयार करा**: प्रगत प्रॉम्प्ट इंजिनिअरिंग आणि डेटा एकत्रीकरणासह AI अॅप्लिकेशन्स तयार करा
...
**मुख्य विषय**: प्रॉम्प्ट इंजिनिअरिंग • डेटा एकत्रीकरण • Azure वर्कफ्लोज • कार्यक्षमता ऑप्टिमायझेशन • मॉनिटरिंग
...
**मुख्य विषय**: मॉडेल तुलना • Edge vs cloud inference • Phi + ONNX Runtime • Chainlit RAG अॅप • WebGPU ऑप्टिमायझेशन
...
**मुख्य विषय**: एजंट डिझाइन पॅटर्न्स • सिस्टम प्रॉम्प्ट इंजिनिअरिंग • ग्राउंडिंग तंत्रे • मल्टी-एजंट सिस्टीम्स • उत्पादन तैनाती
...
**मुख्य विषय**: HTTP क्लायंट अंमलबजावणी • कस्टम ऑथेंटिकेशन • मॉडेल हेल्थ मॉनिटरिंग • स्ट्रीमिंग प्रतिसाद • उत्पादन त्रुटी हाताळणी
...
### [8: Windows 11 नेटिव्ह चॅट अॅप्लिकेशन](./samples/08/README.md)
**फोकस**: Foundry Local एकत्रीकरणासह आधुनिक नेटिव्ह चॅट अॅप्लिकेशन्स तयार करणे
...
**फोकस**: परिष्कृत एजंट समन्वय, विशेष कार्य प्रतिनिधी, आणि सहयोगी AI वर्कफ्लोज
...
**फोकस**: Foundry Local ला विद्यमान अॅप्लिकेशन्स आणि फ्रेमवर्कमध्ये एकत्रित करण्यासाठी टूल-प्रथम आर्किटेक्चर
...
### विकास वातावरण
- Visual Studio Code AI Toolkit एक्सटेंशनसह
- Python 3.10+ आणि pip
...
| सत्र | फोकस क्षेत्र | उदाहरणे | वेळ | गुंतागुंत |
|---------|------------|---------|------|------------|
...
|  8 | Windows 11 चॅट अॅप | 08 | 3-4 तास | प्रगत |
...
- [Microsoft AI Developer Community](https://techcommunity.microsoft.com/category/artificialintelligence) - ताज्या बातम्या आणि सर्वोत्तम पद्धती
...
- **मॉडेल्स एकत्रित करा**: Microsoft, Hugging Face, आणि समुदाय स्रोतांमधील विविध मॉडेल्ससह अखंडपणे काम करा
- **अॅप्लिकेशन्स तयार करा**: प्रगत वैशिष्ट्ये आणि ऑप्टिमायझेशन्ससह उत्पादन-तयार AI अॅप्लिकेशन्स तयार करा
...
- **एंटरप्राइझ स्केलिंग**: स्थानिक प्रोटोटाइप्सपासून एंटरप्राइझ तैनातीपर्यंत स्केल होणाऱ्या अॅप्लिकेशन्स डिझाइन करा
- **गोपनीयता आणि सुरक्षा**: स्थानिक इनफरन्ससह गोपनीयता-संरक्षण AI सोल्यूशन्स अंमलात आणा

### नवकल्पना क्षमता
- **जलद प्रोटोटायपिंग**: सर्व 10 नमुना पॅटर्न्समध्ये AI अॅप्लिकेशन संकल्पना जलद तयार आणि चाचणी करा
- **समुदाय एकत्रीकरण**: ओपन-सोर्स मॉडेल्सचा लाभ घ्या आणि इकोसिस्टममध्ये योगदान द्या
- **प्रगत पॅटर्न्स**: RAG, एजंट्स, आणि टूल्स एकत्रीकरण यासह अत्याधुनिक AI पॅटर्न्स अंमलात आणा
- **फ्रेमवर्क प्राविण्य**: LangChain, Semantic Kernel, Chainlit, आणि Electron सह तज्ज्ञ-स्तरीय एकत्रीकरण
- **उत्पादन तैनाती**: स्थानिक प्रोटोटाइप्सपासून एंटरप्राइझ सिस्टीम्सपर्यंत स्केलेबल AI सोल्यूशन्स तैनात करा
- **भविष्यातील विकासासाठी तयार**: उदयोन्मुख AI तंत्रज्ञान आणि पॅटर्न्ससाठी तयार अॅप्लिकेशन्स तयार करा

## सुरुवात करा

1. **वातावरण सेटअप**: Windows 11 शिफारस केलेल्या हार्डवेअरसह सुनिश्चित करा (पूर्वतयारी पहा)
2. **Foundry Local स्थापित करा**: संपूर्ण स्थापना आणि कॉन्फिगरेशनसाठी सत्र 1 अनुसरण करा
...
### अॅप्लिकेशन स्तर (नमुने 04-06)
- [ ] किमान 4 वेगवेगळ्या मॉडेल कुटुंबे तैनात करा आणि चालवा
- [ ] कार्यशील RAG चॅट अॅप्लिकेशन तयार करा (नमुना 04)
- [ ] मल्टी-एजंट ऑर्केस्ट्रेशन सिस्टीम तयार करा (नमुना 05)
- [ ] बुद्धिमान मॉडेल राउटिंग अंमलात आणा (नमुना 06)

### प्रगत एकत्रीकरण स्तर (नमुने 07-10)
- [ ] उत्पादन-तयार API क्लायंट तयार करा (नमुना 07)
- [ ] Windows 11 नेटिव्ह चॅट अॅप्लिकेशन विकसित करा (नमुना 08)
- [ ] प्रगत मल्टी-एजंट सिस्टीम अंमलात आणा (नमुना 09)
...
**न
हा मॉड्यूल एज एआय विकासाच्या अत्याधुनिक तंत्रज्ञानाचे प्रतिनिधित्व करतो, ज्यामध्ये Microsoft च्या एंटरप्राइझ-ग्रेड साधनांचे ओपन-सोर्स इकोसिस्टमच्या लवचिकता आणि नाविन्यपूर्णतेसह संयोजन केले आहे. Foundry Local मधील सर्व 10 व्यापक नमुन्यांद्वारे प्रावीण्य मिळवल्यास, तुम्ही एआय अनुप्रयोग विकासाच्या अग्रभागी असाल.
