...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T15:14:58+00:00",
...
या सत्रात Foundry Local च्या मदतीने मॉडेल शोध आणि व्यवस्थापनावर भर दिला आहे. तुम्ही उपलब्ध मॉडेल्स कसे यादीत दाखवायचे, विविध पर्याय कसे तपासायचे आणि मूलभूत कार्यक्षमता वैशिष्ट्ये कशी समजून घ्यायची हे शिकाल. हा दृष्टिकोन Foundry CLI च्या वापराने प्रत्यक्ष अन्वेषणावर भर देतो, ज्यामुळे तुमच्या गरजांसाठी योग्य मॉडेल्स निवडणे सोपे होते.
...
## भाग ६: प्रत्यक्ष व्यायाम

### व्यायाम: मॉडेल शोध आणि तुलना

Sample 03 च्या आधारे तुमची स्वतःची मॉडेल मूल्यांकन स्क्रिप्ट तयार करा:
...
3. **संसाधनांचे निरीक्षण करा**: मेमरी वापरावर लक्ष ठेवा
4. **सतत चाचणी करा**: निष्पक्ष तुलना करण्यासाठी समान प्रॉम्प्ट्स वापरा
...
- **[Sample 03: मॉडेल शोध](samples/03/README.md)**: प्रत्यक्ष उदाहरण स्क्रिप्ट
...
✅ **कामगिरी निरीक्षण**: मूलभूत संसाधन वापर आणि प्रतिसाद वेळ मोजमाप  
✅ **मॉडेल निवड**: उपयोग प्रकरणानुसार मॉडेल्स निवडण्यासाठी व्यावहारिक मार्गदर्शक  
✅ **कॅशे व्यवस्थापन**: स्टोरेज आणि साफसफाई प्रक्रियेची समज  

आता तुम्हाला Foundry Local च्या सोप्या CLI दृष्टिकोनाचा वापर करून तुमच्या AI अनुप्रयोगांसाठी योग्य मॉडेल्स शोधणे, चाचणी करणे आणि निवडणे यासाठी व्यावहारिक कौशल्ये प्राप्त झाली आहेत.
...
**टीप:** `--verbose` फ्लॅग तपशीलवार स्टार्टअप माहिती प्रदान करते, ज्यामध्ये:
...
- `phi-4`: अधिक सक्षम आवृत्ती, चांगल्या तर्कसंगततेसह

**मध्यम मॉडेल्स:**
- `qwen2.5-7b-instruct`: उत्कृष्ट तर्कसंगतता आणि लांब संदर्भ
- `deepseek-r1-distill-qwen-7b`: कोड जनरेशनसाठी ऑप्टिमाइझ केलेले

**मोठे मॉडेल्स:**
- `llama-3.2`: Meta चे नवीनतम ओपन-सोर्स मॉडेल
- `qwen2.5-14b-instruct`: एंटरप्राइझ-ग्रेड तर्कसंगतता
...
- डिस्क वापरावर लक्ष ठेवा, विशेषतः लहान SSD वर
- मॉडेल आकार आणि क्षमता व्यापार-ऑफ विचारात घ्या

### मॉडेल कामगिरी निरीक्षण

मॉडेल्स चालू असताना, सिस्टम संसाधने निरीक्षण करा:

**Windows Task Manager:**
- मेमरी वापर पहा (मॉडेल्स RAM मध्ये लोड राहतात)
- इनफरन्स दरम्यान CPU उपयोगावर लक्ष ठेवा
...
- अपग्रेड करा: `phi-4` (चांगले तर्कसंगतता)
- प्रगत: `qwen2.5-7b-instruct` (लांब संदर्भ)

**कोड जनरेशनसाठी:**
- शिफारस केलेले: `deepseek-r1-distill-qwen-7b`
- पर्याय: `qwen2.5-7b-instruct` (कोडसाठी देखील चांगले)

**संकटग्रस्त तर्कसंगततेसाठी:**
- सर्वोत्तम: `qwen2.5-7b-instruct` किंवा `qwen2.5-14b-instruct`
- बजेट पर्याय: `phi-4`
...
- गतीसाठी NPU समर्थन (Windows 11 Copilot+ PCs)
...
**चाचणी प्रॉम्प्ट्स:**
1. "क्वांटम संगणनाची सोप्या शब्दांत व्याख्या करा."
...
- सत्र ४ साठी तयारी करा: LLMs vs SLMs, स्थानिक vs क्लाउड इनफरन्स, आणि प्रत्यक्ष डेमो
