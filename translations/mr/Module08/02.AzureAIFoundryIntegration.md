...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T17:46:52+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "mr"
}
-->
# सत्र २: Azure AI Foundry सह AI उपाय तयार करा

## आढावा

Foundry Local च्या पायाभूत ज्ञानावर आधारित, या सत्रात प्रगत प्रॉम्प्ट इंजिनिअरिंग, अखंड डेटा एकत्रीकरण आणि कृतीशील कार्य स्वयंचलनाद्वारे परिष्कृत AI उपाय तयार करण्यावर लक्ष केंद्रित केले आहे. तुम्ही स्थानिक विकास आणि Azure AI Foundry क्षमतांमध्ये पूल तयार करणे शिकाल, ज्यामुळे एंटरप्राइझ-रेडी अनुप्रयोग तयार होतील जे दोन्ही जगातील सर्वोत्तम गोष्टींचा लाभ घेतात.

## शिकण्याची उद्दिष्टे

या सत्राच्या शेवटी, तुम्ही:
- सातत्यपूर्ण आणि विश्वासार्ह AI प्रतिसादांसाठी प्रगत प्रॉम्प्ट इंजिनिअरिंग तंत्रे आत्मसात कराल
- वास्तविक-जगातील अनुप्रयोगांसाठी मजबूत डेटा एकत्रीकरण पॅटर्न अंमलात आणाल
- व्यवसाय मूल्य वाढवणारी कृतीशील AI कार्ये तयार कराल
- Foundry Local आणि Azure AI Foundry यांच्यात अखंड कनेक्टिव्हिटी स्थापित कराल
- कार्यक्षमता निरीक्षण आणि ऑप्टिमायझेशन वर्कफ्लो तयार कराल
- योग्य त्रुटी हाताळणी आणि स्केलिंगसह उत्पादन-रेडी AI उपाय तैनात कराल

## पूर्वतयारी

- सत्र १ पूर्ण केले आहे: Foundry Local सह सुरुवात
- सक्रिय Foundry Local स्थापना चालू मॉडेल्ससह
- Azure खाते (शिकण्यासाठी मोफत स्तर पुरेसा आहे)
- REST APIs आणि JSON ची मूलभूत समज

## भाग १: प्रगत प्रॉम्प्ट इंजिनिअरिंग

### प्रॉम्प्ट आर्किटेक्चर समजून घेणे

प्रभावी प्रॉम्प्ट इंजिनिअरिंग हे विश्वासार्ह AI अनुप्रयोगांचे मूलभूत तत्त्व आहे. Foundry Local प्रगत प्रॉम्प्टिंग क्षमता प्रदान करते:
...
### प्रॅक्टिकल प्रॉम्प्ट इंजिनिअरिंग उदाहरणे
...
## भाग २: डेटा एकत्रीकरण पॅटर्न

### Foundry Local डेटा कनेक्टर्स
...
### वास्तविक-जगातील डेटा एकत्रीकरण उदाहरण
...
## भाग ३: कृतीशील AI कार्ये

### कार्य स्वयंचलन फ्रेमवर्क
...
### व्यवसाय प्रक्रिया स्वयंचलन उदाहरणे
...
## भाग ४: Azure AI Foundry एकत्रीकरण

### कनेक्टिव्हिटी स्थापित करणे
...
## भाग ५: कार्यक्षमता निरीक्षण आणि ऑप्टिमायझेशन

### सर्वसमावेशक निरीक्षण प्रणाली
...
### व्यायाम १: प्रगत ग्राहक सेवा बॉट
...
### व्यायाम २: स्वयंचलित बाजार संशोधन
...
## भाग ७: पुढील पायऱ्या आणि सत्र ३ ची पूर्वदृष्टी

### सत्रातील उपलब्धी

या सत्रात, तुम्ही आत्मसात केले आहे:
- ✅ सातत्यपूर्ण AI वर्तनासाठी प्रगत प्रॉम्प्ट इंजिनिअरिंग तंत्रे
- ✅ वास्तविक-जगातील अनुप्रयोगांसाठी मजबूत डेटा एकत्रीकरण पॅटर्न
- ✅ व्यवसाय प्रक्रिया ऑप्टिमायझेशनसाठी स्वयंचलित कार्य निर्मिती
- ✅ Azure AI Foundry एकत्रीकरण आणि हायब्रिड तैनाती धोरणे
- ✅ सर्वसमावेशक कार्यक्षमता निरीक्षण आणि ऑप्टिमायझेशन

### सत्र ३ साठी तयारी: ओपन-सोर्स मॉडेल्स

1. **Hugging Face एक्सप्लोर करा**: खाते तयार करा आणि मॉडेल कॅटलॉग ब्राउझ करा
2. **Model Mondays पुनरावलोकन करा**: नवीनतम [Model Mondays मालिका](https://aka.ms/model-mondays) तपासा
3. **कस्टम मॉडेल्सची योजना करा**: तुमच्या उपयोग प्रकरणांसाठी कोणती विशेष मॉडेल्स फायदेशीर ठरतील याचा विचार करा

### अतिरिक्त संसाधने

- [Azure AI Foundry दस्तऐवज](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Foundry Local GitHub रिपॉझिटरी](https://github.com/microsoft/Foundry-Local)
- [प्रगत प्रॉम्प्ट इंजिनिअरिंग मार्गदर्शक](https://platform.openai.com/docs/guides/prompt-engineering)
- [व्यवसाय प्रक्रिया स्वयंचलन सर्वोत्तम पद्धती](https://docs.microsoft.com/en-us/power-automate/)

आता तुम्ही स्थानिक इनफरन्सची ताकद आणि क्लाउड-स्केल क्षमता एकत्रित करणारे परिष्कृत AI उपाय तयार करण्यासाठी सज्ज आहात, ज्यामुळे एंटरप्राइझ-ग्रेड AI अनुप्रयोगांसाठी पाया तयार होतो.
