...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T15:17:23+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "mr"
}
-->
# सत्र २: OpenAI SDK चा Azure AI Foundry सोबत समाकलन

## आढावा

Foundry Local च्या पायाभूत ज्ञानावर आधारित, या सत्रात Microsoft Foundry Local आणि Azure OpenAI दोन्हींसाठी प्रगत OpenAI SDK समाकलन पद्धतींवर लक्ष केंद्रित केले आहे. तुम्ही अशा लवचिक AI अनुप्रयोगांची निर्मिती करण्याची कला आत्मसात कराल जी गोपनीयता आणि विकासासाठी स्थानिक पातळीवर चालवता येतील, तसेच आवश्यकतेनुसार Azure OpenAI च्या माध्यमातून क्लाउड स्केलेबिलिटी प्रदान करतील.

## शिकण्याची उद्दिष्टे

या सत्राच्या शेवटी, तुम्ही:
- Foundry Local आणि Azure OpenAI दोन्हींसाठी प्रगत OpenAI SDK समाकलन आत्मसात कराल
- वापरकर्ता अनुभव सुधारण्यासाठी स्ट्रीमिंग प्रतिसाद अंमलात आणाल
- बहु-प्रदाता समर्थनासाठी मजबूत क्लायंट फॅक्टरी पद्धती तयार कराल
- संदर्भ जतनासह संभाषण व्यवस्थापन प्रणाली तयार कराल
- कार्यक्षमता बेंचमार्किंग आणि आरोग्य निरीक्षण स्थापित कराल
- योग्य त्रुटी हाताळणीसह उत्पादन-तयार अनुप्रयोग तैनात कराल

## पूर्वतयारी

- सत्र १ पूर्ण केलेले: Foundry Local सह सुरुवात
- चालू मॉडेल्ससह सक्रिय Foundry Local स्थापना
- Python 3.8 किंवा त्यानंतरची आवृत्ती आणि वर्च्युअल एन्व्हायर्नमेंट क्षमता
- OpenAI Python SDK स्थापित (`pip install openai foundry-local-sdk`)
- Azure खाते OpenAI सेवेसह (क्लाउड परिस्थितीसाठी पर्यायी)
- Python async/await पद्धतींचे मूलभूत ज्ञान

## भाग १: OpenAI SDK क्लायंट फॅक्टरी पद्धती

### बहु-प्रदाता आर्किटेक्चर समजून घेणे

Foundry Local आणि Azure OpenAI दोन्हींसोबत काम करणारे अनुप्रयोग तयार करण्यासाठी लवचिक क्लायंट निर्मिती पद्धती आवश्यक आहे:
...
## भाग २: स्ट्रीमिंग प्रतिसाद आणि रिअल-टाइम संवाद

### स्ट्रीमिंग चॅट पूर्णता अंमलात आणणे

स्ट्रीमिंग वापरकर्त्याचा अनुभव सुधारते कारण प्रतिसाद तयार होत असतानाच ते दाखवले जातात:
...
## भाग ३: कार्यक्षमता बेंचमार्किंग आणि विश्लेषण

### प्रतिसाद वेळ मोजणे

वेगवेगळ्या कॉन्फिगरेशनमध्ये कार्यक्षमता मोजा आणि तुलना करा:
...
## भाग ४: सेवा आरोग्य निरीक्षण आणि निदान

### व्यापक आरोग्य तपासणी प्रणाली
...
### पर्यावरण कॉन्फिगरेशन व्हॅलिडेटर
...
## भाग ५: पर्यावरणीय व्हेरिएबल्स आणि कॉन्फिगरेशन व्यवस्थापन

### पर्यावरणीय व्हेरिएबल संदर्भ

दोन्ही प्रदात्यांसाठी कॉन्फिगरेशनसाठी संपूर्ण संदर्भ:
...
## भाग ६: हाताळणीचे व्यायाम

### व्यायाम १: बहु-प्रदाता SDK समाकलन

प्रदाता बदलण्याची क्षमता असलेला संपूर्ण अनुप्रयोग तयार करा:
...
### व्यायाम २: प्रगत संभाषण व्यवस्थापन
...
### व्यायाम ३: उत्पादन-तयार आरोग्य निरीक्षण
...
## भाग ७: सारांश आणि पुढील पावले

### सत्रातील उपलब्धी

या सत्रात, तुम्ही आत्मसात केले:
- ✅ **OpenAI SDK समाकलन**: Foundry Local आणि Azure OpenAI साठी प्रगत पद्धती
- ✅ **स्ट्रीमिंग प्रतिसाद**: वापरकर्ता अनुभव सुधारण्यासाठी रिअल-टाइम चॅट पूर्णता
- ✅ **बहु-प्रदाता समर्थन**: स्थानिक आणि क्लाउड AI सेवांमध्ये सहज बदल
- ✅ **संभाषण व्यवस्थापन**: संदर्भ-जाणून बहु-टर्न संभाषणे
- ✅ **कार्यक्षमता निरीक्षण**: उत्पादन तैनातीसाठी बेंचमार्किंग आणि आरोग्य तपासणी
- ✅ **उत्पादन पद्धती**: मजबूत त्रुटी हाताळणी आणि कॉन्फिगरेशन व्यवस्थापन

### मुख्य आर्किटेक्चरल पद्धती

**क्लायंट फॅक्टरी पद्धती:**
```
...
1. **🔄 नेहमी फॉलबॅक अंमलात आणा**: Azure → Foundry Local → त्रुटी हाताळणी
2. **🌊 लांब प्रतिसादांसाठी स्ट्रीमिंग वापरा**: चांगली कार्यक्षमता जाणवते
3. **🛡️ व्यापक त्रुटी हाताळणी अंमलात आणा**: वापरकर्त्यासाठी अनुकूल त्रुटी संदेश
4. **📈 कार्यक्षमता निरीक्षण करा**: प्रतिसाद वेळ आणि यश दर ट्रॅक करा
5. **⚙️ पर्यावरण-आधारित कॉन्फिगरेशन**: dev/staging/prod दरम्यान सहज बदल
6. **🔒 क्रेडेन्शियल व्यवस्थापन सुरक्षित करा**: API की कधीही हार्डकोड करू नका

### प्रदाता निवड मार्गदर्शक

| परिस्थिती | शिफारस केलेला प्रदाता | कारण |
|-----------|---------------------|-------|
| **विकास** | Foundry Local | जलद पुनरावृत्ती, कोणतेही API खर्च नाहीत |
| **गोपनीयता-अत्यावश्यक** | Foundry Local | डेटा कधीही डिव्हाइस सोडत नाही |
| **उच्च-खंड उत्पादन** | Azure OpenAI | चांगले स्केलिंग, एंटरप्राइझ SLA |
| **नवीनतम मॉडेल्स** | Azure OpenAI | नवीनतम मॉडेल्ससाठी प्रवेश |
| **ऑफलाइन आवश्यकता** | Foundry Local | इंटरनेट अवलंबित्व नाही |
| **खर्च-संवेदनशील** | Foundry Local | प्रति-टोकन शुल्क नाही |

### पर्यावरणीय व्हेरिएबल्स जलद संदर्भ
...
### सत्र ३ साठी तयारी: ओपन-सोर्स मॉडेल्स

1. **मॉडेल कॅटलॉग एक्सप्लोर करा**: Foundry Local मधील उपलब्ध मॉडेल्सचा आढावा घ्या
2. **मॉडेल स्वरूप समजून घ्या**: ONNX, क्वांटायझेशन आणि ऑप्टिमायझेशन बद्दल जाणून घ्या
3. **कस्टम मॉडेल्स विचारात घ्या**: डोमेन-विशिष्ट मॉडेल आवश्यकता विचारात घ्या

### समस्या निवारण जलद मार्गदर्शक
...
- **[OpenAI Python SDK दस्तऐवज](https://github.com/openai/openai-python)**: अधिकृत SDK संदर्भ
- **[Azure OpenAI दस्तऐवज](https://learn.microsoft.com/azure/ai-services/openai/)**: Azure OpenAI सेवा मार्गदर्शक
- **[Foundry Local SDK संदर्भ](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: स्थानिक अनुमान दस्तऐवज
- **[स्ट्रीमिंग पूर्णता मार्गदर्शक](https://learn.microsoft.com/azure/ai-foundry/foundry-local/how-to/integrate-with-inference-sdks)**: प्रगत स्ट्रीमिंग पद्धती
- **[नमूना ०१: OpenAI SDK च्या माध्यमातून जलद चॅट](samples/01/README.md)**: मूलभूत समाकलन पद्धती
- **[नमूना ०२: प्रगत SDK समाकलन](samples/02/README.md)**: या सत्रातील हाताळणीचे उदाहरण
- **[नमूना ०४: Chainlit अनुप्रयोग](samples/04/README.md)**: वेब UI विकास
- **[नमूना ०५: बहु-एजंट प्रणाली](samples/05/README.md)**: प्रगत ऑर्केस्ट्रेशन पद्धती

आता तुम्ही स्थानिक आणि क्लाउड AI क्षमता सहजपणे समाकलित करणारे प्रगत AI अनुप्रयोग तयार करण्यासाठी सज्ज आहात, प्रत्येक विशिष्ट उपयोग प्रकरणासाठी योग्य प्रदाता निवडण्याची लवचिकता प्रदान करताना सुसंगत विकास पद्धती राखून.
