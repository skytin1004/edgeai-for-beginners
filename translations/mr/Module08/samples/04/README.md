...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T15:18:09+00:00",
...
Microsoft Foundry Local वापरून उत्पादन-तयार चॅट अनुप्रयोग तयार करण्यासाठी विविध दृष्टिकोन दाखवणारा एक व्यापक नमुना, ज्यामध्ये आधुनिक वेब इंटरफेस, स्ट्रीमिंग प्रतिसाद आणि अत्याधुनिक ब्राउझर तंत्रज्ञान समाविष्ट आहे.

## काय समाविष्ट आहे

- **🚀 Chainlit Chat App** (`app.py`): स्ट्रीमिंगसह उत्पादन-तयार चॅट अनुप्रयोग
- **🌐 WebGPU Demo** (`webgpu-demo/`): हार्डवेअर प्रवेगासह ब्राउझर-आधारित AI अनुमान
- **🎨 Open WebUI Integration** (`open-webui-guide.md`): व्यावसायिक ChatGPT-सारखा इंटरफेस
...
### स्थानिक vs क्लाउड निर्णय मॅट्रिक्स

| परिस्थिती | शिफारस | कारण |
|-----------|---------|-------|
| **गोपनीयतेसाठी संवेदनशील डेटा** | 🏠 स्थानिक (Foundry) | डेटा कधीही डिव्हाइस सोडत नाही |
...
| **संशोधन कार्ये** | ☁️ क्लाउड (Azure OpenAI) | विस्तृत ज्ञान बेस आवश्यक |

### तंत्रज्ञान तुलना

| तंत्रज्ञान | वापर प्रकरण | फायदे | तोटे |
|------------|-------------|-------|------|
...
- **Python**: 3.10+ सह वर्च्युअल वातावरण
...
- 🐳 **Docker तैनाती**: उत्पादन-तयार कंटेनराइज्ड सेटअप
...
- पुनरावृत्ती प्रश्नांसाठी मॉडेल प्रतिसाद कॅश करा
...
- वापरकर्ता डेटासाठी बॅकअप रणनीती अंमलात आणा
...
- [`webgpu-demo/`](../../../../../Module08/samples/04/webgpu-demo) - ब्राउझर-आधारित AI अनुमान
