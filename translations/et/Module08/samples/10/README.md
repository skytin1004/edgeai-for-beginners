...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T13:00:42+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "et"
}
-->
# Foundry Local kui tööriistade integreerimine

Põhjalik raamistik Microsoft Foundry Locali integreerimiseks suuremate rakenduste osana, järgides Microsofti ametlikke mustreid tööriistapõhise AI integreerimise jaoks.

## Ülevaade

See näidis näitab, kuidas muuta Foundry Locali mudelid taaskasutatavateks tööriistadeks, mida saab integreerida olemasolevatesse rakendustesse, töövoogudesse ja arenduskeskkondadesse. Näidis tutvustab Microsofti soovitatud mustreid tööriistade integreerimiseks ja funktsioonide kutsumiseks.

## Põhimõisted

### 🔧 **Tööriistapõhine arhitektuur**
- Foundry Locali mudelid kui kutsutavad funktsioonid
- Standardiseeritud tööriistaliidesed ja skeemid
- Sujuv integreerimine olemasolevatesse koodibaasidesse
- Tüübikindlad tööriistade määratlused ja valideerimine

### ⚡ **Funktsioonide kutsumise mustrid**
- Microsoft Foundry Locali funktsioonide kutsumise rakendamine
- OpenAI-ga ühilduvad tööriistade määratlused
- Automaatne parameetrite valideerimine ja teisendamine
- Vigade käsitlemine ja vastuste vormindamine

### 🔌 **Integreerimisraamistikud**
- **LangChaini integreerimine**: Native LangChaini tööriistade tugi
- **Semantic Kernel**: Microsoft Semantic Kernel funktsioonid
- **REST API**: HTTP-põhised tööriistade lõpp-punktid
- **CLI tööriistad**: Käsurea liidese integreerimine
- **Jupyter Notebookid**: Interaktiivsed arendustööriistad

### 🎯 **Kasutusmustrid**
- Koodi analüüsi ja genereerimise tööriistad
- Sisu töötlemine ja kokkuvõtete loomine
- Andmete analüüs ja visualiseerimine
- Uurimistöö ja teabeotsing
- Otsustustoe süsteemid
...
- **Node.js**: v18+ (JavaScripti integreerimiseks)
- **Mälu**: Soovitatavalt 12GB+
- **Salvestusruum**: 10GB+ mudelite ja tööriistade jaoks
...
### Raamistikuspetsiifilised komponendid
```bash
...
## Põhilised tööriistamustrid

### 1. Funktsioonipõhised tööriistad
```python
...
### Semantic Kernel integreerimine
```python
...
### 2. Kontekstitundlikud tööriistad
```python
...
Pärast selle näidise läbimist mõistate:

1. **Tööriistade integreerimise mustrid**
   - Funktsioonipõhine ja klassipõhine tööriistade disain
   - Microsoft Foundry Locali integreerimise mustrid
   - Skeemi valideerimine ja tüübikindlus
   - Vigade käsitlemine ja taastamine

2. **Raamistiku integreerimine**
   - LangChaini tööriistade arendus
   - Semantic Kernel funktsioonide integreerimine
   - REST API raamistiku integreerimine
   - CLI rakenduste arendus

3. **Tootmiskaalutlused**
   - Jõudluse optimeerimise strateegiad
   - Vahemälu ja ressursside haldamine
   - Jälgimine ja nähtavus
   - Turvalisus ja valideerimine

4. **Täiustatud tööriistamustrid**
   - Tööriistade koostamine ja ahelad
   - Kontekstitundlik töötlemine
   - Partii- ja voogedastustoimingud
   - Kohandatud integreerimise arendus

## Järgmised sammud

- **Integreerimisprojektid**: Looge kohandatud integreerimisi oma eelistatud raamistikuga
- **Tööriistade arendus**: Looge spetsialiseeritud tööriistu oma valdkonna jaoks
- **Jõudluse häälestamine**: Optimeerige oma konkreetsete kasutusjuhtude jaoks
- **Tootmise juurutamine**: Skaleerige tööriistad ettevõtte tasemel kasutamiseks

## Kaastöö

Vaadake peamise repositooriumi juhiseid kaastöö tegemiseks.
