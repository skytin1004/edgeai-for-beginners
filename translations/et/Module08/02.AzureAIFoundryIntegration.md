...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T12:51:24+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "et"
}
-->
# Sessioon 2: OpenAI SDK integreerimine Azure AI Foundryga

## Ülevaade

Tuginedes teie Foundry Locali baasile, keskendub see sessioon edasijõudnud OpenAI SDK integreerimismustritele, mis toetavad sujuvalt nii Microsoft Foundry Locali kui ka Azure OpenAI-d. Õpite looma paindlikke AI-rakendusi, mis töötavad lokaalselt privaatsuse ja arenduse jaoks, pakkudes samal ajal pilve skaleeritavust Azure OpenAI kaudu, kui seda vajatakse.

## Õpieesmärgid

Sessiooni lõpuks oskate:
- Valdada edasijõudnud OpenAI SDK integreerimist nii Foundry Locali kui ka Azure OpenAI-ga
- Rakendada voogesituse vastuseid kasutajakogemuse parandamiseks
- Luua tugevaid klienditehase mustreid mitme teenusepakkuja toetamiseks
- Ehita vestluse haldussüsteeme konteksti säilitamisega
- Kehtestada jõudluse võrdlusuuringud ja tervise jälgimine
- Juurutada tootmisvalmis rakendusi koos korrektse veakäsitlusega

## Eeltingimused

- Lõpetatud sessioon 1: Foundry Locali alustamine
- Aktiivne Foundry Locali installatsioon töötavate mudelitega
- Python 3.8 või uuem koos virtuaalse keskkonna võimalusega
- OpenAI Python SDK paigaldatud (`pip install openai foundry-local-sdk`)
- Azure'i konto koos OpenAI teenusega (valikuline, pilves kasutamiseks)
- Põhiline arusaam Python async/await mustritest

## Osa 1: OpenAI SDK klienditehase muster

### Mitme teenusepakkuja arhitektuuri mõistmine

Rakenduste loomine, mis töötavad nii Foundry Locali kui ka Azure OpenAI-ga, nõuab paindlikku kliendi loomise mustrit:
...
## Osa 2: Voogesituse vastused ja reaalajas interaktsioon

### Voogesituse vestluse lõpetamiste rakendamine

Voogesitus pakub paremat kasutajakogemust, näidates vastuseid nende genereerimise ajal:
...
### Mitme pöörde vestluse haldamine
...
## Osa 3: Jõudluse võrdlusuuringud ja analüüs

### Vastuse aja mõõtmine

Mõõtke ja võrrelge jõudlust erinevates konfiguratsioonides:
...
### Temperatuuri ja parameetrite testimine
...
## Osa 4: Teenuse tervise jälgimine ja diagnostika

### Põhjalik tervisekontrolli süsteem
...
### Keskkonna konfiguratsiooni valideerija
...
## Osa 5: Keskkonnamuutujad ja konfiguratsiooni haldamine

### Keskkonnamuutujate viide

Täielik viide mõlema teenusepakkuja konfigureerimiseks:
...
## Osa 6: Praktilised harjutused

### Harjutus 1: Mitme teenusepakkuja SDK integreerimine

Looge täielik rakendus, mis sujuvalt vahetab teenusepakkujaid:
...
### Harjutus 2: Edasijõudnud vestluse haldamine
...
### Harjutus 3: Tootmisvalmis tervise jälgimine
...
## Osa 7: Kokkuvõte ja järgmised sammud

### Sessiooni saavutused

Selles sessioonis olete omandanud:
- ✅ **OpenAI SDK integreerimine**: Edasijõudnud mustrid nii Foundry Locali kui ka Azure OpenAI jaoks
- ✅ **Voogesituse vastused**: Reaalajas vestluse lõpetamised kasutajakogemuse parandamiseks
- ✅ **Mitme teenusepakkuja tugi**: Sujuv vahetamine lokaalse ja pilve AI teenuste vahel
- ✅ **Vestluse haldamine**: Kontekstitundlikud mitme pöörde vestlused
- ✅ **Jõudluse jälgimine**: Võrdlusuuringud ja tervisekontroll tootmisjuurutuste jaoks
- ✅ **Tootmismustrid**: Tugev veakäsitlus ja konfiguratsiooni haldamine

### Peamised arhitektuurimustrid

**Klienditehase muster:**
```
...
1. **🔄 Alati rakendage varuplaanid**: Azure → Foundry Local → Veakäsitlus
2. **🌊 Kasutage voogesitust pikkade vastuste jaoks**: Parem tajutav jõudlus
3. **🛡️ Rakendage põhjalik veakäsitlus**: Kasutajasõbralikud veateated
4. **📈 Jälgige jõudlust**: Jälgige vastuse aegu ja edukuse määrasid
5. **⚙️ Keskkonnapõhine konfiguratsioon**: Lihtne vahetamine arendus-/test-/tootmiskeskkondade vahel
6. **🔒 Turvaline mandaadi haldamine**: Ärge kunagi kodeerige API võtmeid

### Teenusepakkuja valiku juhised

| Stsenaarium | Soovitatav teenusepakkuja | Põhjendus |
|------------|--------------------------|-----------|
| **Arendus** | Foundry Local | Kiire iteratsioon, puuduvad API kulud |
| **Privaatsuskriitiline** | Foundry Local | Andmed ei lahku seadmest |
| **Suuremahuline tootmine** | Azure OpenAI | Parem skaleerimine, ettevõtte SLA |
| **Uusimad mudelid** | Azure OpenAI | Juurdepääs uusimatele mudeliversioonidele |
| **Võrguta nõuded** | Foundry Local | Pole interneti sõltuvust |
| **Kulutundlik** | Foundry Local | Pole tokenipõhiseid tasusid |

### Keskkonnamuutujate kiire viide
...
### Ettevalmistus sessiooniks 3: Avatud lähtekoodiga mudelid

1. **Uurige mudelikataloogi**: Vaadake saadaval olevaid mudeleid Foundry Localis
2. **Mõistke mudeliformaate**: Õppige ONNX-i, kvantiseerimise ja optimeerimise kohta
3. **Mõelge kohandatud mudelitele**: Mõelge valdkonnaspetsiifiliste mudelite vajadustele

### Kiirjuhend tõrkeotsinguks
...
- **[OpenAI Python SDK dokumentatsioon](https://github.com/openai/openai-python)**: Ametlik SDK viide
- **[Azure OpenAI dokumentatsioon](https://learn.microsoft.com/azure/ai-services/openai/)**: Azure OpenAI teenuse juhend
- **[Foundry Local SDK viide](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Lokaalse järelduse dokumentatsioon
- **[Voogesituse lõpetamiste juhend](https://learn.microsoft.com/azure/ai-foundry/foundry-local/how-to/integrate-with-inference-sdks)**: Edasijõudnud voogesituse mustrid
- **[Näidis 01: Kiire vestlus OpenAI SDK kaudu](samples/01/README.md)**: Põhilised integreerimismustrid
- **[Näidis 02: Edasijõudnud SDK integreerimine](samples/02/README.md)**: Selle sessiooni praktilised näited
- **[Näidis 04: Chainlit rakendus](samples/04/README.md)**: Veebi kasutajaliidese arendus
- **[Näidis 05: Mitme agendi süsteemid](samples/05/README.md)**: Edasijõudnud orkestreerimismustrid

Olete nüüd valmis looma keerukaid AI-rakendusi, mis integreerivad sujuvalt lokaalse ja pilve AI võimekuse, pakkudes paindlikkust valida iga konkreetse kasutusjuhtumi jaoks sobiv teenusepakkuja, säilitades samal ajal järjepidevad arendusmustrid.
