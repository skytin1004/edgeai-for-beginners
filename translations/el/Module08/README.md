...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T22:27:25+00:00",
...
**Κύρια Θέματα**: Πλήρης εγκατάσταση • Εντολές CLI • Προσωρινή αποθήκευση μοντέλων • Επιτάχυνση υλικού • Ανάπτυξη πολλαπλών μοντέλων

**Δείγμα**: [Γρήγορη εκκίνηση REST Chat](./samples/01/README.md) • [Ενσωμάτωση OpenAI SDK](./samples/02/README.md) • [Ανακάλυψη & αξιολόγηση μοντέλων](./samples/03/README.md)
...
**Κύρια Θέματα**: Μηχανική προτροπών • Ενσωμάτωση δεδομένων • Ροές εργασίας Azure • Βελτιστοποίηση απόδοσης • Παρακολούθηση
...
**Κύρια Θέματα**: Ενσωμάτωση Hugging Face • Φέρε το δικό σου μοντέλο • Insights από το Model Mondays • Συνεισφορές κοινότητας • Επιλογή μοντέλων
...
### [4: Εξερεύνηση Μοντέλων Αιχμής](./04.CuttingEdgeModels.md)
**Εστίαση**: LLMs vs SLMs, υλοποίηση EdgeAI και προηγμένα demos

**Κύρια Θέματα**: Σύγκριση μοντέλων • Πρόβλεψη edge vs cloud • Phi + ONNX Runtime • Εφαρμογή Chainlit RAG • Βελτιστοποίηση WebGPU
...
**Κύρια Θέματα**: Σχεδιαστικά πρότυπα πρακτόρων • Μηχανική προτροπών συστήματος • Τεχνικές θεμελίωσης • Συστήματα πολλαπλών πρακτόρων • Ανάπτυξη παραγωγής
...
**Κύρια Θέματα**: Μοντέλα ως εργαλεία • Τοπική ανάπτυξη • Ενσωμάτωση SDK/API • Αρχιτεκτονικές επιχείρησης • Στρατηγικές κλιμάκωσης
...
**Κύρια Θέματα**: Υλοποίηση πελάτη HTTP • Προσαρμοσμένος έλεγχος ταυτότητας • Παρακολούθηση υγείας μοντέλων • Ροές απαντήσεων • Χειρισμός σφαλμάτων παραγωγής
...
**Κύρια Θέματα**: Ανάπτυξη με Electron • Σύστημα Fluent Design • Ενσωμάτωση Windows • Ροές πραγματικού χρόνου • Σχεδιασμός διεπαφής συνομιλίας
...
**Κύρια Θέματα**: Συντονισμός έξυπνων πρακτόρων • Πρότυπα κλήσης λειτουργιών • Επικοινωνία μεταξύ πρακτόρων • Ορχήστρωση ροών εργασίας • Μηχανισμοί διασφάλισης ποιότητας
...
**Κύρια Θέματα**: Ενσωμάτωση LangChain • Λειτουργίες Semantic Kernel • Πλαίσια REST API • Εργαλεία CLI • Ενσωμάτωση Jupyter • Πρότυπα ανάπτυξης παραγωγής
...
1. **Ρύθμιση Περιβάλλοντος**: Εξασφαλίστε Windows 11 με το συνιστώμενο υλικό (δείτε τα Προαπαιτούμενα)
...
- [ ] Υλοποίηση συμβατότητας OpenAI SDK (Δείγμα
Αυτό το module αντιπροσωπεύει την αιχμή της ανάπτυξης edge AI, συνδυάζοντας τα εργαλεία επιχειρηματικής κλάσης της Microsoft με την ευελιξία και την καινοτομία του οικοσυστήματος ανοιχτού κώδικα. Με την πλήρη κατανόηση του Foundry Local μέσω των 10 ολοκληρωμένων παραδειγμάτων, θα βρεθείτε στην πρώτη γραμμή της ανάπτυξης εφαρμογών AI.
