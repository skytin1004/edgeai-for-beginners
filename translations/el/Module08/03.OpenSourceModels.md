...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-01T00:24:23+00:00",
...
- Κατανόηση των μοτίβων προσωρινής αποθήκευσης και τοπικής αποθήκευσης μοντέλων
...
- Εξερεύνηση του αυξανόμενου οικοσυστήματος μοντέλων που είναι διαθέσιμα μέσω του Foundry Local
...
Αυτή η συνεδρία εξερευνά πώς να φέρετε μοντέλα ανοιχτού κώδικα στο Foundry Local.
...
3. **Συγκρίνετε την απόδοση**: Σημειώστε τις διαφορές στην ταχύτητα και την ποιότητα των απαντήσεων
4. **Καταγράψτε ευρήματα**: Δημιουργήστε ένα απλό διάγραμμα σύγκρισης
...
**Αργή Απόδοση:**
- Βεβαιωθείτε ότι το μοντέλο έχει φορτωθεί πλήρως (ελέγξτε την λεπτομερή έξοδο)
...
5. **Καταγράψτε Αποτελέσματα**: Κρατήστε σημειώσεις για την απόδοση των μοντέλων για τις περιπτώσεις χρήσης σας
...
- **[Sample 03: Model Discovery](samples/03/README.md)**: Παράδειγμα πρακτικού σεναρίου
...
✅ **Παρακολούθηση Απόδοσης**: Βασική χρήση πόρων και μέτρηση χρόνου απόκρισης  
...
- Διαχειριστείτε μοντέλα τοπικά με προσωρινή αποθήκευση και εκδόσεις
...
- `qwen2.5-14b`: Λογική επιπέδου επιχείρησης
...
## Μέρος 3: Διαχείριση Cache και Αποθήκευσης Μοντέλων

### Κατανόηση της Cache Μοντέλων

Το Foundry Local διαχειρίζεται αυτόματα τις λήψεις και την προσωρινή αποθήκευση μοντέλων:
...
- Παρακολουθήστε τη χρήση δίσκου, ειδικά σε μικρότερους SSD
- Εξετάστε το μέγεθος του μοντέλου σε σχέση με τις δυνατότητες
...
- Παρακολουθήστε τη χρήση CPU κατά την επεξεργασία
...
- Εναλλακτική: `qwen2.5-7b` (επίσης καλό για κώδικα)

**Για Σύνθετη Λογική:**
- Καλύτερο: `qwen2.5-7b` ή `qwen2.5-14b`
...
- Σύγχρονος επεξεργαστής με καλή απόδοση μονονημάτων
...
- **Σαφήνεια**: Είναι η εξήγηση εύκολα κατανοητή;
- **Πληρότητα**: Αντιμετωπίζει πλήρως την ερώτηση;
