...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T22:25:35+00:00",
...
1. **Διακλαδώστε το Αποθετήριο**: Πατήστε [![Διακλαδώσεις στο GitHub](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)  
...
- **Μικρότερο αποτύπωμα μνήμης**: Αποτελεσματική χρήση της περιορισμένης μνήμης των συσκευών edge
- **Μικρότερη ανάγκη για υπολογιστική ισχύ**: Βελτιστοποιημένα για απόδοση σε CPU και edge GPU
...
| [⚙️ 04](../../Module04) | [Εργαλειοθήκη Βελτιστοποίησης Μοντέλων](./Module04/README.md) | Βελτιστοποίηση σε πολλαπλές πλατφόρμες | Εισαγωγή • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Σύνθεση Ροής Εργασίας | Μεσαίο | 5-6 ώρες |
| [🔧 05](../../Module05) | [SLMOps Παραγωγής](./Module05/README.md) | Λειτουργίες παραγωγής | Εισαγωγή SLMOps • Απόσταξη Μοντέλων • Fine-tuning • Ανάπτυξη Παραγωγής | Προχωρημένο | 5-6 ώρες |
...
- [08: Εφαρμογή Chat για Windows 11](./Module08/samples/08/README.md)  
...
### 🏗️ Πρακτικά Έργα
- **Εφαρμογές Chat Foundry Local**: Εφαρμογή Windows 11 με δυνατότητα εναλλαγής μοντέλων  
...
- **Δρομολογητές Μοντέλων**: Έξυπνη επιλογή
**Τεχνικοί Ρόλοι**: EdgeAI Solutions Architect • ML Engineer (Edge) • IoT AI Developer • Mobile AI Developer

**Βιομηχανικοί Τομείς**: Βιομηχανία 4.0 • Τεχνολογία Υγείας • Αυτόνομα Συστήματα • FinTech • Καταναλωτικά Ηλεκτρονικά

**Έργα Portfolio**: Πολυ-πρακτορικά συστήματα • Εφαρμογές RAG παραγωγής • Ανάπτυξη σε πολλαπλές πλατφόρμες • Βελτιστοποίηση απόδοσης
...
✅ **Προοδευτική Μάθηση**: Θεωρία → Πρακτική → Ανάπτυξη σε παραγωγή  
✅ **Πραγματικές Μελέτες Περίπτωσης**: Microsoft, Japan Airlines, εταιρικές υλοποιήσεις  
✅ **Δείγματα Εφαρμογών**: 50+ παραδείγματα, 10 ολοκληρωμένα demos Foundry Local  
✅ **Εστίαση στην Απόδοση**: 85% βελτίωση ταχύτητας, 75% μείωση μεγέθους  
✅ **Πολλαπλές Πλατφόρμες**: Windows, κινητά, ενσωματωμένα συστήματα, υβριδικό cloud-edge  
