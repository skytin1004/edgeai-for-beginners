...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-09T12:31:42+00:00",
...
[![Αιτήματα συγχώνευσης στο GitHub](https://img.shields.io/github/issues-pr/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/pulls)
...
Καλώς ήρθατε στο **EdgeAI για Αρχάριους** – το ολοκληρωμένο σας ταξίδι στον μετασχηματιστικό κόσμο της Τεχνητής Νοημοσύνης στο Edge. Αυτό το μάθημα γεφυρώνει το χάσμα μεταξύ ισχυρών δυνατοτήτων AI και πρακτικής, πραγματικής εφαρμογής σε edge συσκευές, δίνοντάς σας τη δυνατότητα να αξιοποιήσετε την AI απευθείας εκεί όπου δημιουργούνται τα δεδομένα και λαμβάνονται οι αποφάσεις.
...
- **Απόδοση σε πραγματικό χρόνο**: Εξάλειψη της καθυστέρησης δικτύου για εφαρμογές κρίσιμες για τον χρόνο
...
Το Edge AI αναφέρεται στην εκτέλεση αλγορίθμων AI και γλωσσικών μοντέλων τοπικά σε υλικό, κοντά στο σημείο όπου δημιουργούνται τα δεδομένα, χωρίς να βασίζεται σε πόρους cloud για inference. Μειώνει την καθυστέρηση, ενισχύει την ιδιωτικότητα και επιτρέπει τη λήψη αποφάσεων σε πραγματικό χρόνο.

### Βασικές Αρχές:
- **Inference στη συσκευή**: Τα μοντέλα AI εκτελούνται σε edge συσκευές (τηλέφωνα, routers, μικροελεγκτές, βιομηχανικοί υπολογιστές)
...
- **Μειωμένο αποτύπωμα μνήμης**: Αποτελεσματική χρήση της περιορισμένης μνήμης edge συσκευών
- **Χαμηλότερες απαιτήσεις υπολογισμού**: Βελτιστοποιημένα για απόδοση σε CPU και edge GPU
...
| [🚀 03](../../Module03) | [Πρακτική Ανάπτυξη SLM](./Module03/README.md) | Τοπική & cloud ανάπτυξη | Προχωρημένη Μάθηση • Τοπικό Περιβάλλον • Ανάπτυξη στο Cloud | Μεσαίο | 4-5 ώρες |
...
| [💻 07](../../Module07) | [Υλοποίηση Πλατφόρμας](./Module07/README.md) | Δείγματα για διάφορες πλατφόρμες | Εργαλειοθήκη AI • Foundry Local • Ανάπτυξη Windows | Προχωρημένο | 3-4 ώρες |
...
- **Jupyter Notebooks** (8 διαδραστικά) - Βήμα προς βήμα σεμινάρια με benchmarks και παρακολούθηση απόδοσης
...
- Εργαλεία benchmarking και σύγκρισης πολλαπλών μοντέλων
- Συστήματα ορχήστρωσης πολλαπλών πρακτόρων
- Ευφυή δρομολόγηση μοντέλων με επιλογή βάσει εργασιών

### 📊 **Περίληψη Διαδρομής Μάθησης**
- **Συνολική Διάρκεια**: 36-45 ώρες
- **Διαδρομή Αρχαρίων**: Ενότητες 01-02 (7-9 ώρες)  
- **Διαδρομή Μεσαίου Επιπέδου**: Ενότητες 03-04 (
- **Δρομολογητές Μοντέλων**: Έξυπνη επιλογή μεταξύ μοντέλων βάσει ανάλυσης εργασιών  
- **Πλαίσια API**: Έτοιμοι για παραγωγή πελάτες με streaming και παρακολούθηση υγείας  
- **Εργαλεία Δια-Πλατφόρμας**: Πρότυπα ενσωμάτωσης LangChain/Semantic Kernel  
...
0. **📖 Εισαγωγή** ([Introduction.md](./introduction.md)): Βασικά στοιχεία EdgeAI + βιομηχανικό πλαίσιο + πλαίσιο μάθησης  
1. **📚 Θεμέλια** (Ενότητες 01-02): Έννοιες EdgeAI + οικογένειες μοντέλων SLM  
2. **⚙️ Βελτιστοποίηση** (Ενότητες 03-04): Ανάπτυξη + πλαίσια ποσοτικοποίησης  
3. **🚀 Παραγωγή** (Ενότητες 05-06): SLMOps + πράκτορες AI + κλήση λειτουργιών  
...
**Έργα Χαρτοφυλακίου**: Συστήματα πολλαπλών πρακτόρων • Εφαρμογές RAG παραγωγής • Δια-πλατφόρμα ανάπτυξη • Βελτιστοποίηση απόδοσης  
