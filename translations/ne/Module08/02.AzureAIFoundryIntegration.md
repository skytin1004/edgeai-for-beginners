...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T17:47:05+00:00",
...
Foundry Local को आधारमा निर्माण गर्दै, यो सत्रले उन्नत प्रम्प्ट इन्जिनियरिङ, सहज डेटा एकीकरण, र कार्यात्मक स्वचालन मार्फत परिष्कृत AI समाधानहरू सिर्जना गर्न केन्द्रित छ। तपाईंले स्थानीय विकासलाई Azure AI Foundry क्षमतासँग जोड्न सिक्नुहुनेछ, जसले दुवै पक्षको उत्कृष्टता प्रयोग गरेर उद्यम-तयार अनुप्रयोगहरू सिर्जना गर्दछ।

## सिकाइ उद्देश्यहरू

यो सत्रको अन्त्यसम्ममा, तपाईं:
- स्थिर र भरपर्दो AI प्रतिक्रिया सुनिश्चित गर्न उन्नत प्रम्प्ट इन्जिनियरिङ प्रविधिहरूमा निपुण हुनुहुनेछ
- वास्तविक संसारका अनुप्रयोगहरूको लागि बलियो डेटा एकीकरण ढाँचाहरू कार्यान्वयन गर्नुहुनेछ
- व्यवसायिक मूल्य प्रदान गर्ने कार्यात्मक AI कार्यहरू सिर्जना गर्नुहुनेछ
- Foundry Local र Azure AI Foundry बीच सहज कनेक्टिविटी स्थापना गर्नुहुनेछ
- प्रदर्शन अनुगमन र अनुकूलन कार्यप्रवाह निर्माण गर्नुहुनेछ
- त्रुटि व्यवस्थापन र स्केलिङको साथ उत्पादन-तयार AI समाधानहरू तैनात गर्नुहुनेछ

## पूर्वशर्तहरू

- सत्र १: Foundry Local सुरु गर्ने पूरा गरिसक्नुभएको छ
- चलिरहेको मोडेलहरूसँग सक्रिय Foundry Local स्थापना
- Azure खाता (सिकाइको लागि निःशुल्क स्तर पर्याप्त छ)
- REST APIs र JSON को आधारभूत समझ

## भाग १: उन्नत प्रम्प्ट इन्जिनियरिङ

### प्रम्प्ट आर्किटेक्चर बुझ्दै

प्रभावकारी प्रम्प्ट इन्जिनियरिङ भरपर्दो AI अनुप्रयोगहरूको आधार हो। Foundry Local ले उन्नत प्रम्प्टिङ क्षमताहरू प्रदान गर्दछ:
...
### प्रम्प्ट रणनीतिहरू कार्यान्वयन गर्दै
...
### व्यावहारिक प्रम्प्ट इन्जिनियरिङ उदाहरणहरू
...
## भाग २: डेटा एकीकरण ढाँचाहरू

### Foundry Local डेटा कनेक्टरहरू
...
### वास्तविक संसार डेटा एकीकरण उदाहरण
...
## भाग ३: कार्यात्मक AI कार्यहरू

### कार्य स्वचालन फ्रेमवर्क
...
### व्यवसायिक प्रक्रिया स्वचालन उदाहरणहरू
...
## भाग ४: Azure AI Foundry एकीकरण

### कनेक्टिविटी स्थापना गर्दै
...
## भाग ५: प्रदर्शन अनुगमन र अनुकूलन

### व्यापक अनुगमन प्रणाली
...
### अभ्यास १: उन्नत ग्राहक सेवा बोट
...
### अभ्यास २: स्वचालित बजार अनुसन्धान
...
## भाग ७: आगामी चरणहरू र सत्र ३ पूर्वावलोकन

### सत्र उपलब्धिहरू

यस सत्रमा, तपाईंले निपुणता हासिल गर्नुभएको छ:
- ✅ स्थिर AI व्यवहारको लागि उन्नत प्रम्प्ट इन्जिनियरिङ प्रविधिहरू
- ✅ वास्तविक संसारका अनुप्रयोगहरूको लागि बलियो डेटा एकीकरण ढाँचाहरू
- ✅ व्यवसायिक प्रक्रिया अनुकूलनको लागि स्वचालित कार्य सिर्जना
- ✅ Azure AI Foundry एकीकरण र हाइब्रिड तैनाती रणनीतिहरू
- ✅ व्यापक प्रदर्शन अनुगमन र अनुकूलन

### सत्र ३ को तयारी: ओपन-सोर्स मोडेलहरू

1. **Hugging Face अन्वेषण गर्नुहोस्**: खाता सिर्जना गर्नुहोस् र मोडेल क्याटलग ब्राउज गर्नुहोस्
2. **Model Mondays समीक्षा गर्नुहोस्**: पछिल्लो [Model Mondays श्रृंखला](https://aka.ms/model-mondays) हेर्नुहोस्
3. **कस्टम मोडेल योजना गर्नुहोस्**: तपाईंको प्रयोगका केसहरूलाई फाइदा पुर्‍याउने विशेष मोडेलहरू विचार गर्नुहोस्

### थप स्रोतहरू

- [Azure AI Foundry दस्तावेज](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Foundry Local GitHub रिपोजिटरी](https://github.com/microsoft/Foundry-Local)
- [उन्नत प्रम्प्ट इन्जिनियरिङ गाइड](https://platform.openai.com/docs/guides/prompt-engineering)
- [व्यवसायिक प्रक्रिया स्वचालन उत्कृष्ट अभ्यासहरू](https://docs.microsoft.com/en-us/power-automate/)

अब तपाईं स्थानीय इनफरेन्सको शक्ति र क्लाउड-स्केल क्षमताहरू संयोजन गर्ने परिष्कृत AI समाधानहरू निर्माण गर्न तयार हुनुहुन्छ, जसले उद्यम-ग्रेड AI अनुप्रयोगहरूको आधार तयार गर्दछ।
