...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T01:16:38+00:00",
...
Nadovezujući se na temelje Foundry Local, ova sesija usmjerena je na stvaranje naprednih AI rješenja kroz napredno oblikovanje upita, besprijekornu integraciju podataka i automatizaciju zadataka koji donose rezultate. Naučit ćete kako povezati lokalni razvoj s mogućnostima Azure AI Foundry, stvarajući aplikacije spremne za poslovanje koje koriste najbolje od oba svijeta.

## Ciljevi učenja

Do kraja ove sesije, naučit ćete:
- Ovladati naprednim tehnikama oblikovanja upita za dosljedne i pouzdane AI odgovore
- Implementirati robusne obrasce integracije podataka za stvarne aplikacije
- Kreirati AI zadatke koji donose poslovnu vrijednost
- Uspostaviti besprijekornu povezanost između Foundry Local i Azure AI Foundry
- Izgraditi radne tokove za praćenje performansi i optimizaciju
- Implementirati AI rješenja spremna za produkciju uz pravilno rukovanje greškama i skaliranje

## Preduvjeti

- Završena Sesija 1: Uvod u Foundry Local
- Aktivna instalacija Foundry Local s pokrenutim modelima
- Azure račun (besplatni nivo dovoljan za učenje)
- Osnovno razumijevanje REST API-ja i JSON-a

## Dio 1: Napredno oblikovanje upita

### Razumijevanje arhitekture upita

Učinkovito oblikovanje upita temelj je pouzdanih AI aplikacija. Foundry Local pruža poboljšane mogućnosti oblikovanja upita:
...
### Implementacija strategija oblikovanja upita
...
### Primjeri praktičnog oblikovanja upita
...
## Dio 2: Obrasci integracije podataka

### Poveznici podataka Foundry Local
...
### Primjer integracije podataka u stvarnom svijetu
...
## Dio 3: Akcijski AI zadaci

### Okvir za automatizaciju zadataka
...
### Primjeri automatizacije poslovnih procesa
...
## Dio 4: Integracija s Azure AI Foundry
...
### Obrasci hibridne implementacije
...
## Dio 5: Praćenje performansi i optimizacija

### Sveobuhvatan sustav praćenja
...
### Vježba 1: Napredni chatbot za korisničku podršku
...
### Vježba 2: Automatizirano istraživanje tržišta
...
## Dio 7: Sljedeći koraci i pregled Sesije 3

### Postignuća sesije

U ovoj sesiji ste savladali:
- ✅ Napredne tehnike oblikovanja upita za dosljedno AI ponašanje
- ✅ Robusne obrasce integracije podataka za stvarne aplikacije
- ✅ Automatizaciju zadataka za optimizaciju poslovnih procesa
- ✅ Integraciju s Azure AI Foundry i strategije hibridne implementacije
- ✅ Sveobuhvatno praćenje performansi i optimizaciju

### Priprema za Sesiju 3: Open-Source modeli

1. **Istražite Hugging Face**: Kreirajte račun i pregledajte katalog modela
2. **Pregledajte Model Mondays**: Pogledajte najnoviju seriju [Model Mondays](https://aka.ms/model-mondays)
3. **Planirajte prilagođene modele**: Razmislite o specijaliziranim modelima koji bi koristili vašim slučajevima upotrebe
...
- [Vodič za napredno oblikovanje upita](https://platform.openai.com/docs/guides/prompt-engineering)
- [Najbolje prakse za automatizaciju poslovnih procesa](https://docs.microsoft.com/en-us/power-automate/)

Sada ste opremljeni za izgradnju sofisticiranih AI rješenja koja kombiniraju snagu lokalne inferencije s mogućnostima u oblaku, postavljajući temelje za AI aplikacije spremne za poslovanje.
