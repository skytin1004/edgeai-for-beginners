...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T03:14:38+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "hr"
}
-->
# Foundry Local kao integracija alata

Sveobuhvatan okvir za integraciju Microsoft Foundry Local modela kao pozivnih alata unutar većih aplikacija, slijedeći službene Microsoftove obrasce za integraciju alata temeljenih na AI-u.

## Pregled

Ovaj primjer pokazuje kako izložiti Foundry Local modele kao višekratno upotrebljive alate koji se mogu integrirati u postojeće aplikacije, tijekove rada i razvojna okruženja. Prikazuje preporučene Microsoftove obrasce za integraciju alata i pozivanje funkcija.

## Ključni pojmovi

### 🔧 **Arhitektura usmjerena na alate**
- Foundry Local modeli kao pozivne funkcije
- Standardizirana sučelja i sheme alata
- Besprijekorna integracija s postojećim kodnim bazama
- Tipno sigurne definicije alata i validacija

### ⚡ **Obrasci pozivanja funkcija**
- Implementacija pozivanja funkcija Microsoft Foundry Local
- Definicije alata kompatibilne s OpenAI-jem
- Automatska validacija i konverzija parametara
- Upravljanje greškama i formatiranje odgovora

### 🔌 **Okviri za integraciju**
- **LangChain integracija**: Izvorna podrška za LangChain alate
- **Semantic Kernel**: Funkcije Microsoft Semantic Kernel-a
- **REST API**: Krajnje točke temeljene na HTTP-u
- **CLI alati**: Integracija sučelja naredbenog retka
- **Jupyter Notebooks**: Interaktivni razvojni alati

### 🎯 **Obrasci upotrebe**
- Alati za analizu i generiranje koda
- Obrada sadržaja i sažimanje
- Analiza podataka i vizualizacija
- Istraživanje i dohvat informacija
...
### Sistemski zahtjevi
- **Python**: 3.9+ s podrškom za asyncio
- **Node.js**: v18+ (za JavaScript integracije)
- **Memorija**: Preporučeno 12GB+
- **Pohrana**: 10GB+ za modele i alate
...
## Osnovni obrasci alata

### 1. Alati temeljeni na funkcijama
```python
...
### 2. Upravljanje modelskim resursima
```python
...
1. **Obrasce integracije alata**
   - Dizajn alata temeljenih na funkcijama i klasama
   - Obrasce integracije Microsoft Foundry Local
   - Validaciju shema i sigurnost tipova
   - Upravljanje greškama i oporavak

2. **Integraciju okvira**
   - Razvoj alata za LangChain
   - Integraciju funkcija Semantic Kernel-a
   - Integraciju REST API okvira
   - Razvoj CLI aplikacija

3. **Razmatranja za produkciju**
   - Strategije optimizacije performansi
   - Predmemoriranje i upravljanje resursima
   - Praćenje i preglednost
   - Sigurnost i validacija

4. **Napredne obrasce alata**
   - Kompozicija i povezivanje alata
   - Obrada svjesna konteksta
   - Operacije u serijama i streamingu
   - Razvoj prilagođenih integracija

## Sljedeći koraci

- **Projekti integracije**: Izradite prilagođene integracije s vašim preferiranim okvirima
- **Razvoj alata**: Kreirajte specijalizirane alate za vaše područje
- **Podešavanje performansi**: Optimizirajte za vaše specifične slučajeve upotrebe
- **Produkcijsko postavljanje**: Skalirajte alate za poslovnu upotrebu

## Doprinos

Pogledajte glavne smjernice repozitorija za upute o doprinosu.
