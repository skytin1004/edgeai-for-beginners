...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T02:05:55+00:00",
...
- **Praćenje zdravlja**: Provjera valjanosti usluga i dostupnosti modela
...
- Kompilacija Hugging Face modela: https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/how-to/how-to-compile-hugging-face-models6: Foundry Local – Models as Tools
...
## Dio 1: Inteligentni usmjerivač modela (moderna implementacija)
...
Korak 1) Predzagrijavanje i provjera lokalne krajnje točke
```cmd
foundry model run phi-4-mini
curl http://localhost:8000/v1/models
```

Korak 2) Sanitizacija ulaza
```python
...
Korak 3) Zastavica za lokalno korištenje i zapisivanje
```python
...
- [ ] Postaviti konfiguraciju modela temeljem okruženja
- [ ] Implementirati praćenje zdravlja usluge i rukovanje greškama
- [ ] Postaviti produkcijski usmjerivač s detaljnim zapisivanjem
