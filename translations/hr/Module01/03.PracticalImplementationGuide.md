...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T23:58:29+00:00",
...
- **SDK**: Osigurajte da je .NET SDK instaliran za razvoj na više platformi
...
- **Prednosti**: Izvrsni omjer performansi i veličine, optimizirani za zadatke zaključivanja
- **Resurs**: [Phi-4 kolekcija na Hugging Face](https://huggingface.co/collections/microsoft/phi-4-677e9380e514feb5577a40e4)
- **Primjene**: Generiranje koda, matematičko zaključivanje, opća komunikacija

**Qwen-3 obitelj**
- **Opis**: Najnovija generacija Alibaba-inih višejezičnih modela
...
- **Omjer performansi i veličine**: Razumijevanje kada odabrati manje ili veće modele
- **Optimizacija za specifične zadatke**: Prilagodba modela specifičnim primjenama
...
- **Ključne značajke**:
  ...
  - Izvršavanje uz malu potrošnju memorije
...
- **Ključne značajke**:
  - Automatizirani radni procesi optimizacije modela
...
- **Instalacija i osnovna upotreba**:
  ...
  # Definirajte model i konfiguraciju optimizacije
  ...
  # Pokrenite radni proces optimizacije
  result = run_workflow(config)
  optimized_model = result.optimized_model
  
  # Spremite optimizirani model
...
- **Installation and Basic Usage**:
  ...
  # Primjer Python skripte za učitavanje i optimizaciju modela
  ```python
...
- **Svrha**: Akceleracija inferencije za ONNX modele na više platformi
- **Ključne značajke**:
  - Optimizacije specifične za hardver (CPU, GPU, NPU)
  - Grafičke optimizacije za inferenciju
...
- "Optimizacija transformacijskih modela za rubno računalstvo"
...
- [ ] Osnovno poznavanje ciljnih obitelji modela
- [ ] Instalirani i testirani alati za kvantizaciju
...
- **Microsoft .NET dokumentacija**: Službeni resursi za .NET razvoj
...
### Razvojni alati
- **Visual Studio Code**: Lagani uređivač koda s proširenjima za AI razvoj
- **Jupyter Notebooks**: Interaktivno računalno okruženje za ML eksperimentiranje
...
- **Online tečajevi**: Dodatni materijali za učenje o AI optimizaciji
- **Zajednički forumi**: Platforme za pitanja i odgovore o izazovima EdgeAI razvoja
- **Referentni skupovi podataka**: Standardni skupovi podataka za procjenu performansi modela

## Ishodi učenja

Nakon završetka ovog pripremnog vodiča, imat ćete:

1. Potpuno konfigurirano razvojno okruženje spremno za EdgeAI razvoj
2. Razumijevanje hardverskih i softverskih zahtjeva za različite scenarije implementacije
3. Poznavanje ključnih okvira i alata koji se koriste tijekom tečaja
4. Sposobnost odabira odgovarajućih modela na temelju ograničenja uređaja i zahtjeva
5. Osnovno znanje o tehnikama optimizacije za rubnu primjenu
