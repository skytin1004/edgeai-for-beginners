...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T07:48:17+00:00",
...
- 為 Intel、Apple 和跨平台硬體的生產邊緣環境部署優化模型
...
1. **簡單代理**：構建一個具有函數調用功能的基本 AI 代理（1 小時）
...
- [AI Toolkit for VS Code](https://code.visualstudio.com/docs/intelligentapps/overview) - 整合的 EdgeAI 開發環境
...
7. **函數調用代理**：構建具有函數調用能力的 AI 代理，用於邊緣場景
...
EdgeAI 代表了人工智慧實作的前沿技術，將強大的能力直接帶到設備上，同時解決隱私、延遲和連接性等關鍵問題。本課程提供了 20 小時的核心知識和實作技能，讓你能立即開始使用 EdgeAI 技術。

課程內容精簡且專注於最重要的概念，幫助你快速獲得有價值的專業知識，而不會感到負擔。請記住，即使是簡單的實作練習，也能有效鞏固你的學習成果。
