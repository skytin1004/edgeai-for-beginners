...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T18:33:13+00:00",
...
歡迎來到 **EdgeAI 初學者指南**——這是一個全面的旅程，帶您進入邊緣人工智能的變革世界。本課程將強大的 AI 能力與邊緣設備上的實際部署相結合，幫助您直接在數據生成和決策需要的地方發揮 AI 的潛力。
...
它們在以下場景中解鎖了強大的 NLP 能力，同時滿足約束條件：
- **嵌入式系統**：物聯網設備和工業控制器
...
**主題**：SLM Agentic 系統的實作，從基礎到高級函數調用及模型上下文協議整合
...
- [**使用 Windows ML 的 EdgeAI**](./Module07/README.md#4-edgeai-with-windows-ml)
  - Windows AI Foundry 基礎，用於高效能的設備端推論
...
**實作技能**
- 在多樣化邊緣平台（移動、嵌入式、IoT、邊緣伺服器）部署小型語言模型
...
- 根據特定部署限制選擇合適的小型語言模型家族及配置

**系統架構**
- 設計端到端 EdgeAI 解決方案，與現有基礎架構整合
...
- 實際操作多樣化 EdgeAI 平台及實作策略
- 精通 NVIDIA、移動、Azure 和 Windows 平台的硬體特定優化技術
- 理解效能、成本及隱私需求之間的部署權衡
- 獲得構建不同生態系統的實際 EdgeAI 應用技能
...
- 為混合邊緣-雲端架構做好準備
- 成為新興 AI 技術及框架的入門途徑
本課程將您定位於人工智慧技術部署的最前沿，智能功能無縫整合到驅動現代生活的設備和系統中。
...
5. 完成 **Module05**，掌握 SLMOps，實現生產就緒的應用
6. 探索 **Module06**，了解 SLM 智能代理系統及功能調用能力
7. 最後完成 **Module07**，獲得 AI 工具包和多樣化 EdgeAI 實施範例的實際經驗

每個模組都設計為獨立完整，但按順序學習將能獲得最佳效果。

## 學習指南

提供了一份全面的 [學習指南](STUDY_GUIDE.md)，幫助您最大化學習體驗。學習指南包括：

- **結構化學習路徑**：優化的課程完成時間表，20 小時內完成課程
- **時間分配指導**：針對閱讀、練習和項目平衡的具體建議
- **重點概念聚焦**：每個模組的優先學習目標
- **自我評估工具**：測試理解的問題和練習
- **迷你項目點子**：加強學習的實際應用

學習指南適合密集學習（一週）和兼職學習（三週），即使您只能投入 10 小時，也提供清晰的時間分配指導。
