...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T07:50:12+00:00",
...
歡迎來到 **EdgeAI 初學者指南**——這是一個全面探索邊緣人工智慧世界的旅程。本課程將強大的 AI 能力與實際的邊緣設備部署相結合，幫助您直接在數據生成和決策需要的地方發揮 AI 的潛力。
...
邊緣 AI 是指在硬體本地運行 AI 算法和語言模型，靠近數據生成的地方，而不依賴雲端資源進行推理。它能降低延遲、增強隱私並實現即時決策。
...
像 Phi-4、Mistral-7B 和 Gemma 這樣的 SLM 是大型 LLM 的優化版本——經過訓練或蒸餾以實現：
...
每個模組包含理論、實作練習，以及可直接用於生產環境的程式碼範例。
...
**作品集專案**：多代理系統 • 生產級 RAG 應用程式 • 跨平台部署 • 性能優化  
...
✅ **實作範例**：超過 50 個範例，10 個完整的 Foundry Local 示範  
✅ **性能專注**：提升速度 85%，減少大小 75%  
✅ **多平台支持**：Windows、移動端、嵌入式、雲端與邊緣混合  
✅ **生產就緒**：監控、擴展、安全性、合規框架  

📖 **[學習指南](STUDY_GUIDE.md)**：結構化的 20 小時學習路徑，包含時間分配指導與自我評估工具。

---

**EdgeAI 代表 AI 部署的未來**：本地優先、隱私保護、高效能。掌握這些技能，打造下一代智慧應用程式。
