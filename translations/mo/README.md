...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T14:21:34+00:00",
...
歡迎來到 **EdgeAI 初學者指南**——這是一個全面探索邊緣人工智慧世界的旅程。本課程將強大的 AI 能力與實際應用部署相結合，幫助您在數據生成和決策需要的地方直接利用 AI 的潛力。
...
邊緣 AI 是指在硬體上本地運行 AI 演算法和語言模型，靠近數據生成的地方，無需依賴雲端資源進行推理。它能降低延遲、增強隱私並支持即時決策。
...
| [🏭 08](../../Module08) | [Foundry Local 工具包](./Module08/README.md) | 生產級範例 | 範例應用（詳情見下文） | 專家 | 8-10 小時 |
...
3. **🚀 生產**（模組 05-06）：SLMOps + AI 代理 + 功能調用
4. **💻 實施**（模組 07-08）：平台範例 + Foundry Local 工具包

每個模組都包含理論、實踐練習和生產級代碼範例。

## 職業影響
**技術角色**: EdgeAI 解決方案架構師 • 機器學習工程師（Edge） • IoT AI 開發者 • 移動 AI 開發者

**產業領域**: 工業 4.0 • 醫療科技 • 自主系統 • 金融科技 • 消費電子
