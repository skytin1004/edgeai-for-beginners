...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-09T07:58:31+00:00",
...
歡迎來到 **EdgeAI 初學者指南**——這是一個全面的旅程，帶您進入邊緣人工智慧的變革世界。本課程將強大的 AI 能力與邊緣設備上的實際部署相結合，幫助您直接在數據生成和決策需要的地方發揮 AI 的潛力。
...
像 Phi-4、Mistral-7B 和 Gemma 這樣的 SLM 是更大 LLM 的優化版本——通過訓練或蒸餾實現：
