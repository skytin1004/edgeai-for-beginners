...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T18:51:42+00:00",
...
Microsoft Olive 是一款功能強大且易於使用的硬體感知模型優化工具包，簡化了針對不同硬體平台部署機器學習模型的優化過程。無論目標是 CPU、GPU 還是專用 AI 加速器，Olive 都能幫助您在保持模型準確性的同時實現最佳性能。
...
- **流行模型支持**：Olive 可自動優化流行模型架構，如 Llama、Phi、Qwen、Gemma 等
...
- **部落格文章**：Microsoft 開源部落格提供詳細的 Olive 教程
