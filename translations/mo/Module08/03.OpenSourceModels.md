...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:21:35+00:00",
...
本節課程專注於使用 Foundry Local 進行模型探索與管理的實踐操作。您將學習如何列出可用模型、測試不同選項，以及了解基本性能特徵。課程重點在於通過 Foundry CLI 的實際操作，幫助您選擇適合自己使用場景的模型。
...
- **[範例 03：模型探索](samples/03/README.md)**：實作示例腳本
...
您現在擁有使用 Foundry Local 的 CLI 方法探索、測試和選擇適合 AI 應用的模型的實用技能。
