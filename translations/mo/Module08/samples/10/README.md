...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T14:30:27+00:00",
...
此範例展示如何將 Foundry Local 模型作為可重用工具，整合到現有的應用程式、工作流程和開發環境中。它展示了 Microsoft 推薦的工具整合和函數調用模式。
...
### 🔌 **整合框架**
- **LangChain 整合**：原生 LangChain 工具支援
