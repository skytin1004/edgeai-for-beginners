...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T14:26:54+00:00",
...
Foundry Local 提供了強大的設備端 AI，將模型轉化為智能化、專業化的工具。通過自動模型選擇、全面監控和生產就緒模式，團隊可以部署適應不同任務類型的高級 AI 應用，同時保持隱私和性能。本次展示的智能路由器模式為構建複雜 AI 系統提供了基礎，這些系統可以從本地開發擴展到生產部署。
