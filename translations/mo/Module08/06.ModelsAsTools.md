...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T16:56:19+00:00",
...
將 AI 模型視為模組化、可定制的工具，並透過 Foundry Local 在設備上直接運行。本節重點介紹隱私保護、低延遲推理的實用工作流程，以及如何通過 SDK、API 或 CLI 整合這些工具。您還將學習如何在需要時擴展至 Azure AI Foundry。
...
## 學習目標
- 設計基於設備的模型作為工具的模式
- 通過 OpenAI 兼容的 REST API 或 SDK 進行整合
- 根據特定領域需求定制模型
...
Foundry Local 使模型成為可組合工具，實現強大的設備端 AI。通過清晰的介面、治理和混合擴展，團隊可以部署即時、安全的 AI 應用，既尊重用戶隱私，又符合企業需求。
