...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T16:56:51+00:00",
...
在 Foundry Local 的基礎上，本節課著重於透過進階提示工程、無縫數據整合以及可執行的任務自動化來創建高級 AI 解決方案。您將學習如何將本地開發與 Azure AI Foundry 的功能相結合，打造企業級應用，充分利用兩者的優勢。
...
3. **規劃自訂模型**：思考哪些專屬模型能夠為您的使用案例帶來益處
...
您現在已具備建構高級 AI 解決方案的能力，結合本地推理與雲端規模的優勢，為企業級 AI 應用奠定基礎。
