...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T14:27:52+00:00",
...
在您已掌握 Foundry Local 的基礎上，本節課程將專注於進階的 OpenAI SDK 整合模式，這些模式能無縫支援 Microsoft Foundry Local 和 Azure OpenAI。您將學習如何構建靈活的 AI 應用程式，既能在本地運行以保護隱私和進行開發，又能在需要時透過 Azure OpenAI 提供雲端擴展能力。

## 學習目標

完成本節課程後，您將能夠：
- 精通 Foundry Local 和 Azure OpenAI 的進階 OpenAI SDK 整合技術
- 實現流式回應以提升使用者體驗
- 創建支持多供應商的穩健客戶端工廠模式
- 構建具備上下文保留功能的對話管理系統
- 建立效能基準測試和健康監控
...
1. **探索模型目錄**：檢視 Foundry Local 中可用的模型
...
- **[流式完成指南](https://learn.microsoft.com/azure/ai-foundry/foundry-local/how-to/integrate-with-inference-sdks)**：進階流式模式
- **[範例 01：透過 OpenAI SDK 快速聊天](samples/01/README.md)**：基本整合模式
...
您現在已具備構建複雜 AI 應用程式的能力，能無縫整合本地和雲端 AI 功能，並根據具體使用場景選擇合適的供應商，同時保持一致的開發模式。
