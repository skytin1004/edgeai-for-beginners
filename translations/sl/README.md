...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:52:25+00:00",
...
Edge AI se nanaša na izvajanje AI algoritmov in jezikovnih modelov lokalno na strojni opremi, blizu mesta, kjer se podatki ustvarjajo, brez zanašanja na oblačne vire za inferenco. To zmanjšuje zakasnitev, izboljšuje zasebnost in omogoča odločanje v realnem času.
...
- **Sposobnost delovanja brez povezave**: Deluje brez stalne internetne povezave
...
| [⚙️ 04](../../Module04) | [Orodja za optimizacijo modelov](./Module04/README.md) | Optimizacija na različnih platformah | Uvod • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • Sinteza delovnih tokov | Srednje zahtevno | 5-6 ur |
...
| [💻 07](../../Module07) | [Implementacija na platformi](./Module07/README.md) | Primeri na različnih platformah | AI orodja • Foundry Local • Razvoj na Windows | Napredno | 3-4 ure |
| [🏭 08](../../Module08) | [Orodja Foundry Local](./Module08/README.md) | Primeri, pripravljeni za proizvodnjo | Primeri aplikacij (glejte podrobnosti spodaj) | Strokovno | 8-10 ur |
...
Celoviti materiali za delavnico s primeri, pripravljenimi za proizvodnjo:
...
**Kaj boste zgradili:**
- Lokalna AI aplikacija za klepet s podporo za pretakanje
- RAG pipeline z ocenjevanjem kakovosti (RAGAS)
- Orodja za primerjavo in benchmarking več modelov
...
- **Foundry lokalne aplikacije za klepet**: Windows 11 aplikacija z možnostjo preklapljanja modelov
...
- **API ogrodja**: Produkcijsko pripravljeni odjemalci s pretočnim prenosom in spremljanjem stanja
...
✅ **Praktični primeri**: Več kot 50 primerov, 10 obsežnih demo projektov Foundry Local  
...
✅ **Pripravljeno za produkcijo**: Spremljanje, skaliranje, varnost, okvirji za skladnost
