...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T01:16:49+00:00",
...
Na podlagi vaše osnove Foundry Local se ta seja osredotoča na ustvarjanje naprednih AI rešitev prek naprednega oblikovanja pozivov, brezhibne integracije podatkov in avtomatizacije nalog, ki prinašajo rezultate. Naučili se boste povezati lokalni razvoj z zmogljivostmi Azure AI Foundry, da ustvarite aplikacije, pripravljene za podjetja, ki združujejo najboljše iz obeh svetov.

## Cilji učenja

Do konca te seje boste:
- Obvladali napredne tehnike oblikovanja pozivov za dosledne in zanesljive AI odgovore
- Uvedli robustne vzorce integracije podatkov za aplikacije v resničnem svetu
- Ustvarili izvedljive AI naloge, ki prinašajo poslovno vrednost
- Vzpostavili brezhibno povezljivost med Foundry Local in Azure AI Foundry
- Zgradili delovne tokove za spremljanje zmogljivosti in optimizacijo
- Uvedli AI rešitve, pripravljene za produkcijo, z ustreznim ravnanjem z napakami in skaliranjem

## Predpogoji

- Zaključena seja 1: Začetek z Foundry Local
- Aktivna namestitev Foundry Local z delujočimi modeli
- Azure račun (brezplačna različica zadostuje za učenje)
- Osnovno razumevanje REST API-jev in JSON

## 1. del: Napredno oblikovanje pozivov

### Razumevanje arhitekture pozivov

Učinkovito oblikovanje pozivov je temelj zanesljivih AI aplikacij. Foundry Local ponuja izboljšane zmogljivosti oblikovanja pozivov:
...
### Uvedba strategij oblikovanja pozivov
...
### Praktični primeri oblikovanja pozivov
...
## 2. del: Vzorci integracije podatkov

### Povezovalniki podatkov Foundry Local
...
### Primer integracije podatkov v resničnem svetu
...
## 3. del: Izvedljive AI naloge

### Okvir za avtomatizacijo nalog
...
### Primeri avtomatizacije poslovnih procesov
...
## 4. del: Integracija Azure AI Foundry

### Vzpostavitev povezljivosti
...
## 5. del: Spremljanje zmogljivosti in optimizacija

### Celovit sistem spremljanja
...
### Vaja 1: Napreden bot za podporo strankam
...
### Vaja 2: Avtomatizirano raziskovanje trga
...
## 7. del: Naslednji koraki in predogled seje 3

### Dosežki seje

V tej seji ste obvladali:
- ✅ Napredne tehnike oblikovanja pozivov za dosledno vedenje AI
- ✅ Robustne vzorce integracije podatkov za aplikacije v resničnem svetu
- ✅ Ustvarjanje avtomatiziranih nalog za optimizacijo poslovnih procesov
- ✅ Integracijo Azure AI Foundry in strategije hibridne uvedbe
- ✅ Celovito spremljanje zmogljivosti in optimizacijo

### Priprava na sejo 3: Modeli odprte kode

1. **Raziskujte Hugging Face**: Ustvarite račun in preglejte katalog modelov
2. **Preglejte Model Mondays**: Oglejte si najnovejšo serijo [Model Mondays](https://aka.ms/model-mondays)
3. **Načrtujte prilagojene modele**: Razmislite, kateri specializirani modeli bi koristili vašim primerom uporabe

### Dodatni viri

- [Dokumentacija Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [GitHub repozitorij Foundry Local](https://github.com/microsoft/Foundry-Local)
- [Vodnik za napredno oblikovanje pozivov](https://platform.openai.com/docs/guides/prompt-engineering)
- [Najboljše prakse avtomatizacije poslovnih procesov](https://docs.microsoft.com/en-us/power-automate/)

Zdaj ste opremljeni za gradnjo naprednih AI rešitev, ki združujejo moč lokalnega sklepanja z zmogljivostmi v oblaku, kar postavlja temelje za AI aplikacije na ravni podjetja.
