...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T02:10:38+00:00",
...
- Vzpostaviti praktične delovne tokove za izbiro in primerjanje modelov
...
- Dovolj prostora za shranjevanje za prenos modelov (velikost modelov se giblje od 1 GB do več kot 20 GB)
...
- Prevesti in zagnati izbrane modele Hugging Face znotraj Foundry Local
...
- `phi-4-mini`: Hiter, učinkovit, odličen za splošne pogovore
- `phi-4`: Bolj zmogljiva različica z boljšim sklepanjem

**Srednji modeli:**
- `qwen2.5-7b-instruct`: Odlično sklepanje in daljši kontekst
- `deepseek-r1-distill-qwen-7b`: Optimiziran za generiranje kode

**Večji modeli:**
- `llama-3.2`: Najnovejši odprtokodni model Meta
- `qwen2.5-14b-instruct`: Sklepanje na ravni podjetja

## Del 2: Hitro testiranje in primerjava modelov

### Pristop Vzorec 03: Preprosto seznam in ocena

Na podlagi našega vzorca 03 je tukaj minimalni delovni tok:
...
Foundry Local samodejno upravlja prenose modelov in predpomnilnik:
...
- Spremljajte uporabo pomnilnika (modeli ostanejo naloženi v RAM)
- Spremljajte uporabo CPU med sklepanjem
- Preverite diskovni I/O med začetnim nalaganjem modela

**Spremljanje prek ukazne vrstice:**
```cmd
...
**Za splošne pogovore in vprašanja:**
- Začnite z: `phi-4-mini` (hiter, učinkovit)
- Nadgradite na: `phi-4` (boljše sklepanje)
- Napredno: `qwen2.5-7b-instruct` (daljši kontekst)

**Za generiranje kode:**
- Priporočeno: `deepseek-r1-distill-qwen-7b`
- Alternativa: `qwen2.5-7b-instruct` (prav tako dobro za kodo)

**Za kompleksno sklepanje:**
- Najboljše: `qwen2.5-7b-instruct` ali `qwen2.5-14b-instruct`
...
- Podpora za NPU (Windows 11 Copilot+ računalniki) za pospeševanje

### Delovni tok preklapljanja med modeli
...
Tukaj je preprost pristop za primerjavo zmogljivosti modelov:
