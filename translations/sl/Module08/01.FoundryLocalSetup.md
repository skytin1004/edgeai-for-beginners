...
- **Strojna oprema**: Naprava z NPU ali GPU (Copilot+ PC ali NVIDIA GPU) je priporočena
...
| `AZURE_OPENAI_ENDPOINT` | Končna točka Azure OpenAI | - | Za Azure |
| `AZURE_OPENAI_API_KEY` | API ključ Azure OpenAI | - | Za Azure |
| `AZURE_OPENAI_API_VERSION` | Različica API Azure | `2024-08-01-preview` | Ne |
...
- **Obravnava napak**: Implementirajte ustrezne strategije za obravnavo napak v produkcijskih aplikacijah
- **Redno posodabljanje**: Posodabljajte Foundry Local za dostop do novih modelov in popravkov
- **Začnite z majhnimi modeli**: Začnite z manjšimi modeli (Phi mini, Qwen 7B) in postopoma povečujte
...
### Naloga 3: Celovita preverba zdravja storitve
