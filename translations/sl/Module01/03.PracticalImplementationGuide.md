...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T23:58:59+00:00",
...
Ta obsežen vodič vam bo pomagal pripraviti se na tečaj EdgeAI, ki se osredotoča na gradnjo praktičnih rešitev umetne inteligence, ki učinkovito delujejo na robnih napravah. Tečaj poudarja praktični razvoj z uporabo sodobnih ogrodij in najsodobnejših modelov, optimiziranih za robno uporabo.
...
- **SDK**: Prepričajte se, da je .NET SDK nameščen za razvoj na več platformah
...
### Strategija za računalniške vire
...
- **Opis**: Googlove lahke modele, optimizirane za robno uporabo
...
- **Optimizacija za specifične naloge**: Ujemanje modelov z določenimi primeri uporabe
...
- **Namen**: Visoko zmogljiv pogonski sistem za sklepanje LLM-jev
- **Ključne funkcije**:
...
- **Ključne funkcije**:
  ...
  - Orodja za primerjavo zmogljivosti
- **Namestitev in osnovna uporaba**:
  ```bash
  # Install Olive
  ...
  # Določite model in konfiguracijo optimizacije
  ...
  # Zaženite delovni tok optimizacije
  result = run_workflow(config)
  optimized_model = result.optimized_model
  
  # Shranite optimiziran model
...
- **Installation and Basic Usage**:
  ...
  # Primer Python skripte za nalaganje in optimizacijo modela
  ```python
...
- **Ključne funkcije**:
  ...
  - Optimizacija grafov za sklepanje
...
### Tehnični članki
- "Učinkovita Edge AI: Pregled tehnik kvantizacije"
- "Kompresija modelov za mobilne in robne naprave"
- "Optimizacija Transformer modelov za robno računalništvo"

### Skupnostni viri
- **EdgeAI Slack/Discord skupnosti**: Podpora med vrstniki in razprave
- **GitHub repozitoriji**: Primeri implementacij in vadnice
- **YouTube kanali**: Tehnične poglobitve in vadnice
...
- [ ] Nameščena in preizkušena orodja za kvantizacijo
...
1. Nastavili popolno razvojno okolje za razvoj aplikacij EdgeAI
2. Namestili in konfigurirali potrebna orodja in ogrodja za optimizacijo modelov
3. Izbrali ustrezne konfiguracije strojne in programske opreme za svoje projekte EdgeAI
4. Razumeli ključne vidike pri uporabi AI modelov na robnih napravah
5. Pripravili svoj sistem za praktične vaje v tečaju

## Dodatni viri

### Uradna dokumentacija
- **Python dokumentacija**: Uradna dokumentacija programskega jezika Python
...
### Razvojna orodja
- **Visual Studio Code**: Lahek urejevalnik kode z razširitvami za razvoj AI
...
### Učni viri
- **Raziskovalni članki o EdgeAI**: Najnovejše akademske raziskave o učinkovitih modelih
- **Spletni tečaji**: Dodatni učni materiali o optimizaciji AI
- **Skupnostni forumi**: Platforme za vprašanja in odgovore o izzivih razvoja EdgeAI
- **Referenčni podatkovni nabori**: Standardni podatkovni nabori za ocenjevanje zmogljivosti modelov
...
3. Seznanjeni s ključnimi ogrodji in orodji, ki se uporabljajo v tečaju
4. Znali izbrati ustrezne modele glede na omejitve naprav in zahteve
