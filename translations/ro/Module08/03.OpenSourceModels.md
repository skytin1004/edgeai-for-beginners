...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T01:35:48+00:00",
...
- Spațiu de stocare suficient pentru descărcarea modelelor (modelele pot varia între 1GB și 20GB+)
...
1. **Rulează scriptul Exemplul 03**: `samples\03\list_and_bench.cmd`
2. **Testează diferite modele**: Testează cel puțin 3 modele diferite
3. **Compară performanța**: Notează diferențele de viteză și calitatea răspunsurilor
...
- Upgradează RAM-ul dacă limitele sunt frecvent atinse

**Performanță Lentă:**
- Asigură-te că modelul este complet încărcat (verifică output-ul detaliat)
...
3. **Monitorizează Resursele**: Fii atent la utilizarea memoriei
4. **Testează Consistent**: Folosește aceleași prompturi pentru comparații corecte
5. **Documentează Rezultatele**: Notează performanța modelelor pentru cazurile tale de utilizare

## Partea 8: Pași Următori și Referințe

### Pregătirea pentru Sesiunea 4

- **Focus Sesiunea 4**: Instrumente și tehnici de optimizare
...
- **[Model Mondays](https://aka.ms/model-mondays)**: Spotlight săptămânal pentru modele
- **[Foundry Local GitHub](https://github.com/microsoft/Foundry-Local)**: Comunitate și probleme
- **[Exemplul 03: Descoperirea Modelelor](samples/03/README.md)**: Script practic exemplu
...
**Modele Medii:**
- `qwen2.5-7b-instruct`: Raționament excelent și context mai lung
- `deepseek-r1-distill-qwen-7b`: Optimizat pentru generarea de cod

**Modele Mari:**
- `llama-3.2`: Cel mai recent model open-source de la Meta
- `qwen2.5-14b-instruct`: Raționament de nivel enterprise

## Partea 2: Testarea Rapidă și Compararea Modelelor

### Abordarea Exemplului 03: Listare Simplă și Evaluare

Bazat pe modelul Exemplul 03, iată fluxul de lucru minim:
...
După ce un model este pornit, testează-l cu prompturi consistente:
...
### Alternativa Testării în PowerShell
...
### Considerații de Stocare a Modelelor
...
- Păstrează 2-3 modele în cache pentru schimbare rapidă
...
- Avansat: `qwen2.5-7b-instruct` (context mai lung)

**Pentru Generarea de Cod:**
- Recomandat: `deepseek-r1-distill-qwen-7b`
- Alternativă: `qwen2.5-7b-instruct` (bun și pentru cod)

**Pentru Raționament Complex:**
- Cel mai bun: `qwen2.5-7b-instruct` sau `qwen2.5-14b-instruct`
- Opțiune bugetară: `phi-4`
...
- RAM de 32GB+ pentru schimbarea confortabilă între modele
- Stocare SSD pentru încărcarea mai rapidă a modelelor
- CPU modern cu performanță bună pe un singur thread
- Suport NPU (PC-uri Windows 11 Copilot+) pentru accelerare

### Flux de Lucru pentru Schimbarea Modelelor
...
### Testarea de Bază a Performanței
...
2. "Scrie o funcție Python pentru sortarea unei liste."
3. "Care sunt avantajele și dezavantajele muncii la distanță?"
4. "Rezumă beneficiile AI la margine."
