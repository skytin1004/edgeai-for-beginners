...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-15T16:41:38+00:00",
...
Microsoft Olive 是一款功能強大且易於使用的硬體感知模型優化工具包，簡化了針對不同硬體平台部署機器學習模型的優化過程。無論目標是 CPU、GPU 或專用 AI 加速器，Olive 都能幫助您在保持模型準確性的同時實現最佳性能。
...
- **部落格文章**：Microsoft 開源部落格有詳細的 Olive 教學

### 相關工具
- **ONNX Runtime**：高性能推理引擎
- **Hugging Face Transformers**：許多兼容模型的來源
- **Azure Machine Learning**：基於雲的優化工作流程
