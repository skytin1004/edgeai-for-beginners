...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T09:45:26+00:00",
...
- `manager.endpoint` 和 `manager.api_key`：連接詳細信息
...
WebGPU 支援直接在瀏覽器中運行 AI 模型，提供最大隱私和零安裝體驗。本範例展示了使用 ONNX Runtime Web 和 WebGPU 執行的演示。
...
Open WebUI 提供了一個專業的 ChatGPT 類似介面，能夠連接到 Foundry Local 的 OpenAI 兼容 API。
...
- ✅ **Chainlit 框架**：支持聊天應用程式的現代化 UI 和流式回應
...
- **[Chainlit 教育 Notebook](samples/04/chainlit_app.ipynb)**：互動學習材料
