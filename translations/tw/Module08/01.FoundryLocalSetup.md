...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T09:44:20+00:00",
...
Microsoft Foundry Local 將 Azure AI Foundry 的功能直接帶到您的 Windows 11 開發環境，提供隱私保護、低延遲的 AI 開發，並配備企業級工具。本節涵蓋完整的安裝、配置以及流行模型（包括 phi、qwen、deepseek 和 GPT-OSS-20B）的實際部署。
...
使用 OpenAI SDK 與 Foundry Local 集成，按照 Sample 01 的模式創建一個可投入生產的聊天應用程式。
...
- **FoundryLocalManager**：使用官方 SDK 進行服務管理（如有提供）
...
- **Sample 01: 快速聊天（OpenAI SDK）**: samples/01/README.md
- **Sample 02: 高級 SDK 集成**: samples/02/README.md
