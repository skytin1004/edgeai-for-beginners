...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T11:48:08+00:00",
...
在 Foundry Local 的基礎上，本節課著重於通過高級提示工程、無縫數據整合以及可執行的任務自動化來創建複雜的 AI 解決方案。您將學習如何將本地開發與 Azure AI Foundry 的功能相結合，打造企業級應用，充分利用兩者的優勢。

## 學習目標

完成本節課後，您將能夠：
- 掌握高級提示工程技術，確保 AI 回應的一致性和可靠性
- 實現穩健的數據整合模式，應用於實際場景
- 創建可執行的 AI 任務，提升業務價值
- 建立 Foundry Local 與 Azure AI Foundry 的無縫連接
- 構建性能監控和優化工作流程
- 部署具備錯誤處理和擴展能力的生產級 AI 解決方案

## 先決條件

- 完成第一節課：Foundry Local 入門
- 已安裝並運行模型的 Foundry Local
- Azure 帳戶（免費層即可滿足學習需求）
- 基本了解 REST API 和 JSON
...
在本節課中，您已掌握：
- ✅ 高級提示工程技術，確保 AI 行為的一致性
- ✅ 穩健的數據整合模式，應用於實際場景
- ✅ 自動化任務創建，優化業務流程
- ✅ Azure AI Foundry 整合及混合部署策略
- ✅ 全面的性能監控和優化

### 為第三節課做準備：開源模型

1. **探索 Hugging Face**：創建帳戶並瀏覽模型目錄
2. **查看 Model Mondays**：了解最新的 [Model Mondays 系列](https://aka.ms/model-mondays)
3. **規劃自定義模型**：思考哪些專業化模型能夠為您的使用場景帶來益處
...
- [高級提示工程指南](https://platform.openai.com/docs/guides/prompt-engineering)
- [業務流程自動化最佳實踐](https://docs.microsoft.com/en-us/power-automate/)

您現在已具備構建複雜 AI 解決方案的能力，能夠結合本地推理與雲端規模的優勢，為企業級 AI 應用奠定基礎。
