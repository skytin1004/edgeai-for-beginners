...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T09:58:00+00:00",
...
由 Microsoft Foundry Local 驅動的高級多代理系統，展示了智能代理協調、專業任務分配以及協作問題解決模式。

## 概述

此範例展示如何使用 Foundry Local 建立複雜的 AI 代理系統，實現 Microsoft 官方的函數調用、代理協作以及協作式 AI 工作流程模式。
