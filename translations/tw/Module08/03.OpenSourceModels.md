...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T09:43:45+00:00",
...
本節課程專注於使用 Foundry Local 進行實際的模型探索與管理。您將學習如何列出可用模型、測試不同選項，以及了解基本性能特徵。課程重點在於使用 Foundry CLI 進行實際操作，幫助您選擇適合自己使用場景的模型。
...
您現在擁有使用 Foundry Local 的簡單 CLI 方法來探索、測試和選擇適合 AI 應用的模型的實用技能。
...
**最佳性能推薦：**
- 32GB+ RAM 以便舒適地進行多模型切換
- SSD 存儲以加快模型加載速度
- 現代 CPU，具有良好的單線程性能
- 支援 NPU（Windows 11 Copilot+ PC）以進行加速
