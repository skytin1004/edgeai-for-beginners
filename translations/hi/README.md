...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T07:46:51+00:00",
...
1. **रेपॉजिटरी को फोर्क करें**: क्लिक करें [![GitHub forks](https://img.shields.io/github/forks/microsoft/edgeai-for-beginners.svg?style=social&label=Fork)](https://GitHub.com/microsoft/edgeai-for-beginners/fork)
2. **रेपॉजिटरी को क्लोन करें**: `git clone https://github.com/microsoft/edgeai-for-beginners.git`
...
- **मॉडल ऑप्टिमाइज़ेशन**: मॉडल को क्वांटाइज़ और संपीड़ित करें edge तैनाती के लिए (85% गति वृद्धि, 75% आकार में कमी)
- **मल्टी-प्लेटफॉर्म तैनाती**: Windows, मोबाइल, एम्बेडेड, और क्लाउड-edge हाइब्रिड सिस्टम
- **उत्पादन संचालन**: Edge AI को उत्पादन में मॉनिटर, स्केल और बनाए रखें

### 🏗️ व्यावहारिक परियोजनाएँ
- **Foundry Local चैट ऐप्स**: Windows 11 का मूल अनुप्रयोग मॉडल स्विचिंग के साथ
...
- **API फ्रेमवर्क**: उत्पादन-तैयार क्लाइंट स्ट्रीमिंग और स्वास्थ्य मॉनिटरिंग के साथ
...
0. **📖 परिचय** ([Introduction.md](./introduction.md)): EdgeAI की नींव + उद्योग संदर्भ + सीखने का ढांचा
1. **📚 नींव** (मॉड्यूल 01-02): EdgeAI अवधारणाएँ + SLM मॉडल परिवार
2. **⚙️ ऑप्टिमाइज़ेशन** (मॉड्यूल 03-04): तैनाती + क्वांटाइज़ेशन फ्रेमवर्क  
3. **🚀 उत्पादन** (मॉड्यूल 05-06): SLMOps + AI एजेंट्स + फंक्शन कॉलिंग  
...
**उद्योग क्षेत्र**: मैन्युफैक्चरिंग 4.0 • हेल्थकेयर टेक • स्वायत्त सिस्टम • फिनटेक • कंज्यूमर इलेक्ट्रॉनिक्स  
...
✅ **व्यावहारिक नमूने**: 50+ उदाहरण, 10 व्यापक Foundry Local डेमो  
...
📖 **[अध्ययन गाइड उपलब्ध](STUDY_GUIDE.md)**: 20 घंटे का संरचित सीखने का मार्ग, समय आवंटन मार्गदर्शन और आत्म-मूल्यांकन उपकरण।  

---  

**EdgeAI AI डिप्लॉयमेंट का भविष्य है**: स्थानीय-प्रथम, गोपनीयता-संरक्षण, और कुशल। इन कौशलों में महारत हासिल करें और अगली पीढ़ी के बुद्धिमान एप्लिकेशन बनाएं।  
