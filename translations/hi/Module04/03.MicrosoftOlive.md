...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T13:28:23+00:00",
  "source_file": "Module04/03.MicrosoftOlive.md",
  "language_code": "hi"
}
-->
# अनुभाग 3 : Microsoft Olive Optimization Suite

## सामग्री सूची
1. [परिचय](../../../Module04)
2. [Microsoft Olive क्या है?](../../../Module04)
3. [इंस्टॉलेशन](../../../Module04)
4. [त्वरित प्रारंभ मार्गदर्शिका](../../../Module04)
...
- **प्रदर्शन सुधार**: महत्वपूर्ण गति सुधार (कुछ मामलों में 6x तक)
...
Olive अतिरिक्त फीचर्स के लिए विभिन्न वैकल्पिक डिपेंडेंसी प्रदान करता है:
...
यदि सफल हो, तो आपको Olive CLI हेल्प मैसेज दिखाई देगा।
...
ऑप्टिमाइज़ेशन प्रक्रिया में शामिल हैं: मॉडल को लोकल कैश से प्राप्त करना, ONNX ग्राफ को कैप्चर करना और वेट्स को ONNX डेटा फ़ाइल में स्टोर करना, ONNX ग्राफ को ऑप्टिमाइज़ करना, और RTN विधि का उपयोग करके मॉडल को int4 में क्वांटाइज़ करना।

### कमांड पैरामीटर का विवरण

- `--model_name_or_path`: Hugging Face मॉडल पहचानकर्ता या लोकल पथ
...
- `--use_ort_genai`: इन्फेरेंस के लिए ONNX Runtime Generate AI का उपयोग करें
...
Hugging Face के दिए गए उदाहरण [lokinfey/Qwen3-8B-ONNX-INT4-CPU](https://huggingface.co/lokinfey/Qwen3-8B-ONNX-INT4-CPU) के आधार पर, यहाँ Qwen3 मॉडल को ऑप्टिमाइज़ करने का तरीका दिया गया है:
...
ऑप्टिमाइज़ेशन के बाद, आपका आउटपुट डायरेक्टरी निम्नलिखित सामग्री रखेगा:
...
Olive मॉडल को फाइन-ट्यूनिंग का समर्थन भी करता है:
...
### संबंधित उपकरण
- **ONNX Runtime**: उच्च-प्रदर्शन इन्फेरेंस इंजन — https://onnxruntime.ai/
- **Hugging Face Transformers**: कई संगत मॉडल का स्रोत — https://huggingface.co/docs/transformers/index
- **Azure Machine Learning**: क्लाउड-आधारित ऑप्टिमाइज़ेशन वर्कफ़्लो — https://learn.microsoft.com/azure/machine-learning/
