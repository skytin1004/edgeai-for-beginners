...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T18:26:16+00:00",
...
- **Foundry Local में महारत हासिल करें**: Windows 11 विकास के लिए स्थापना, कॉन्फ़िगरेशन और अनुकूलन करें
- **विविध मॉडल तैनात करें**: phi, qwen, deepseek, और GPT मॉडल को CLI कमांड के साथ स्थानीय रूप से चलाएं
- **उत्पादन समाधान बनाएं**: उन्नत प्रॉम्प्ट इंजीनियरिंग और डेटा एकीकरण के साथ AI एप्लिकेशन बनाएं
- **ओपन-सोर्स इकोसिस्टम का लाभ उठाएं**: Hugging Face मॉडल और सामुदायिक योगदान को एकीकृत करें
- **AI एजेंट विकसित करें**: ग्राउंडिंग और ऑर्केस्ट्रेशन क्षमताओं के साथ बुद्धिमान एजेंट बनाएं
- **एंटरप्राइज़ पैटर्न लागू करें**: उत्पादन तैनाती के लिए मॉड्यूलर, स्केलेबल AI समाधान बनाएं

## सत्र संरचना

### [1: Foundry Local के साथ शुरुआत करें](./01.FoundryLocalSetup.md)
...
**नमूना**: [REST चैट क्विकस्टार्ट](./samples/01/README.md) • [OpenAI SDK एकीकरण](./samples/02/README.md) • [मॉडल डिस्कवरी और बेंचमार्किंग](./samples/03/README.md)
...
**मुख्य विषय**: HuggingFace एकीकरण • अपना खुद का मॉडल लाएं • Model Mondays अंतर्दृष्टि • सामुदायिक योगदान • मॉडल चयन
...
### [10: Foundry Local को टूल्स फ्रेमवर्क के रूप में](./samples/10/README.md)
...
@@
यह मॉड्यूल एज एआई विकास के अत्याधुनिक पहलुओं का प्रतिनिधित्व करता है, जिसमें Microsoft के एंटरप्राइज़-ग्रेड टूल्स को ओपन-सोर्स इकोसिस्टम की लचीलापन और नवाचार के साथ जोड़ा गया है। Foundry Local के सभी 10 व्यापक नमूनों को सीखकर, आप एआई एप्लिकेशन विकास के अग्रणी स्थान पर होंगे।

**पूर्ण शिक्षण पथ:**
- **आधार** (नमूने 01-03): API एकीकरण और मॉडल प्रबंधन
- **एप्लिकेशन** (नमूने 04-06): RAG, एजेंट्स, और बुद्धिमान रूटिंग
- **उन्नत** (नमूने 07-10): उत्पादन फ्रेमवर्क और एंटरप्राइज़ एकीकरण

Azure OpenAI एकीकरण (सत्र 2) के लिए, आवश्यक पर्यावरण चर और API संस्करण सेटिंग्स के लिए व्यक्तिगत नमूने के README फाइलें देखें।
