...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T19:27:54+00:00",
...
एज एआई कृत्रिम बुद्धिमत्ता और एज कंप्यूटिंग का संगम है, जो उपकरणों पर सीधे बुद्धिमान प्रोसेसिंग को सक्षम बनाता है, बिना क्लाउड कनेक्टिविटी पर निर्भर हुए। इस अध्याय में विभिन्न प्लेटफॉर्म और फ्रेमवर्क पर आधारित पांच अलग-अलग EdgeAI कार्यान्वयन की चर्चा की गई है, जो एज पर एआई मॉडल चलाने की बहुमुखी प्रतिभा और शक्ति को प्रदर्शित करते हैं।

## 1. NVIDIA Jetson Orin Nano में EdgeAI

NVIDIA Jetson Orin Nano एज एआई कंप्यूटिंग में एक क्रांतिकारी कदम है, जो क्रेडिट-कार्ड के आकार के कॉम्पैक्ट फॉर्म फैक्टर में 67 TOPS तक एआई प्रदर्शन प्रदान करता है। यह शक्तिशाली एज एआई प्लेटफॉर्म शौकिया, छात्रों और पेशेवर डेवलपर्स के लिए जनरेटिव एआई विकास को सुलभ बनाता है।
...
- केवल $249 की कीमत पर, यह डेवलपर्स, छात्रों और निर्माताओं के लिए सबसे सस्ती और सुलभ प्लेटफॉर्म प्रदान करता है
...
- ONNX Runtime GenAI एकीकरण मोबाइल उपकरणों पर जनरेटिव एआई मॉडल को सीधे चलाने में सक्षम बनाता है
...
- जनरेटिव एआई लूप को पूरी तरह से लागू करता है, जिसमें प्री और पोस्ट प्रोसेसिंग, इनफेरेंस, लॉजिट्स प्रोसेसिंग, सर्च और सैंपलिंग, और KV कैश प्रबंधन शामिल हैं

### विकास लाभ
.NET MAUI दृष्टिकोण डेवलपर्स को उनके मौजूदा C# और .NET कौशल का लाभ उठाने की अनुमति देता है, जबकि क्रॉस-प्लेटफॉर्म एआई एप्लिकेशन बनाता है। ONNX Runtime GenAI फ्रेमवर्क कई मॉडल आर्किटेक्चर का समर्थन करता है, जिसमें Llama, Mistral, Phi, Gemma और अन्य शामिल हैं। अनुकूलित ARM64 कर्नेल INT4 क्वांटाइज़्ड मैट्रिक्स मल्टीप्लिकेशन को तेज करता है, मोबाइल हार्डवेयर पर कुशल प्रदर्शन सुनिश्चित करता है, जबकि परिचित .NET विकास अनुभव बनाए रखता है।

### उपयोग के मामले
यह समाधान उन डेवलपर्स के लिए आदर्श है जो .NET तकनीकों का उपयोग करके एआई-संचालित मोबाइल एप्लिकेशन बनाना चाहते हैं, जिसमें बुद्धिमान चैटबॉट, छवि पहचान ऐप्स, भाषा अनुवाद उपकरण और व्यक्तिगत अनुशंसा प्रणाली शामिल हैं, जो बेहतर गोपनीयता और ऑफलाइन क्षमता के लिए पूरी तरह से ऑन-डिवाइस चलती हैं।
...
- ONNX Runtime के साथ SLMs/LLMs और मल्टी-मोडल मॉडल को ऑन-डिवाइस और क्लाउड में चलाएं
...
Windows ML Microsoft का अत्याधुनिक रनटाइम है, जो ऑन-डिवाइस मॉडल इनफेरेंस और सरलीकृत तैनाती के लिए अनुकूलित है। यह Windows AI Foundry की नींव के रूप में कार्य करता है। यह प्लेटफॉर्म डेवलपर्स को एआई-संचालित Windows एप्लिकेशन बनाने में सक्षम बनाता है, जो पीसी हार्डवेयर की पूरी क्षमता का लाभ उठाते हैं।

### प्लेटफॉर्म क्षमताएं
- सभी Windows 11 पीसी पर काम करता है, जो संस्करण 24H2 (बिल्ड 26100) या उससे अधिक पर चल रहे हैं
- सभी x64 और ARM64 पीसी हार्डवेयर पर काम करता है, यहां तक कि वे पीसी भी जिनमें NPUs या GPUs नहीं हैं
...
## [5. Foundry Local एप्लिकेशन के साथ EdgeAI](./foundrylocal.md)

Foundry Local Windows और Mac डेवलपर्स को स्थानीय संसाधनों का उपयोग करके .NET में Retrieval Augmented Generation (RAG) एप्लिकेशन बनाने में सक्षम बनाता है। यह दृष्टिकोण स्थानीय भाषा मॉडल को सेमांटिक सर्च क्षमताओं के साथ जोड़ता है, जिससे गोपनीयता-केंद्रित एआई समाधान बनते हैं जो पूरी तरह से स्थानीय बुनियादी ढांचे पर काम करते हैं।

### तकनीकी वास्तुकला
- Phi भाषा मॉडल, स्थानीय एम्बेडिंग और सेमांटिक कर्नेल को जोड़कर RAG परिदृश्य बनाता है
...
- सेमांटिक कर्नेल मुख्य ऑर्केस्ट्रेटर के रूप में कार्य करता है, Phi और स्मार्ट घटकों को एक सहज RAG पाइपलाइन बनाने के लिए एकीकृत करता है
- SQLite और Qdrant सहित स्थानीय वेक्टर डेटाबेस का समर्थन करता है

### कार्यान्वयन लाभ
RAG, या Retrieval Augmented Generation, का मतलब है "कुछ जानकारी खोजें और उसे प्रॉम्प्ट में डालें"। यह स्थानीय कार्यान्वयन डेटा गोपनीयता सुनिश्चित करता है, जबकि कस्टम ज्ञान आधारों पर आधारित बुद्धिमान प्रतिक्रियाएं प्रदान करता है। यह दृष्टिकोण विशेष रूप से उन एंटरप्राइज़ परिदृश्यों के लिए मूल्यवान है जिनमें डेटा संप्रभुता और ऑफलाइन संचालन क्षमताओं की आवश्यकता होती है।
...
- इस रिपॉजिटरी में Windows के लिए पूर्ण गाइड: [foundrylocal.md](./foundrylocal.md)
...
मॉडल सूचीबद्ध करने के लिए त्वरित REST जांच (स्टेटस से PORT बदलें):
```cmd
...
Windows AI Foundry प्लेटफॉर्म Windows उपकरणों पर Edge AI विकास के लिए विशेष रूप से डिज़ाइन किए गए टूल्स और APIs का एक व्यापक सूट प्रदान करता है। इसमें NPU-त्वरित हार्डवेयर, Windows ML एकीकरण, और प्लेटफॉर्म-विशिष्ट अनुकूलन तकनीकों के लिए विशेष समर्थन शामिल है।
...
### [Edge AI विकास के लिए AI टूलकिट](./aitoolkit.md)
Visual Studio Code का उपयोग करने वाले डेवलपर्स के लिए, AI टूलकिट एक्सटेंशन Edge AI एप्लिकेशन बनाने, परीक्षण करने और तैनात करने के लिए विशेष रूप से डिज़ाइन किया गया एक व्यापक विकास वातावरण प्रदान करता है। यह टूलकिट VS Code के भीतर पूरे Edge AI विकास वर्कफ़्लो को सुव्यवस्थित करता है।

**विकास गाइड**: [Edge AI विकास के लिए AI टूलकिट](./aitoolkit.md)

AI टूलकिट गाइड में शामिल हैं:
...
इन सभी प्लेटफॉर्म्स में एक सामान्य सूत्र है: एआई क्षमताओं का लोकतंत्रीकरण, जो विभिन्न कौशल स्तरों और उपयोग मामलों के डेवलपर्स के लिए परिष्कृत मशीन लर्निंग को सुलभ बनाता है। चाहे मोबाइल एप्लिकेशन, डेस्कटॉप सॉफ़्टवेयर, या एम्बेडेड सिस्टम बना रहे हों, ये EdgeAI समाधान अगली पीढ़ी के बुद्धिमान एप्लिकेशन के लिए नींव प्रदान करते हैं, जो एज पर कुशलतापूर्वक और निजी तौर पर काम करते हैं।
