...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T13:28:55+00:00",
...
एज एआई कृत्रिम बुद्धिमत्ता और एज कंप्यूटिंग का संगम है, जो उपकरणों पर सीधे बुद्धिमान प्रोसेसिंग को सक्षम बनाता है, बिना क्लाउड कनेक्टिविटी पर निर्भर हुए। इस अध्याय में विभिन्न प्लेटफॉर्म और फ्रेमवर्क पर आधारित पांच अलग-अलग EdgeAI कार्यान्वयन की खोज की गई है, जो एज पर एआई मॉडल चलाने की बहुमुखी प्रतिभा और शक्ति को प्रदर्शित करता है।
...
- एआई प्रोसेसिंग के लिए 1024 CUDA कोर और 32 Tensor कोर
...
### अनुप्रयोग
Jetson Orin Nano आधुनिक जनरेटिव एआई मॉडल जैसे विज़न ट्रांसफॉर्मर्स, बड़े भाषा मॉडल और विज़न-भाषा मॉडल चलाने में उत्कृष्ट है। इसे विशेष रूप से GenAI उपयोग मामलों के लिए डिज़ाइन किया गया है, और अब आप कई LLMs को एक हथेली के आकार के उपकरण पर चला सकते हैं। लोकप्रिय उपयोग मामलों में एआई-संचालित रोबोटिक्स, स्मार्ट ड्रोन, बुद्धिमान कैमरे और स्वायत्त एज डिवाइस शामिल हैं।
...
- ONNX Runtime GenAI एकीकरण मोबाइल उपकरणों पर सीधे जनरेटिव एआई मॉडल चलाने में सक्षम बनाता है
...
### विकास लाभ
.NET MAUI दृष्टिकोण डेवलपर्स को उनके मौजूदा C# और .NET कौशल का लाभ उठाने की अनुमति देता है, जबकि क्रॉस-प्लेटफॉर्म एआई एप्लिकेशन बनाते हैं। ONNX Runtime GenAI फ्रेमवर्क कई मॉडल आर्किटेक्चर का समर्थन करता है, जिसमें Llama, Mistral, Phi, Gemma और अन्य शामिल हैं। अनुकूलित ARM64 कर्नल INT4 क्वांटाइज़्ड मैट्रिक्स मल्टीप्लिकेशन को तेज करता है, मोबाइल हार्डवेयर पर कुशल प्रदर्शन सुनिश्चित करता है, जबकि परिचित .NET विकास अनुभव बनाए रखता है।

### उपयोग के मामले
यह समाधान उन डेवलपर्स के लिए आदर्श है जो .NET तकनीकों का उपयोग करके एआई-संचालित मोबाइल एप्लिकेशन बनाना चाहते हैं, जिसमें बुद्धिमान चैटबॉट्स, छवि पहचान ऐप्स, भाषा अनुवाद उपकरण और व्यक्तिगत अनुशंसा प्रणाली शामिल हैं, जो बेहतर गोपनीयता और ऑफलाइन क्षमता के लिए पूरी तरह से ऑन-डिवाइस चलते हैं।
...
### प्लेटफॉर्म क्षमताएं
- Windows 11 PCs पर काम करता है, जो संस्करण 24H2 (बिल्ड 26100) या उससे अधिक पर चल रहे हैं
- सभी x64 और ARM64 PC हार्डवेयर पर काम करता है, यहां तक कि वे पीसी भी जिनमें NPUs या GPUs नहीं हैं
...
### डेवलपर लाभ
Windows ML हार्डवेयर और निष्पादन प्रदाताओं को अमूर्त करता है, जिससे आप अपने कोड लिखने पर ध्यान केंद्रित कर सकते हैं। साथ ही, Windows ML नवीनतम NPUs, GPUs और CPUs का समर्थन करने के लिए स्वचालित रूप से अपडेट होता है। यह प्लेटफॉर्म Windows हार्डवेयर इकोसिस्टम में एआई विकास के लिए एकीकृत फ्रेमवर्क प्रदान करता है।
...
Microsoft Foundry Local एक OpenAI-संगत REST सर्वर प्रदान करता है, जो Windows पर स्थानीय रूप से मॉडल चलाने के लिए ONNX Runtime द्वारा संचालित है। नीचे एक त्वरित, मान्य सारांश दिया गया है; पूर्ण विवरण के लिए आधिकारिक दस्तावेज़ देखें।
...
### Edge AI विकास के लिए AI टूलकिट
Visual Studio Code का उपयोग करने वाले डेवलपर्स के लिए, AI टूलकिट एक्सटेंशन विशेष रूप से Edge AI एप्लिकेशन बनाने, परीक्षण करने और तैनात करने के लिए डिज़ाइन किया गया एक व्यापक विकास वातावरण प्रदान करता है। यह टूलकिट VS Code के भीतर पूरे Edge AI विकास वर्कफ़्लो को सुव्यवस्थित करता है।
...
इन सभी प्लेटफॉर्म्स में एक सामान्य सूत्र है: एआई क्षमताओं का लोकतंत्रीकरण, जो विभिन्न कौशल स्तरों और उपयोग मामलों के डेवलपर्स के लिए परिष्कृत मशीन लर्निंग को सुलभ बनाता है। चाहे मोबाइल एप्लिकेशन, डेस्कटॉप सॉफ़्टवेयर, या एम्बेडेड सिस्टम बना रहे हों, ये EdgeAI समाधान अगली पीढ़ी के बुद्धिमान एप्लिकेशन के लिए आधार प्रदान करते हैं, जो एज पर कुशलता और गोपनीयता के साथ काम करते हैं।
