...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T15:23:28+00:00",
...
यह व्यापक गाइड आपको EdgeAI कोर्स के लिए तैयार करेगा, जो ऐसे व्यावहारिक AI समाधान बनाने पर केंद्रित है जो एज डिवाइस पर कुशलतापूर्वक चलते हैं। यह कोर्स आधुनिक फ्रेमवर्क और एज डिप्लॉयमेंट के लिए अनुकूलित अत्याधुनिक मॉडलों का उपयोग करके व्यावहारिक विकास पर जोर देता है।
...
**Python पर्यावरण**
- **संस्करण**: Python 3.10 या उससे उच्च (सुझाव: Python 3.11)
- **पैकेज प्रबंधक**: pip या conda
- **वर्चुअल पर्यावरण**: अलगाव के लिए venv या conda पर्यावरण का उपयोग करें
- **मुख्य पुस्तकालय**: कोर्स के दौरान हम विशेष EdgeAI पुस्तकालय स्थापित करेंगे

**Microsoft .NET पर्यावरण**
- **संस्करण**: .NET 8 या उससे उच्च
- **IDE**: Visual Studio 2022, Visual Studio Code, या JetBrains Rider
- **SDK**: क्रॉस-प्लेटफ़ॉर्म विकास के लिए .NET SDK सुनिश्चित करें
...
- Jupyter Notebooks इंटरैक्टिव विकास और प्रोटोटाइप के लिए

**संस्करण नियंत्रण**
- Git (नवीनतम संस्करण)
- रिपॉजिटरी एक्सेस और सहयोग के लिए GitHub खाता

## 2. हार्डवेयर आवश्यकताएं और सिफारिशें
...
यह कोर्स विभिन्न हार्डवेयर कॉन्फ़िगरेशन पर सुलभ होने के लिए डिज़ाइन किया गया है:

**स्थानीय विकास (CPU/NPU फोकस)**
- प्राथमिक विकास CPU और NPU त्वरण का उपयोग करेगा
- अधिकांश आधुनिक लैपटॉप और डेस्कटॉप के लिए उपयुक्त
- दक्षता और व्यावहारिक डिप्लॉयमेंट पर ध्यान केंद्रित
...
- **मजबूतियां**: उत्कृष्ट प्रदर्शन-से-आकार अनुपात, तर्क कार्यों के लिए अनुकूलित
...
**Qwen-3 परिवार**
- **विवरण**: अलीबाबा के नवीनतम पीढ़ी के बहुभाषी मॉडल
- **मजबूतियां**: मजबूत बहुभाषी क्षमताएं, कुशल आर्किटेक्चर
- **संसाधन**: [Qwen-3 संग्रह Hugging Face पर](https://huggingface.co/collections/Qwen/qwen3-67dd247413f0e2e4f653967f)
- **उपयोग के मामले**: बहुभाषी अनुप्रयोग, क्रॉस-सांस्कृतिक AI समाधान

**Google Gemma-3n परिवार**
- **विवरण**: एज डिप्लॉयमेंट के लिए अनुकूलित Google के हल्के मॉडल
- **मजबूतियां**: तेज़ अनुमान, मोबाइल-अनुकूल आर्किटेक्चर
- **संसाधन**: [Gemma-3n संग्रह Hugging Face पर](https://huggingface.co/collections/google/gemma-3n-685065323f5984ef315c93f4)
- **उपयोग के मामले**: मोबाइल अनुप्रयोग, रीयल-टाइम प्रोसेसिंग

### मॉडल चयन मानदंड
- **प्रदर्शन बनाम आकार संतुलन**: छोटे बनाम बड़े मॉडलों को चुनने का समय समझना
- **कार्य-विशिष्ट अनुकूलन**: मॉडलों को विशिष्ट उपयोग मामलों से मेल करना
- **डिप्लॉयमेंट बाधाएं**: मेमोरी, विलंबता, और पावर खपत विचार
...
- **स्थापना और मूल उपयोग**:
  ...
  # मॉडल और अनुकूलन कॉन्फ़िग परिभाषित करें
...
- **Installation and Basic Usage**:
  ...
  # मॉडल लोड और अनुकूलित करने के लिए उदाहरण Python स्क्रिप्ट
  ```python
...
- **Edge AI डिज़ाइन पैटर्न**: एज डिप्लॉयमेंट के लिए सर्वोत्तम प्रथाएं
...
- **YouTube चैनल**: तकनीकी गहन अध्ययन और ट्यूटोरियल

## 6. मूल्यांकन और सत्यापन

### पूर्व-कोर्स चेकलिस्ट
...
- [ ] क्वांटाइजेशन उपकरण स्थापित और परीक्षण किए गए
- [ ] हार्डवेयर आवश्यकताएं पूरी हुईं
- [ ] क्लाउड कंप्यूटिंग खाते सेटअप (यदि आवश्यक हो)

## प्रमुख सीखने के उद्देश्य

इस गाइड के अंत तक, आप सक्षम होंगे:

1. EdgeAI अनुप्रयोग विकास के लिए एक पूर्ण विकास पर्यावरण सेट करें
...
4. एज डिवाइस पर AI मॉडल डिप्लॉय करने के लिए प्रमुख विचारों को समझें
5. कोर्स में व्यावहारिक अभ्यास के लिए अपनी प्रणाली तैयार करें
...
- **ऑनलाइन कोर्स**: AI अनुकूलन पर पूरक शिक्षण सामग्री
...
इस तैयारी गाइड को पूरा करने के बाद, आप:

1. EdgeAI विकास के लिए पूरी तरह से कॉन्फ़िगर किया गया विकास पर्यावरण तैयार करेंगे
2. विभिन्न डिप्लॉयमेंट परिदृश्यों के लिए हार्डवेयर और सॉफ़्टवेयर आवश्यकताओं को समझेंगे
3. कोर्स में उपयोग किए जाने वाले प्रमुख फ्रेमवर्क और उपकरणों से परिचित होंगे
4. डिवाइस बाधाओं और आवश्यकताओं के आधार पर उपयुक्त मॉडल चुनने में सक्षम होंगे
5. एज डिप्लॉयमेंट के लिए अनुकूलन तकनीकों का आवश्यक ज्ञान प्राप्त करेंगे

## ➡️ आगे क्या

- [04: EdgeAI हार्डवेयर और डिप्लॉयमेंट](04.EdgeDeployment.md)
