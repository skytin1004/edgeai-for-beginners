...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T10:19:33+00:00",
...
Microsoft Foundry Local apporte les capacités d'Azure AI Foundry directement à votre environnement de développement Windows 11, permettant un développement IA à faible latence et respectueux de la vie privée avec des outils de niveau entreprise. Cette session couvre l'installation complète, la configuration et le déploiement pratique de modèles populaires tels que phi, qwen, deepseek et GPT-OSS-20B.
...
Créez une application de chat prête pour la production en utilisant le SDK OpenAI avec l'intégration Foundry Local, en suivant les modèles de notre exemple 01.
...
| `API_KEY` | Clé API (généralement non nécessaire en local) | `""` | Non |
...
- **Utiliser le SDK OpenAI** : Préférez le SDK OpenAI aux requêtes HTTP brutes pour une meilleure maintenabilité
...
### Exercice 2 : Test d'intégration SDK OpenAI
...
- **Intégration SDK OpenAI** : https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/how-to/how-to-integrate-with-inference-sdks
...
- **Exemple 01 : Chat rapide via SDK OpenAI** : samples/01/README.md
- **Exemple 02 : Intégration avancée du SDK** : samples/02/README.md
