...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T12:27:11+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "fr"
}
-->
# Session 2 : Créer des solutions IA avec Azure AI Foundry

## Aperçu

En s'appuyant sur les bases de Foundry Local, cette session se concentre sur la création de solutions IA avancées grâce à l'ingénierie de prompts, l'intégration fluide des données et l'automatisation des tâches. Vous apprendrez à relier le développement local aux capacités d'Azure AI Foundry pour créer des applications prêtes pour l'entreprise, tirant parti des avantages des deux environnements.

## Objectifs d'apprentissage

À la fin de cette session, vous serez capable de :
- Maîtriser des techniques avancées d'ingénierie de prompts pour des réponses IA cohérentes et fiables
- Mettre en œuvre des modèles d'intégration de données robustes pour des applications concrètes
- Créer des tâches IA exploitables qui génèrent de la valeur pour l'entreprise
- Établir une connectivité fluide entre Foundry Local et Azure AI Foundry
- Construire des workflows de surveillance et d'optimisation des performances
- Déployer des solutions IA prêtes pour la production avec gestion des erreurs et mise à l'échelle

## Prérequis

- Avoir terminé la Session 1 : Introduction à Foundry Local
- Installation active de Foundry Local avec des modèles en fonctionnement
- Compte Azure (le niveau gratuit suffit pour l'apprentissage)
- Compréhension de base des API REST et du format JSON

## Partie 1 : Ingénierie avancée de prompts

### Comprendre l'architecture des prompts

L'ingénierie efficace des prompts est la base des applications IA fiables. Foundry Local offre des capacités avancées pour la création de prompts :
...
### Mettre en œuvre des stratégies de prompts
...
### Exemples pratiques d'ingénierie de prompts
...
## Partie 2 : Modèles d'intégration de données

### Connecteurs de données Foundry Local
...
### Exemple concret d'intégration de données
...
## Partie 3 : Tâches IA exploitables

### Cadre d'automatisation des tâches
...
## Partie 4 : Intégration avec Azure AI Foundry
...
## Partie 5 : Surveillance et optimisation des performances
...
### Exercice 1 : Bot avancé pour le service client
...
### Exercice 2 : Recherche de marché automatisée
...
## Partie 7 : Prochaines étapes et aperçu de la Session 3

### Réalisations de la session

Dans cette session, vous avez maîtrisé :
- ✅ Techniques avancées d'ingénierie de prompts pour un comportement IA cohérent
- ✅ Modèles d'intégration de données robustes pour des applications concrètes
- ✅ Création de tâches automatisées pour l'optimisation des processus métier
- ✅ Intégration avec Azure AI Foundry et stratégies de déploiement hybride
- ✅ Surveillance et optimisation complètes des performances

### Préparation à la Session 3 : Modèles open source

1. **Explorer Hugging Face** : Créez un compte et parcourez le catalogue de modèles
2. **Revoir les "Model Mondays"** : Consultez la dernière série [Model Mondays](https://aka.ms/model-mondays)
3. **Planifier des modèles personnalisés** : Réfléchissez aux modèles spécialisés qui pourraient bénéficier à vos cas d'utilisation

### Ressources supplémentaires

- [Documentation Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Répertoire GitHub Foundry Local](https://github.com/microsoft/Foundry-Local)
- [Guide avancé d'ingénierie de prompts](https://platform.openai.com/docs/guides/prompt-engineering)
- [Meilleures pratiques pour l'automatisation des processus métier](https://docs.microsoft.com/en-us/power-automate/)

Vous êtes maintenant prêt à créer des solutions IA sophistiquées qui combinent la puissance de l'inférence locale avec les capacités à grande échelle du cloud, posant ainsi les bases d'applications IA de niveau entreprise.
