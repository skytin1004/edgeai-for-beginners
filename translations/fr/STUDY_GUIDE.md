...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T10:15:40+00:00",
...
2. **Fondations des petits modèles de langage (SLM)** - Explorer diverses familles de SLM et leurs architectures
3. **Déploiement des petits modèles de langage (SLM)** - Mettre en œuvre des stratégies de déploiement pratiques
...
- **Concepts prioritaires** : 
  ...
  - Framework d'optimisation d'inférence
...
## Module 3 : Déploiement des petits modèles de langage (SLM)
...
1. **Déploiement local basique** : Déployez un SLM simple en utilisant Ollama (1 heure)
...
## Module 4 : Conversion de format de modèle et quantification
...
- Déployer des modèles optimisés pour des environnements edge en production sur Intel, Apple et matériel multiplateforme
...
- **Concepts prioritaires** : 
  ...
  - Capacités de fine-tuning avec LoRA
...
6. Comment la synthèse des workflows aide-t-elle à sélectionner les frameworks d'optimisation optimaux ?

### Exercices pratiques

1. **Quantification de modèle** : Appliquez différents niveaux de quantification à un modèle et comparez les résultats (1 heure)
2. **Optimisation OpenVINO** : Utilisez NNCF pour compresser un modèle destiné au matériel Intel (1 heure)
...
## Module 5 : SLMOps - Opérations pour les petits modèles de langage
...
#### Section 2 : Distillation de modèle
- **Concepts prioritaires** : 
...
- **Concepts prioritaires** : 
  - Déploiement NVIDIA Jetson Orin Nano (performance IA de 67 TOPS)
...
## Module 8 : Microsoft Foundry Local – Toolkit complet pour développeurs (modernisé)
...
- Déployer des solutions IA prêtes pour la production avec un suivi complet
- Intégrer avec Azure AI Foundry pour des scénarios de déploiement hybrides
- Maîtriser les modèles SDK modernes avec FoundryLocalManager et client OpenAI
...
- **Concepts prioritaires** : 
  ...
  - Découverte automatique des services et suivi de la santé
...
#### Section 3 : Routage intelligent de modèles
- **Concepts prioritaires** : 
  - Algorithmes de sélection de modèles basés sur des mots-clés
  - Support multi-modèles (général, raisonnement, code, créatif)
  - Configuration des variables d'environnement pour la flexibilité
...
- **Concepts prioritaires** : 
  ...
  - Exemples interactifs avec Jupyter notebooks et benchmarks
...
4. Quels sont les principaux composants d'un système d'agent IA prêt pour la production ?
5. Comment implémentez-vous un suivi complet de la santé des services Foundry Local ?
6. Comparez les avantages de l'approche modernisée par rapport aux modèles d'implémentation traditionnels.

### Exercices pratiques

1. **Configuration SDK moderne** : Configurez FoundryLocalManager avec découverte automatique des services (30 minutes)
2. **Système multi-agents** : Exécutez le modèle de coordination avancé avec agents spécialisés (30 minutes)
3. **Routage intelligent** : Testez le routeur de modèles avec différents types de requêtes (30 minutes)
4. **Exploration interactive** : Utilisez les Jupyter notebooks pour explorer les fonctionnalités avancées (45 minutes)
5. **Déploiement en production** : Implémentez des modèles de suivi et de gestion des erreurs (30 minutes)
6. **Intégration hybride** : Configurez des scénarios de secours avec Azure AI Foundry (30 minutes)

## Guide de répartition du temps

Pour vous aider à tirer le meilleur parti des 20 heures de cours, voici une répartition suggérée de votre temps :
...
| Auto-évaluation | 2 heures | Test de votre compréhension via des questions et réflexions |
...
- Complétez tous les sept modules
...
- [Ollama Quick Start](https://github.com/ollama/ollama#get-started) - La manière la plus rapide de déployer des SLM localement
...
- [OpenVINO GenAI](https://github.com/openvinotoolkit/openvino.genai) - Toolkit de déploiement de modèles de langage étendus
...
4. **Workflow avec AI Toolkit** : Utilisez VS Code AI Toolkit pour optimiser et déployer un modèle de bout en bout.
...
7. **Agent d'appel de fonctions** : Construisez un agent AI avec des capacités d'appel de fonctions pour des scénarios Edge.

### Projets d'Intégration Avancée (4-5 heures chacun)
8. **Pipeline d'optimisation OpenVINO** : Implémentez une optimisation complète de modèle en utilisant NNCF et GenAI toolkit.
9. **Pipeline SLMOps** : Mettez en œuvre un cycle de vie complet de modèle, de l'entraînement au déploiement Edge.
10. **Système Edge multi-modèles** : Déployez plusieurs modèles spécialisés travaillant ensemble sur du matériel Edge.
11. **Système d'intégration MCP** : Construisez un système agentique utilisant le protocole Model Context pour l'interaction avec des outils.

## Références

- Microsoft Learn (Foundry Local)
  - Vue d'ensemble : https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/
  - Commencer : https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/get-started
  - Référence CLI : https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/reference/reference-cli
  - Intégrer avec les SDK d'inférence : https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/how-to/how-to-integrate-with-inference-sdks
  - Guide WebUI ouvert : https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/how-to/how-to-chat-application-with-open-web-ui
...
- Outils d'optimisation et d'inférence
  ...
  - ONNX Runtime (commencer) : https://onnxruntime.ai/docs/get-started/with-python.html
...
- Frameworks de déploiement et modèles
  ...
  - Ollama (guide rapide) : https://github.com/ollama/ollama#get-started
...
- Discussions GitHub sur le [répertoire EdgeAI for Beginners](https://github.com/microsoft/edgeai-for-beginners/discussions)
- [Microsoft Tech Community](https://techcommunity.microsoft.com/)
- [Stack Overflow](https://stackoverflow.com/questions/tagged/edge-ai)

## Conclusion

EdgeAI représente l'avant-garde de la mise en œuvre de l'intelligence artificielle, apportant des capacités puissantes directement aux appareils tout en répondant à des préoccupations critiques concernant la confidentialité, la latence et la connectivité. Ce cours de 20 heures vous fournit les connaissances essentielles et les compétences pratiques pour commencer à travailler avec les technologies EdgeAI immédiatement.

Le cours est délibérément concis et axé sur les concepts les plus importants, vous permettant d'acquérir rapidement une expertise précieuse sans un engagement de temps écrasant. N'oubliez pas que la pratique concrète, même avec des exemples simples, est la clé pour renforcer ce que vous avez appris.
