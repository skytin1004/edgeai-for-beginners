...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T12:02:16+00:00",
...
Microsoft Olive est un outil puissant et facile à utiliser pour l'optimisation des modèles, conçu pour tirer parti des spécificités matérielles. Il simplifie le processus d'optimisation des modèles d'apprentissage automatique pour leur déploiement sur différentes plateformes matérielles. Que vous cibliez des CPU, GPU ou des accélérateurs IA spécialisés, Olive vous aide à atteindre des performances optimales tout en préservant la précision des modèles.

## Qu'est-ce que Microsoft Olive ?

Olive est un outil d'optimisation des modèles, conscient des spécificités matérielles, qui combine des techniques de pointe dans les domaines de la compression, de l'optimisation et de la compilation des modèles. Il fonctionne avec ONNX Runtime comme solution d'optimisation de bout en bout pour l'inférence.
...
- **40+ composants d'optimisation intégrés** : Inclut la compression des modèles, la quantification, l'optimisation des graphes, et bien plus
...
- **Précision préservée** : Les optimisations maintiennent la qualité des modèles tout en améliorant leurs performances
...
Basé sur l'exemple Hugging Face fourni à [lokinfey/Qwen3-8B-ONNX-INT4-CPU](https://huggingface.co/lokinfey/Qwen3-8B-ONNX-INT4-CPU), voici comment optimiser un modèle Qwen3 :
...
- Envisagez DirectML pour les machines Windows avec des graphiques intégrés
...
- Expérimentez avec différents passages d'optimisation
...
- **Notebooks Jupyter** : Disponibles dans le dépôt GitHub Olive — https://github.com/microsoft/Olive/tree/main/examples
...
- **Hugging Face Transformers** : Source de nombreux modèles compatibles — https://huggingface.co/docs/transformers/index
