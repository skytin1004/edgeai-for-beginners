...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T00:36:10+00:00",
...
Building on your Foundry Local foundation, this session focuses on advanced OpenAI SDK integration techniques that support both Microsoft Foundry Local and Azure OpenAI. You'll learn how to create flexible AI applications that can operate locally for privacy and development purposes, while offering cloud scalability through Azure OpenAI when required.

## Learning Objectives

By the end of this session, you will:
- Gain expertise in advanced OpenAI SDK integration with Foundry Local and Azure OpenAI
- Implement streaming responses for improved user experience
- Develop robust client factory patterns for multi-provider support
- Build conversation management systems that preserve context
- Perform performance benchmarking and health monitoring
- Deploy production-ready applications with effective error handling

## Prerequisites

- Completion of Session 1: Getting Started with Foundry Local
- Active Foundry Local installation with operational models
- Python 3.8 or later with virtual environment support
- OpenAI Python SDK installed (`pip install openai foundry-local-sdk`)
- Azure account with OpenAI service (optional, for cloud scenarios)
...
Creating applications that work with both Foundry Local and Azure OpenAI requires a flexible client creation approach:
...
Streaming enhances user experience by displaying responses as they are generated:
...
### Temperature and Parameter Testing
...
Complete guide for configuring both providers:
...
Develop a complete application that seamlessly switches between providers:
...
In this session, you have mastered:
- ✅ **OpenAI SDK Integration**: Advanced techniques for Foundry Local and Azure OpenAI
- ✅ **Streaming Responses**: Real-time chat completions for better user experience
...
- ✅ **Performance Monitoring**: Benchmarking and health checks for production environments
- ✅ **Production Patterns**: Effective error handling and configuration management
...
2. **🌊 Use Streaming for Long Responses**: Improves perceived performance
3. **🛡️ Implement Comprehensive Error Handling**: Provide user-friendly error messages
4. **📈 Monitor Performance**: Track response times and success rates
5. **⚙️ Environment-Based Configuration**: Simplify switching between dev/staging/prod
6. **🔒 Secure Credential Management**: Avoid hardcoding API keys
...
| **Privacy-Critical**  | Foundry Local       | Data stays on the device     |
| **High-Volume Production** | Azure OpenAI | Better scalability, enterprise SLA |
...
1. **Explore Model Catalog**: Review available models in Foundry Local
2. **Understand Model Formats**: Learn about ONNX, quantization, and optimization
3. **Consider Custom Models**: Evaluate domain-specific model needs
...
- **[Streaming Completions Guide](https://learn.microsoft.com/azure/ai-foundry/foundry-local/how-to/integrate-with-inference-sdks)**: Advanced streaming techniques
- **[Sample 01: Quick Chat via OpenAI SDK](samples/01/README.md)**: Basic integration patterns
- **[Sample 02: Advanced SDK Integration](samples/02/README.md)**: Hands-on examples from this session
- **[Sample 04: Chainlit Application](samples/04/README.md)**: Web UI development
- **[Sample 05: Multi-Agent Systems](samples/05/README.md)**: Advanced orchestration techniques

You are now equipped to create sophisticated AI applications that integrate local and cloud AI capabilities, offering the flexibility to choose the best provider for each use case while maintaining consistent development practices.
