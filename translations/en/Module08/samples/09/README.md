...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T02:57:38+00:00",
...
An advanced multi-agent system powered by Microsoft Foundry Local, showcasing intelligent agent coordination, specialized task delegation, and collaborative problem-solving techniques.

## Overview

This example demonstrates how to create sophisticated AI agent systems using Foundry Local, implementing Microsoft's official patterns for function calling, agent orchestration, and collaborative AI workflows.
...
- **Problem Solver**: Complex reasoning, decision making

### ⚡ **Advanced Function Calling**
- Microsoft Foundry Local function calling patterns
...
- **Memory**: 16GB+ recommended for multiple agents
- **Storage**: 15GB+ for multiple models
- **CPU/GPU**: Multi-core processor, GPU recommended
...
### Example 3: Problem Solving Session
```python
...
- **Advanced Topics**: Custom agent development
...
This example follows the same license as the Microsoft Foundry Local project.
