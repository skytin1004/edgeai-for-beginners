...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T20:25:22+00:00",
...
Med utgangspunkt i din Foundry Local-kunnskap, fokuserer denne sesjonen på å lage avanserte AI-løsninger gjennom forbedret promptutforming, sømløs dataintegrasjon og automatisering av oppgaver. Du vil lære å koble lokal utvikling med Azure AI Foundry-funksjoner, og skape bedriftsklare applikasjoner som utnytter det beste fra begge verdener.

## Læringsmål

Ved slutten av denne sesjonen vil du:
- Mestre avanserte teknikker for promptutforming som gir konsistente og pålitelige AI-responser
- Implementere robuste mønstre for dataintegrasjon i virkelige applikasjoner
- Lage handlingsrettede AI-oppgaver som skaper forretningsverdi
- Etablere sømløs tilkobling mellom Foundry Local og Azure AI Foundry
- Bygge arbeidsflyter for ytelsesovervåking og optimalisering
- Distribuere produksjonsklare AI-løsninger med riktig feilhåndtering og skalering

## Forutsetninger

- Fullført Sesjon 1: Kom i gang med Foundry Local
- Aktiv Foundry Local-installasjon med fungerende modeller
- Azure-konto (gratisnivå er tilstrekkelig for læring)
- Grunnleggende forståelse av REST API-er og JSON

## Del 1: Avansert promptutforming

### Forståelse av promptarkitektur

Effektiv promptutforming er grunnlaget for pålitelige AI-applikasjoner. Foundry Local tilbyr forbedrede muligheter for promptutforming:
...
### Implementering av promptstrategier
...
### Praktiske eksempler på promptutforming
...
## Del 2: Mønstre for dataintegrasjon

### Foundry Local datakoblinger
...
### Eksempel på dataintegrasjon i virkeligheten
...
## Del 3: Handlingsrettede AI-oppgaver

### Rammeverk for oppgaveautomatisering
...
### Eksempler på automatisering av forretningsprosesser
...
## Del 4: Integrasjon med Azure AI Foundry
...
### Mønstre for hybrid distribusjon
...
## Del 5: Ytelsesovervåking og optimalisering

### Omfattende overvåkingssystem
...
### Øvelse 1: Avansert kundeservicebot
...
### Øvelse 2: Automatisert markedsundersøkelse
...
## Del 7: Neste steg og forhåndsvisning av Sesjon 3

### Oppnåelser i denne sesjonen

I denne sesjonen har du mestret:
- ✅ Avanserte teknikker for promptutforming som gir konsistent AI-adferd
- ✅ Robuste mønstre for dataintegrasjon i virkelige applikasjoner
- ✅ Automatisert oppgaveoppretting for optimalisering av forretningsprosesser
- ✅ Integrasjon med Azure AI Foundry og strategier for hybrid distribusjon
- ✅ Omfattende overvåking og optimalisering av ytelse

### Forberedelse til Sesjon 3: Åpen kildekode-modeller

1. **Utforsk Hugging Face**: Opprett en konto og bla gjennom modellkatalogen
2. **Gjennomgå Model Mondays**: Sjekk ut den nyeste [Model Mondays-serien](https://aka.ms/model-mondays)
3. **Planlegg tilpassede modeller**: Vurder hvilke spesialiserte modeller som kan være nyttige for dine bruksområder

### Tilleggsressurser

- [Azure AI Foundry-dokumentasjon](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Foundry Local GitHub-repositorium](https://github.com/microsoft/Foundry-Local)
- [Avansert veiledning for promptutforming](https://platform.openai.com/docs/guides/prompt-engineering)
- [Beste praksis for automatisering av forretningsprosesser](https://docs.microsoft.com/en-us/power-automate/)

Du er nå rustet til å bygge avanserte AI-løsninger som kombinerer kraften fra lokal inferens med skalerbare skyfunksjoner, og legger grunnlaget for AI-applikasjoner i bedriftsklasse.
