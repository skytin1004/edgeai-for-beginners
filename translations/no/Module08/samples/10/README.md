...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T23:38:38+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "no"
}
-->
# Foundry Local som Verktøysintegrasjon

Et omfattende rammeverk for å integrere Microsoft Foundry Local som kallbare verktøy i større applikasjoner, i tråd med Microsofts offisielle mønstre for AI-integrasjon basert på verktøy.

## Oversikt

Dette eksemplet viser hvordan Foundry Local-modeller kan eksponeres som gjenbrukbare verktøy som kan integreres i eksisterende applikasjoner, arbeidsflyter og utviklingsmiljøer. Det demonstrerer Microsofts anbefalte mønstre for verktøysintegrasjon og funksjonskall.

## Nøkkelkonsepter

### 🔧 **Verktøy-først Arkitektur**
- Foundry Local-modeller som kallbare funksjoner
- Standardiserte verktøygrensesnitt og skjemaer
- Sømløs integrasjon med eksisterende kodebaser
- Type-sikre verktøydefinisjoner og validering

### ⚡ **Mønstre for Funksjonskall**
- Microsoft Foundry Local-implementasjon for funksjonskall
- OpenAI-kompatible verktøydefinisjoner
- Automatisk parametervalidering og konvertering
- Feilhåndtering og responsformatering

### 🔌 **Integrasjonsrammeverk**
- **LangChain-integrasjon**: Native støtte for LangChain-verktøy
- **Semantic Kernel**: Microsoft Semantic Kernel-funksjoner
- **REST API**: HTTP-baserte verktøyendepunkter
- **CLI-verktøy**: Kommandolinjeintegrasjon
- **Jupyter Notebooks**: Interaktive utviklingsverktøy

### 🎯 **Bruksmønstre**
- Verktøy for kodeanalyse og generering
- Innholdsbehandling og oppsummering
...
### Systemkrav
- **Python**: 3.9+ med asyncio-støtte
- **Node.js**: v18+ (for JavaScript-integrasjoner)
- **Minne**: Anbefalt 12GB+
- **Lagring**: 10GB+ for modeller og verktøy
...
### Rammeverksspesifikke avhengigheter
```bash
...
### 1. Grunnleggende Verktøyopprettelse
```python
...
## Kjerneverktøysmønstre

### 1. Funksjonsbaserte Verktøy
```python
...
1. **Mønstre for Verktøysintegrasjon**
   - Design av funksjonsbaserte og klassebaserte verktøy
   - Microsoft Foundry Local-integrasjonsmønstre
   - Skjemavalidering og type-sikkerhet
   - Feilhåndtering og gjenoppretting

2. **Rammeverksintegrasjon**
   - Utvikling av LangChain-verktøy
   - Integrasjon av Semantic Kernel-funksjoner
   - REST API-rammeverksintegrasjon
   - Utvikling av CLI-applikasjoner

3. **Produksjonsbetraktninger**
   - Strategier for ytelsesoptimalisering
   - Hurtigbuffer og ressursstyring
   - Overvåking og observabilitet
   - Sikkerhet og validering

4. **Avanserte Verktøysmønstre**
   - Verktøysammensetning og kjeding
   - Kontekstbevisst behandling
   - Batch- og strømmeoperasjoner
   - Utvikling av tilpassede integrasjoner

## Neste Steg

- **Integrasjonsprosjekter**: Bygg tilpassede integrasjoner med dine foretrukne rammeverk
- **Verktøyutvikling**: Lag spesialiserte verktøy for ditt domene
- **Ytelsestilpasning**: Optimaliser for dine spesifikke bruksområder
- **Produksjonsutrulling**: Skaler verktøy for bedriftsbruk

## Bidra

Se retningslinjene for hovedrepoet for instruksjoner om hvordan du kan bidra.
