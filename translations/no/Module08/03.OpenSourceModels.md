...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T23:20:45+00:00",
  "source_file": "Module08/03.OpenSourceModels.md",
  "language_code": "no"
}
-->
# Økt 3: Oppdagelse og administrasjon av åpne modeller

## Oversikt

Denne økten fokuserer på praktisk oppdagelse og administrasjon av modeller med Foundry Local. Du vil lære hvordan du lister tilgjengelige modeller, tester ulike alternativer og forstår grunnleggende ytelseskarakteristikker. Tilnærmingen legger vekt på praktisk utforskning med foundry CLI for å hjelpe deg med å velge de riktige modellene for dine bruksområder.
...
- Fullført Økt 1: Komme i gang med Foundry Local
...
**Treg ytelse:**
- Sørg for at modellen er fullstendig lastet (sjekk detaljert utdata)
...
3. **Overvåk ressurser**: Følg med på minnebruk
4. **Test konsekvent**: Bruk de samme spørsmålene for rettferdige sammenligninger
5. **Dokumenter resultater**: Ta notater om modellens ytelse for dine bruksområder

## Del 8: Neste steg og referanser

### Forberedelse til Økt 4

- **Fokus for Økt 4**: Optimaliseringsverktøy og teknikker
- **Forutsetninger**: Komfortabel med modellbytte og grunnleggende ytelsestesting
- **Anbefalt**: Ha 2-3 favorittmodeller identifisert fra denne økten
...
✅ **Modellvalg**: Praktiske retningslinjer for å velge modeller etter bruksområde  
...
- Oppdag og evaluer åpne modeller for lokal inferens
- Kompiler og kjør utvalgte Hugging Face-modeller i Foundry Local
...
Start med populære, velprøvde modeller for å forstå ytelseskarakteristikker:
...
**Merk:** Flagget `--verbose` gir detaljerte oppstartsopplysninger, inkludert:
...
- `phi-4`: Mer kapabel versjon med bedre resonnering

**Middels store modeller:**
- `qwen2.5-7b-instruct`: Utmerket resonnering og lengre kontekst
- `deepseek-r1-distill-qwen-7b`: Optimalisert for kodegenerering

**Større modeller:**
- `llama-3.2`: Metas nyeste åpne modell
- `qwen2.5-14b-instruct`: Bedriftsnivå resonnering
...
Når en modell kjører, test den med konsekvente spørsmål:
...
### PowerShell-alternativ for testing
...
### Velge modeller etter bruksområde

**For generell chat og spørsmål/svar:**
- Start med: `phi-4-mini` (rask, effektiv)
- Oppgrader til: `phi-4` (bedre resonnering)
- Avansert: `qwen2.5-7b-instruct` (lengre kontekst)

**For kodegenerering:**
- Anbefalt: `deepseek-r1-distill-qwen-7b`
- Alternativ: `qwen2.5-7b-instruct` (også god for kode)

**For kompleks resonnering:**
- Best: `qwen2.5-7b-instruct` eller `qwen2.5-14b-instruct`
...
For hver modell, test med konsekvente spørsmål og vurder manuelt:
...
- Forbered deg til Økt 4: sammenligning av LLM-er vs SLM-er, lokal vs sky-inferens, og praktiske demoer
