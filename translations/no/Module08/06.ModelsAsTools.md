...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T23:22:36+00:00",
...
Behandle AI-modeller som modulære, tilpassbare verktøy som kjører direkte på enheten med Foundry Local. Denne økten fokuserer på praktiske arbeidsflyter for personvernbevarende, lav-latens inferens og hvordan du kan integrere disse verktøyene via SDK-er, API-er eller CLI. Du vil også lære hvordan du kan skalere til Azure AI Foundry når det er nødvendig.
...
- **Helsesjekk**: Validering av tjenester og sjekking av modelltilgjengelighet
...
- `samples/06/model_router.ipynb` - Interaktive eksempler og ytelsestester
...
## Del 1: Intelligent modellruter (moderne implementering)
...
Trinn 2) Initialiser klienten med moderne SDK og tjenesteoppdagelse  
```python
...
Trinn 2) Konfigurer miljøet (valgfritt - se `samples/06/README.md`)  
```cmd
...
Trinn 1) Opprett en prompt-mal for domenet  
```python
# domain/templates.py
...
Mål: Utplassere den intelligente ruteren med overvåking og integrasjon med Azure AI Foundry.
...
- [ ] Implementere helsesjekk for tjenester og feilhåndtering
