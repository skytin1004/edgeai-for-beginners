...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T09:03:08+00:00",
...
- Forstå hva EdgeAI er og hvorfor det er viktig i dagens teknologilandskap
- Identifisere store industrier transformert av EdgeAI og deres spesifikke bruksområder
...
- Gjenkjenne karrieremuligheter og ferdighetskrav innen EdgeAI-feltet

### Studieområder

#### Seksjon 1: EdgeAI Paradigme og Definisjon
- **Prioriterte Konsepter**: 
  - EdgeAI vs. tradisjonell skybasert AI-prosessering
...
1. Hva er de tre viktigste teknologiske trendene som har muliggjort EdgeAI?
2. Sammenlign fordelene og utfordringene med EdgeAI vs. skybasert AI.
3. Nevn tre industrier der EdgeAI gir kritisk forretningsverdi og forklar hvorfor.
4. Hvordan gjør Små Språkmodeller EdgeAI praktisk for implementering i virkeligheten?
...
1. **Industriforskning**: Velg ett bruksområde og undersøk en virkelig EdgeAI-implementering (30 minutter)
...
- [EdgeAI Markedsoversikt - McKinsey](https://www.mckinsey.com/capabilities/mckinsey-digital/our-insights/the-age-of-ai)
- [Oversikt over Små Språkmodeller - Hugging Face](https://huggingface.co/blog/small-language-models)
- [Edge Computing Grunnlag](https://www.edgecomputing.org/)
...
- **Prioriterte Konsepter**: 
  - Kant vs. Sky computing paradigmer
...
#### Seksjon 1: Microsoft Phi Modellfamilie
- **Prioriterte Konsepter**: 
...
5. For en mobilapplikasjon med begrenset tilkobling, hvilken modellsamling ville være mest passende og hvorfor?  
...
4. Hva er de viktigste ytelsesindikatorene å overvåke for en SLM distribuert på kanten?  
...
2. **Ytelsessjekk**: Kjør en rask benchmark på den distribuerte modellen din (30 minutter)  
3. **Enkel Integrasjon**: Lag en minimal applikasjon som bruker den distribuerte modellen din (1 time)  
...
- Distribuere optimaliserte modeller for produksjonsmiljøer på kanten for Intel, Apple og plattformuavhengig maskinvare  

### Studieområder  

#### Seksjon 1: Grunnleggende om Kvantisering  
- **Prioriterte Konsepter**:  
  - Rammeverk for presisjonsklassifisering  
  - Avveining mellom ytelse og nøyaktighet  
  - Optimalisering av minnefotavtrykk  

#### Seksjon 2: Implementering i Llama.cpp  
- **Prioriterte Konsepter**:  
...
2. **OpenVINO Optimalisering**: Bruk NNCF for å komprimere en modell for Intel-maskinvare (1 time)  
...
- **Prioriterte Konsepter**:  
  ...
  - Strategisk forretningspåvirkning og konkurransefortrinn  

#### Seksjon 2: Modell Distillasjon  
- **Prioriterte Konsepter**:  
...
- **Prioriterte Konsepter**:  
  ...
  - Konfigurasjon for distribusjon med Foundry Local  
  - Ytelsesbenchmarking og kvalitetsvalidering  

### Selvtestspørsmål  

1. Hvordan skiller SLMOps seg fra tradisjonell MLOps?  
2. Forklar fordelene med modell distillasjon for distribusjon på kanten.  
3. Hva er de viktigste hensynene for finjustering av SLM-er i ressursbegrensede miljøer?  
4. Beskriv en komplett distribusjonspipeline for Edge AI-applikasjoner.  
...
3. **Distribusjonspipeline**: Sett opp en grunnleggende CI/CD-pipeline for modell-distribusjon (1 time)  

## Modul 6: Agentiske SLM-systemer - AI-agenter og Funksjonskall  

### Viktige Læringsmål  

- Bygge intelligente AI-agenter for kantmiljøer ved bruk av små språkmodeller  
- Implementere funksjonskallevner med systematiske arbeidsflyter  
- Mestre integrasjon av Model Context Protocol (MCP) for standardisert verktøysamhandling  
...
#### Seksjon 2: Funksjonskall i Små Språkmodeller  
- **Prioriterte Konsepter**:  
...
- **Prioriterte Konsepter**:  
  ...
  - Tilkoblingsprotokoller (STDIO og SSE-moduser)  
...
2. Hvordan forbedrer funksjonskall agentens evner?  
3. Forklar rollen til Model Context Protocol i agentkommunikasjon.  

### Praktiske Øvelser  

1. **Enkel Agent**: Bygg en grunnleggende AI-agent med funksjonskall (1 time)  
...
- **Prioriterte Konsepter**:  
  ...
  - Ytelsesovervåking og evaluering for kant-scenarier  
...
- **Prioriterte Konsepter**:  
  ...
  - Azure EdgeAI-løsninger med hybrid arkitektur for sky og kant  
...
1. Hvordan forenkler AI Toolkit arbeidsflyten for EdgeAI-utvikling?  
2. Sammenlign distribusjonsstrategier på tvers av ulike maskinvareplattformer.  
3. Hva er fordelene med Windows AI Foundry for kantutvikling?  
...
6. Sammenlign fordelene med lokal vs. skybasert distribusjon for personvernfølsomme applikasjoner.  
...
- **Prioriterte Konsepter**:  
  - Integrasjon av FoundryLocalManager SDK  
  - Automatisk tjenesteoppdagelse og helsetilstandsovervåking  
  - Konfigurasjonsmønstre basert på miljøer  
  - Hensyn for produksjonsdistribusjon  

#### Seksjon 2: Avanserte Multi-Agent-Systemer  
- **Prioriterte Konsepter**:  
  - Koordinator-mønster med spesialistagenter  
  - Spesialisering av agenter for henting, resonnering og utførelse  
  - Mekanismer for tilbakemeldingssløyfer for forbedring  
  - Overvåking av ytelse og sporing av statistikk  

#### Seksjon 3: Intelligent Modellruting  
- **Prioriterte Konsepter**:  
  - Algoritmer for modellvalg basert på nøkkelord  
  - Støtte for flere modeller (generell, resonnering, kode, kreativ)  
  - Konfigurasjon av miljøvariabler for fleksibilitet  
  - Helsetilstandssjekk og feilhåndtering  
...
- **Prioriterte Konsepter**:  
  ...
  - Interaktive Jupyter-notatbokeksempler med benchmarks  
  - Integrasjonsmønstre med eksisterende applikasjoner  

### Selvtestspørsmål  

1. Hvordan skiller den moderne tilnærmingen med FoundryLocalManager seg fra manuelle REST-kall?  
2. Forklar koordinator-mønsteret og hvordan det orkestrerer spesialistagenter.  
3. Hvordan velger den intelligente ruteren passende modeller basert på forespørselens innhold?  
4. Hva er de viktigste komponentene i et produksjonsklart AI-agent-system?  
5. Hvordan implementerer du omfattende helsetilstandsovervåking for Foundry Local-tjenester?  
6. Sammenlign fordelene med den moderniserte tilnærmingen vs. tradisjonelle implementeringsmønstre.  
...
3. **Intelligent Ruting**: Test modellruteren med ulike forespørselstyper (30 minutter)  
4. **Interaktiv Utforskning**: Bruk Jupyter-notatbøker for å utforske avanserte funksjoner (45 minutter)  
5. **Produksjonsdistribusjon**: Implementer mønstre for overvåking og feilhåndtering (30 minutter)  
6. **Hybrid Integrasjon**: Konfigurer fallback-scenarier med Azure AI Foundry (30 minutter)  

## Tidsallokeringsguide  

For å hjelpe deg med å få mest
| Praktiske øvelser | 6 timer | Praktisk implementering av nøkkelteknikker |
| Selv-evaluering | 2 timer | Test forståelsen din gjennom spørsmål og refleksjon |
| Mini-prosjekt | 3 timer | Bruke kunnskap på en liten praktisk implementering |
...
- Fokuser på å forstå de grunnleggende konseptene fremfor detaljer i implementeringen

**Hvis du kan dedikere hele 20 timer:**
- Fullfør alle åtte moduler (inkludert Introduksjon)
...
- Fullfør alle moduler (inkludert Introduksjon) med detaljerte øvelser
- Bygg flere mini-prosjekter
- Utforsk avanserte optimaliseringsteknikker i Modul 4
- Implementer produksjonsutplassering fra Modul 5
...
- [OpenVINO Documentation](https://docs.openvino.ai/2025/index.html) - Intels omfattende optimaliseringsverktøy
...
- [Hugging Face Transformers](https://huggingface.co/docs/transformers/index) - Rask tilgang til og distribusjon av modeller
...
- [OpenVINO GenAI](https://github.com/openvinotoolkit/openvino.genai) - Verktøy for distribusjon av store språkmodeller
...
3. **Optimaliseringseksperiment**: Mål effekten av ulike kvantiseringsnivåer på samme basismodell
...
11. **MCP-integrasjonssystem**: Bygg et agentisk system ved hjelp av Model Context Protocol for verktøysinteraksjon
...
- Utviklingsverktøy (Windows og VS Code)
...
EdgeAI representerer frontlinjen for implementering av kunstig intelligens, og bringer kraftige kapabiliteter direkte til enheter samtidig som det adresserer viktige bekymringer rundt personvern, forsinkelse og tilkobling. Dette 20-timers kurset gir deg essensiell kunnskap og praktiske ferdigheter for å begynne å arbeide med EdgeAI-teknologier umiddelbart.
