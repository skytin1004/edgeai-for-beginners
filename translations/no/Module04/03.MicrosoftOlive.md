...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T20:06:56+00:00",
...
Microsoft Olive er et kraftig og brukervennlig verktøy for maskinvarebevisst modelloptimalisering som forenkler prosessen med å optimalisere maskinlæringsmodeller for distribusjon på ulike maskinvareplattformer. Enten du retter deg mot CPU-er, GPU-er eller spesialiserte AI-akseleratorer, hjelper Olive deg med å oppnå optimal ytelse samtidig som modellens nøyaktighet opprettholdes.

## Hva er Microsoft Olive?

Olive er et brukervennlig verktøy for maskinvarebevisst modelloptimalisering som kombinerer ledende teknikker innen modellkompresjon, optimalisering og kompilering. Det fungerer sammen med ONNX Runtime som en ende-til-ende løsning for inferensoptimalisering.
...
- **Bevart nøyaktighet**: Optimaliseringer opprettholder modellkvaliteten samtidig som ytelsen forbedres
...
### Trinn 1: Last ned modellen (valgfritt)
...
### 3. Presisjonsvalg
- **INT4**: Maksimal kompresjon, noe nøyaktighetstap
...
- Eksperimenter med ulike optimaliseringspasseringer
...
#### 3. Minneproblemer
- Bruk mindre batchstørrelser under optimalisering
...
- **Jupyter Notebooks**: Tilgjengelig i Olive GitHub-repositoriet — https://github.com/microsoft/Olive/tree/main/examples
