...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T20:07:21+00:00",
...
Edge AI representerer sammensmeltingen av kunstig intelligens og edge computing, som muliggjør intelligent behandling direkte på enheter uten avhengighet av skytilkobling. Dette kapittelet utforsker fem ulike EdgeAI-implementeringer på forskjellige plattformer og rammeverk, og viser frem allsidigheten og kraften ved å kjøre AI-modeller på kanten.

## 1. EdgeAI på NVIDIA Jetson Orin Nano

NVIDIA Jetson Orin Nano representerer et gjennombrudd innen tilgjengelig edge AI-databehandling, og leverer opptil 67 TOPS med AI-ytelse i et kompakt format på størrelse med et kredittkort. Denne kraftige edge AI-plattformen demokratiserer utviklingen av generativ AI for hobbyister, studenter og profesjonelle utviklere.

### Nøkkelfunksjoner
- Leverer opptil 67 TOPS med AI-ytelse—en 1,7X forbedring sammenlignet med forgjengeren
...
- Priset til bare $249, og gir utviklere, studenter og skapere den mest tilgjengelige plattformen

### Bruksområder
Jetson Orin Nano utmerker seg ved å kjøre moderne generative AI-modeller, inkludert visuelle transformatorer, store språkmodeller og visuell-språk-modeller. Den er spesielt designet for GenAI-brukstilfeller, og nå kan du kjøre flere LLM-er på en håndholdt enhet. Populære bruksområder inkluderer AI-drevne roboter, smarte droner, intelligente kameraer og autonome edge-enheter.
...
### Utviklingsfordeler
.NET MAUI-tilnærmingen lar utviklere utnytte sine eksisterende C#- og .NET-ferdigheter mens de bygger plattformuavhengige AI-applikasjoner. ONNX Runtime GenAI-rammeverket støtter flere modellarkitekturer, inkludert Llama, Mistral, Phi, Gemma og mange andre. Optimaliserte ARM64-kjerner akselererer INT4-kvantisert matriksmultiplikasjon, og sikrer effektiv ytelse på mobil maskinvare samtidig som den bevarer den velkjente .NET-utviklingsopplevelsen.
...
### Bruksområder
Azure EdgeAI-implementeringen utmerker seg i scenarier som krever AI-distribusjon i bedriftsklasse med skyadministrasjonsmuligheter. Dette inkluderer intelligent dokumentbehandling, sanntidsanalyse og hybride AI-arbeidsflyter som utnytter både sky- og edge-databehandling.
...
- Ved å utnytte infrastruktur-API-er trenger utviklere ikke lenger å lage flere versjoner av appen for å målrette mot ulike silisiumtyper
...
**Les mer**: [Foundry Local RAG Samples](https://github.com/microsoft/Foundry-Local/tree/main/samples/dotNET/rag)
...
For utviklere som bruker Visual Studio Code, gir AI Toolkit-utvidelsen et omfattende utviklingsmiljø spesielt designet for å bygge, teste og distribuere Edge AI-applikasjoner. Dette verktøysettet strømlinjeformer hele Edge AI-utviklingsarbeidsflyten innenfor VS Code.
...
- Lokal testing og optimaliseringsarbeidsflyter
...
Disse fem EdgeAI-implementeringene demonstrerer modenheten og mangfoldet av edge AI-løsninger som er tilgjengelige i dag. Fra maskinvareakselererte edge-enheter som Jetson Orin Nano til programvarerammeverk som ONNX Runtime GenAI og Windows ML, har utviklere enestående muligheter for å distribuere intelligente applikasjoner på kanten.
