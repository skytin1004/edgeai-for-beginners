...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T03:12:55+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "hu"
}
-->
# Foundry Local mint Eszközök Integrációja

Átfogó keretrendszer a Microsoft Foundry Local integrálására hívható eszközként nagyobb alkalmazásokban, a Microsoft hivatalos mintái alapján az eszközalapú AI integrációhoz.

## Áttekintés

Ez a példa bemutatja, hogyan lehet a Foundry Local modelleket újrahasznosítható eszközként elérhetővé tenni, amelyek integrálhatók meglévő alkalmazásokba, munkafolyamatokba és fejlesztési környezetekbe. Bemutatja a Microsoft által ajánlott mintákat az eszközintegrációhoz és a funkcióhíváshoz.

## Kulcsfogalmak

### 🔧 **Eszköz-első Architektúra**
- Foundry Local modellek hívható funkcióként
- Standardizált eszköz interfészek és sémák
- Zökkenőmentes integráció meglévő kódbázisokkal
- Típusbiztos eszközdefiníciók és validáció

### ⚡ **Funkcióhívási Minták**
- Microsoft Foundry Local funkcióhívási implementáció
- OpenAI-kompatibilis eszközdefiníciók
- Automatikus paramétervalidáció és konverzió
- Hibakezelés és válaszformázás

### 🔌 **Integrációs Keretrendszerek**
- **LangChain Integráció**: Natív LangChain eszköztámogatás
- **Semantic Kernel**: Microsoft Semantic Kernel funkciók
- **REST API**: HTTP-alapú eszközvégpontok
- **CLI Eszközök**: Parancssori interfész integráció
- **Jupyter Notebookok**: Interaktív fejlesztési eszközök

### 🎯 **Felhasználási Minták**
- Kódelemző és generáló eszközök
- Tartalomfeldolgozás és összegzés
...
- **Python**: 3.9+ asyncio támogatással
- **Node.js**: v18+ (JavaScript integrációkhoz)
- **Memória**: Legalább 12GB ajánlott
- **Tárhely**: Legalább 10GB modellekhez és eszközökhöz
...
### Keretrendszer-specifikus Függőségek
```bash
...
## Alapvető Eszközminták

### 1. Funkcióalapú Eszközök
```python
...
A példa befejezése után megérted:

1. **Eszközintegrációs Minták**
   - Funkcióalapú és osztályalapú eszköztervezés
   - Microsoft Foundry Local integrációs minták
   - Séma validáció és típusbiztonság
   - Hibakezelés és helyreállítás

2. **Keretrendszer Integráció**
   - LangChain eszközfejlesztés
   - Semantic Kernel funkcióintegráció
   - REST API keretrendszer integráció
   - CLI alkalmazásfejlesztés

3. **Gyártási Szempontok**
   - Teljesítményoptimalizálási stratégiák
   - Gyorsítótárazás és erőforrás-kezelés
   - Felügyelet és megfigyelhetőség
   - Biztonság és validáció

4. **Haladó Eszközminták**
   - Eszközkompozíció és láncolás
   - Kontextusérzékeny feldolgozás
   - Csoportos és streaming műveletek
   - Egyedi integrációs fejlesztés

## Következő Lépések

- **Integrációs Projektek**: Egyedi integrációk létrehozása a preferált keretrendszerekkel
- **Eszközfejlesztés**: Speciális eszközök létrehozása a saját területedhez
- **Teljesítményhangolás**: Optimalizálás az egyedi felhasználási esetekhez
- **Gyártási Telepítés**: Eszközök skálázása vállalati használatra

## Hozzájárulás

Lásd a fő repó irányelveit a hozzájárulási utasításokért.

## Licenc

Ez a példa ugyanazt a licencet követi, mint a Microsoft Foundry Local projekt.
