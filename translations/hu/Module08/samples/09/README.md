...
Ez a példa bemutatja, hogyan lehet kifinomult AI ügynökrendszereket építeni a Foundry Local segítségével, a Microsoft hivatalos mintáinak alkalmazásával a funkcióhívásokhoz, ügynökök orkesztrációjához és együttműködő AI munkafolyamatokhoz.
...
### 🤖 **Intelligens ügynökök koordinációja**
- Dinamikus feladatelemzés és ügynökválasztás
- Automatikus munkaterhelés-elosztás
- Eredmények összesítése és szintézise
- Ügynökök közötti kommunikációs protokollok

### 🔧 **Specializált ügynöktípusok**
- **Kód Szakértő**: Programozás, hibakeresés, kódellenőrzés
- **Adatelemző**: Adatfeldolgozás, vizualizáció, betekintések
- **Kutatási Asszisztens**: Információgyűjtés, összegzés
- **Írás Szakértő**: Tartalomkészítés, szerkesztés, dokumentáció
- **Problémamegoldó**: Összetett érvelés, döntéshozatal

### ⚡ **Fejlett funkcióhívások**
- Microsoft Foundry Local funkcióhívási minták
- Típusbiztos eszközdefiníciók
- Automatikus paraméterellenőrzés
- Hibakezelés és helyreállítás
- Eszközláncolás és kompozíció

### 🎯 **Okos feladatirányítás**
- Szándékosztályozás és elemzés
- Ügynöki képességekhez való illesztés
- Terheléskiegyenlítés és optimalizálás
- Tartalék és redundancia kezelése

## Előfeltételek

### Rendszerkövetelmények
- **Python**: 3.9+ asyncio támogatással
- **Memória**: Legalább 16GB ajánlott több ügynökhöz
- **Tárhely**: Legalább 15GB több modellhez
- **CPU/GPU**: Többmagos processzor, GPU ajánlott
...
### 1. Alapvető többügynökös munkafolyamat
```python
...
## Ügynöktípusok részletes bemutatása

### 1. Kód Szakértő Ügynök
```python
...
## Funkcióhívás integrációja

### Microsoft Foundry Local minták
```python
...
### 1. Modellterhelés kiegyensúlyozása
```python
...
### Példa 1: Szoftverfejlesztési munkafolyamat
```python
...
A minta befejezése után megérted:

1. **Többügynökös rendszer architektúrája**
   - Ügynökök koordinációs mintái
   - Feladatelosztási stratégiák
   - Eredményszintézis technikák
   - Kontextuskezelés ügynökök között

2. **Microsoft Foundry Local integráció**
   - Funkcióhívás megvalósítása
   - Eszközintegrációs minták
   - Többmodell orkesztráció
   - Teljesítményoptimalizálás

3. **Fejlett AI orkesztráció**
   - Munkafolyamat tervezés és végrehajtás
   - Minőségbiztosítási mechanizmusok
   - Hibakezelés és helyreállítás
   - Skálázhatósági szempontok

4. **Termelési rendszer tervezése**
   - Felügyelet és analitika
   - Konfigurációkezelés
...
- **Minta 10**: Foundry Local mint eszközintegráció
- **Fejlett témák**: Egyedi ügynökfejlesztés
- **Skálázás**: Elosztott ügynökrendszerek
- **Integráció**: Vállalati munkafolyamat integráció

## Hozzájárulás

Lásd a fő repozitórium irányelveit a hozzájárulási utasításokért.

## Licenc

Ez a minta a Microsoft Foundry Local projekt licencével megegyező licencet követ.
