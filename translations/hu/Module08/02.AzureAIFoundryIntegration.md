...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T01:15:23+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "hu"
}
-->
# 2. szekció: AI megoldások létrehozása az Azure AI Foundry segítségével

## Áttekintés

A Foundry Local alapjaira építve ez a szekció a fejlett prompt mérnöki technikákra, zökkenőmentes adatintegrációra és cselekvésre alkalmas feladat automatizálásra összpontosít. Megtanulhatod, hogyan hidald át a helyi fejlesztést az Azure AI Foundry képességeivel, és hogyan hozz létre vállalati szintű alkalmazásokat, amelyek a két világ legjobbjait ötvözik.

## Tanulási célok

A szekció végére képes leszel:
- Elsajátítani fejlett prompt mérnöki technikákat a következetes és megbízható AI válaszok érdekében
- Megvalósítani robusztus adatintegrációs mintákat valós alkalmazásokhoz
- Létrehozni cselekvésre alkalmas AI feladatokat, amelyek üzleti értéket teremtenek
- Zökkenőmentes kapcsolatot kialakítani a Foundry Local és az Azure AI Foundry között
- Teljesítményfigyelési és optimalizálási munkafolyamatokat építeni
- Üzemkész AI megoldásokat telepíteni megfelelő hibakezeléssel és skálázással

## Előfeltételek

- Az 1. szekció elvégzése: Bevezetés a Foundry Local használatába
- Aktív Foundry Local telepítés futó modellekkel
- Azure fiók (tanuláshoz elegendő az ingyenes szint)
- Alapvető ismeretek a REST API-król és a JSON-ról

## 1. rész: Fejlett prompt mérnöki technikák

### A prompt architektúra megértése

A hatékony prompt mérnöki technikák az AI alkalmazások megbízhatóságának alapját képezik. A Foundry Local fejlett prompt képességeket biztosít:
...
### Prompt stratégiák megvalósítása
...
### Gyakorlati prompt mérnöki példák
...
## 2. rész: Adatintegrációs minták

### Foundry Local adatcsatlakozók
...
## 3. rész: Cselekvésre alkalmas AI feladatok

### Feladat automatizálási keretrendszer
...
### Üzleti folyamat automatizálási példák
...
## 4. rész: Azure AI Foundry integráció
...
## 5. rész: Teljesítményfigyelés és optimalizálás

### Átfogó figyelési rendszer
...
### 1. gyakorlat: Fejlett ügyfélszolgálati bot
...
### 2. gyakorlat: Automatizált piackutatás
...
## 7. rész: Következő lépések és a 3. szekció előzetese

### A szekció eredményei

Ebben a szekcióban elsajátítottad:
- ✅ Fejlett prompt mérnöki technikák a következetes AI viselkedés érdekében
- ✅ Robusztus adatintegrációs minták valós alkalmazásokhoz
- ✅ Automatizált feladatok létrehozása üzleti folyamatok optimalizálásához
- ✅ Azure AI Foundry integráció és hibrid telepítési stratégiák
- ✅ Átfogó teljesítményfigyelés és optimalizálás

### Felkészülés a 3. szekcióra: Nyílt forráskódú modellek

1. **Fedezd fel a Hugging Face-t**: Hozz létre egy fiókot, és böngészd a modellkatalógust
2. **Tekintsd meg a Model Mondays-t**: Nézd meg a legújabb [Model Mondays sorozatot](https://aka.ms/model-mondays)
3. **Tervezd meg az egyedi modelleket**: Gondold át, milyen speciális modellek lennének hasznosak az eseteidhez

### További források

- [Azure AI Foundry dokumentáció](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Foundry Local GitHub repó](https://github.com/microsoft/Foundry-Local)
- [Fejlett prompt mérnöki útmutató](https://platform.openai.com/docs/guides/prompt-engineering)
- [Üzleti folyamat automatizálási legjobb gyakorlatok](https://docs.microsoft.com/en-us/power-automate/)

Most már készen állsz arra, hogy olyan kifinomult AI megoldásokat építs, amelyek ötvözik a helyi inferencia erejét a felhő méretű képességekkel, megteremtve az alapot a vállalati szintű AI alkalmazásokhoz.
