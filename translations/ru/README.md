...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T07:37:52+00:00",
...
3. [**Присоединяйтесь к Discord Azure AI Foundry и познакомьтесь с экспертами и разработчиками**](https://discord.com/invite/ByRwuEEgH4)
...
Добро пожаловать в **EdgeAI для начинающих** – ваш полный путь в мир передовых технологий искусственного интеллекта на периферийных устройствах. Этот курс соединяет мощные возможности ИИ с практическим применением в реальных условиях, позволяя вам использовать потенциал ИИ непосредственно там, где генерируются данные и принимаются решения.

### Чему вы научитесь

Курс охватывает путь от базовых концепций до готовых к производству решений, включая:
- **Малые языковые модели (SLM)**, оптимизированные для периферийного развертывания
...
### Основные принципы:
- **Инференс на устройстве**: модели ИИ работают на периферийных устройствах (телефоны, маршрутизаторы, микроконтроллеры, промышленные ПК)
...
- **Суверенитет данных**: хранение конфиденциальных данных локально, улучшение безопасности и соответствия требованиям
...
| [📚 01](../../Module01) | [Основы EdgeAI](./Module01/README.md) | Сравнение облачного и периферийного ИИ | Основы EdgeAI • Примеры из реальной жизни • Руководство по реализации • Развертывание на периферии | Начальный | 3-4 часа |
...
| [🤖 06](../../Module06) | [ИИ-агенты и вызов функций](./Module06/README.md) | Фреймворки агентов и MCP | Введение в агентов • Вызов функций • Протокол контекста модели | Продвинутый | 4-5 часов |
...
| [🏭 08](../../Module08) | [Инструментарий Foundry Local](./Module08/README.md) | Примеры, готовые к производству | Примерные приложения (см. подробности ниже) | Эксперт | 8-10 часов |
...
✅ **Постепенное обучение**: Теория → Практика → Развертывание в производстве  
...
Наша команда предлагает и другие курсы! Ознакомьтесь:  
