...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T16:36:24+00:00",
...
Edge AI представляет собой новый подход, который решает ключевые современные задачи:
...
SLMs, такие как Phi-4, Mistral-7B и Gemma, представляют собой оптимизированные версии больших языковых моделей, обученные или сжатые для:
...
- [**Раздел 1: Основы EdgeAI**](./Module01/01.EdgeAIFundamentals.md)
  ...
  - Преимущества: конфиденциальность, безопасность, низкая задержка, возможности работы офлайн, экономическая эффективность

- [**Раздел 2: Реальные примеры использования**](./Module01/02.RealWorldCaseStudies.md)
  - Экосистема моделей Microsoft Phi & Mu
  - Пример использования системы отчетности AI Japan Airlines
  - Влияние на рынок и направления развития
...
- [**Раздел 3: Практическое руководство по реализации**](./Module01/03.PracticalImplementationGuide.md)
  ...
  - Ресурсы для семейства основных моделей
  - Инструменты квантования и оптимизации (Llama.cpp, Microsoft Olive, Apple MLX)
  - Контрольный список оценки и проверки
...
- [**Раздел 4: Аппаратные платформы для развертывания Edge AI**](./Module01/04.EdgeDeployment.md)
  ...
  - Платформы NVIDIA Jetson и вычисления на краю
  - Платформы Windows AI для ПК с ускорением NPU
  - Стратегии оптимизации, ориентированные на оборудование
...
- [**Раздел 1: Основы семейства моделей Microsoft Phi**](./Module02/01.PhiFamily.md)
  ...
  - Специализированные возможности (логика, мультимодальность, развертывание на краю)

- [**Раздел 2: Основы семейства моделей Qwen**](./Module02/02.QwenFamily.md)
...
- [**Раздел 3: Основы семейства моделей Gemma**](./Module02/03.GemmaFamily.md)
  - Инновации, основанные на исследованиях (Gemma 3 и 3n)
  - Мультимодальные возможности
  - Архитектура, ориентированная на мобильные устройства

- [**Раздел 4: Основы семейства моделей BitNET**](./Module02/04.BitNETFamily.md)
  - Революционная технология квантования (1.58-бит)
  - Специализированная платформа инференса из https://github.com/microsoft/BitNet
  - Устойчивое лидерство в области ИИ благодаря высокой эффективности
...
- [**Раздел 5: Основы модели Microsoft Mu**](./Module02/05.mumodel.md)
  ...
  - Операция с сохранением конфиденциальности
...
**Тема**: Полный цикл развертывания SLM, от теории до производственной среды

#### Структура главы:
- [**Раздел 1: Продвинутое обучение SLM**](./Module03/01.SLMAdvancedLearning.md)
  - Классификационная структура параметров (Micro SLM 100M-1.4B, Medium SLM 14B-30B)
  - Продвинутые методы оптимизации (методы квантования, квантование BitNET 1-бит)
...
- [**Раздел 3: Контейнеризированное облачное развертывание**](./Module03/03.DeployingSLMinCloud.md)
  ...
  - Оптимизированная реализация ONNX Runtime для краевых устройств

---

### [Модуль 04: Конвертация форматов моделей и квантование](./Module04/README.md)
**Тема**: Полный набор инструментов для оптимизации моделей для развертывания на краевых платформах

#### Структура главы:
- [**Раздел 1: Основы конвертации форматов моделей и квантования**](./Module04/01.Introduce.md)
  - Классификационная структура точности (ультра-низкая, низкая, средняя точность)
  - Преимущества форматов GGUF и ONNX и их области применения
...
- [**Раздел 3: Набор инструментов Microsoft Olive Optimization Suite**](./Module04/03.MicrosoftOlive.md)
  ...
  - Интеграция в корпоративные рабочие процессы Azure ML
...
- [**Раздел 4: Набор инструментов OpenVINO Toolkit Optimization Suite**](./Module04/04.openvino.md)
  ...
  - Фреймворк сжатия нейронных сетей (NNCF) для продвинутой оптимизации
  - OpenVINO GenAI для развертывания моделей больших языков
  - Аппаратное ускорение на CPU, GPU, VPU и ИИ-ускорителях

- [**Раздел 5: Углубленный анализ фреймворка Apple MLX**](./Module04/05.AppleMLX.md)
  - Унифицированная архитектура памяти для Apple Silicon
  - Поддержка моделей LLaMA, Mistral, Phi-3, выбранных моделей Qwen
...
- [**Раздел 6: Синтез рабочего процесса разработки Edge AI**](./Module04/06.workflow-synthesis.md)
  - Унифицированная архитектура рабочего процесса с интеграцией нескольких фреймворков оптимизации
...
- [**Раздел 3: Тонкая настройка - кастомизация моделей для конкретных задач**](./Module05/03.SLMOps-Finetuing.md)
  ...
  - Реализация тонкой настройки с использованием Microsoft Olive
  - Многомодульное обучение и оптимизация гиперпараметров
...
**Тема**: Реализация агентных систем SLM от основ до продвинутого вызова функций и интеграции протокола контекста модели (MCP)
...
- [**Раздел 2: Вызов функций в малых языковых моделях**](./Module06/02.FunctionCalling.md)
  - Систематическая реализация рабочего процесса (определение намерений, вывод JSON, внешнее выполнение)
...
- [**Раздел 3: Интеграция протокола контекста модели (MCP)**](./Module06/03.IntroduceMCP.md)
...
- [**EdgeAI на NVIDIA Jetson Orin Nano**](./Module07/README.md#1-edgeai-in-nvidia-jetson-orin-nano)
  ...
  - Поддержка генеративных моделей ИИ (визуальные трансформеры, LLM, модели визуального языка)
...
- [**EdgeAI в мобильных приложениях с .NET MAUI и ONNX Runtime GenAI**](./Module07/README.md#2-edgeai-in-mobile-applications-with-net-maui-and-onnx-runtime-genai)
  ...
  - Полная реализация цикла генеративного ИИ
...
- [**EdgeAI в Azure с движком малых языковых моделей**](./Module07/README.md#3-edgeai-in-azure-with-small-language-models-engine)
  ...
  - Интеграция с Azure AI и ONNX Runtime
...
- [**EdgeAI с локальными приложениями Foundry**](./Module07/README.md#5-edgeai-with-foundry-local-applications)
  ...
  - Интеграция языковой модели Phi-3 с семантическим поиском (только модели Phi)
  - Поддержка локальных векторных баз данных (SQLite, Qdrant)
  - Возможности автономной работы и соблюдения суверенитета данных

## Цели обучения курса

Пройдя этот комплексный курс по EdgeAI, вы приобретете навыки проектирования, реализации и развертывания готовых к производству решений EdgeAI. Наш структурированный подход гарантирует освоение как теоретических основ, так и практических навыков реализации.
...
**Навыки реализации**
- Развертывание малых языковых моделей на различных edge-платформах (мобильные, встроенные, IoT, edge-серверы)
...
- Оценка возможностей EdgeAI и выбор подходящих вариантов для бизнес-приложений
...
- Планирование гибридных архитектур облако-edge для оптимальной производительности и эффективности затрат
...
- **Транспорт**: Принятие решений автономными транспортными средствами и управление движением
- **Умные города**: Интеллектуальная инфраструктура и системы управления ресурсами
- **Потребительская электроника**: Мобильные приложения с поддержкой ИИ и устройства для умного дома
...
- Распознавание реальных приложений и успешных примеров
...
- Навыки развертывания в производстве для кроссплатформенных вычислительных сред edge
...
- Понимание основ ИИ-агентов и архитектуры малых языковых моделей
- Освоение реализации вызова функций на различных платформах и фреймворках
- Интеграция протокола контекста модели (MCP) для стандартизированного взаимодействия с внешними инструментами
- Создание сложных агентных систем с минимальными требованиями к вмешательству человека

### Результаты обучения модуля 07:
- Освоение набора инструментов ИИ для Visual Studio Code для комплексных рабочих процессов разработки Edge AI
...
- Освоение техник оптимизации, специфичных для оборудования, на платформах NVIDIA, мобильных, Azure и Windows
...
- **Архитектура решений**: Проектирование комплексных систем EdgeAI, соответствующих требованиям предприятия
...
- **Управление рисками**: Идентификация и минимизация технических и операционных рисков в развертывании EdgeAI
- **Оптимизация ROI**: Демонстрация измеримой бизнес-ценности от реализации EdgeAI

### Возможности карьерного роста

**Профессиональные роли**
- Архитектор решений EdgeAI
- Инженер машинного обучения (специализация Edge)
- Разработчик IoT AI
- Разработчик мобильных приложений с ИИ
- Консультант по корпоративным решениям ИИ
...
- Завершение комплексных проектов EdgeAI, демонстрирующих практическую компетенцию
...
- Основа для углубленных специализаций в области ИИ
- Подготовка к гибридным архитектурам облако-edge
- Вход в мир новых технологий и фреймворков ИИ
Этот курс ставит вас на передовую внедрения технологий искусственного интеллекта, где интеллектуальные возможности органично интегрируются в устройства и системы, которые обеспечивают современную жизнь.
...
- **Постепенное обучение**: Переход от базовых концепций к продвинутому внедрению
- **Интеграция теории и практики**: Каждый модуль включает теоретические основы и практические операции
- **Реальные кейсы**: Основаны на примерах из Microsoft, Alibaba, Google и других компаний
- **Практическая работа**: Завершение конфигурационных файлов, тестирование API и написание скриптов для внедрения
- **Оценка производительности**: Детальные сравнения скорости вывода, использования памяти и требований к ресурсам
- **Корпоративные аспекты**: Практики безопасности, рамки соответствия и стратегии защиты данных

## Начало работы

Рекомендуемый путь обучения:
1. Начните с **Module01**, чтобы заложить фундаментальные знания о EdgeAI
2. Перейдите к **Module02**, чтобы глубже понять различные семейства моделей SLM
3. Изучите **Module03**, чтобы освоить практические навыки внедрения
4. Продолжите с **Module04** для углубленной оптимизации моделей, конверсии форматов и синтеза фреймворков
5. Завершите **Module05**, чтобы освоить SLMOps для готовых к производству решений
6. Исследуйте **Module06**, чтобы понять агентные системы SLM и возможности вызова функций
7. Закончите с **Module07**, чтобы получить практический опыт работы с AI Toolkit и разнообразными примерами внедрения EdgeAI
...
**Будущее EdgeAI заключается в постоянном совершенствовании архитектур моделей, методов квантования и стратегий внедрения, которые ставят эффективность и специализацию выше универсальных возможностей. Организации, которые примут эту смену парадигмы, будут хорошо подготовлены к использованию трансформирующего потенциала ИИ, сохраняя контроль над своими данными и операциями.**
...
- [Генеративный ИИ для начинающих с использованием JavaScript](https://github.com/microsoft/generative-ai-with-javascript?WT.mc_id=academic-105485-koreyst)
