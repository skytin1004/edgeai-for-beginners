...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T14:24:53+00:00",
...
Опираясь на вашу базу Foundry Local, эта сессия посвящена созданию сложных AI-решений с использованием продвинутой инженерии подсказок, интеграции данных и автоматизации задач. Вы научитесь объединять локальную разработку с возможностями Azure AI Foundry, создавая приложения корпоративного уровня, которые используют преимущества обеих платформ.

## Цели обучения

К концу этой сессии вы сможете:
- Освоить продвинутые техники инженерии подсказок для получения стабильных и надежных ответов AI
- Реализовать надежные шаблоны интеграции данных для реальных приложений
- Создавать задачи AI, которые приносят бизнес-ценность
- Установить бесшовное соединение между Foundry Local и Azure AI Foundry
- Построить рабочие процессы мониторинга производительности и оптимизации
- Развернуть готовые к производству AI-решения с правильной обработкой ошибок и масштабированием

## Предварительные требования

- Завершенная Сессия 1: Начало работы с Foundry Local
- Активная установка Foundry Local с работающими моделями
- Аккаунт Azure (достаточно бесплатного уровня для обучения)
- Базовое понимание REST API и JSON

## Часть 1: Продвинутая инженерия подсказок

### Понимание архитектуры подсказок

Эффективная инженерия подсказок — это основа надежных AI-приложений. Foundry Local предоставляет расширенные возможности для работы с подсказками:
...
### Реализация стратегий подсказок
...
### Практические примеры инженерии подсказок
...
## Часть 2: Шаблоны интеграции данных

### Коннекторы данных Foundry Local
...
### Пример интеграции данных в реальном мире
...
## Часть 3: Выполнимые задачи AI

### Фреймворк автоматизации задач
...
## Часть 4: Интеграция с Azure AI Foundry
...
### Шаблоны гибридного развертывания
...
## Часть 5: Мониторинг производительности и оптимизация
...
### Упражнение 1: Продвинутый бот для обслуживания клиентов
...
### Упражнение 2: Автоматизированное исследование рынка
...
## Часть 7: Следующие шаги и обзор Сессии 3

### Достижения сессии

В этой сессии вы освоили:
- ✅ Продвинутые техники инженерии подсказок для стабильного поведения AI
- ✅ Надежные шаблоны интеграции данных для реальных приложений
- ✅ Создание автоматизированных задач для оптимизации бизнес-процессов
- ✅ Интеграцию с Azure AI Foundry и стратегии гибридного развертывания
- ✅ Комплексный мониторинг производительности и оптимизацию

### Подготовка к Сессии 3: Модели с открытым исходным кодом

1. **Изучите Hugging Face**: Создайте аккаунт и ознакомьтесь с каталогом моделей
2. **Просмотрите Model Mondays**: Ознакомьтесь с последними выпусками [серии Model Mondays](https://aka.ms/model-mondays)
3. **Запланируйте кастомные модели**: Подумайте, какие специализированные модели могут быть полезны для ваших задач

### Дополнительные ресурсы

- [Документация Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Репозиторий Foundry Local на GitHub](https://github.com/microsoft/Foundry-Local)
- [Руководство по продвинутой инженерии подсказок](https://platform.openai.com/docs/guides/prompt-engineering)
- [Лучшие практики автоматизации бизнес-процессов](https://docs.microsoft.com/en-us/power-automate/)

Теперь вы готовы создавать сложные AI-решения, которые объединяют мощь локального анализа с масштабируемыми облачными возможностями, закладывая основу для приложений корпоративного уровня.
