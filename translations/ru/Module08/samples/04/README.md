...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:05:21+00:00",
...
- **🌐 WebGPU Demo** (`webgpu-demo/`): Инференс ИИ в браузере с аппаратным ускорением
...
|----------|--------------|---------|
| **Конфиденциальные данные** | 🏠 Локально (Foundry) | Данные никогда не покидают устройство |
...
| **Исследовательские задачи** | ☁️ Облако (Azure OpenAI) | Требуется обширная база знаний |

### Сравнение технологий

| Технология | Сценарий использования | Преимущества | Недостатки |
|------------|------------------------|--------------|------------|
| **Chainlit** | Разработчики на Python, быстрый прототип | Простая настройка, поддержка потоков | Только Python |
| **WebGPU** | Максимальная конфиденциальность, офлайн-сценарии | Нативно для браузера, сервер не нужен | Ограниченный размер модели |
...
- 🛡️ **Надежная обработка ошибок**: Плавное восстановление и деградация
...
**Особенности:**
- 🌐 **Нативный ИИ для браузера**: Сервер не требуется, работает полностью в браузере
...
- 🔄 **Плавное резервирование**: Переход на CPU, если WebGPU недоступен
...
| `BASE_URL` | Локальная конечная точка Foundry | Автоопределение | `http://localhost:51211` |
...
- Настройте обратный прокси для завершения SSL
...
- **Метрики**: Отслеживайте время отклика, частоту ошибок, использование ресурсов
...
- [`webgpu-demo/`](../../../../../Module08/samples/04/webgpu-demo) - Инференс ИИ в браузере
