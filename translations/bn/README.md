...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T19:14:24+00:00",
...
### [মডিউল ০১: EdgeAI এর মৌলিক বিষয় এবং রূপান্তর](./Module01/README.md)
**থিম**: Edge AI ডিপ্লয়মেন্টের রূপান্তরকারী পরিবর্তন
...
- [**সেকশন ২: বাস্তব-জগতের কেস স্টাডি**](./Module01/02.RealWorldCaseStudies.md)
...
- [**সেকশন ৪: Edge AI ডিপ্লয়মেন্ট হার্ডওয়্যার প্ল্যাটফর্ম**](./Module01/04.EdgeDeployment.md)
  ...
  - মোবাইল এবং এম্বেডেড সিস্টেমের জন্য Qualcomm AI সমাধান
...
- [**সেকশন ২: Qwen পরিবারের মৌলিক বিষয়**](./Module02/02.QwenFamily.md)
  - ওপেন সোর্স উৎকর্ষতা (Qwen 1.0 থেকে Qwen3) - Hugging Face এর মাধ্যমে উপলব্ধ
  - উন্নত যুক্তি আর্কিটেকচার চিন্তাশীল মোড ক্ষমতা সহ
...
- [**সেকশন ৫: Microsoft Mu মডেল পরিবারের মৌলিক বিষয়**](./Module02/05.mumodel.md)
  ...
  - গোপনীয়তা-রক্ষাকারী অফলাইন অপারেশন
...
- [**সেকশন ১: SLM উন্নত শিক্ষা**](./Module03/01.SLMAdvancedLearning.md)
  - প্যারামিটার শ্রেণীবিন্যাস ফ্রেমওয়ার্ক (Micro SLM 100M-1.4B, Medium SLM 14B-30B)
...
- [**সেকশন ১: মডেল ফরম্যাট রূপান্তর এবং কোয়ান্টাইজেশন ভিত্তি**](./Module04/01.Introduce.md)
  - নির্ভুলতা শ্রেণীবিন্যাস ফ্রেমওয়ার্ক (অতি-নিম্ন, নিম্ন, মাঝারি নির্ভুলতা)
  - GGUF এবং ONNX ফরম্যাটের সুবিধা এবং ব্যবহার ক
- [**সেকশন ২: Llama.cpp ইমপ্লিমেন্টেশন গাইড**](./Module04/02.Llamacpp.md)
  - ক্রস-প্ল্যাটফর্ম ইনস্টলেশন (Windows, macOS, Linux)
  - GGUF ফরম্যাট কনভার্সন এবং কোয়ান্টাইজেশন লেভেল (Q2_K থেকে Q8_0)
  - হার্ডওয়্যার অ্যাক্সেলারেশন (CUDA, Metal, OpenCL, Vulkan)
  - পাইথন ইন্টিগ্রেশন এবং REST API ডিপ্লয়মেন্ট

- [**সেকশন ৩: Microsoft Olive অপ্টিমাইজেশন স্যুট**](./Module04/03.MicrosoftOlive.md)
  - হার্ডওয়্যার-অওয়্যার মডেল অপ্টিমাইজেশন ৪০+ বিল্ট-ইন কম্পোনেন্ট সহ
  - ডাইনামিক এবং স্ট্যাটিক কোয়ান্টাইজেশন সহ অটো-অপ্টিমাইজেশন
  - এন্টারপ্রাইজ ইন্টিগ্রেশন Azure ML ওয়ার্কফ্লো সহ
  - জনপ্রিয় মডেল সাপোর্ট (Llama, Phi, নির্বাচিত Qwen মডেল, Gemma)

- [**সেকশন ৪: OpenVINO Toolkit অপ্টিমাইজেশন স্যুট**](./Module04/04.openvino.md)
  ...
  - CPU, GPU, VPU এবং AI অ্যাক্সেলারেটর জুড়ে হার্ডওয়্যার অ্যাক্সেলারেশন

- [**সেকশন ৫: Apple MLX Framework ডিপ ডাইভ**](./Module04/05.AppleMLX.md)
  - Apple Silicon-এর জন্য ইউনিফাইড মেমরি আর্কিটেকচার
  - LLaMA, Mistral, Phi-3, নির্বাচিত Qwen মডেল সাপোর্ট
  - LoRA ফাইন-টিউনিং এবং মডেল কাস্টমাইজেশন
  - Hugging Face ইন্টিগ্রেশন ৪-বিট/৮-বিট কোয়ান্টাইজেশন সহ

- [**সেকশন ৬: Edge AI ডেভেলপমেন্ট ওয়ার্কফ্লো সিন্থেসিস**](./Module04/06.workflow-synthesis.md)
...
### [মডিউল ০৫: SLMOps - ছোট ভাষার মডেল অপারেশন](./Module05/README.md)
**থিম**: সম্পূর্ণ SLM লাইফসাইকেল অপারেশন ডিস্টিলেশন থেকে প্রোডাকশন ডিপ্লয়মেন্ট পর্যন্ত

#### অধ্যায় কাঠামো:
- [**সেকশন ১: SLMOps-এর পরিচিতি**](./Module05/01.IntroduceSLMOps.md)
...
- [**সেকশন ২: মডেল ডিস্টিলেশন - তত্ত্ব থেকে বাস্তবায়ন**](./Module05/02.SLMOps-Distillation.md)
  - শিক্ষক থেকে ছাত্র মডেলে জ্ঞান স্থানান্তর
  - দুই-পর্যায়ের ডিস্টিলেশন প্রক্রিয়া বাস্তবায়ন
  - Azure ML ডিস্টিলেশন ওয়ার্কফ্লো বাস্তব উদাহরণ সহ
  - ৮৫% ইনফারেন্স সময় হ্রাস ৯২% সঠিকতা ধরে রেখে

- [**সেকশন ৩: ফাইন-টিউনিং - নির্দিষ্ট কাজের জন্য মডেল কাস্টমাইজেশন**](./Module05/03.SLMOps-Finetuing.md)
...
- [**সেকশন ৪: ডিপ্লয়মেন্ট - প্রোডাকশন-রেডি বাস্তবায়ন**](./Module05/04.SLMOps.Deployment.md)
...
### [মডিউল ০৬: SLM Agentic Systems - AI এজেন্ট এবং ফাংশন কলিং](./Module06/README.md)
**থিম**: SLM এজেন্টিক সিস্টেম বাস্তবায়ন ফাউন্ডেশন থেকে উন্নত ফাংশন কলিং এবং Model Context Protocol ইন্টিগ্রেশন

#### অধ্যায় কাঠামো:
- [**সেকশন ১: AI এজেন্ট এবং ছোট ভাষার মডেলের ভিত্তি**](./Module06/01.IntroduceAgent.md)
  - এজেন্ট শ্রেণীবিভাগ কাঠামো (রিফ্লেক্স, মডেল-ভিত্তিক, লক্ষ্য-ভিত্তিক, লার্নিং এজেন্ট)
  - SLM-এর মৌলিক বিষয় এবং অপ্টিমাইজেশন কৌশল (GGUF, কোয়ান্টাইজেশন, এজ ফ্রেমওয়ার্ক)
  - SLM বনাম LLM ট্রেড-অফ বিশ্লেষণ (১০-৩০× খরচ হ্রাস, ৭০-৮০% কার্যকারিতা)
  - Ollama, VLLM, এবং Microsoft এজ সলিউশন দিয়ে বাস্তবায়ন

- [**সেকশন ২: ছোট ভাষার মডেলে ফাংশন কলিং**](./Module06/02.FunctionCalling.md)
  - সিস্টেমেটিক ওয়ার্কফ্লো বাস্তবায়ন (ইন্টেন্ট ডিটেকশন, JSON আউটপুট, এক্সটার্নাল এক্সিকিউশন)
  - প্ল্যাটফর্ম-নির্দিষ্ট বাস্তবায়ন (Phi-4-mini, নির্বাচিত Qwen মডেল, Microsoft Foundry Local)
  - উন্নত উদাহরণ (মাল্টি-এজেন্ট সহযোগিতা, ডাইনামিক টুল নির্বাচন)
  - প্রোডাকশন বিবেচনা (রেট লিমিটিং, অডিট লগিং, সিকিউরিটি ব্যবস্থা)

- [**সেকশন ৩: Model Context Protocol (MCP) ইন্টিগ্রেশন**](./Module06/03.IntroduceMCP.md)
  - প্রোটোকল আর্কিটেকচার এবং লেয়ারড সিস্টেম ডিজাইন
...
### [মডিউল ০৭: EdgeAI বাস্তবায়ন নমুনা](./Module07/README.md)
**থিম**: বিভিন্ন প্ল্যাটফর্ম এবং ফ্রেমওয়ার্ক জুড়ে ব্যাপক EdgeAI বাস্তবায়ন

#### অধ্যায় কাঠামো:
- [**Visual Studio Code-এর জন্য AI Toolkit**](./Module07/aitoolkit.md)
  - Visual Studio Code-এর মধ্যে ব্যাপক Edge AI ডেভেলপমেন্ট পরিবেশ
...
- [**Windows EdgeAI ডেভেলপমেন্ট গাইড**](./Module07/windowdeveloper.md)
...
- [**NVIDIA Jetson Orin Nano-তে EdgeAI**](./Module07/README.md#1-edgeai-in-nvidia-jetson-orin-nano)
  - ক্রেডিট-কার্ড-সাইজড ফর্ম ফ্যাক্টরে ৬৭ TOPS AI পারফরম্যান্স
...
- [**.NET MAUI এবং ONNX Runtime GenAI সহ মোবাইল অ্যাপ্লিকেশনে EdgeAI**](./Module07/README.md#2-edgeai-in-mobile-applications-with-net-maui-and-onnx-runtime-genai)
  - একক C# কোডবেস সহ ক্রস-প্ল্যাটফর্ম মোবাইল AI
  - হার্ডওয়্যার অ্যাক্সেলারেশন সাপোর্ট (CPU, GPU, মোবাইল AI প্রসেসর)
  - প্ল্যাটফর্ম-নির্দিষ্ট অপ্টিমাইজেশন (iOS-এর জন্য CoreML, Android-এর জন্য NNAPI)
  - সম্পূর্ণ জেনারেটিভ AI লুপ বাস্তবায়ন

- [**Azure-এ ছোট ভাষার মডেল ইঞ্জিন সহ EdgeAI**](./Module07/README.md#3-edgeai-in-azure-with-small-language-models-engine)
  ...
  - বুদ্ধিমান ডকুমেন্ট প্রসেসিংয়ের জন্য হাইব্রিড AI ওয়ার্কফ্লো

- [**Windows ML সহ EdgeAI**](./Module07/README.md#4-edgeai-with-windows-ml)
...
- [**Foundry Local অ্যাপ্লিকেশন সহ EdgeAI**](./Module07/README.md#5-edgeai-with-foundry-local-applications)
  - প্রাইভেসি-ফোকাসড RAG বাস্তবায়ন লোকাল রিসোর্স সহ
  - Phi-3 ভাষার মডেল ইন্টিগ্রেশন সেমান্টিক সার্চ সহ (শুধুমাত্র Phi মডেল)
  - লোকাল ভেক্টর ডাটাবেস সাপোর্ট (SQLite, Qdrant)
  - ডেটা সার্বভৌমত্ব এবং অফলাইন অপারেশন সক্ষমতা

## কোর্স শেখার লক্ষ্য

এই ব্যাপক EdgeAI কোর্স সম্পন্ন করার মাধ্যমে, আপনি প্রোডাকশন-রেডি EdgeAI সমাধান ডিজাইন, বাস্তবায়ন এবং ডিপ্লয় করার দক্ষতা অর্জন করবেন। আমাদের গঠনমূলক পদ্ধতি নিশ্চিত করে যে আপনি তাত্ত্বিক ভিত্তি এবং ব্যবহারিক বাস্তবায়ন দক্ষতা উভয়ই আয়ত্ত করবেন।
এই কোর্সটি আপনাকে এআই প্রযুক্তি বাস্তবায়নের অগ্রভাগে নিয়ে যায়, যেখানে বুদ্ধিমান সক্ষমতাগুলি আধুনিক জীবনের শক্তি প্রদানকারী ডিভাইস এবং সিস্টেমগুলিতে নির্বিঘ্নে সংযুক্ত হয়।
...
- **ক্রমবর্ধমান শেখা**: মৌলিক ধারণা থেকে উন্নত বাস্তবায়নের দিকে ধাপে ধাপে অগ্রসর হওয়া
- **তত্ত্ব এবং প্র্যাকটিসের সংমিশ্রণ**: প্রতিটি মডিউলে তাত্ত্বিক ভিত্তি এবং ব্যবহারিক কার্যক্রম অন্তর্ভুক্ত
- **বাস্তব কেস স্টাডি**: মাইক্রোসফট, আলিবাবা, গুগল এবং অন্যান্যদের প্রকৃত কেসের উপর ভিত্তি করে
- **হ্যান্ডস-অন প্র্যাকটিস**: সম্পূর্ণ কনফিগারেশন ফাইল, API টেস্টিং পদ্ধতি এবং বাস্তবায়ন স্ক্রিপ্ট
- **পারফরম্যান্স বেঞ্চমার্ক**: ইনফারেন্স স্পিড, মেমরি ব্যবহার এবং রিসোর্সের প্রয়োজনীয়তার বিস্তারিত তুলনা
- **এন্টারপ্রাইজ-গ্রেড বিবেচনা**: নিরাপত্তা অনুশীলন, সম্মতি কাঠামো এবং ডেটা সুরক্ষা কৌশল

## শুরু করার জন্য

প্রস্তাবিত শেখার পথ:
1. **Module01** দিয়ে শুরু করুন EdgeAI-এর মৌলিক ধারণা তৈরি করতে
2. **Module02**-এ এগিয়ে যান বিভিন্ন SLM মডেল পরিবারের গভীর জ্ঞান অর্জন করতে
3. **Module03** শিখুন ব্যবহারিক বাস্তবায়ন দক্ষতা আয়ত্ত করতে
4. **Module04** চালিয়ে যান উন্নত মডেল অপ্টিমাইজেশন, ফরম্যাট রূপান্তর এবং ফ্রেমওয়ার্ক সংশ্লেষণের জন্য
5. **Module05** সম্পূর্ণ করুন SLMOps আয়ত্ত করতে যা প্রোডাকশন-রেডি বাস্তবায়নের জন্য
6. **Module06** অন্বেষণ করুন SLM এজেন্টিক সিস্টেম এবং ফাংশন কলিং সক্ষমতা বুঝতে
7. **Module07** শেষ করুন AI Toolkit এবং বিভিন্ন EdgeAI বাস্তবায়নের নমুনার সাথে ব্যবহারিক অভিজ্ঞতা অর্জন করতে

প্রতিটি মডিউল স্বাধীনভাবে সম্পূর্ণভাবে ডিজাইন করা হয়েছে, তবে ধারাবাহিকভাবে শেখা সেরা ফলাফল প্রদান করবে।

## স্টাডি গাইড

একটি বিস্তৃত [স্টাডি গাইড](STUDY_GUIDE.md) উপলব্ধ রয়েছে যা আপনার শেখার অভিজ্ঞতা সর্বাধিক করতে সাহায্য করবে। স্টাডি গাইডটি প্রদান করে:

- **গঠনমূলক শেখার পথ**: ২০ ঘণ্টার মধ্যে কোর্স সম্পন্ন করার জন্য অপ্টিমাইজড সময়সূচি
- **সময় বরাদ্দ নির্দেশিকা**: পড়া, অনুশীলন এবং প্রকল্পের মধ্যে ভারসাম্য বজায় রাখার জন্য নির্দিষ্ট সুপারিশ
- **মূল ধারণার উপর ফোকাস**: প্রতিটি মডিউলের জন্য অগ্রাধিকারপ্রাপ্ত শেখার লক্ষ্য
- **স্ব-মূল্যায়ন সরঞ্জাম**: আপনার বোঝাপড়া পরীক্ষা করার জন্য প্রশ্ন এবং অনুশীলন
- **মিনি-প্রজেক্ট আইডিয়া**: আপনার শেখাকে শক্তিশালী করার জন্য ব্যবহারিক প্রয়োগ

স্টাডি গাইডটি তীব্র শেখার (১ সপ্তাহ) এবং পার্ট-টাইম অধ্যয়ন (৩ সপ্তাহ) উভয়কেই সমর্থন করার জন্য ডিজাইন করা হয়েছে, যেখানে স্পষ্ট নির্দেশনা রয়েছে যে কীভাবে আপনার সময় কার্যকরভাবে বরাদ্দ করবেন, এমনকি যদি আপনি কোর্সে মাত্র ১০ ঘণ্টা দিতে পারেন।

---

**EdgeAI-এর ভবিষ্যৎ মডেল আর্কিটেকচার, কোয়ান্টাইজেশন কৌশল এবং বাস্তবায়ন কৌশলের ক্রমাগত উন্নতির মধ্যে নিহিত, যা দক্ষতা এবং বিশেষায়নের উপর সাধারণ উদ্দেশ্য সক্ষমতার পরিবর্তে অগ্রাধিকার দেয়। যে সংস্থাগুলি এই প্যারাডাইম শিফট গ্রহণ করবে তারা এআই-এর রূপান্তরকারী সম্ভাবনাকে কাজে লাগানোর জন্য ভালোভাবে অবস্থান করবে, একই সাথে তাদের ডেটা এবং অপারেশনের উপর নিয়ন্ত্রণ বজায় রাখবে।**
