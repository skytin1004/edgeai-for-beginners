...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:47:50+00:00",
...
- **📚 শিক্ষামূলক নোটবুক** (`chainlit_app.ipynb`): ইন্টারঅ্যাকটিভ লার্নিং উপকরণ
...
| **জটিল যুক্তি** | ☁️ ক্লাউড (Azure OpenAI) | বড় মডেলের অ্যাক্সেস |
...
- ⚡ **WebGPU অ্যাক্সিলারেশন**: হার্ডওয়্যার অ্যাক্সিলারেশন যখন উপলব্ধ
- 🔒 **সর্বাধিক গোপনীয়তা**: কোনো ডেটা ডিভাইসের বাইরে যায় না
...
1. **WebGPU সমর্থিত নয়:**
   ...
   - WebGPU চালু করুন: `chrome://flags/#enable-unsafe-webgpu`
   - GPU স্ট্যাটাস চেক করুন: `chrome://gpu`
   - ডেমো স্বয়ংক্রিয়ভাবে CPU-তে ফিরে যাবে

2. **মডেল লোডিং ত্রুটি:**
   - মডেল ডাউনলোডের জন্য ইন্টারনেট সংযোগ নিশ্চিত করুন
   - ব্রাউজার কনসোলে CORS ত্রুটি চেক করুন
...
- ব্রাউজার স্টোরেজে কম্পাইল করা মডেল ক্যাশ করুন
...
- **API কী**: এনভায়রনমেন্ট ভেরিয়েবল ব্যবহার করুন, কখনো হার্ডকোড করবেন না
- **নেটওয়ার্ক**: প্রোডাকশনে HTTPS ব্যবহার করুন, টিম অ্যাক্সেসের জন্য VPN বিবেচনা করুন
- **অ্যাক্সেস কন্ট্রোল**: Open WebUI-এর জন্য অথেনটিকেশন বাস্তবায়ন করুন
...
- **মেট্রিক্স**: রেসপন্স টাইম, ত্রুটি হার, রিসোর্স ব্যবহার ট্র্যাক করুন
...
- [Open WebUI ডকুমেন্টেশন](https://docs.openwebui.com/) - উন্নত কনফিগারেশন
...
- [`open-webui-guide.md`](./open-webui-guide.md) - সম্পূর্ণ Open WebUI সেটআপ
