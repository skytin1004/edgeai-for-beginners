...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T15:04:56+00:00",
...
এই সেশনে Chainlit এবং Microsoft Foundry Local ব্যবহার করে প্রোডাকশন-রেডি চ্যাট অ্যাপ্লিকেশন তৈরি করার উপর ফোকাস করা হয়েছে। আপনি শিখবেন কীভাবে AI কথোপকথনের জন্য আধুনিক ওয়েব ইন্টারফেস তৈরি করবেন, স্ট্রিমিং রেসপন্স বাস্তবায়ন করবেন এবং সঠিক ত্রুটি পরিচালনা ও ব্যবহারকারীর অভিজ্ঞতা ডিজাইনের মাধ্যমে শক্তিশালী চ্যাট অ্যাপ্লিকেশন মোতায়েন করবেন।
...
- **প্রোডাকশন প্যাটার্ন**: ত্রুটি পরিচালনা, মনিটরিং এবং মোতায়েন কৌশল
...
- **Python**: ৩.১০ বা তার বেশি ভার্সন, ভার্চুয়াল এনভায়রনমেন্ট সক্ষমতা সহ
...
| **খরচ** | 💰 হার্ডওয়্যার পর খরচ নেই | 💸 প্রতি টোকেন খরচ |
...
অ্যাপ্লিকেশনটি স্বয়ংক্রিয়ভাবে `http://localhost:8080` এ আধুনিক চ্যাট ইন্টারফেস সহ খুলে যায়।
...
নমুনা ০৪ একটি বিস্তৃত Jupyter নোটবুক (`chainlit_app.ipynb`) অন্তর্ভুক্ত করে যা প্রদান করে:

- **📚 শিক্ষামূলক বিষয়বস্তু**: ধাপে ধাপে শেখার উপকরণ
- **🔬 ইন্টারঅ্যাকটিভ এক্সপ্লোরেশন**: কোড সেল চালানো এবং পরীক্ষা করা
- **📊 ভিজ্যুয়াল ডেমোনস্ট্রেশন**: চার্ট, ডায়াগ্রাম এবং আউটপুট ভিজ্যুয়ালাইজেশন
- **🛠️ ডেভেলপমেন্ট টুলস**: টেস্টিং এবং ডিবাগিং সক্ষমতা
...
3. "Foundry Local" কার্নেল নির্বাচন করুন যখন প্রম্পট দেখাবে
...
### ইন্টারঅ্যাকটিভ উদাহরণ এবং অনুশীলন
...
#### অনুশীলন ২: স্ট্রিমিং রেসপন্স সিমুলেশন
...
WebGPU AI মডেলগুলোকে সরাসরি ব্রাউজারে চালানোর সুযোগ দেয়, যা সর্বাধিক গোপনীয়তা এবং জিরো-ইনস্টল অভিজ্ঞতা প্রদান করে। এই নমুনা ONNX Runtime Web এর সাথে WebGPU এক্সিকিউশন প্রদর্শন করে।
...
Open WebUI একটি পেশাদার ChatGPT-এর মতো ইন্টারফেস প্রদান করে যা Foundry Local এর OpenAI-সামঞ্জস্যপূর্ণ API এর সাথে সংযুক্ত হয়।
...
- ✅ **প্রোডাকশন প্যাটার্ন**: ত্রুটি পরিচালনা, মনিটরিং এবং স্কেলিং

নমুনা ০৪ অ্যাপ্লিকেশন Microsoft Foundry Local এর মাধ্যমে স্থানীয় AI মডেল ব্যবহার করে শক্তিশালী চ্যাট ইন্টারফেস তৈরি করার সেরা অনুশীলন প্রদর্শন করে, যা চমৎকার ব্যবহারকারীর অভিজ্ঞতা প্রদান করে।

## রেফারেন্স

- **[নমুনা ০৪: Chainlit অ্যাপ্লিকেশন](samples/04/README.md)**: সম্পূর্ণ অ্যাপ্লিকেশন সহ ডকুমেন্টেশন
- **[Chainlit শিক্ষামূলক নোটবুক](samples/04/chainlit_app.ipynb)**: ইন্টারঅ্যাকটিভ শেখার উপকরণ
