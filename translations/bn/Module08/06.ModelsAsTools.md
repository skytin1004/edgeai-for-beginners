...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T15:04:31+00:00",
...
Foundry Local-এর মাধ্যমে AI মডেলগুলোকে মডুলার, কাস্টমাইজযোগ্য টুল হিসেবে ব্যবহার করুন যা সরাসরি ডিভাইসে চলে। এই সেশনে গোপনীয়তা রক্ষা, কম-লেটেন্সি ইনফারেন্সের জন্য ব্যবহারিক ওয়ার্কফ্লো এবং SDKs, APIs বা CLI-এর মাধ্যমে এই টুলগুলোকে কীভাবে ইন্টিগ্রেট করবেন তা নিয়ে আলোচনা করা হয়েছে। এছাড়াও, প্রয়োজনে Azure AI Foundry-তে স্কেল করার পদ্ধতি শিখবেন।
...
## শেখার লক্ষ্য
- ডিভাইসে মডেল-অ্যাস-এ-টুল প্যাটার্ন ডিজাইন করুন
...
ধাপ ১) FoundryLocalManager দিয়ে আধুনিক মডেল রাউটার ডিফাইন করুন  
```python
