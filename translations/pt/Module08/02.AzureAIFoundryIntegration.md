...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T12:57:09+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "pt"
}
-->
# Sessão 2: Criar Soluções de IA com Azure AI Foundry

## Visão Geral

Com base nos conhecimentos adquiridos no Foundry Local, esta sessão foca na criação de soluções avançadas de IA através de técnicas de engenharia de prompts, integração de dados sem falhas e automação de tarefas acionáveis. Vais aprender a ligar o desenvolvimento local às capacidades do Azure AI Foundry, criando aplicações empresariais que aproveitam o melhor dos dois mundos.

## Objetivos de Aprendizagem

Até ao final desta sessão, serás capaz de:
- Dominar técnicas avançadas de engenharia de prompts para respostas de IA consistentes e fiáveis
- Implementar padrões robustos de integração de dados para aplicações reais
- Criar tarefas de IA acionáveis que geram valor para o negócio
- Estabelecer conectividade perfeita entre Foundry Local e Azure AI Foundry
- Construir fluxos de trabalho para monitorização e otimização de desempenho
- Implementar soluções de IA prontas para produção com tratamento de erros adequado e escalabilidade

## Pré-requisitos

- Sessão 1 concluída: Introdução ao Foundry Local
- Instalação ativa do Foundry Local com modelos em execução
- Conta Azure (o nível gratuito é suficiente para aprendizagem)
- Compreensão básica de REST APIs e JSON

## Parte 1: Engenharia Avançada de Prompts

### Compreender a Arquitetura de Prompts

A engenharia eficaz de prompts é a base de aplicações de IA fiáveis. O Foundry Local oferece capacidades avançadas de criação de prompts:
...
### Implementação de Estratégias de Prompts
...
## Parte 2: Padrões de Integração de Dados

### Conectores de Dados do Foundry Local
...
### Exemplo de Integração de Dados no Mundo Real
...
## Parte 3: Tarefas de IA Acionáveis

### Estrutura de Automação de Tarefas
...
### Exemplos de Automação de Processos Empresariais
...
## Parte 4: Integração com Azure AI Foundry
...
### Padrões de Implementação Híbrida
...
## Parte 5: Monitorização e Otimização de Desempenho

### Sistema de Monitorização Abrangente
...
### Exercício 1: Bot Avançado de Atendimento ao Cliente
...
### Exercício 2: Pesquisa de Mercado Automatizada
...
## Parte 7: Próximos Passos e Prévia da Sessão 3

### Conquistas da Sessão

Nesta sessão, dominaste:
- ✅ Técnicas avançadas de engenharia de prompts para comportamento consistente da IA
- ✅ Padrões robustos de integração de dados para aplicações reais
- ✅ Criação de tarefas automatizadas para otimização de processos empresariais
- ✅ Integração com Azure AI Foundry e estratégias de implementação híbrida
- ✅ Monitorização e otimização de desempenho abrangentes

### Preparação para a Sessão 3: Modelos Open-Source

1. **Explorar Hugging Face**: Cria uma conta e explora o catálogo de modelos
2. **Revisar Model Mondays**: Consulta a série mais recente [Model Mondays](https://aka.ms/model-mondays)
3. **Planear Modelos Personalizados**: Considera que modelos especializados poderiam beneficiar os teus casos de uso

### Recursos Adicionais

- [Documentação do Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Repositório GitHub do Foundry Local](https://github.com/microsoft/Foundry-Local)
- [Guia Avançado de Engenharia de Prompts](https://platform.openai.com/docs/guides/prompt-engineering)
- [Melhores Práticas de Automação de Processos Empresariais](https://docs.microsoft.com/en-us/power-automate/)

Agora estás preparado para criar soluções de IA sofisticadas que combinam o poder da inferência local com capacidades em escala na cloud, estabelecendo a base para aplicações de IA de nível empresarial.
