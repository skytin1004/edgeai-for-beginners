...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-17T13:13:04+00:00",
...
Este guia abrangente irá ajudá-lo a preparar-se para o curso de EdgeAI, que se concentra na criação de soluções práticas de IA que funcionam de forma eficiente em dispositivos edge. O curso enfatiza o desenvolvimento prático utilizando frameworks modernos e modelos de última geração otimizados para implementação em edge.
...
- **Ambiente Virtual**: Utilize ambientes venv ou conda para isolamento
...
## 2. Requisitos de Hardware & Recomendações
...
## 3. Famílias de Modelos Principais & Recursos

### Famílias de Modelos Principais

**Família Microsoft Phi-4**
- **Descrição**: Modelos compactos e eficientes projetados para implementação em edge
...
- **Compromisso Desempenho vs. Tamanho**: Compreender quando escolher modelos menores ou maiores
...
## 4. Ferramentas de Quantização & Otimização
...
- **Propósito**: Kit de ferramentas de otimização de modelos para implementação em edge
- **Principais Funcionalidades**:
...
## 5. Leituras & Recursos Recomendados

### Documentação Essencial
- **Documentação ONNX Runtime**: Compreensão de inferência multiplataforma
...
- **Documentação ONNX Runtime**: Guia abrangente do ONNX Runtime
...
3. Estar familiarizado com os principais frameworks e ferramentas utilizados ao longo do curso
4. Selecionar modelos apropriados com base em restrições e requisitos dos dispositivos
