...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-08T20:53:17+00:00",
  "source_file": "Workshop/FOUNDRY_SDK_QUICKREF.md",
  "language_code": "pt"
}
-->
# Foundry Local SDK - Referência Rápida
...
## Aliases Comuns de Modelos

| Alias | Tamanho | Melhor Para |
|-------|---------|-------------|
...
2. **Pedidos em Lote**: Processe múltiplos prompts sequencialmente
3. **Ajuste max_tokens**: Menor = respostas mais rápidas
4. **Pré-carregue Modelos**: Faça o download antes do uso em produção
5. **Monitorize o Uso**: Acompanhe tokens com `SHOW_USAGE=1`
