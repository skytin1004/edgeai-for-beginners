...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:31:20+00:00",
...
Bem-vindo ao **EdgeAI para Iniciantes** – a sua jornada completa no mundo transformador da Inteligência Artificial na Edge. Este curso conecta as capacidades poderosas da IA com a implementação prática em dispositivos de edge, permitindo que você aproveite o potencial da IA diretamente onde os dados são gerados e as decisões precisam ser tomadas.
...
- **Inferência no dispositivo**: Modelos de IA executados em dispositivos de edge (telemóveis, routers, microcontroladores, PCs industriais)
...
- **Redução de memória**: Uso eficiente da memória limitada de dispositivos de edge
- **Menor demanda computacional**: Otimizado para desempenho em CPU e GPU de edge
- **Início mais rápido**: Inicialização rápida para aplicações responsivas
...
- **Servidores de edge**: Unidades de processamento local com recursos limitados de GPU
...
| [🚀 03](../../Module03) | [Prática de Implementação de SLM](./Module03/README.md) | Implementação local e na nuvem | Aprendizagem avançada • Ambiente local • Implementação na nuvem | Intermediário | 4-5 hrs |
...
- **Implementação Multiplataforma**: Windows, dispositivos móveis, sistemas embarcados e híbridos entre nuvem e edge  
- **Operações de Produção**: Monitorização, escalonamento e manutenção de IA de ponta em produção

### 🏗️ Projetos Práticos
- **Foundry Local Chat Apps**: Aplicação nativa para Windows 11 com alternância de modelos
...
0. **📖 Introdução** ([Introduction.md](./introduction.md)): Fundamentos de EdgeAI + contexto industrial + framework de aprendizagem
...
**Projetos de Portfólio**: Sistemas multi-agente • Aplicações RAG em produção • Implementação multiplataforma • Otimização de desempenho
...
**EdgeAI representa o futuro da implementação de IA**: local-first, preservação de privacidade e eficiência. Domine estas competências para construir a próxima geração de aplicações inteligentes.
