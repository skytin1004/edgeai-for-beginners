...
Dieses Beispiel zeigt, wie Foundry Local-Modelle als wiederverwendbare Tools bereitgestellt werden können, die in bestehende Anwendungen, Workflows und Entwicklungsumgebungen integriert werden können. Es veranschaulicht die von Microsoft empfohlenen Muster für Tool-Integration und Funktionsaufrufe.

## Wichtige Konzepte

### 🔧 **Tool-First-Architektur**
- Foundry Local-Modelle als aufrufbare Funktionen
- Standardisierte Tool-Schnittstellen und Schemas
- Nahtlose Integration in bestehende Codebasen
- Typensichere Tool-Definitionen und Validierung

### ⚡ **Muster für Funktionsaufrufe**
- Implementierung von Funktionsaufrufen mit Microsoft Foundry Local
- OpenAI-kompatible Tool-Definitionen
- Automatische Parametervalidierung und -konvertierung
- Fehlerbehandlung und Antwortformatierung

### 🔌 **Integrations-Frameworks**
- **LangChain-Integration**: Native Unterstützung für LangChain-Tools
- **Semantic Kernel**: Funktionen des Microsoft Semantic Kernel
- **REST API**: HTTP-basierte Tool-Endpunkte
- **CLI-Tools**: Integration über die Kommandozeile
- **Jupyter Notebooks**: Interaktive Entwicklungswerkzeuge

### 🎯 **Anwendungsmuster**
- Tools zur Codeanalyse und -generierung
- Verarbeitung und Zusammenfassung von Inhalten
...
### Systemanforderungen
- **Python**: Version 3.9+ mit asyncio-Unterstützung
- **Node.js**: Version 18+ (für JavaScript-Integrationen)
- **Speicher**: Mindestens 12 GB empfohlen
- **Speicherplatz**: Mindestens 10 GB für Modelle und Tools
...
### 1. Erstellung eines einfachen Tools
```python
...
## Kernmuster für Tools

### 1. Funktionsbasierte Tools
```python
...
1. **Muster für Tool-Integration**
   - Design von funktions- und klassenbasierten Tools
   - Integrationsmuster für Microsoft Foundry Local
   - Schema-Validierung und Typensicherheit
   - Fehlerbehandlung und Wiederherstellung

2. **Framework-Integration**
   - Entwicklung von LangChain-Tools
   - Integration von Semantic Kernel-Funktionen
   - Integration in REST API-Frameworks
   - Entwicklung von CLI-Anwendungen

3. **Produktionsüberlegungen**
   - Strategien zur Leistungsoptimierung
   - Caching und Ressourcenmanagement
   - Überwachung und Beobachtbarkeit
   - Sicherheit und Validierung

4. **Erweiterte Tool-Muster**
   - Tool-Komposition und -Verkettung
   - Kontextbewusste Verarbeitung
   - Batch- und Streaming-Operationen
   - Entwicklung benutzerdefinierter Integrationen

## Nächste Schritte

- **Integrationsprojekte**: Erstellen Sie benutzerdefinierte Integrationen mit Ihren bevorzugten Frameworks
- **Tool-Entwicklung**: Entwickeln Sie spezialisierte Tools für Ihre Domäne
- **Leistungsoptimierung**: Optimieren Sie für Ihre spezifischen Anwendungsfälle
- **Produktionsbereitstellung**: Skalieren Sie Tools für den Unternehmenseinsatz

## Mitwirken

Siehe die Richtlinien des Hauptrepositories für Anweisungen zur Mitwirkung.
