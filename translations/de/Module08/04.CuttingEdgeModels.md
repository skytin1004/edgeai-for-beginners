...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T11:43:37+00:00",
...
Diese Sitzung konzentriert sich auf die Entwicklung von produktionsreifen Chat-Anwendungen mit Chainlit und Microsoft Foundry Local. Sie lernen, moderne Weboberflächen für KI-Konversationen zu erstellen, Streaming-Antworten zu implementieren und robuste Chat-Anwendungen mit angemessenem Fehlerhandling und Benutzererlebnisdesign bereitzustellen.
...
- **Produktionsmuster**: Fehlerhandling, Überwachung und Bereitstellungsstrategien
...
- Angemessenes Fehlerhandling und schrittweise Degradierung anwenden
...
| **Datenschutz** | 🔒 Daten verlassen das Gerät nicht | ⚠️ Daten werden in die Cloud gesendet |
...
|----------|-------------|---------|----------|
| `MODEL` | Zu verwendender Modellalias | `phi-4-mini` | `qwen2.5-7b-instruct` |
...
Open WebUI bietet eine professionelle ChatGPT-ähnliche Oberfläche, die sich mit der OpenAI-kompatiblen API von Foundry Local verbindet.
...
4. **Verbindung testen:** Modelle sollten im Dropdown erscheinen
...
- ✅ **Produktionsmuster**: Fehlerhandling, Überwachung und Skalierung
...
- **[Chainlit-Lern-Notebook](samples/04/chainlit_app.ipynb)**: Interaktive Lernmaterialien
...
- **[Open WebUI-Integrationsanleitung](https://github.com/microsoft/foundry-local/blob/main/docs/tutorials/chat-application-with-open-web-ui.md)**: Offizielles Tutorial
