...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T11:41:56+00:00",
...
- Rüsten Sie den Arbeitsspeicher auf, wenn häufig Speichergrenzen erreicht werden
...
- Kompilieren und ausführen Sie ausgewählte Hugging Face-Modelle innerhalb von Foundry Local
...
**Hinweis:** Der `--verbose`-Schalter liefert detaillierte Startinformationen, einschließlich:
- Fortschritt des Modelldownloads (beim ersten Start)
...
**Mittlere Modelle:**
- `qwen2.5-7b-instruct`: Hervorragendes logisches Denken und längerer Kontext
- `deepseek-r1-distill-qwen-7b`: Optimiert für Codegenerierung

**Größere Modelle:**
- `llama-3.2`: Metas neuestes Open-Source-Modell
- `qwen2.5-14b-instruct`: Unternehmensgerechtes logisches Denken

## Teil 2: Schnelles Testen und Vergleichen von Modellen

### Ansatz von Sample 03: Einfaches Listen und Benchmarken

Basierend auf unserem Sample 03-Muster hier der minimale Workflow:
...
Foundry Local verwaltet automatisch Modelldownloads und Caching:
...
- Berücksichtigen Sie den Kompromiss zwischen Modellgröße und Leistung
...
- Starten Sie mit: `phi-4-mini` (schnell, effizient)
- Wechseln Sie zu: `phi-4` (besseres logisches Denken)
- Fortgeschritten: `qwen2.5-7b-instruct` (längerer Kontext)

**Für Codegenerierung:**
- Empfohlen: `deepseek-r1-distill-qwen-7b`
- Alternative: `qwen2.5-7b-instruct` (auch gut für Code)

**Für komplexes logisches Denken:**
- Beste Wahl: `qwen2.5-7b-instruct` oder `qwen2.5-14b-instruct`
- Budgetoption: `phi-4`
...
- 32GB+ RAM für komfortablen Multi-Modell-Wechsel
...
Testen Sie jedes Modell mit konsistenten Eingaben und bewerten Sie manuell:
...
- Teilen Sie Ihre Ergebnisse im `models.json` Ihrer Gruppe
