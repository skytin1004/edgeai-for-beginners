...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T12:57:32+00:00",
...
Aufbauend auf Ihrer Foundry Local-Grundlage konzentriert sich diese Sitzung darauf, fortschrittliche KI-Lösungen durch fortgeschrittenes Prompt-Engineering, nahtlose Datenintegration und umsetzbare Aufgabenautomatisierung zu erstellen. Sie lernen, lokale Entwicklung mit den Funktionen von Azure AI Foundry zu verbinden, um unternehmensgerechte Anwendungen zu schaffen, die das Beste aus beiden Welten nutzen.

## Lernziele

Am Ende dieser Sitzung werden Sie:
- Fortgeschrittene Techniken des Prompt-Engineerings für konsistente und zuverlässige KI-Antworten beherrschen
- Robuste Muster für die Datenintegration in realen Anwendungen implementieren
- Umsetzbare KI-Aufgaben erstellen, die geschäftlichen Mehrwert liefern
- Nahtlose Konnektivität zwischen Foundry Local und Azure AI Foundry herstellen
- Workflows zur Leistungsüberwachung und Optimierung aufbauen
- Produktionsreife KI-Lösungen mit ordnungsgemäßer Fehlerbehandlung und Skalierung bereitstellen

## Voraussetzungen

- Abschluss von Sitzung 1: Einführung in Foundry Local
- Aktive Foundry Local-Installation mit laufenden Modellen
- Azure-Konto (kostenloses Konto reicht für Lernzwecke aus)
- Grundlegendes Verständnis von REST-APIs und JSON

## Teil 1: Fortgeschrittenes Prompt-Engineering

### Verständnis der Prompt-Architektur

Effektives Prompt-Engineering ist die Grundlage zuverlässiger KI-Anwendungen. Foundry Local bietet erweiterte Möglichkeiten für das Prompting:
...
### Umsetzung von Prompt-Strategien
...
### Praktische Beispiele für Prompt-Engineering
...
## Teil 2: Muster für Datenintegration

### Foundry Local-Datenkonnektoren
...
### Beispiel für reale Datenintegration
...
## Teil 3: Umsetzbare KI-Aufgaben

### Rahmenwerk für Aufgabenautomatisierung
...
## Teil 4: Integration von Azure AI Foundry
...
### Muster für hybride Bereitstellung
...
## Teil 5: Leistungsüberwachung und Optimierung
...
### Übung 1: Fortgeschrittener Kundenservice-Bot
...
### Übung 2: Automatisierte Marktanalyse
...
## Teil 7: Nächste Schritte und Vorschau auf Sitzung 3

### Erfolge der Sitzung

In dieser Sitzung haben Sie:
- ✅ Fortgeschrittene Techniken des Prompt-Engineerings für konsistentes KI-Verhalten gemeistert
- ✅ Robuste Muster für die Datenintegration in realen Anwendungen implementiert
- ✅ Automatisierte Aufgaben für die Optimierung von Geschäftsprozessen erstellt
- ✅ Azure AI Foundry integriert und Strategien für hybride Bereitstellungen entwickelt
- ✅ Umfassende Leistungsüberwachung und Optimierung durchgeführt

### Vorbereitung auf Sitzung 3: Open-Source-Modelle

1. **Hugging Face erkunden**: Erstellen Sie ein Konto und durchsuchen Sie den Modellkatalog
2. **Model Mondays überprüfen**: Sehen Sie sich die neuesten [Model Mondays-Serie](https://aka.ms/model-mondays) an
3. **Eigene Modelle planen**: Überlegen Sie, welche spezialisierten Modelle für Ihre Anwendungsfälle von Vorteil wären
...
- [Leitfaden für fortgeschrittenes Prompt-Engineering](https://platform.openai.com/docs/guides/prompt-engineering)
- [Best Practices für Geschäftsprozessautomatisierung](https://docs.microsoft.com/en-us/power-automate/)

Sie sind nun bereit, anspruchsvolle KI-Lösungen zu entwickeln, die die Leistungsfähigkeit lokaler Inferenz mit Cloud-Skalierung kombinieren und die Grundlage für unternehmensgerechte KI-Anwendungen schaffen.
