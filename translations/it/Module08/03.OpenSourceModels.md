...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-01T00:11:24+00:00",
...
- Comprendere i pattern di cache dei modelli e archiviazione locale
...
## Parte 7: Risoluzione dei Problemi e Best Practices
...
- **[Documentazione di Foundry Local](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Documentazione ufficiale
...
✅ **Monitoraggio delle Prestazioni**: Misurazione di base dell'uso delle risorse e dei tempi di risposta  
✅ **Selezione dei Modelli**: Linee guida pratiche per scegliere i modelli in base ai casi d'uso  
✅ **Gestione della Cache**: Comprendere le procedure di archiviazione e pulizia  
...
**Modelli Medi:**
- `qwen2.5-7b`: Ottimo ragionamento e contesto più lungo
- `deepseek-r1-7b`: Ottimizzato per la generazione di codice

**Modelli Grandi:**
- `llama-3.2`: Ultimo modello open-source di Meta
- `qwen2.5-14b`: Ragionamento di livello enterprise
...
- Monitora l'uso del disco, soprattutto su SSD più piccoli
...
### Scelta dei Modelli in Base ai Casi d'Uso

**Per Chat Generali e Q&A:**
- Inizia con: `phi-4-mini` (veloce, efficiente)
- Passa a: `phi-4` (miglior ragionamento)
- Avanzato: `qwen2.5-7b` (contesto più lungo)

**Per Generazione di Codice:**
- Consigliato: `deepseek-r1-7b`
- Alternativa: `qwen2.5-7b` (anche buono per il codice)

**Per Ragionamento Complesso:**
- Migliore: `qwen2.5-7b` o `qwen2.5-14b`
...
- RAM da 32GB+ per un cambio di modelli confortevole
- Archiviazione SSD per un caricamento più veloce dei modelli
...
- Contribuisci con i risultati al `models.json` del tuo team
