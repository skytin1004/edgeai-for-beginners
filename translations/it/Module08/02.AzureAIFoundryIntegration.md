...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T18:33:40+00:00",
...
Basandosi sulle fondamenta di Foundry Local, questa sessione si concentra sulla creazione di soluzioni AI avanzate attraverso tecniche di ingegneria dei prompt, integrazione dei dati senza interruzioni e automazione di attività operative. Imparerai a collegare lo sviluppo locale con le funzionalità di Azure AI Foundry, creando applicazioni aziendali pronte per l'uso che sfruttano il meglio di entrambi i mondi.

## Obiettivi di Apprendimento

Alla fine di questa sessione, sarai in grado di:
- Padroneggiare tecniche avanzate di ingegneria dei prompt per risposte AI consistenti e affidabili
- Implementare modelli di integrazione dei dati robusti per applicazioni reali
- Creare attività AI operative che generano valore per il business
- Stabilire una connessione fluida tra Foundry Local e Azure AI Foundry
- Costruire flussi di lavoro per il monitoraggio delle prestazioni e l'ottimizzazione
- Distribuire soluzioni AI pronte per la produzione con gestione degli errori e scalabilità adeguata
...
- Account Azure (il livello gratuito è sufficiente per l'apprendimento)
- Comprensione di base delle API REST e del formato JSON

## Parte 1: Ingegneria Avanzata dei Prompt

### Comprendere l'Architettura dei Prompt

L'ingegneria efficace dei prompt è la base delle applicazioni AI affidabili. Foundry Local offre funzionalità avanzate per la creazione di prompt:
...
### Implementare Strategie di Prompt
...
### Esempi Pratici di Ingegneria dei Prompt
...
## Parte 2: Modelli di Integrazione dei Dati

### Connettori di Dati di Foundry Local
...
### Esempio di Integrazione dei Dati nel Mondo Reale
...
## Parte 3: Attività AI Operative

### Framework per l'Automazione delle Attività
...
## Parte 4: Integrazione con Azure AI Foundry
...
## Parte 5: Monitoraggio delle Prestazioni e Ottimizzazione
...
### Esercizio 1: Bot Avanzato per il Servizio Clienti
...
### Esercizio 2: Ricerca di Mercato Automatizzata
...
## Parte 7: Prossimi Passi e Anteprima della Sessione 3

### Risultati della Sessione

In questa sessione, hai acquisito:
- ✅ Tecniche avanzate di ingegneria dei prompt per un comportamento AI consistente
- ✅ Modelli di integrazione dei dati robusti per applicazioni reali
- ✅ Creazione di attività automatizzate per l'ottimizzazione dei processi aziendali
- ✅ Integrazione con Azure AI Foundry e strategie di distribuzione ibrida
- ✅ Monitoraggio completo delle prestazioni e ottimizzazione

### Prepararsi per la Sessione 3: Modelli Open-Source

1. **Esplora Hugging Face**: Crea un account e sfoglia il catalogo dei modelli
2. **Rivedi Model Mondays**: Dai un'occhiata alla serie [Model Mondays](https://aka.ms/model-mondays)
3. **Pianifica Modelli Personalizzati**: Considera quali modelli specializzati potrebbero essere utili per i tuoi casi d'uso

### Risorse Aggiuntive

- [Documentazione di Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Repository GitHub di Foundry Local](https://github.com/microsoft/Foundry-Local)
- [Guida Avanzata all'Ingegneria dei Prompt](https://platform.openai.com/docs/guides/prompt-engineering)
- [Best Practices per l'Automazione dei Processi Aziendali](https://docs.microsoft.com/en-us/power-automate/)

Ora sei pronto per creare soluzioni AI avanzate che combinano la potenza dell'inferenza locale con le capacità su scala cloud, ponendo le basi per applicazioni AI di livello aziendale.
