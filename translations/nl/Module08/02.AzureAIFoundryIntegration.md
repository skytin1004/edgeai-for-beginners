...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T23:54:11+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "nl"
}
-->
# Sessie 2: OpenAI SDK-integratie met Azure AI Foundry

## Overzicht

Op basis van je Foundry Local-kennis richt deze sessie zich op geavanceerde integratiepatronen van de OpenAI SDK die zowel Microsoft Foundry Local als Azure OpenAI ondersteunen. Je leert hoe je flexibele AI-toepassingen bouwt die lokaal kunnen draaien voor privacy en ontwikkeling, terwijl ze cloud-schaalbaarheid bieden via Azure OpenAI wanneer nodig.

## Leerdoelen

Aan het einde van deze sessie kun je:
- Geavanceerde OpenAI SDK-integratie beheersen met zowel Foundry Local als Azure OpenAI
- Streamingreacties implementeren voor een verbeterde gebruikerservaring
- Robuuste client factory-patronen creëren voor ondersteuning van meerdere providers
- Gespreksbeheersystemen bouwen met behoud van context
- Prestatiebenchmarking en gezondheidsmonitoring opzetten
- Productieklare toepassingen implementeren met correcte foutafhandeling

## Vereisten

- Sessie 1: Aan de slag met Foundry Local voltooid
- Actieve Foundry Local-installatie met werkende modellen
- Python 3.8 of later met ondersteuning voor virtuele omgevingen
- OpenAI Python SDK geïnstalleerd (`pip install openai foundry-local-sdk`)
- Azure-account met OpenAI-service (optioneel, voor cloudscenario's)
- Basiskennis van Python async/await-patronen

## Deel 1: OpenAI SDK Client Factory Pattern

### Begrip van Multi-Provider Architectuur

Toepassingen bouwen die werken met zowel Foundry Local als Azure OpenAI vereist een flexibel patroon voor het maken van clients:
...
## Deel 2: Streamingreacties en realtime interactie

### Streaming Chat Completions implementeren

Streaming biedt een betere gebruikerservaring door reacties te tonen terwijl ze worden gegenereerd:
...
## Deel 3: Prestatiebenchmarking en analyse

### Reactietijd meten

Meet en vergelijk prestaties tussen verschillende configuraties:
...
### Temperatuur- en parameterinstellingen testen
...
## Deel 4: Gezondheidsmonitoring en diagnostiek

### Uitgebreid systeem voor gezondheidscontrole
...
### Validator voor omgevingsconfiguratie
...
## Deel 5: Omgevingsvariabelen en configuratiebeheer

### Referentie voor omgevingsvariabelen

Volledige referentie voor het configureren van beide providers:
...
## Deel 6: Praktische oefeningen

### Oefening 1: Multi-Provider SDK-integratie

Bouw een complete toepassing die naadloos schakelt tussen providers:
...
### Oefening 2: Geavanceerd gespreksbeheer
...
### Oefening 3: Productieklare gezondheidsmonitoring
...
## Deel 7: Samenvatting en volgende stappen

### Sessieresultaten

In deze sessie heb je geleerd:
- ✅ **OpenAI SDK-integratie**: Geavanceerde patronen voor zowel Foundry Local als Azure OpenAI
- ✅ **Streamingreacties**: Realtime chatcompletions voor een verbeterde gebruikerservaring
- ✅ **Multi-Provider Ondersteuning**: Naadloos schakelen tussen lokale en cloud AI-services
- ✅ **Gespreksbeheer**: Contextbewuste multi-turn gesprekken
- ✅ **Prestatiemonitoring**: Benchmarking en gezondheidscontrole voor productie-implementaties
- ✅ **Productiepatronen**: Robuuste foutafhandeling en configuratiebeheer
...
1. **🔄 Altijd fallback-opties implementeren**: Azure → Foundry Local → Foutafhandeling
2. **🌊 Gebruik streaming voor lange reacties**: Betere waargenomen prestaties
3. **🛡️ Uitgebreide foutafhandeling implementeren**: Gebruiksvriendelijke foutmeldingen
4. **📈 Monitor prestaties**: Houd reactietijden en succespercentages bij
5. **⚙️ Configuratie op basis van omgeving**: Gemakkelijk schakelen tussen dev/staging/prod
6. **🔒 Beveilig beheer van referenties**: API-sleutels nooit hardcoderen

### Richtlijnen voor providerselectie

| Scenario | Aanbevolen provider | Reden |
|----------|---------------------|-------|
| **Ontwikkeling** | Foundry Local | Snelle iteratie, geen API-kosten |
| **Privacy-kritisch** | Foundry Local | Gegevens blijven op het apparaat |
| **Productie op grote schaal** | Azure OpenAI | Betere schaalbaarheid, enterprise SLA |
| **Nieuwste modellen** | Azure OpenAI | Toegang tot nieuwste modelreleases |
| **Offline vereisten** | Foundry Local | Geen internetafhankelijkheid |
| **Kostenbewust** | Foundry Local | Geen kosten per token |

### Snelle referentie voor omgevingsvariabelen
...
### Voorbereiding op Sessie 3: Open-Source Modellen

1. **Verken Modelcatalogus**: Bekijk beschikbare modellen in Foundry Local
2. **Begrijp Modelformaten**: Leer over ONNX, kwantisering en optimalisatie
3. **Overweeg Aangepaste Modellen**: Denk na over domeinspecifieke modelvereisten
...
- **[OpenAI Python SDK Documentatie](https://github.com/openai/openai-python)**: Officiële SDK-referentie
- **[Azure OpenAI Documentatie](https://learn.microsoft.com/azure/ai-services/openai/)**: Gids voor Azure OpenAI-service
- **[Foundry Local SDK Referentie](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Documentatie voor lokale inferentie
- **[Streaming Completions Gids](https://learn.microsoft.com/azure/ai-foundry/foundry-local/how-to/integrate-with-inference-sdks)**: Geavanceerde streamingpatronen
- **[Sample 01: Snelle Chat via OpenAI SDK](samples/01/README.md)**: Basisintegratiepatronen
- **[Sample 02: Geavanceerde SDK-integratie](samples/02/README.md)**: Hands-on voorbeelden van deze sessie
- **[Sample 04: Chainlit Toepassing](samples/04/README.md)**: Web UI-ontwikkeling
- **[Sample 05: Multi-Agent Systemen](samples/05/README.md)**: Geavanceerde orkestratiepatronen

Je bent nu uitgerust om geavanceerde AI-toepassingen te bouwen die naadloos lokale en cloud AI-mogelijkheden integreren, met de flexibiliteit om de juiste provider te kiezen voor elke specifieke use case, terwijl consistente ontwikkelingspatronen worden gehandhaafd.
