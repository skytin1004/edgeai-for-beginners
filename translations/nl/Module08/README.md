...
### [3: Open-source modellen in Foundry Local](./03.OpenSourceModels.md)
...
### [8: Windows 11 Native Chat Applicatie](./samples/08/README.md)
**Focus**: Moderne native chatapplicaties bouwen met Foundry Local-integratie
...
**Voorbeeld**: [Windows 11 Chat Applicatie](./samples/08/README.md)
...
- REST API-concepten
- Basiskennis van prompting en modelinference
...
- [Azure AI Foundry Documentatie](https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/) - Complete setup- en gebruiksgids
...
**Voorbeeld 04: Chainlit RAG Applicatie**
```powershell
...
**Voorbeeld 08: Windows 11 Chat Applicatie**
```powershell
# Navigate to sample directory
cd samples/08
...
Voor Azure OpenAI-integratie (Sessie 2), raadpleeg de individuele README-bestanden van de voorbeelden voor vereiste omgevingsvariabelen en API-versie-instellingen.
