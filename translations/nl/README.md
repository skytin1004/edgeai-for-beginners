...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T09:12:55+00:00",
...
### 🎯 Kerncompetenties
- **Edge AI Architectuur**: Ontwerp lokale AI-systemen met cloudintegratie
...
- **RAG Applicaties**: Lokale documentverwerking met vectorzoekopdrachten
...
0. **📖 Introductie** ([Introduction.md](./introduction.md)): Basis EdgeAI + context in de industrie + leerframework
1. **📚 Basis** (Modules 01-02): Concepten EdgeAI + SLM modelfamilies
