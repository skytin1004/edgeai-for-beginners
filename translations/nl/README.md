...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T11:33:47+00:00",
...
**Als je extra vertalingen wilt, worden ondersteunde talen vermeld [hier](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**
...
- **Robuuste werking**: Blijf functioneel tijdens netwerkstoringen
...
- [**Sectie 1: EdgeAI Grondbeginselen**](./Module01/01.EdgeAIFundamentals.md)
  - Vergelijking traditionele cloud AI vs edge AI
  - Uitdagingen en beperkingen van edge computing
  - Belangrijke technologieën: modelkwantisatie, compressieoptimalisatie, Small Language Models (SLMs)
  - Hardwareversnelling: NPUs, GPU-optimalisatie, CPU-optimalisatie
  - Voordelen: privacy, veiligheid, lage vertraging, offline mogelijkheden, kostenbesparing

- [**Sectie 2: Praktijkvoorbeelden**](./Module01/02.RealWorldCaseStudies.md)
  - Microsoft Phi & Mu model ecosysteem
  - Praktijkvoorbeeld van Japan Airlines AI-rapportagesysteem
  - Marktimpact en toekomstige richtingen
  - Implementatieoverwegingen en best practices

- [**Sectie 3: Praktische Implementatiegids**](./Module01/03.PracticalImplementationGuide.md)
  - Ontwikkelomgeving instellen (Python 3.10+, .NET 8+)
  - Hardwarevereisten en aanbevolen configuraties
  - Bronnen van kernmodelfamilies
  - Kwantisatie- en optimalisatietools (Llama.cpp, Microsoft Olive, Apple MLX)
...
- [**Sectie 4: BitNET Familie Grondbeginselen**](./Module02/04.BitNETFamily.md)
  - Revolutionaire kwantisatietechnologie (1.58-bit)
...
**Thema**: Volledige levenscyclus van SLM-implementatie, van theorie tot productieomgeving

#### Hoofdstukstructuur:
- [**Sectie 1: Geavanceerd leren van SLMs**](./Module03/01.SLMAdvancedLearning.md)
  - Parameterclassificatiekader (Micro SLM 100M-1.4B, Medium SLM 14B-30B)
  - Geavanceerde optimalisatietechnieken (kwantisatiemethoden, BitNET 1-bit kwantisatie)
  - Modelacquisitiestrategieën (Azure AI Foundry voor Phi-modellen, Hugging Face voor geselecteerde modellen)
...
### [Module 04: Modelformaatconversie en kwantisatie](./Module04/README.md)
**Thema**: Compleet modeloptimalisatiepakket voor edge-implementatie op verschillende platforms

#### Hoofdstukstructuur:
- [**Sectie 1: Grondbeginselen van modelformaatconversie en kwantisatie**](./Module04/01.Introduce.md)
  - Precisieclassificatiekader (ultra-laag, laag, medium precisie)
  - GGUF- en ONNX-formaatvoordelen en gebruiksscenario's
  - Voordelen van kwantisatie voor operationele efficiëntie
...
- [**Sectie 3: Microsoft Olive Optimalisatiesuite**](./Module04/03.MicrosoftOlive.md)
  - Hardwarebewuste modeloptimalisatie met meer dan 40 ingebouwde componenten
  - Automatische optimalisatie met dynamische en statische kwantisatie
  - Bedrijfsintegratie met Azure ML-workflows
...
- [**Sectie 5: Apple MLX Framework Diepgaande Analyse**](./Module04/05.AppleMLX.md)
  - Geïntegreerde geheugenarchitectuur voor Apple Silicon
  - Ondersteuning voor LLaMA, Mistral, Phi-3, geselecteerde Qwen-modellen
  - LoRA-finetuning en modelaanpassing
  - Hugging Face-integratie met 4-bit/8-bit kwantisatie

- [**Sectie 6: Edge AI Ontwikkelworkflow Synthese**](./Module04/06.workflow-synthesis.md)
  - Geïntegreerde workflowarchitectuur met meerdere optimalisatieframeworks
...
**Thema**: Volledige levenscyclusoperaties van SLM's, van distillatie tot productie-implementatie

#### Hoofdstukstructuur:
- [**Sectie 1: Introductie tot SLMOps**](./Module05/01.IntroduceSLMOps.md)
  - Paradigmaverschuiving van SLMOps in AI-operaties
  - Kostenefficiëntie en privacy-eerste architectuur
...
- [**Sectie 3: Fine-Tuning - Modellen Aanpassen voor Specifieke Taken**](./Module05/03.SLMOps-Finetuing.md)
  ...
  - Multi-adapter training en hyperparameteroptimalisatie

- [**Sectie 4: Implementatie - Productieklaar Maken**](./Module05/04.SLMOps.Deployment.md)
  - Modelconversie en kwantisatie voor productie
  - Foundry Local configuratie voor implementatie
  - Prestatiebenchmarking en kwaliteitsvalidatie
  - 75% reductie in modelgrootte met productiecontrole

---

### [Module 06: SLM Agentische Systemen - AI Agenten en Functieaanroepen](./Module06/README.md)
**Thema**: Implementatie van SLM-agentische systemen, van basisprincipes tot geavanceerde functieaanroepen en integratie van Model Context Protocol

#### Hoofdstukstructuur:
- [**Sectie 1: AI Agenten en Basisprincipes van Kleine Taalmodellen**](./Module06/01.IntroduceAgent.md)
  - Classificatiekader voor agenten (reflex, modelgebaseerd, doelgebaseerd, lerende agenten)
  - Basisprincipes van SLM's en optimalisatiestrategieën (GGUF, kwantisatie, edge-frameworks)
  - Analyse van afwegingen tussen SLM's en LLM's (10-30× kostenreductie, 70-80% taakdoeltreffendheid)
  - Praktische implementatie met Ollama, VLLM en Microsoft edge-oplossingen

- [**Sectie 2: Functieaanroepen in Kleine Taalmodellen**](./Module06/02.FunctionCalling.md)
  - Systematische workflowimplementatie (intentieherkenning, JSON-uitvoer, externe uitvoering)
  - Platformspecifieke implementaties (Phi-4-mini, geselecteerde Qwen-modellen, Microsoft Foundry Local)
  - Geavanceerde voorbeelden (samenwerking tussen meerdere agenten, dynamische gereedschapsselectie)
...
- [**AI Toolkit voor Visual Studio Code**](./Module07/aitoolkit.md)
  ...
  - Lokale tests, optimalisatie en workflows voor agentontwikkeling
  - Prestatiemonitoring en evaluatie voor edge-scenario's

- [**Windows EdgeAI Ontwikkelgids**](./Module07/windowdeveloper.md)
...
- [**EdgeAI in NVIDIA Jetson Orin Nano**](./Module07/README.md#1-edgeai-in-nvidia-jetson-orin-nano)
  ...
  - Ondersteuning voor generatieve AI-modellen (vision transformers, LLM's, vision-language modellen)
...
- [**EdgeAI in Mobiele Applicaties met .NET MAUI en ONNX Runtime GenAI**](./Module07/README.md#2-edgeai-in-mobile-applications-with-net-maui-and-onnx-runtime-genai)
  ...
  - Platformspecificieke optimalisaties (CoreML voor iOS, NNAPI voor Android)
  - Volledige implementatie van de generatieve AI-cyclus
...
- [**EdgeAI met Windows ML**](./Module07/README.md#4-edgeai-with-windows-ml)
  - Windows AI Foundry als basis voor performante on-device inferentie
  - Universele hardwareondersteuning (AMD, Intel, NVIDIA, Qualcomm silicon)
  - Automatische hardwareabstractie en optimalisatie
  - Geïntegreerd framework voor diverse Windows-hardware-ecosystemen

- [**EdgeAI met Foundry Local Applicaties**](./Module07/README.md#5-edgeai-with-foundry-local-applications)
  - Privacygerichte RAG-implementatie met lokale bronnen
  - Integratie van Phi-3 taalmodel met semantisch zoeken (alleen Phi-modellen)
  - Ondersteuning voor lokale vectordatabases (SQLite, Qdrant)
  - Mogelijkheden voor gegevenssoevereiniteit en offline werking
...
**Basiskennis**
- Begrijp de fundamentele verschillen tussen cloudgebaseerde en edgegebaseerde AI-architecturen
- Beheers de principes van modelkwantisatie, compressie en optimalisatie voor omgevingen met beperkte middelen
- Begrijp hardwareversnellingsopties (NPU's, GPU's, CPU's) en hun implementatie-implicaties

**Implementatievaardigheden**
- Implementeer Kleine Taalmodellen op diverse edgeplatforms (mobiel, embedded, IoT, edge-servers)
- Pas optimalisatieframeworks toe, waaronder Llama.cpp, Microsoft Olive, ONNX Runtime en Apple MLX
- Implementeer realtime inferentiesystemen met sub-seconde responstijden
...
- Beoordeel afwegingen tussen modelnauwkeurigheid, inferentiesnelheid, stroomverbruik en hardwarekosten
...
- Plan hybride edge-cloudarchitecturen voor optimale prestaties en kostenefficiëntie
- Implementeer gegevensstromen en verwerkingspijplijnen voor realtime AI-toepassingen
...
- **Consumentenelektronica**: AI-aangedreven mobiele applicaties en slimme apparaten voor thuis
...
- Diepgaand begrip van verschillende SLM-ontwerpfilosofieën en hun implementatie-implicaties
- Beheers strategische besluitvormingsvaardigheden op basis van rekenkundige beperkingen en prestatievereisten
- Begrijp afwegingen in implementatieflexibiliteit
...
- Hardwarebewuste optimalisatiekeuzevaardigheden voor diverse platforms
- Vaardigheden voor productie-implementatie in cross-platform edge computing-omgevingen
- Strategische frameworkselectie en workflowsynthese voor optimale EdgeAI-oplossingen
...
- Begrijp basisconcepten van AI-agenten en architectuur van Kleine Taalmodellen
- Beheers implementatie van functieaanroepen op meerdere platforms en frameworks
- Integreer Model Context Protocol (MCP) voor gestandaardiseerde interactie met externe tools
- Bouw geavanceerde agentische systemen met minimale menselijke tussenkomst

### Module 07 Leerresultaten:
- Beheers de AI Toolkit voor Visual Studio Code voor uitgebreide EdgeAI-ontwikkelworkflows
- Verwerf expertise in het Windows AI Foundry-platform en NPU-optimalisatiestrategieën
- Doe hands-on ervaring op met diverse EdgeAI-platforms en implementatiestrategieën
- Beheers hardware-specifieke optimalisatietechnieken voor NVIDIA, mobiel, Azure en Windows-platforms
- Begrijp afwegingen in implementatie tussen prestaties, kosten en privacyvereisten
...
Na succesvolle afronding van deze cursus ben je uitgerust met de kennis, vaardigheden en het zelfvertrouwen om EdgeAI-initiatieven te leiden in professionele omgevingen.
...
- **Cross-Platform Implementatie**: Implementeer oplossingen op Windows, Linux, mobiel en embedded platforms
...
- **ROI-optimalisatie**: Toon meetbare zakelijke waarde aan van EdgeAI-implementaties

### Carrièrekansen

**Professionele Rollen**
- EdgeAI Oplossingsarchitect
- Machine Learning Engineer (Edge-specialisatie)
- IoT AI Ontwikkelaar
- Mobiele AI Applicatieontwikkelaar
...
- Voltooi end-to-end EdgeAI-projecten die praktische bekwaamheid aantonen
...
- Voorbereiding op hybride cloud-edge architecturen
- Toegangspoort tot opkomende AI-technologieën en frameworks
Deze cursus plaatst je aan de voorhoede van AI-technologie, waar intelligente mogelijkheden naadloos worden geïntegreerd in de apparaten en systemen die het moderne leven aandrijven.
...
- **Progressief Leren**: Geleidelijk doorgroeien van basisconcepten naar geavanceerde implementatie
...
- **Bedrijfsklare Overwegingen**: Beveiligingspraktijken, compliancekaders en strategieën voor gegevensbescherming

## Aan de Slag

Aanbevolen leerpad:
1. Begin met **Module01** om een fundamenteel begrip van EdgeAI op te bouwen
2. Ga verder met **Module02** om diepgaand inzicht te krijgen in verschillende SLM-modelfamilies
...
6. Verken **Module06** om SLM-agentische systemen en functieaanroepmogelijkheden te begrijpen
7. Sluit af met **Module07** om praktische ervaring op te doen met de AI Toolkit en diverse EdgeAI-implementatievoorbeelden

Elke module is ontworpen om zelfstandig compleet te zijn, maar leren in volgorde levert de beste resultaten op.
...
- **Gestructureerde Leertrajecten**: Geoptimaliseerde schema's om de cursus in 20 uur te voltooien
- **Tijdsinzet Aanbevelingen**: Specifieke richtlijnen voor het balanceren van lezen, oefeningen en projecten
...
De studiegids is ontworpen voor zowel intensief leren (1 week) als deeltijdstudie (3 weken), met duidelijke richtlijnen over hoe je je tijd effectief kunt indelen, zelfs als je slechts 10 uur aan de cursus kunt besteden.

---

**De toekomst van EdgeAI ligt in de voortdurende verbetering van modelarchitecturen, kwantiseringstechnieken en implementatiestrategieën die efficiëntie en specialisatie boven algemene capaciteiten stellen. Organisaties die deze paradigmaverschuiving omarmen, zullen goed gepositioneerd zijn om het transformerende potentieel van AI te benutten, terwijl ze controle behouden over hun gegevens en operaties.**
