...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T14:12:56+00:00",
...
اولیو ایک آسان استعمال کرنے والا ہارڈویئر-آگاہ ماڈل آپٹیمائزیشن ٹول ہے جو ماڈل کمپریشن، آپٹیمائزیشن، اور کمپائلیشن کے لیے صنعت کے بہترین طریقوں کو یکجا کرتا ہے۔ یہ ONNX Runtime کے ساتھ ایک مکمل انفرنس آپٹیمائزیشن حل کے طور پر کام کرتا ہے۔
...
- **درستگی برقرار رکھیں**: آپٹیمائزیشنز ماڈل کی کوالٹی کو برقرار رکھتے ہوئے کارکردگی کو بہتر بناتے ہیں
...
آپٹیمائزیشن کا عمل شامل کرتا ہے: ماڈل کو لوکل کیش سے حاصل کرنا، ONNX گراف کو کیپچر کرنا اور ویٹس کو ONNX ڈیٹا فائل میں اسٹور کرنا، ONNX گراف کو آپٹیمائز کرنا، اور RTN طریقہ استعمال کرتے ہوئے ماڈل کو int4 میں کوانٹائز کرنا۔
...
- Windows مشینز کے لیے DirectML پر غور کریں جن میں انٹیگریٹڈ گرافکس ہیں
...
- یقینی بنائیں کہ تمام مطلوبہ ماڈل فائلیں ڈاؤنلوڈ ہو چکی ہیں
...
### کمیونٹی مثالیں
- **Jupyter نوٹ بکس**: اولیو GitHub ریپوزٹری میں دستیاب ہیں — https://github.com/microsoft/Olive/tree/main/examples
- **VS کوڈ ایکسٹینشن**: VS کوڈ کے لیے AI ٹول کٹ کا جائزہ — https://learn.microsoft.com/azure/ai-toolkit/overview
- **بلاگ پوسٹس**: مائیکروسافٹ اوپن سورس بلاگ — https://opensource.microsoft.com/blog/

### متعلقہ ٹولز
- **ONNX Runtime**: ہائی پرفارمنس انفرنس انجن — https://onnxruntime.ai/
- **Hugging Face Transformers**: بہت سے مطابقت پذیر ماڈلز کا ذریعہ — https://huggingface.co/docs/transformers/index
- **Azure Machine Learning**: کلاؤڈ بیسڈ آپٹیمائزیشن ورک فلو — https://learn.microsoft.com/azure/machine-learning/
