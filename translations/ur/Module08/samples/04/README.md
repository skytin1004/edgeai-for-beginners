...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-30T23:17:27+00:00",
...
| **پیچیدہ تجزیہ** | ☁️ کلاؤڈ (Azure OpenAI) | بڑے ماڈلز تک رسائی |
...
- **پائتھون**: 3.10+ کے ساتھ ورچوئل انوائرمنٹ
- **ماڈل**: کم از کم ایک لوڈ کیا ہوا (`foundry model run phi-4-mini`)
- **براؤزر**: کروم/ایج ویب جی پی یو سپورٹ کے ساتھ ڈیموز کے لیے
- **ڈوکر**: اوپن ویب UI کے لیے (اختیاری)

## انسٹالیشن اور سیٹ اپ

### 1. پائتھون انوائرمنٹ سیٹ اپ
...
- 🎨 **جدید UI**: پروفیشنل چیٹ انٹرفیس
- 🔧 **لچکدار کنفیگریشن**: انوائرمنٹ ویریبلز اور آٹو ڈیٹیکشن
...
**خصوصیات:**
- 🌐 **براؤزر نیٹو AI**: سرور کی ضرورت نہیں، مکمل طور پر براؤزر میں چلتا ہے
...
| ویریبل | تفصیل | ڈیفالٹ | مثال |
|--------|-------|--------|------|
| `MODEL` | استعمال کرنے کے لیے ماڈل کا عرف | `phi-4-mini` | `qwen2.5-7b` |
| `BASE_URL` | فاؤنڈری لوکل اینڈ پوائنٹ | آٹو ڈیٹیکٹڈ | `http://localhost:51211` |
...
1. **ویب جی پی یو سپورٹ نہیں:**
   ...
   - ڈیمو خود بخود CPU پر واپس آ جائے گا

2. **ماڈل لوڈنگ کی غلطیاں:**
   - ماڈل ڈاؤنلوڈ کے لیے انٹرنیٹ کنکشن یقینی بنائیں
   - براؤزر کنسول میں CORS غلطیوں کو چیک کریں
...
**چینلٹ:**
- بہتر محسوس ہونے والی کارکردگی کے لیے اسٹریمنگ استعمال کریں
- زیادہ ہم وقتی کے لیے کنکشن پولنگ نافذ کریں
- بار بار سوالات کے لیے ماڈل جوابات کی کیشنگ کریں
- بڑی گفتگو کی تاریخوں کے ساتھ میموری کے استعمال کی نگرانی کریں
...
- **API کیز**: انوائرمنٹ ویریبلز استعمال کریں، کبھی بھی ہارڈ کوڈ نہ کریں
...
- **میٹرکس**: رسپانس ٹائمز، ایرر ریٹس، وسائل کے استعمال کو ٹریک کریں
