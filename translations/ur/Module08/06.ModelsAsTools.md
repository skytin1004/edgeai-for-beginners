...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T13:37:51+00:00",
...
AI ماڈلز کو ماڈیولر، حسب ضرورت ٹولز کے طور پر دیکھیں جو Foundry Local کے ساتھ براہ راست ڈیوائس پر چلتے ہیں۔ یہ سیشن پرائیویسی کو محفوظ رکھنے والے، کم تاخیر والے انفرینس کے عملی ورک فلو اور SDKs، APIs، یا CLI کے ذریعے ان ٹولز کو انٹیگریٹ کرنے کے طریقے پر زور دیتا ہے۔ آپ یہ بھی سیکھیں گے کہ Azure AI Foundry پر ضرورت کے مطابق کیسے اسکیل کیا جائے۔

> **🔄 جدید SDK کے لیے اپ ڈیٹ**: اس ماڈیول کو Microsoft Foundry-Local ریپوزٹری کے تازہ ترین پیٹرنز کے ساتھ ہم آہنگ کیا گیا ہے اور یہ `samples/06/` میں ذہین روٹنگ کے نفاذ سے میل کھاتا ہے۔ مثالیں اب جدید `foundry-local-sdk` اور ایڈوانسڈ ماڈل سلیکشن اسٹریٹجیز استعمال کرتی ہیں۔
...
**📁 مقامی نفاذ:**
- `samples/06/router.py` - ذہین ماڈل روٹر کی ورڈ پر مبنی انتخاب کے ساتھ
- `samples/06/model_router.ipynb` - انٹرایکٹو مثالیں اور بینچ مارکس
- `samples/06/README.md` - ترتیب اور استعمال کی ہدایات

حوالہ جات:
- Foundry Local ڈاکس: https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/
...
مقصد: کوئری مواد کی بنیاد پر خودکار روٹنگ کے ساتھ ذہین ماڈل سلیکشن کو نافذ کریں۔
...
مرحلہ 1) FoundryLocalManager کے ساتھ جدید ماڈل روٹر کی تعریف کریں  
```python
...
مرحلہ 2) ماحول کی ترتیب کریں (اختیاری - دیکھیں `samples/06/README.md`)  
```cmd
...
مقصد: ذہین روٹر کو مانیٹرنگ اور Azure AI Foundry انٹیگریشن کے ساتھ ڈپلائے کریں۔
...
## ہینڈز-آن چیک لسٹ
- [ ] کی ورڈ پر مبنی انتخاب کے ساتھ ذہین ماڈل روٹر کو نافذ کریں (`samples/06/router.py`)  
- [ ] متعدد اسپیشلائزڈ ماڈلز کو ترتیب دیں (جنرل، ریزننگ، کوڈ، تخلیقی)  
- [ ] انٹرایکٹو Jupyter نوٹ بک کو ٹیسٹ کریں (`samples/06/model_router.ipynb`)  
- [ ] ماحول پر مبنی ماڈل ترتیب کو سیٹ اپ کریں  
- [ ] سروس صحت کی نگرانی اور ایرر ہینڈلنگ کو نافذ کریں  
- [ ] جامع لاگنگ کے ساتھ پروڈکشن روٹر کو ڈپلائے کریں  
...
- **انٹیگریشن ڈاکس**: [انفرینس SDKs کے ساتھ انٹیگریٹ کریں](https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/how-to/how-to-integrate-with-inference-sdks)  
- **ایڈوانسڈ پیٹرنز**: ماڈیول 5 میں فنکشن کالنگ اور ملٹی-ایجنٹ آرکیسٹریشن کو دریافت کریں  

## اختتام

Foundry Local مضبوط آن-ڈیوائس AI کو فعال کرتا ہے جہاں ماڈلز ذہین، اسپیشلائزڈ ٹولز بن جاتے ہیں۔ خودکار ماڈل سلیکشن، جامع مانیٹرنگ، اور پروڈکشن کے لیے تیار پیٹرنز کے ساتھ، ٹیمیں پیچیدہ AI ایپلیکیشنز کو تیار کر سکتی ہیں جو مختلف ٹاسک ٹائپس کے مطابق ڈھل جاتی ہیں جبکہ پرائیویسی اور کارکردگی کو برقرار رکھتی ہیں۔ یہاں دکھایا گیا ذہین روٹر پیٹرن پیچیدہ AI سسٹمز بنانے کے لیے ایک بنیاد فراہم کرتا ہے جو مقامی ترقی سے پروڈکشن ڈپلائمنٹ تک اسکیل کر سکتے ہیں۔
