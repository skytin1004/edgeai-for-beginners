...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T13:38:59+00:00",
...
اس سیشن میں چینلٹ اور مائیکروسافٹ فاؤنڈری لوکل کے ذریعے پروڈکشن کے لیے تیار چیٹ ایپلیکیشنز بنانے پر توجہ دی گئی ہے۔ آپ جدید ویب انٹرفیسز بنانا سیکھیں گے جو AI گفتگو کے لیے موزوں ہوں، اسٹریمنگ جوابات نافذ کریں گے، اور مضبوط چیٹ ایپلیکیشنز کو بہتر ایرر ہینڈلنگ اور صارف کے تجربے کے ڈیزائن کے ساتھ تعینات کریں گے۔
...
- **پائتھون**: 3.10 یا اس سے جدید ورچوئل انوائرمنٹ کی صلاحیت کے ساتھ
...
- `cl.Message().stream_token()`: ریئل ٹائم اسٹریمنگ
...
| **پرائیویسی** | 🔒 ڈیٹا کبھی ڈیوائس سے باہر نہیں جاتا | ⚠️ ڈیٹا کلاؤڈ کو بھیجا جاتا ہے |
| **لاگت** | 💰 ہارڈویئر کے بعد مفت | 💸 ہر ٹوکن پر ادائیگی |
| **آف لائن** | ✅ انٹرنیٹ کے بغیر کام کرتا ہے | ❌ انٹرنیٹ کی ضرورت ہے |
| **ماڈل سائز** | ⚠️ ہارڈویئر کی حد | ✅ سب سے بڑے ماڈلز تک رسائی |
...
| `BASE_URL` | فاؤنڈری لوکل اینڈ پوائنٹ | خودکار طور پر معلوم | `http://localhost:51211` |
...
#### مرحلہ 1: جیوپیٹر انوائرمنٹ سیٹ اپ کریں
...
### نوٹ بک اسٹرکچر کے بہترین طریقے
...
ویب جی پی یو AI ماڈلز کو براہ راست براؤزر میں چلانے کی اجازت دیتا ہے تاکہ زیادہ سے زیادہ پرائیویسی اور زیرو انسٹال تجربات فراہم کیے جا سکیں۔ یہ سیمپل ONNX Runtime Web کے ساتھ ویب جی پی یو ایکزیکیوشن کو ظاہر کرتا ہے۔
...
سیشن 4 میں چینلٹ ایپلیکیشنز کے لیے پروڈکشن کے لیے تیار چیٹ انٹرفیسز بنانے کا احاطہ کیا گیا۔ آپ نے سیکھا:
...
سیمپل 04 ایپلیکیشن بہترین طریقوں کو ظاہر کرتی ہے جو مائیکروسافٹ فاؤنڈری لوکل کے ذریعے لوکل AI ماڈلز کو فائدہ پہنچاتے ہوئے مضبوط چیٹ انٹرفیسز بنانے کے لیے موزوں ہیں اور بہترین صارف تجربہ فراہم کرتی ہیں۔
