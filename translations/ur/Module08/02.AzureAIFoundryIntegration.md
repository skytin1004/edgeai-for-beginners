...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T14:25:18+00:00",
...
Foundry Local کی بنیاد پر، یہ سیشن جدید پرامپٹ انجینئرنگ، ہموار ڈیٹا انضمام، اور قابل عمل ٹاسک آٹومیشن کے ذریعے پیچیدہ AI حل بنانے پر مرکوز ہے۔ آپ سیکھیں گے کہ مقامی ترقی کو Azure AI Foundry کی صلاحیتوں کے ساتھ کیسے جوڑنا ہے، اور ایسے انٹرپرائز ایپلیکیشنز بنائیں گے جو دونوں دنیاوں کے بہترین پہلوؤں سے فائدہ اٹھائیں۔

## سیکھنے کے مقاصد

اس سیشن کے اختتام تک، آپ:
- مستقل اور قابل اعتماد AI جوابات کے لیے جدید پرامپٹ انجینئرنگ تکنیکوں میں مہارت حاصل کریں گے
- حقیقی دنیا کی ایپلیکیشنز کے لیے مضبوط ڈیٹا انضمام کے نمونے نافذ کریں گے
- کاروباری قدر کو بڑھانے والے قابل عمل AI ٹاسک تخلیق کریں گے
- Foundry Local اور Azure AI Foundry کے درمیان ہموار کنیکٹیویٹی قائم کریں گے
- کارکردگی کی نگرانی اور اصلاح کے ورک فلو بنائیں گے
- پروڈکشن کے لیے تیار AI حل تعینات کریں گے، مناسب ایرر ہینڈلنگ اور اسکیلنگ کے ساتھ

## ضروریات

- سیشن 1: Foundry Local کے ساتھ شروعات مکمل کر چکے ہوں
- فعال Foundry Local انسٹالیشن، چلتے ہوئے ماڈلز کے ساتھ
- Azure اکاؤنٹ (سیکھنے کے لیے مفت ٹائر کافی ہے)
- REST APIs اور JSON کی بنیادی سمجھ

## حصہ 1: جدید پرامپٹ انجینئرنگ

### پرامپٹ آرکیٹیکچر کو سمجھنا

موثر پرامپٹ انجینئرنگ قابل اعتماد AI ایپلیکیشنز کی بنیاد ہے۔ Foundry Local بہتر پرامپٹنگ کی صلاحیتیں فراہم کرتا ہے:
...
### عملی پرامپٹ انجینئرنگ کی مثالیں
...
## حصہ 2: ڈیٹا انضمام کے نمونے

### Foundry Local ڈیٹا کنیکٹرز
...
### حقیقی دنیا کے ڈیٹا انضمام کی مثال
...
## حصہ 3: قابل عمل AI ٹاسک

### ٹاسک آٹومیشن فریم ورک
...
### کاروباری عمل آٹومیشن کی مثالیں
...
## حصہ 4: Azure AI Foundry انضمام

### کنیکٹیویٹی قائم کرنا
...
## حصہ 5: کارکردگی کی نگرانی اور اصلاح
...
## حصہ 7: اگلے اقدامات اور سیشن 3 کا پیش نظارہ

### سیشن کی کامیابیاں

اس سیشن میں، آپ نے مہارت حاصل کی:
- ✅ مستقل AI رویے کے لیے جدید پرامپٹ انجینئرنگ تکنیکیں
- ✅ حقیقی دنیا کی ایپلیکیشنز کے لیے مضبوط ڈیٹا انضمام کے نمونے
- ✅ کاروباری عمل کی اصلاح کے لیے خودکار ٹاسک تخلیق
- ✅ Azure AI Foundry انضمام اور ہائبرڈ تعیناتی کی حکمت عملی
- ✅ جامع کارکردگی کی نگرانی اور اصلاح

### سیشن 3 کی تیاری: اوپن سورس ماڈلز

1. **Hugging Face کو دریافت کریں**: ایک اکاؤنٹ بنائیں اور ماڈل کیٹلاگ کو براؤز کریں
2. **Model Mondays کا جائزہ لیں**: تازہ ترین [Model Mondays سیریز](https://aka.ms/model-mondays) دیکھیں
3. **حسب ضرورت ماڈلز کی منصوبہ بندی کریں**: غور کریں کہ کون سے خصوصی ماڈلز آپ کے استعمال کے معاملات کے لیے فائدہ مند ہوں گے

### اضافی وسائل

- [Azure AI Foundry دستاویزات](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Foundry Local GitHub ریپوزٹری](https://github.com/microsoft/Foundry-Local)
- [جدید پرامپٹ انجینئرنگ گائیڈ](https://platform.openai.com/docs/guides/prompt-engineering)
- [کاروباری عمل آٹومیشن کے بہترین طریقے](https://docs.microsoft.com/en-us/power-automate/)

آپ اب ایسے پیچیدہ AI حل بنانے کے لیے تیار ہیں جو مقامی انفرنس کی طاقت کو کلاؤڈ اسکیل صلاحیتوں کے ساتھ جوڑتے ہیں، اور انٹرپرائز گریڈ AI ایپلیکیشنز کے لیے بنیاد قائم کرتے ہیں۔
