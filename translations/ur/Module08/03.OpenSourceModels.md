...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T13:36:21+00:00",
...
- ماڈل ڈاؤنلوڈز کے لیے کافی اسٹوریج اسپیس (ماڈلز کا سائز 1GB سے 20GB+ تک ہو سکتا ہے)
...
Sample 03 کی بنیاد پر اپنا ماڈل تشخیص اسکرپٹ بنائیں:
...
1. **Sample 03 اسکرپٹ چلائیں**: `samples\03\list_and_bench.cmd`
2. **مختلف ماڈلز آزمائیں**: کم از کم 3 مختلف ماڈلز کو آزمائیں
...
## حصہ 7: خرابیوں کا سراغ لگانا اور بہترین طریقے
...
4. **مسلسل ٹیسٹ کریں**: منصفانہ موازنہ کے لیے ایک جیسے پرامپٹس استعمال کریں
...
- **سیشن 4 کا فوکس**: اصلاح کے اوزار اور تکنیکیں
- **ضروریات**: ماڈل سوئچنگ اور بنیادی کارکردگی کی جانچ میں مہارت
- **تجویز کردہ**: اس سیشن سے 2-3 پسندیدہ ماڈلز کی شناخت کریں

### اضافی وسائل

- **[Foundry Local Documentation](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: آفیشل دستاویزات
- **[CLI Reference](https://learn.microsoft.com/azure/ai-foundry/foundry-local/reference/reference-cli)**: مکمل کمانڈ حوالہ
- **[Model Mondays](https://aka.ms/model-mondays)**: ہفتہ وار ماڈل کی جھلکیاں
- **[Foundry Local GitHub](https://github.com/microsoft/Foundry-Local)**: کمیونٹی اور مسائل
- **[Sample 03: Model Discovery](samples/03/README.md)**: عملی مثال اسکرپٹ

### اہم نکات

✅ **ماڈل دریافت**: دستیاب ماڈلز کو دریافت کرنے کے لیے `foundry model list` استعمال کریں  
✅ **جلدی جانچ**: تیز تشخیص کے لیے `list_and_bench.cmd` پیٹرن  
✅ **کارکردگی کی نگرانی**: بنیادی وسائل کے استعمال اور جواب کے وقت کی پیمائش  
✅ **ماڈل کا انتخاب**: استعمال کے کیس کے مطابق ماڈلز منتخب کرنے کے عملی رہنما اصول  
✅ **کیش مینجمنٹ**: اسٹوریج اور صفائی کے طریقہ کار کو سمجھنا  

اب آپ کے پاس Foundry Local کے آسان CLI طریقہ کار کا استعمال کرتے ہوئے اپنے AI ایپلیکیشنز کے لیے مناسب ماڈلز دریافت، جانچ، اور منتخب کرنے کی عملی مہارتیں موجود ہیں۔

---

## سیکھنے کے مقاصد

- مقامی انفرینس کے لیے اوپن سورس ماڈلز دریافت اور جانچیں
- Foundry Local کے اندر منتخب Hugging Face ماڈلز کو کمپائل اور چلائیں
- درستگی، تاخیر، اور وسائل کی ضروریات کے لیے ماڈل انتخاب کی حکمت عملیوں کا اطلاق کریں
...
- ماڈل ڈاؤنلوڈ کی پیش رفت (پہلی بار چلانے پر)
...
**درمیانے ماڈلز:**
- `qwen2.5-7b-instruct`: بہترین استدلال اور طویل سیاق و سباق
- `deepseek-r1-distill-qwen-7b`: کوڈ جنریشن کے لیے بہتر بنایا گیا

**بڑے ماڈلز:**
- `llama-3.2`: Meta کا تازہ ترین اوپن سورس ماڈل
- `qwen2.5-14b-instruct`: انٹرپرائز گریڈ استدلال

## حصہ 2: جلدی ماڈل جانچ اور موازنہ

### Sample 03 طریقہ: سادہ فہرست اور بینچ

Sample 03 پیٹرن کی بنیاد پر، یہاں کم سے کم ورک فلو ہے:
...
ایک ماڈل چلنے کے بعد، مستقل پرامپٹس کے ساتھ اس کی جانچ کریں:
...
Foundry Local خود بخود ماڈل ڈاؤنلوڈز اور کیشنگ کا انتظام کرتا ہے:
...
- خاص طور پر چھوٹے SSDs پر ڈسک کے استعمال کی نگرانی کریں
- ماڈل کے سائز بمقابلہ صلاحیت کے تجارتی معاہدوں پر غور کریں

### ماڈل کی کارکردگی کی نگرانی

جب ماڈلز چل رہے ہوں، سسٹم کے وسائل کی نگرانی کریں:
...
- ایڈوانسڈ: `qwen2.5-7b-instruct` (طویل سیاق و سباق)

**کوڈ جنریشن کے لیے:**
- تجویز کردہ: `deepseek-r1-distill-qwen-7b`
- متبادل: `qwen2.5-7b-instruct` (کوڈ کے لیے بھی اچھا)

**پیچیدہ استدلال کے لیے:**
- بہترین: `qwen2.5-7b-instruct` یا `qwen2.5-14b-instruct`
- بجٹ آپشن: `phi-4`

### ہارڈویئر کی ضروریات کا رہنما
...
- NPU سپورٹ (Windows 11 Copilot+ PCs) کے لیے تیز رفتاری
...
ہر ماڈل کے لیے، مستقل پرامپٹس کے ساتھ جانچ کریں اور دستی طور پر تشخیص کریں:
