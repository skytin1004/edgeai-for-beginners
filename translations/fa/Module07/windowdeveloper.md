...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T13:10:57+00:00",
...
Windows AI Foundry یک پلتفرم یکپارچه، قابل اعتماد و امن است که از چرخه کامل توسعه هوش مصنوعی پشتیبانی می‌کند - از انتخاب و تنظیم مدل تا بهینه‌سازی و استقرار در معماری‌های CPU، GPU، NPU و ابر هیبریدی. این پلتفرم توسعه هوش مصنوعی را دموکراتیک می‌کند و امکانات زیر را ارائه می‌دهد:

- **انتزاع سخت‌افزاری**: استقرار بی‌دردسر در سیلیکون‌های AMD، Intel، NVIDIA و Qualcomm  
- **هوش در دستگاه**: هوش مصنوعی حفظ‌کننده حریم خصوصی که به طور کامل روی سخت‌افزار محلی اجرا می‌شود  
...
Windows ML بهینه‌سازی سخت‌افزاری خودکار را در سراسر اکوسیستم ویندوز ارائه می‌دهد و تضمین می‌کند که برنامه‌های هوش مصنوعی شما بدون توجه به معماری سیلیکون زیرین، عملکرد بهینه‌ای داشته باشند.
...
API‌های طراحی‌شده به طور خاص برای دستگاه‌های نسل بعدی ویندوز با واحدهای پردازش عصبی (NPUs) که عملکرد استثنایی در هر وات ارائه می‌دهند.
...
با تکمیل این راهنمای توسعه هوش مصنوعی Edge در ویندوز، شما مهارت‌های ضروری برای ساخت برنامه‌های هوش مصنوعی آماده تولید در پلتفرم ویندوز را به دست خواهید آورد.
...
- اجرای طراحی‌های رابط کاربری پاسخگو که با حالت‌های پردازش هوش مصنوعی سازگار هستند  
- مدیریت عملیات غیرهمزمان هوش مصنوعی با الگوهای مناسب تجربه کاربری  

**بهینه‌سازی عملکرد**  
- پروفایل‌سازی و بهینه‌سازی عملکرد استنتاج هوش مصنوعی در پیکربندی‌های مختلف سخت‌افزاری  
...
Foundry Local دسترسی سریع به مدل‌های زبان متن‌باز آماده استفاده در سیلیکون ویندوز را برای توسعه‌دهندگان فراهم می‌کند و امکان مرور، آزمایش، تعامل و استقرار مدل‌ها در برنامه‌های محلی را ارائه می‌دهد.

#### ویژگی‌های کلیدی

**کاتالوگ مدل**  
- مجموعه جامع مدل‌های متن‌باز از پیش بهینه‌شده  
- مدل‌هایی که برای CPU، GPU و NPU بهینه شده‌اند و آماده استقرار هستند  
...
4. ایجاد ابزارهای پروفایل‌سازی عملکرد و نظارت  

**کاوش گالری توسعه هوش مصنوعی**  
- بررسی برنامه‌های نمونه و پیاده‌سازی‌های مرجع  
- آزمایش API‌های هوش مصنوعی ویندوز با نمایش‌های تعاملی  
- مرور کد منبع برای بهترین شیوه‌ها و الگوها  
...
**بهینه‌سازی عملکرد**  
- پروفایل‌سازی عملکرد برنامه در پیکربندی‌های سخت‌افزاری هدف  
...
ایجاد یک سیستم مدیریت موجودی مجهز به هوش مصنوعی برای برنامه‌های خرده‌فروشی:

**فناوری‌های استفاده‌شده:**  
- تقسیم‌بندی تصویر برای شناسایی محصولات  
- مدل‌های بینایی سفارشی برای طبقه‌بندی برند و دسته‌بندی  
- استقرار محلی Foundry Local از مدل‌های زبان تخصصی خرده‌فروشی  
- ادغام با سیستم‌های موجود POS و مدیریت موجودی  
...
### مثال 3: دستیار مستندسازی در حوزه سلامت

توسعه یک ابزار مستندسازی حوزه سلامت حفظ‌کننده حریم خصوصی:
...
**رویکرد پیاده‌سازی:**  
- اطمینان از عملیات کامل آفلاین برای حفظ حریم خصوصی بیماران  
...
- استفاده از ابزارهای پروفایل‌سازی انرژی برای بهینه‌سازی مصرف انرژی  
...
- استفاده از کش پایدار برای عملیات پیش‌پردازش پر
...
توسعه Windows Edge AI نمایانگر همگرایی قابلیت‌های قدرتمند هوش مصنوعی با پلتفرم امن، مقیاس‌پذیر و قدرتمند ویندوز است. با تسلط بر اکوسیستم Windows AI Foundry، توسعه‌دهندگان می‌توانند برنامه‌های هوشمندی ایجاد کنند که تجربه‌های استثنایی کاربری را ارائه دهند و در عین حال بالاترین استانداردهای حریم خصوصی، امنیت و عملکرد را حفظ کنند.  
...
چه در حال ساخت برنامه‌های مصرف‌کننده، راه‌حل‌های سازمانی یا ابزارهای تخصصی صنعتی باشید، توسعه Windows Edge AI به شما این امکان را می‌دهد که تجربه‌های هوشمند، پاسخگو و عمیقاً یکپارچه‌ای ایجاد کنید که از پتانسیل کامل دستگاه‌های مدرن ویندوز بهره‌مند شوند.  

## منابع اضافی  

برای راهنمای گام‌به‌گام ویندوز در مورد Foundry Local (نصب، CLI، نقطه پایانی پویا، استفاده از SDK)، به راهنمای مخزن مراجعه کنید: [foundrylocal.md](./foundrylocal.md).  
...
*این راهنما طراحی شده است تا با اکوسیستم در حال پیشرفت Windows AI همگام باشد. به‌روزرسانی‌های منظم، هماهنگی با آخرین قابلیت‌های پلتفرم و بهترین شیوه‌های توسعه را تضمین می‌کنند.*  
