...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T13:39:55+00:00",
...
با تکیه بر پایه Foundry Local، این جلسه بر ایجاد راه‌حل‌های پیشرفته هوش مصنوعی از طریق مهندسی پیشرفته درخواست‌ها، یکپارچه‌سازی داده‌ها و خودکارسازی وظایف متمرکز است. شما یاد خواهید گرفت که توسعه محلی را با قابلیت‌های Azure AI Foundry ترکیب کنید و برنامه‌های آماده برای سازمان ایجاد کنید که بهترین ویژگی‌های هر دو جهان را به کار می‌گیرند.

## اهداف یادگیری

تا پایان این جلسه، شما:
- تکنیک‌های پیشرفته مهندسی درخواست‌ها را برای پاسخ‌های قابل اعتماد و پایدار هوش مصنوعی فرا خواهید گرفت
- الگوهای یکپارچه‌سازی داده‌های قوی برای کاربردهای واقعی را پیاده‌سازی خواهید کرد
- وظایف هوش مصنوعی عملیاتی ایجاد خواهید کرد که ارزش تجاری ایجاد کنند
- اتصال بدون مشکل بین Foundry Local و Azure AI Foundry را برقرار خواهید کرد
- جریان‌های کاری نظارت بر عملکرد و بهینه‌سازی را ایجاد خواهید کرد
- راه‌حل‌های هوش مصنوعی آماده تولید را با مدیریت خطا و مقیاس‌پذیری مناسب مستقر خواهید کرد

## پیش‌نیازها

- تکمیل جلسه ۱: شروع کار با Foundry Local
- نصب فعال Foundry Local با مدل‌های در حال اجرا
- حساب Azure (سطح رایگان برای یادگیری کافی است)
- درک پایه‌ای از REST APIs و JSON

## بخش ۱: مهندسی پیشرفته درخواست‌ها

### درک معماری درخواست‌ها

مهندسی مؤثر درخواست‌ها پایه برنامه‌های قابل اعتماد هوش مصنوعی است. Foundry Local قابلیت‌های پیشرفته‌ای برای درخواست‌ها ارائه می‌دهد:
...
### پیاده‌سازی استراتژی‌های درخواست
...
### مثال‌های عملی مهندسی درخواست‌ها
...
## بخش ۲: الگوهای یکپارچه‌سازی داده‌ها

### اتصال‌دهنده‌های داده Foundry Local
...
### مثال یکپارچه‌سازی داده‌های واقعی
...
## بخش ۳: وظایف عملیاتی هوش مصنوعی

### چارچوب خودکارسازی وظایف
...
### مثال‌های خودکارسازی فرآیندهای تجاری
...
## بخش ۴: یکپارچه‌سازی Azure AI Foundry
...
## بخش ۵: نظارت بر عملکرد و بهینه‌سازی
...
### تمرین ۱: ربات پیشرفته خدمات مشتری
...
## بخش ۷: مراحل بعدی و پیش‌نمایش جلسه ۳

### دستاوردهای جلسه

در این جلسه، شما مهارت‌های زیر را کسب کرده‌اید:
- ✅ تکنیک‌های پیشرفته مهندسی درخواست‌ها برای رفتار پایدار هوش مصنوعی
- ✅ الگوهای یکپارچه‌سازی داده‌های قوی برای کاربردهای واقعی
- ✅ ایجاد وظایف خودکار برای بهینه‌سازی فرآیندهای تجاری
- ✅ یکپارچه‌سازی Azure AI Foundry و استراتژی‌های استقرار ترکیبی
- ✅ نظارت جامع بر عملکرد و بهینه‌سازی

### آماده‌سازی برای جلسه ۳: مدل‌های متن‌باز

1. **کاوش در Hugging Face**: یک حساب کاربری ایجاد کنید و کاتالوگ مدل‌ها را مرور کنید
2. **بررسی Model Mondays**: آخرین سری [Model Mondays](https://aka.ms/model-mondays) را بررسی کنید
3. **برنامه‌ریزی مدل‌های سفارشی**: در نظر بگیرید که چه مدل‌های تخصصی می‌توانند برای موارد استفاده شما مفید باشند

### منابع اضافی

- [مستندات Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [مخزن GitHub Foundry Local](https://github.com/microsoft/Foundry-Local)
- [راهنمای پیشرفته مهندسی درخواست‌ها](https://platform.openai.com/docs/guides/prompt-engineering)
- [بهترین شیوه‌های خودکارسازی فرآیندهای تجاری](https://docs.microsoft.com/en-us/power-automate/)

اکنون شما آماده ساخت راه‌حل‌های پیشرفته هوش مصنوعی هستید که قدرت استنتاج محلی را با قابلیت‌های ابری ترکیب می‌کنند و پایه‌ای برای برنامه‌های هوش مصنوعی در سطح سازمان ایجاد می‌کنند.
