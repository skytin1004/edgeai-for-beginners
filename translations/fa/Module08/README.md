...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T18:17:25+00:00",
...
**تمرکز**: نصب، راه‌اندازی CLI، استقرار مدل و بهینه‌سازی سخت‌افزار

**موضوعات کلیدی**: نصب کامل • دستورات CLI • ذخیره‌سازی مدل • شتاب‌دهی سخت‌افزاری • استقرار چندمدلی
...
**نمونه‌ها**: [برنامه RAG Chainlit](./samples/04/README.md)
...
**تمرکز**: LLMها در مقابل SLMها، پیاده‌سازی EdgeAI و دموهای پیشرفته

**موضوعات کلیدی**: مقایسه مدل‌ها • استنتاج لبه در مقابل ابر • Phi + ONNX Runtime • برنامه RAG Chainlit • بهینه‌سازی WebGPU
...
**نمونه‌ها**: [Router مدل‌ها به عنوان ابزار](./samples/06/README.md) • [چارچوب ابزار Foundry](./samples/10/README.md)
...
### [۱۰: Foundry Local به عنوان چارچوب ابزار](./samples/10/README.md)
...
**نمونه‌ها**: [چارچوب ابزار Foundry](./samples/10/README.md)
...
- **حافظه**: ۱۶ گیگابایت RAM (۳۲ گیگابایت توصیه‌شده برای مدل‌های بزرگ‌تر)
- **فضای ذخیره‌سازی**: ۵۰ گیگابایت فضای آزاد برای ذخیره‌سازی مدل
- **سخت‌افزار**: دستگاه مجهز به NPU توصیه‌شده (Copilot+ PC)، GPU اختیاری
...
- Azure CLI (اختیاری برای یکپارچگی ابر)
...
|------|------------|----------|------|----------|
|  ۱ | راه‌اندازی و اصول | ۰۱، ۰۲، ۰۳ | ۲-۳ ساعت | مبتدی |
...
| ۱۰ | چارچوب ابزار | ۱۰ | ۴-۵ ساعت | متخصص |

## منابع کلیدی

**مستندات رسمی:**
- [GitHub Microsoft Foundry Local](https://github.com/microsoft/Foundry-Local) - کد منبع و نمونه‌های رسمی
- [مستندات Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/foundry-local/) - راهنمای کامل راه‌اندازی و استفاده
...
### درک استراتژیک
- **تصمیمات معماری**: انتخاب‌های آگاهانه بین استقرار محلی و ابر
...
۱. **راه‌اندازی محیط**: اطمینان از ویندوز ۱۱ با سخت‌افزار توصیه‌شده (به پیش‌نیازها مراجعه کنید)
...
### شاخص‌های تسلط
- [ ] اجرای موفق تمام ۱۰ نمونه بدون خطا
...
### راه‌اندازی محیط (مورد نیاز برای تمام نمونه‌ها)
...
## خلاصه
این ماژول نمایانگر پیشرفته‌ترین سطح توسعه هوش مصنوعی در لبه است که ابزارهای درجه یک مایکروسافت را با انعطاف‌پذیری و نوآوری اکوسیستم متن‌باز ترکیب می‌کند. با تسلط بر Foundry Local از طریق تمام ۱۰ نمونه جامع، شما در خط مقدم توسعه کاربردهای هوش مصنوعی قرار خواهید گرفت.
