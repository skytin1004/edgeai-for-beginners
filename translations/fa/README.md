...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:19:38+00:00",
...
### اصول اصلی:
- **استنتاج روی دستگاه**: مدل‌های هوش مصنوعی بر روی دستگاه‌های لبه (تلفن‌ها، روترها، میکروکنترلرها، کامپیوترهای صنعتی) اجرا می‌شوند
...
- [03: کشف مدل و ارزیابی عملکرد](./Module08/samples/03/README.md)  
...
- **ابزارهای اعتبارسنجی** - اسکریپت‌هایی برای بررسی کیفیت کد و اجرای تست‌های اولیه  
...
### 🎯 شایستگی‌های اصلی
- **معماری Edge AI**: طراحی سیستم‌های هوش مصنوعی محلی با یکپارچه‌سازی ابری  
...
**بخش‌های صنعتی**: تولید 4.0 • فناوری سلامت • سیستم‌های خودران • فین‌تک • الکترونیک مصرفی
...
**EdgeAI نمایانگر آینده استقرار هوش مصنوعی است**: محلی‌محور، حفظ حریم خصوصی و کارآمد. این مهارت‌ها را بیاموزید تا نسل بعدی اپلیکیشن‌های هوشمند را بسازید.
