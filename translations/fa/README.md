...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T12:12:57+00:00",
...
به **EdgeAI برای مبتدیان** خوش آمدید – سفر جامع شما به دنیای تحول‌آفرین هوش مصنوعی لبه‌ای. این دوره شکاف بین قابلیت‌های قدرتمند هوش مصنوعی و استقرار عملی در دستگاه‌های لبه‌ای را پر می‌کند و به شما امکان می‌دهد تا پتانسیل هوش مصنوعی را مستقیماً در جایی که داده‌ها تولید می‌شوند و تصمیمات باید گرفته شوند، به کار بگیرید.

### آنچه یاد خواهید گرفت

این دوره شما را از مفاهیم پایه تا پیاده‌سازی‌های آماده تولید هدایت می‌کند و شامل موارد زیر است:
- **مدل‌های زبان کوچک (SLMs)** بهینه‌شده برای استقرار لبه‌ای
...
هوش مصنوعی لبه‌ای یک تغییر پارادایم است که به چالش‌های مدرن حیاتی پاسخ می‌دهد:
...
Edge AI به اجرای الگوریتم‌های هوش مصنوعی و مدل‌های زبان به صورت محلی بر روی سخت‌افزار، نزدیک به جایی که داده‌ها تولید می‌شوند، بدون وابستگی به منابع ابری برای استنتاج اشاره دارد. این فناوری تأخیر را کاهش می‌دهد، حریم خصوصی را افزایش می‌دهد و تصمیم‌گیری بلادرنگ را ممکن می‌سازد.

### اصول اصلی:
- **استنتاج روی دستگاه**: مدل‌های هوش مصنوعی بر روی دستگاه‌های لبه‌ای (تلفن‌ها، روترها، میکروکنترلرها، رایانه‌های صنعتی) اجرا می‌شوند
...
- **کاهش حافظه مورد نیاز**: استفاده کارآمد از حافظه محدود دستگاه‌های لبه‌ای
- **کاهش نیاز به محاسبات**: بهینه‌سازی برای عملکرد CPU و GPU لبه‌ای
- **زمان‌های راه‌اندازی سریع‌تر**: راه‌اندازی سریع برای برنامه‌های پاسخگو

این مدل‌ها قابلیت‌های قدرتمند پردازش زبان طبیعی را فراهم می‌کنند و در عین حال محدودیت‌های زیر را رعایت می‌کنند:
...
- **سرورهای لبه‌ای**: واحدهای پردازش محلی با منابع GPU محدود
...
|--------|-------|------------|-------------|--------|----------|
| [📚 01](../../Module01) | [مبانی EdgeAI](./Module01/README.md) | مقایسه هوش مصنوعی ابری و لبه‌ای | مبانی EdgeAI • مطالعات موردی واقعی • راهنمای پیاده‌سازی • استقرار لبه‌ای | مبتدی | 3-4 ساعت |
| [🧠 02](../../Module02) | [پایه‌های مدل SLM](./Module02/README.md) | خانواده‌های مدل و معماری | خانواده Phi • خانواده Qwen • خانواده Gemma • BitNET • μModel • Phi-Silica | مبتدی | 4-5 ساعت |
...
| [⚙️ 04](../../Module04) | [جعبه ابزار بهینه‌سازی مدل](./Module04/README.md) | بهینه‌سازی چندپلتفرمی | مقدمه • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • سنتز جریان کاری | متوسط | 5-6 ساعت |
...
| [💻 07](../../Module07) | [پیاده‌سازی پلتفرم](./Module07/README.md) | نمونه‌های چندپلتفرمی | جعبه ابزار هوش مصنوعی • Foundry Local • توسعه ویندوز | پیشرفته | 3-4 ساعت |
| [🏭 08](../../Module08) | [جعبه ابزار Foundry Local](./Module08/README.md) | نمونه‌های آماده تولید | برنامه‌های نمونه (جزئیات زیر را ببینید) | متخصص | 8-10 ساعت |
...
- [05: ارکستراسیون چندعاملی](./Module08/samples/05/README.md)
...
- [09: سیستم چندعاملی پیشرفته](./Module08/samples/09/README.md)
...
### 🎯 مهارت‌های اصلی
- **معماری هوش مصنوعی لبه‌ای**: طراحی سیستم‌های هوش مصنوعی محلی با یکپارچه‌سازی ابری
- **بهینه‌سازی مدل**: کمینه‌سازی و فشرده‌سازی مدل‌ها برای استقرار لبه‌ای (85% افزایش سرعت، 75% کاهش اندازه)
- **استقرار چندپلتفرمی**: ویندوز، موبایل، سیستم‌های تعبیه‌شده و سیستم‌های ترکیبی ابری-لبه‌ای
- **عملیات تولید**: نظارت، مقیاس‌پذیری و نگهداری هوش مصنوعی لبه‌ای در تولید
...
- **چارچوب‌های API**: کلاینت‌های آماده تولید با جریان و نظارت بر سلامت
- **ابزارهای چندپلتفرمی**: الگوهای یکپارچه‌سازی LangChain/Semantic Kernel

### 🏢 کاربردهای صنعتی
**تولید** • **بهداشت و درمان** • **وسایل نقلیه خودران** • **شهرهای هوشمند** • **برنامه‌های موبایل**

## شروع سریع

**مسیر یادگیری پیشنهادی** (20-30 ساعت در مجموع):
...
4. **💻 پیاده‌سازی** (ماژول‌های 07-08): نمونه‌های پلتفرم + جعبه ابزار Foundry Local
