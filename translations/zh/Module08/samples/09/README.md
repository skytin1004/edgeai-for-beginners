...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T09:57:45+00:00",
  "source_file": "Module08/samples/09/README.md",
  "language_code": "zh"
}
-->
# 多代理编排系统 - Foundry Local

一个由 Microsoft Foundry Local 提供支持的高级多代理系统，展示了智能代理协调、专门任务分配以及协作问题解决模式。

## 概述

此示例展示了如何使用 Foundry Local 构建复杂的 AI 代理系统，实施微软官方的函数调用、代理编排和协作 AI 工作流模式。
...
### ⚡ **高级函数调用**
- Microsoft Foundry Local 函数调用模式
- 类型安全的工具定义
- 自动参数验证
- 错误处理与恢复
- 工具链与组合
