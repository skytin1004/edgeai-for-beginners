...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T11:47:56+00:00",
...
在第一节的 Foundry Local 基础上，本节将重点介绍如何通过高级提示工程、无缝数据集成和可操作的任务自动化来创建复杂的 AI 解决方案。您将学习如何将本地开发与 Azure AI Foundry 的功能相结合，构建企业级应用程序，充分利用两者的优势。

## 学习目标

完成本节后，您将能够：
- 掌握高级提示工程技术，确保 AI 响应的一致性和可靠性
- 实现适用于实际应用的强大数据集成模式
- 创建可推动业务价值的可操作 AI 任务
- 建立 Foundry Local 与 Azure AI Foundry 的无缝连接
- 构建性能监控和优化工作流
- 部署具有错误处理和扩展能力的生产级 AI 解决方案

## 前提条件

- 完成第一节：Foundry Local 入门
- 已安装并运行模型的 Foundry Local
- Azure 账户（免费层即可满足学习需求）
...
有效的提示工程是可靠 AI 应用程序的基础。Foundry Local 提供了增强的提示功能：
...
在本节中，您已经掌握了：
- ✅ 确保 AI 行为一致性的高级提示工程技术
- ✅ 适用于实际应用的强大数据集成模式
- ✅ 用于优化业务流程的自动化任务创建
- ✅ Azure AI Foundry 集成和混合部署策略
- ✅ 综合性能监控与优化

### 为第三节做准备：开源模型

1. **探索 Hugging Face**：创建账户并浏览模型目录
2. **查看 Model Mondays**：了解最新的 [Model Mondays 系列](https://aka.ms/model-mondays)
3. **规划定制模型**：考虑哪些专用模型能为您的用例带来益处
...
- [高级提示工程指南](https://platform.openai.com/docs/guides/prompt-engineering)
- [业务流程自动化最佳实践](https://docs.microsoft.com/en-us/power-automate/)

您现在已经具备构建复杂 AI 解决方案的能力，这些解决方案结合了本地推理的优势和云规模的能力，为企业级 AI 应用奠定了坚实的基础。
