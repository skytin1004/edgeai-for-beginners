...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-11T10:21:24+00:00",
...
**如果您希望支持其他语言，支持的语言列表请参见 [此处](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**

## 简介

欢迎来到 **EdgeAI 初学者指南**——一场探索边缘人工智能（Edge AI）变革世界的全面旅程。本课程将强大的 AI 能力与实际的边缘设备部署相结合，帮助您直接在数据生成和决策发生的地方释放 AI 的潜力。
...
|------|------|----------|----------|------|------|
| [📖 00 ](./introduction.md) | [EdgeAI 简介](./introduction.md) | 基础与背景 | EdgeAI 概述 • 行业应用 • SLM 简介 • 学习目标 | 初级 | 1-2 小时 |
| [📚 01](../../Module01) | [EdgeAI 基础](./Module01/README.md) | 云端与边缘 AI 对比 | EdgeAI 基础 • 实际案例研究 • 实现指南 • 边缘部署 | 初级 | 3-4 小时 |
...
| [⚙️ 04](../../Module04) | [模型优化工具包](./Module04/README.md) | 跨平台优化 | 简介 • Llama.cpp • Microsoft Olive • OpenVINO • Apple MLX • 工作流综合 | 中级 | 5-6 小时 |
| [🔧 05](../../Module05) | [SLMOps 生产](./Module05/README.md) | 生产操作 | SLMOps 简介 • 模型蒸馏 • 微调 • 生产部署 | 高级 | 5-6 小时 |
| [🤖 06](../../Module06) | [AI 代理与函数调用](./Module06/README.md) | 代理框架与 MCP | 代理简介 • 函数调用 • 模型上下文协议 | 高级 | 4-5 小时 |
...
- [01: REST Chat 快速入门](./Module08/samples/01/README.md)  
...
- [IoT入门](https://aka.ms/iot-beginners?WT.mc_id=academic-105485-koreyst)
