...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-03T08:06:37+00:00",
...
[![Mga Contributor sa GitHub](https://img.shields.io/github/contributors/microsoft/edgeai-for-beginners.svg)](https://GitHub.com/microsoft/edgeai-for-beginners/graphs/contributors)  
...
**Kung nais mong magkaroon ng karagdagang mga wika, ang mga sinusuportahang wika ay nakalista [dito](https://github.com/Azure/co-op-translator/blob/main/getting_started/supported-languages.md)**

## Panimula

Maligayang pagdating sa **EdgeAI para sa mga Baguhan** – ang iyong komprehensibong paglalakbay sa makabagong mundo ng Edge Artificial Intelligence. Ang kursong ito ay nag-uugnay sa makapangyarihang kakayahan ng AI at praktikal na aplikasyon sa mga edge device, na nagbibigay-daan sa iyo upang magamit ang potensyal ng AI kung saan nalilikha ang data at kailangang gawin ang mga desisyon.

### Ano ang Iyong Matututuhan

Ang kursong ito ay magdadala sa iyo mula sa mga pangunahing konsepto hanggang sa mga handang ipatupad na solusyon, kabilang ang:
...
Ang Edge AI ay nagdadala ng pagbabago na tumutugon sa mga kritikal na hamon ng modernong panahon:
- **Privacy at Seguridad**: Pinoproseso ang sensitibong data nang lokal nang hindi umaasa sa cloud  
- **Real-time na Performance**: Inaalis ang network latency para sa mga time-critical na aplikasyon  
- **Makatipid sa Gastos**: Binabawasan ang bandwidth at gastos sa cloud computing  
- **Matatag na Operasyon**: Nagpapanatili ng functionality kahit walang koneksyon sa network  
- **Pagsunod sa Regulasyon**: Tumutugon sa mga kinakailangan sa data sovereignty  

### Edge AI

Ang Edge AI ay tumutukoy sa pagpapatakbo ng mga AI algorithm at language model nang lokal sa hardware, malapit sa kung saan nalilikha ang data, nang hindi umaasa sa cloud resources para sa inference. Binabawasan nito ang latency, pinapahusay ang privacy, at nagbibigay-daan sa real-time na paggawa ng desisyon.
...
Ang mga SLM tulad ng Phi-4, Mistral-7B, at Gemma ay mga na-optimize na bersyon ng mas malalaking LLM—na sinanay o dinistill para sa:
- **Mas maliit na memory footprint**: Mahusay na paggamit ng limitadong memorya ng edge device  
...
Binubuksan nila ang makapangyarihang kakayahan ng NLP habang tinutugunan ang mga limitasyon ng:
...
- **Personal Computers**: Mga desktop at laptop deployment scenario  

## Mga Module ng Kurso at Navigation

| Module | Paksa | Pokus na Lugar | Pangunahing Nilalaman | Antas | Tagal |
|--------|-------|----------------|-----------------------|-------|-------|
| [📖 00 ](./introduction.md) | [Panimula sa EdgeAI](./introduction.md) | Pundasyon at Konteksto | Pangkalahatang-ideya ng EdgeAI • Mga Aplikasyon sa Industriya • Panimula sa SLM • Mga Layunin sa Pagkatuto | Baguhan | 1-2 oras |
| [📚 01](../../Module01) | [Mga Pangunahing Kaalaman sa EdgeAI](./Module01/README.md) | Paghahambing ng Cloud vs Edge AI | Mga Pangunahing Kaalaman sa EdgeAI • Mga Halimbawa sa Tunay na Mundo • Gabay sa Implementasyon • Edge Deployment | Baguhan | 3-4 oras |
...
| [🚀 03](../../Module03) | [Praktika sa SLM Deployment](./Module03/README.md) | Lokal at cloud deployment | Advanced na Pagkatuto • Lokal na Kapaligiran • Cloud Deployment | Intermediate | 4-5 oras |
...
| [💻 07](../../Module07) | [Implementasyon sa Platform](./Module07/README.md) | Mga halimbawa sa cross-platform | AI Toolkit • Foundry Local • Windows Development | Advanced | 3-4 oras |
| [🏭 08](../../Module08) | [Foundry Local Toolkit](./Module08/README.md) | Mga handang-gamitin na halimbawa | Mga sample na aplikasyon (tingnan ang mga detalye sa ibaba) | Eksperto | 8-10 oras |
...
- **Arkitektura ng Edge AI**: Magdisenyo ng mga lokal-unang AI system na may cloud integration  
- **Model Optimization**: I-quantize at i-compress ang mga modelo para sa edge deployment (85% bilis, 75% bawas sa laki)  
- **Multi-Platform Deployment**: Windows, mobile, embedded, at cloud-edge hybrid systems  
- **Production Operations**: Pagsubaybay, pag-scale, at pagpapanatili ng edge AI sa produksyon  

### 🏗️ Praktikal na Proyekto
- **Foundry Local Chat Apps**: Windows 11 native application na may model switching  
- **Multi-Agent Systems**: Coordinator na may mga espesyalistang agent para sa mga komplikadong workflow  
...
- **API Frameworks**: Mga handang-gamitin na kliyente na may streaming at health monitoring  
- **Cross-Platform Tools**: Mga pattern ng integration ng LangChain/Semantic Kernel  

### 🏢 Mga Aplikasyon sa Industriya
**Paggawa** • **Kalusugan** • **Mga Sasakyang Walang Driver** • **Smart Cities** • **Mobile Apps**

## Mabilis na Pagsisimula

**Inirerekomendang Learning Path** (20-30 oras kabuuan):

0. **📖 Panimula** ([Introduction.md](./introduction.md)): Pundasyon ng EdgeAI + konteksto ng industriya + framework sa pagkatuto  
1. **📚 Pundasyon** (Modules 01-02): Mga konsepto ng EdgeAI + mga pamilya ng SLM model  
2. **⚙️ Optimization** (Modules 03-04): Deployment + mga framework sa quantization  
...
Ang bawat module ay may kasamang teorya, praktikal na mga gawain, at mga sample ng code na handa para sa produksyon.

## Epekto sa Karera

**Mga Teknikal na Posisyon**: EdgeAI Solutions Architect • ML Engineer (Edge) • IoT AI Developer • Mobile AI Developer  

**Mga Industriya**: Manufacturing 4.0 • Teknolohiyang Pangkalusugan • Autonomous Systems • FinTech • Consumer Electronics  

**Mga Proyekto sa Portfolio**: Multi-agent systems • Mga RAG app para sa produksyon • Deployment sa iba't ibang platform • Pag-optimize ng performance  
...
✅ **Progressibong Pag-aaral**: Teorya → Praktikal → Deployment sa produksyon  
✅ **Mga Tunay na Kaso**: Microsoft, Japan Airlines, mga implementasyon sa negosyo  
✅ **Mga Praktikal na Halimbawa**: 50+ na halimbawa, 10 komprehensibong demo ng Foundry Local  
✅ **Pokús sa Performance**: 85% na pagpapabilis, 75% na pagbabawas ng laki  
✅ **Multi-Platform**: Windows, mobile, embedded, cloud-edge hybrid  
✅ **Handa para sa Produksyon**: Monitoring, scaling, seguridad, mga framework para sa pagsunod  

📖 **[Magagamit na Gabay sa Pag-aaral](STUDY_GUIDE.md)**: Isang naka-istrukturang 20-oras na landas sa pag-aaral na may gabay sa paglalaan ng oras at mga tool para sa sariling pagtatasa.

---

**Ang EdgeAI ang kinabukasan ng AI deployment**: lokal muna, pinapanatili ang privacy, at mahusay. Masterin ang mga kasanayang ito upang makabuo ng susunod na henerasyon ng mga intelligent na aplikasyon.
