...
Ipinapakita ng sample na ito kung paano gawing reusable tools ang mga modelo ng Foundry Local na maaaring isama sa mga umiiral na aplikasyon, workflows, at development environments. Ipinapakita nito ang mga inirerekomendang pattern ng Microsoft para sa integrasyon ng tool at pagtawag ng mga function.

## Mga Pangunahing Konsepto

### 🔧 **Arkitektura na Nakatuon sa Tool**
- Mga modelo ng Foundry Local bilang maaring tawaging mga function
- Standardized na mga interface at schema ng tool
- Walang kahirap-hirap na integrasyon sa mga umiiral na codebase
- Type-safe na mga depinisyon ng tool at validation

### ⚡ **Mga Pattern ng Pagtawag ng Function**
- Implementasyon ng pagtawag ng function ng Microsoft Foundry Local
- Mga depinisyon ng tool na compatible sa OpenAI
- Awtomatikong validation at conversion ng parameter
- Paghawak ng error at pag-format ng tugon

### 🔌 **Mga Framework ng Integrasyon**
- **LangChain Integration**: Suporta sa native na LangChain tool
- **Semantic Kernel**: Mga function ng Microsoft Semantic Kernel
- **REST API**: Mga endpoint na nakabatay sa HTTP
- **CLI Tools**: Integrasyon sa command-line interface
- **Jupyter Notebooks**: Mga interactive na tool para sa pag-develop

### 🎯 **Mga Pattern ng Paggamit**
- Mga tool para sa pagsusuri at pagbuo ng code
- Pagproseso at pagbuod ng nilalaman
- Pagsusuri ng datos at visualization
...
- **Node.js**: v18+ (para sa mga integrasyon sa JavaScript)
- **Memory**: Inirerekomenda ang 12GB+
- **Storage**: 10GB+ para sa mga modelo at tool
...
### Mga Dependency na Tukoy sa Framework
```bash
...
### 1. Pangunahing Paglikha ng Tool
```python
...
### 1. Mga Tool na Nakabatay sa Function
```python
...
### 2. Mga Tool na Nakabatay sa Class
```python
...
### Integrasyon sa Semantic Kernel
```python
...
### 2. Mga Tool na May Kamalayan sa Konteksto
```python
...
1. **Mga Pattern ng Integrasyon ng Tool**
   - Disenyo ng tool na nakabatay sa function at class
   - Mga pattern ng integrasyon ng Microsoft Foundry Local
   - Validation ng schema at type safety
   - Paghawak ng error at pag-recover

2. **Integrasyon ng Framework**
   - Pag-develop ng tool sa LangChain
   - Integrasyon ng function sa Semantic Kernel
   - Integrasyon ng framework ng REST API
   - Pag-develop ng aplikasyon sa CLI

3. **Mga Pagsasaalang-alang sa Produksyon**
   - Mga estratehiya sa pag-optimize ng performance
   - Pamamahala ng caching at resources
   - Monitoring at observability
   - Seguridad at validation

4. **Mga Advanced na Pattern ng Tool**
   - Komposisyon at pagkakabit ng tool
   - Pagproseso na may kamalayan sa konteksto
   - Mga operasyon sa batch at streaming
   - Pag-develop ng custom na integrasyon

## Mga Susunod na Hakbang

- **Mga Proyekto ng Integrasyon**: Bumuo ng mga custom na integrasyon gamit ang iyong mga paboritong framework
- **Pag-develop ng Tool**: Gumawa ng mga espesyal na tool para sa iyong domain
- **Pag-tune ng Performance**: I-optimize para sa iyong partikular na mga kaso ng paggamit
- **Deployment sa Produksyon**: I-scale ang mga tool para sa paggamit sa enterprise

## Pag-aambag

Tingnan ang mga alituntunin ng pangunahing repository para sa mga tagubilin sa pag-aambag.

## Lisensya

Ang sample na ito ay sumusunod sa parehong lisensya ng proyekto ng Microsoft Foundry Local.
