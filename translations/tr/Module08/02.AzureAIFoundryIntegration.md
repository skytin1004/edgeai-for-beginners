...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T18:33:56+00:00",
...
Foundry Local temeliniz üzerine inşa ederek, bu oturumda gelişmiş istem mühendisliği, sorunsuz veri entegrasyonu ve uygulanabilir görev otomasyonu ile karmaşık yapay zeka çözümleri oluşturmayı öğreneceksiniz. Yerel geliştirme ile Azure AI Foundry yeteneklerini birleştirerek, her iki dünyanın en iyilerini kullanan kurumsal düzeyde uygulamalar oluşturmayı öğreneceksiniz.

## Öğrenme Hedefleri

Bu oturumun sonunda:
- Tutarlı ve güvenilir yapay zeka yanıtları için gelişmiş istem mühendisliği tekniklerini ustalıkla kullanabileceksiniz
- Gerçek dünya uygulamaları için sağlam veri entegrasyonu desenlerini uygulayabileceksiniz
- İş değerini artıran uygulanabilir yapay zeka görevleri oluşturabileceksiniz
- Foundry Local ile Azure AI Foundry arasında sorunsuz bağlantı kurabileceksiniz
- Performans izleme ve optimizasyon iş akışları oluşturabileceksiniz
- Hata yönetimi ve ölçeklendirme ile üretime hazır yapay zeka çözümleri dağıtabileceksiniz

## Ön Koşullar

- Oturum 1: Foundry Local ile Başlangıç tamamlanmış olmalı
- Çalışan modellerle aktif bir Foundry Local kurulumu
- Azure hesabı (öğrenme için ücretsiz katman yeterlidir)
- REST API'ler ve JSON hakkında temel bilgi

## Bölüm 1: Gelişmiş İstem Mühendisliği

### İstem Mimarisi Anlama

Etkili istem mühendisliği, güvenilir yapay zeka uygulamalarının temelidir. Foundry Local, gelişmiş istem oluşturma yetenekleri sunar:
...
### Pratik İstem Mühendisliği Örnekleri
...
## Bölüm 2: Veri Entegrasyonu Desenleri

### Foundry Local Veri Bağlayıcıları
...
### Gerçek Dünya Veri Entegrasyonu Örneği
...
## Bölüm 3: Uygulanabilir Yapay Zeka Görevleri

### Görev Otomasyonu Çerçevesi
...
## Bölüm 4: Azure AI Foundry Entegrasyonu
...
## Bölüm 5: Performans İzleme ve Optimizasyon
...
### Alıştırma 1: Gelişmiş Müşteri Hizmetleri Botu
...
### Alıştırma 2: Otomatik Pazar Araştırması
...
## Bölüm 7: Sonraki Adımlar ve Oturum 3 Önizlemesi

### Oturumda Kazanılanlar

Bu oturumda şunları öğrendiniz:
- ✅ Tutarlı yapay zeka davranışı için gelişmiş istem mühendisliği teknikleri
- ✅ Gerçek dünya uygulamaları için sağlam veri entegrasyonu desenleri
- ✅ İş süreci optimizasyonu için otomatik görev oluşturma
- ✅ Azure AI Foundry entegrasyonu ve hibrit dağıtım stratejileri
- ✅ Kapsamlı performans izleme ve optimizasyon

### Oturum 3'e Hazırlık: Açık Kaynak Modeller

1. **Hugging Face'i Keşfedin**: Bir hesap oluşturun ve model kataloğunu inceleyin
2. **Model Mondays'i İnceleyin**: En son [Model Mondays serisini](https://aka.ms/model-mondays) kontrol edin
3. **Özel Modeller Planlayın**: Kullanım senaryolarınıza fayda sağlayacak özel modelleri düşünün

### Ek Kaynaklar

- [Azure AI Foundry Belgeleri](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Foundry Local GitHub Deposu](https://github.com/microsoft/Foundry-Local)
- [Gelişmiş İstem Mühendisliği Kılavuzu](https://platform.openai.com/docs/guides/prompt-engineering)
- [İş Süreci Otomasyonu En İyi Uygulamaları](https://docs.microsoft.com/en-us/power-automate/)

Artık yerel çıkarımın gücünü bulut ölçeği yetenekleriyle birleştiren karmaşık yapay zeka çözümleri oluşturmak için donanımlısınız ve kurumsal düzeyde yapay zeka uygulamaları için temel oluşturmuş durumdasınız.
