...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T21:33:18+00:00",
  "source_file": "Module08/04.CuttingEdgeModels.md",
  "language_code": "tr"
}
-->
# Oturum 4: Chainlit ile Üretim Chat Uygulamaları Geliştirme

## Genel Bakış

Bu oturum, Chainlit ve Microsoft Foundry Local kullanarak üretime hazır chat uygulamaları geliştirmeye odaklanıyor. AI sohbetleri için modern web arayüzleri oluşturmayı, akış yanıtlarını uygulamayı ve hata yönetimi ile kullanıcı deneyimi tasarımıyla sağlam chat uygulamaları dağıtmayı öğreneceksiniz.

**Geliştireceğiniz Uygulamalar:**
...
- Chainlit ile üretime hazır chat uygulamaları geliştirme
- Kullanıcı deneyimini geliştirmek için akış yanıtlarını uygulama
- Foundry Local SDK entegrasyon kalıplarını öğrenme
- Hataları doğru bir şekilde yönetme ve zarif bir şekilde degrade etme
...
- **Tarayıcı**: WebGPU desteği olan modern bir web tarayıcı (Chrome/Edge)
...
**Chainlit Framework:**
- `@cl.on_chat_start`: Chat oturumlarını başlatma
...
|----------|----------|------------|-------|
| `MODEL` | Kullanılacak model aliası | `phi-4-mini` | `qwen2.5-7b-instruct` |
...
Örnek 04, aşağıdaki özelliklere sahip kapsamlı bir Jupyter notebook (`chainlit_app.ipynb`) içerir:
...
### Kendi Notebooklarınızı Oluşturma
...
WebGPU, maksimum gizlilik ve sıfır kurulum deneyimleri için AI modellerini doğrudan tarayıcıda çalıştırmayı sağlar. Bu örnek, ONNX Runtime Web ile WebGPU çalıştırmasını gösterir.
...
2. **İlk Kurulum:** Admin hesabı oluşturun
...
4. **Bağlantıyı Test Edin:** Modeller açılır listede görünmelidir
...
Oturum 4, konuşma AI için üretime hazır Chainlit uygulamaları geliştirmeyi ele aldı. Şunları öğrendiniz:
...
- **[Foundry Local Belgeleri](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Platformun tam belgeleri
- **[Chainlit Belgeleri](https://docs.chainlit.io/)**: Resmi framework belgeleri
- **[Open WebUI Entegrasyon Kılavuzu](https://github.com/microsoft/foundry-local/blob/main/docs/tutorials/chat-application-with-open-web-ui.md)**: Resmi eğitim
