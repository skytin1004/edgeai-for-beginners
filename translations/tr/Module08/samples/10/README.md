...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T21:36:24+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "tr"
}
-->
# Foundry Local'ı Araç Olarak Entegrasyon

Microsoft Foundry Local'ı daha büyük uygulamalar içinde çağrılabilir araçlar olarak entegre etmek için Microsoft'un resmi araç tabanlı yapay zeka entegrasyon desenlerini takip eden kapsamlı bir çerçeve.

## Genel Bakış

Bu örnek, Foundry Local modellerini mevcut uygulamalara, iş akışlarına ve geliştirme ortamlarına entegre edilebilen yeniden kullanılabilir araçlar olarak nasıl sunacağınızı gösterir. Microsoft'un araç entegrasyonu ve işlev çağrımı için önerilen desenlerini sergiler.

## Temel Kavramlar

### 🔧 **Araç-Öncelikli Mimari**
- Foundry Local modelleri çağrılabilir fonksiyonlar olarak
- Standartlaştırılmış araç arayüzleri ve şemaları
- Mevcut kod tabanlarıyla sorunsuz entegrasyon
- Tür güvenli araç tanımları ve doğrulama

### ⚡ **Fonksiyon Çağrımı Desenleri**
- Microsoft Foundry Local fonksiyon çağrımı uygulaması
- OpenAI uyumlu araç tanımları
- Otomatik parametre doğrulama ve dönüştürme
- Hata yönetimi ve yanıt formatlama

### 🔌 **Entegrasyon Çerçeveleri**
- **LangChain Entegrasyonu**: Yerel LangChain araç desteği
- **Semantic Kernel**: Microsoft Semantic Kernel fonksiyonları
- **REST API**: HTTP tabanlı araç uç noktaları
- **CLI Araçları**: Komut satırı arayüz entegrasyonu
- **Jupyter Notebooks**: Etkileşimli geliştirme araçları

### 🎯 **Kullanım Senaryosu Desenleri**
- Kod analizi ve üretim araçları
- İçerik işleme ve özetleme
...
- **Python**: 3.9+ asyncio desteği ile
- **Node.js**: v18+ (JavaScript entegrasyonları için)
- **Bellek**: 12GB+ önerilir
- **Depolama**: Modeller ve araçlar için 10GB+
...
### 2. Bağlam Farkındalığına Sahip Araçlar
```python
...
1. **Araç Entegrasyon Desenleri**
   - Fonksiyon tabanlı ve sınıf tabanlı araç tasarımı
   - Microsoft Foundry Local entegrasyon desenleri
   - Şema doğrulama ve tür güvenliği
   - Hata yönetimi ve kurtarma

2. **Çerçeve Entegrasyonu**
   - LangChain araç geliştirme
   - Semantic Kernel fonksiyon entegrasyonu
   - REST API çerçeve entegrasyonu
   - CLI uygulama geliştirme

3. **Üretim Düşünceleri**
   - Performans optimizasyon stratejileri
   - Önbellek ve kaynak yönetimi
   - İzleme ve gözlemlenebilirlik
   - Güvenlik ve doğrulama

4. **İleri Düzey Araç Desenleri**
   - Araç bileşimi ve zincirleme
   - Bağlam farkındalığına sahip işleme
   - Toplu ve akış işlemleri
   - Özel entegrasyon geliştirme

## Sonraki Adımlar

- **Entegrasyon Projeleri**: Tercih ettiğiniz çerçevelerle özel entegrasyonlar oluşturun
- **Araç Geliştirme**: Alanınıza özel araçlar oluşturun
- **Performans Ayarı**: Özel kullanım senaryolarınıza göre optimize edin
- **Üretim Dağıtımı**: Araçları kurumsal kullanım için ölçeklendirin

## Katkıda Bulunma

Katkı talimatları için ana depo yönergelerine bakın.
