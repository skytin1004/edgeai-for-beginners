...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T01:30:28+00:00",
...
- Pochopiť stratégie ukladania modelov pre optimálny výkon
...
Nainštalujte Foundry Local pomocou Winget alebo stiahnite inštalátor z GitHubu:
...
## Časť 3: Ukladanie modelov a ich správa

Foundry Local implementuje inteligentné ukladanie modelov na optimalizáciu výkonu a úložiska:
...
### Spustenie modelov Microsoft Phi
...
- **FoundryLocalManager**: Používajte oficiálny SDK na správu služieb, ak je dostupný
- **Riešenie chýb**: Implementujte správne stratégie záložných riešení pre produkčné aplikácie
- **Pravidelné aktualizácie**: Udržujte Foundry Local aktualizovaný, aby ste mali prístup k novým modelom a opravám
...
### Cvičenie 3: Komplexná kontrola zdravia služby
