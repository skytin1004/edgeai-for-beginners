...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T01:29:38+00:00",
...
- **WebGPU Demo**: Inferencia v prehliadači pre aplikácie zamerané na ochranu súkromia  
...
- Pochopiť moderné webové UI vzory pre konverzačné AI

## Predpoklady

- **Foundry Local**: Nainštalovaný a spustený ([Inštalačný návod](https://learn.microsoft.com/azure/ai-foundry/foundry-local/))
...
- `@cl.on_message`: Spracovanie prichádzajúcich správ od používateľa  
...
| **Súkromie** | 🔒 Dáta nikdy neopustia zariadenie | ⚠️ Dáta sa posielajú do cloudu |
...
**Automatické objavovanie služieb:**
```python
...
- **📚 Vzdelávací obsah**: Krok za krokom výučbové materiály
...
3. Vyberte "Foundry Local" kernel, keď budete vyzvaní
4. Začnite pridávať bunky s vaším obsahom
...
4. **Testovanie pripojenia:** Modely by sa mali zobraziť v rozbaľovacom zozname
...
Relácia 4 pokryla vytváranie produkčne pripravených Chainlit aplikácií pre konverzačné AI. Naučili ste sa:

- ✅ **Chainlit Framework**: Moderné UI a podpora streamovania pre chatovacie aplikácie
- ✅ **Integrácia Foundry Local**: Použitie SDK a vzory konfigurácie  
- ✅ **WebGPU Inferencia**: AI v prehliadači pre maximálnu ochranu súkromia
...
Ukážka 04 demonštruje najlepšie praktiky pre vytváranie robustných chatovacích rozhraní, ktoré využívajú lokálne AI modely cez Microsoft Foundry Local a zároveň poskytujú vynikajúci používateľský zážitok.

## Referencie

- **[Ukážka 04: Chainlit Application](samples/04/README.md)**: Kompletná aplikácia s dokumentáciou
- **[Chainlit Educational Notebook](samples/04/chainlit_app.ipynb)**: Interaktívne vzdelávacie materiály
- **[Foundry Local Dokumentácia](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Kompletná dokumentácia platformy
- **[Chainlit Dokumentácia](https://docs.chainlit.io/)**: Oficiálna dokumentácia frameworku
- **[Open WebUI Integrácia](https://github.com/microsoft/foundry-local/blob/main/docs/tutorials/chat-application-with-open-web-ui.md)**: Oficiálny tutoriál
