...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T03:13:27+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "sk"
}
-->
# Foundry Local ako integrácia nástrojov

Komplexný rámec na integráciu Microsoft Foundry Local ako volateľných nástrojov v rámci väčších aplikácií, podľa oficiálnych vzorov Microsoftu pre integráciu AI založenú na nástrojoch.

## Prehľad

Tento príklad demonštruje, ako sprístupniť modely Foundry Local ako opakovane použiteľné nástroje, ktoré je možné integrovať do existujúcich aplikácií, pracovných postupov a vývojových prostredí. Ukazuje odporúčané vzory Microsoftu pre integráciu nástrojov a volanie funkcií.

## Kľúčové koncepty

### 🔧 **Architektúra orientovaná na nástroje**
- Modely Foundry Local ako volateľné funkcie
- Štandardizované rozhrania a schémy nástrojov
- Bezproblémová integrácia do existujúcich kódových základov
- Typovo bezpečné definície nástrojov a validácia

### ⚡ **Vzory volania funkcií**
- Implementácia volania funkcií Microsoft Foundry Local
- Definície nástrojov kompatibilné s OpenAI
- Automatická validácia a konverzia parametrov
- Spracovanie chýb a formátovanie odpovedí

### 🔌 **Rámce integrácie**
- **Integrácia LangChain**: Natívna podpora nástrojov LangChain
- **Semantic Kernel**: Funkcie Microsoft Semantic Kernel
- **REST API**: Koncové body založené na HTTP
- **CLI nástroje**: Integrácia príkazového riadku
- **Jupyter Notebooks**: Interaktívne vývojové nástroje

### 🎯 **Vzory použitia**
- Nástroje na analýzu a generovanie kódu
- Spracovanie obsahu a sumarizácia
- Analýza a vizualizácia dát
- Výskum a vyhľadávanie informácií
...
- **Node.js**: v18+ (pre JavaScript integrácie)
- **Pamäť**: Odporúča sa 12GB+
- **Úložisko**: 10GB+ pre modely a nástroje
...
### Závislosti špecifické pre rámec
```bash
...
### 1. Základné vytvorenie nástroja
```python
...
## Základné vzory nástrojov

### 1. Nástroje založené na funkciách
```python
...
### 2. Nástroje založené na triedach
```python
...
1. **Vzory integrácie nástrojov**
   - Návrh nástrojov založených na funkciách a triedach
   - Vzory integrácie Microsoft Foundry Local
   - Validácia schém a typová bezpečnosť
   - Spracovanie chýb a obnova

2. **Integrácia rámcov**
   - Vývoj nástrojov LangChain
   - Integrácia funkcií Semantic Kernel
   - Integrácia rámca REST API
   - Vývoj aplikácií príkazového riadku

3. **Úvahy o produkcii**
   - Stratégie optimalizácie výkonu
   - Cachovanie a správa zdrojov
   - Monitorovanie a pozorovateľnosť
   - Bezpečnosť a validácia

4. **Pokročilé vzory nástrojov**
   - Kompozícia a reťazenie nástrojov
   - Spracovanie citlivé na kontext
   - Batchové a streamingové operácie
   - Vývoj vlastných integrácií

## Ďalšie kroky

- **Projekty integrácie**: Vytvorte vlastné integrácie s preferovanými rámcami
- **Vývoj nástrojov**: Vytvorte špecializované nástroje pre vašu oblasť
- **Ladenie výkonu**: Optimalizujte pre vaše konkrétne prípady použitia
- **Nasadenie do produkcie**: Škálujte nástroje pre podnikové použitie

## Prispievanie

Pozrite si hlavné pokyny pre prispievanie v repozitári.
