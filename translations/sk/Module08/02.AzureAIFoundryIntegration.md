...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T01:15:48+00:00",
...
Na základe vašich znalostí z Foundry Local sa táto relácia zameriava na vytváranie pokročilých AI riešení prostredníctvom pokročilého návrhu promptov, bezproblémovej integrácie dát a automatizácie úloh. Naučíte sa, ako prepojiť lokálny vývoj s funkciami Azure AI Foundry a vytvárať aplikácie pripravené pre podnikové prostredie, ktoré využívajú to najlepšie z oboch svetov.

## Ciele učenia

Na konci tejto relácie budete:
- Ovládať pokročilé techniky návrhu promptov pre konzistentné a spoľahlivé odpovede AI
- Implementovať robustné vzory integrácie dát pre aplikácie v reálnom svete
- Vytvárať akčné AI úlohy, ktoré prinášajú obchodnú hodnotu
- Zabezpečiť bezproblémové prepojenie medzi Foundry Local a Azure AI Foundry
- Budovať pracovné postupy na monitorovanie výkonu a optimalizáciu
- Nasadzovať AI riešenia pripravené na produkciu s riadnym spracovaním chýb a škálovaním

## Predpoklady

- Dokončená relácia 1: Začíname s Foundry Local
- Aktívna inštalácia Foundry Local s bežiacimi modelmi
- Azure účet (bezplatná verzia postačuje na učenie)
- Základné porozumenie REST API a JSON

## Časť 1: Pokročilý návrh promptov

### Porozumenie architektúre promptov

Efektívny návrh promptov je základom spoľahlivých AI aplikácií. Foundry Local poskytuje rozšírené možnosti návrhu promptov:
...
### Implementácia stratégií promptov
...
### Praktické príklady návrhu promptov
...
## Časť 2: Vzory integrácie dát

### Konektory dát Foundry Local
...
### Príklad integrácie dát v reálnom svete
...
## Časť 3: Akčné AI úlohy

### Rámec automatizácie úloh
...
### Príklady automatizácie obchodných procesov
...
## Časť 4: Integrácia Azure AI Foundry
...
## Časť 5: Monitorovanie výkonu a optimalizácia
...
### Cvičenie 1: Pokročilý chatbot pre zákaznícky servis
...
### Cvičenie 2: Automatizovaný prieskum trhu
...
## Časť 7: Ďalšie kroky a náhľad na reláciu 3

### Dosiahnuté výsledky relácie

V tejto relácii ste zvládli:
- ✅ Pokročilé techniky návrhu promptov pre konzistentné správanie AI
- ✅ Robustné vzory integrácie dát pre aplikácie v reálnom svete
- ✅ Automatizáciu úloh na optimalizáciu obchodných procesov
- ✅ Integráciu Azure AI Foundry a hybridné stratégie nasadenia
- ✅ Komplexné monitorovanie výkonu a optimalizáciu

### Príprava na reláciu 3: Open-Source modely

1. **Preskúmajte Hugging Face**: Vytvorte si účet a prehliadajte katalóg modelov
2. **Preštudujte Model Mondays**: Pozrite si najnovšiu sériu [Model Mondays](https://aka.ms/model-mondays)
3. **Plánujte vlastné modely**: Zvážte, aké špecializované modely by mohli byť prospešné pre vaše prípady použitia

### Dodatočné zdroje

- [Dokumentácia Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [GitHub repozitár Foundry Local](https://github.com/microsoft/Foundry-Local)
- [Pokročilý sprievodca návrhom promptov](https://platform.openai.com/docs/guides/prompt-engineering)
- [Najlepšie praktiky automatizácie obchodných procesov](https://docs.microsoft.com/en-us/power-automate/)

Teraz ste pripravení vytvárať pokročilé AI riešenia, ktoré kombinujú silu lokálneho inferencovania s cloudovými schopnosťami, čím nastavujete základ pre AI aplikácie na podnikovej úrovni.
