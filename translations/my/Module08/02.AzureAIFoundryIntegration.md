...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T01:16:59+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "my"
}
-->
# အခန်း ၂: Azure AI Foundry ဖြင့် AI ဖြေရှင်းချက်များ တည်ဆောက်ခြင်း

## အကျဉ်းချုပ်

Foundry Local အခြေခံပညာအပေါ် အခြေခံပြီး ဒီအခန်းမှာ အဆင့်မြင့် prompt engineering, ဒေတာပေါင်းစည်းမှုရိုးရာများ, နှင့် လုပ်ဆောင်နိုင်သော task automation များကို အသုံးပြု၍ အဆင့်မြင့် AI ဖြေရှင်းချက်များကို ဖန်တီးခြင်းကို အဓိကထားပါမည်။ Foundry Local နှင့် Azure AI Foundry တို့၏ စွမ်းရည်များကို ပေါင်းစည်းပြီး လုပ်ငန်းအဆင့် AI အက်ပလီကေးရှင်းများ ဖန်တီးရန် သင်လေ့လာနိုင်ပါမည်။

## သင်ယူရမည့် ရည်မှန်းချက်များ

ဒီအခန်းအဆုံးသတ်ချိန်တွင် သင်သည်:
- AI မှာ ယုံကြည်ရသော အဖြေများရရှိရန် အဆင့်မြင့် prompt engineering နည်းလမ်းများကို ကျွမ်းကျင်မည်
- အမှန်တကယ်အသုံးချနိုင်သော ဒေတာပေါင်းစည်းမှု ပုံစံများကို အကောင်အထည်ဖော်မည်
- လုပ်ငန်းတန်ဖိုးကို မြှင့်တင်နိုင်သော AI task များ ဖန်တီးမည်
- Foundry Local နှင့် Azure AI Foundry အကြား seamless ချိတ်ဆက်မှုကို တည်ဆောက်မည်
- စွမ်းဆောင်ရည်ကို စောင့်ကြည့်ခြင်းနှင့် အဆင့်မြှင့်တင်ခြင်းလုပ်ငန်းစဉ်များ တည်ဆောက်မည်
- အမှားကို ကိုင်တွယ်နိုင်သော၊ အရွယ်အစားချဲ့နိုင်သော production-ready AI ဖြေရှင်းချက်များကို deploy လုပ်မည်

## ကြိုတင်လိုအပ်ချက်များ

- အခန်း ၁: Foundry Local စတင်အသုံးပြုခြင်းကို ပြီးစီးထားရမည်
- Foundry Local installation တစ်ခုရှိပြီး မော်ဒယ်များ run လုပ်နေသည်
- Azure အကောင့် (သင်ယူရန်အတွက် အခမဲ့ tier လုံလောက်သည်)
- REST APIs နှင့် JSON အခြေခံနားလည်မှု

## အပိုင်း ၁: အဆင့်မြင့် Prompt Engineering

### Prompt Architecture ကို နားလည်ခြင်း

ယုံကြည်ရသော AI အက်ပလီကေးရှင်းများအတွက် prompt engineering သည် အခြေခံအဆင့်ဖြစ်သည်။ Foundry Local သည် prompt များကို အဆင့်မြှင့်တင်ထားသော စွမ်းရည်များပေးသည်။
...
### Prompt Strategies ကို အကောင်အထည်ဖော်ခြင်း
...
### Prompt Engineering ၏ အကဲဖြတ်နိုင်သော နမူနာများ
...
## အပိုင်း ၂: ဒေတာပေါင်းစည်းမှု ပုံစံများ

### Foundry Local Data Connectors
...
### အမှန်တကယ် ဒေတာပေါင်းစည်းမှု နမူနာ
...
## အပိုင်း ၃: လုပ်ဆောင်နိုင်သော AI Tasks
...
### လုပ်ငန်းလုပ်ငန်းစဉ်များကို အလိုအလျောက်လုပ်ဆောင်ခြင်း နမူနာများ
...
## အပိုင်း ၄: Azure AI Foundry Integration

### ချိတ်ဆက်မှု တည်ဆောက်ခြင်း
...
## အပိုင်း ၅: စွမ်းဆောင်ရည် စောင့်ကြည့်ခြင်းနှင့် အဆင့်မြှင့်တင်ခြင်း
...
## အပိုင်း ၆: လက်တွေ့ လေ့ကျင့်မှုများ

### လေ့ကျင့်မှု ၁: အဆင့်မြင့် Customer Service Bot
...
### လေ့ကျင့်မှု ၂: Automated Market Research
...
## အပိုင်း ၇: နောက်တစ်ဆင့်များနှင့် အခန်း ၃ ရှေ့ကြည့်မှု

### အခန်းတွင် ရရှိထားသော အောင်မြင်မှုများ

ဒီအခန်းတွင် သင်သည် ကျွမ်းကျင်ထားပါပြီ:
- ✅ AI ၏ အပြုသဘောဆောင်သော အပြုအမူများအတွက် အဆင့်မြင့် prompt engineering နည်းလမ်းများ
- ✅ အမှန်တကယ်အသုံးချနိုင်သော ဒေတာပေါင်းစည်းမှု ပုံစံများ
- ✅ လုပ်ငန်းလုပ်ငန်းစဉ်များကို အလိုအလျောက်လုပ်ဆောင်နိုင်သော task များ ဖန်တီးခြင်း
- ✅ Azure AI Foundry integration နှင့် hybrid deployment strategies
- ✅ စွမ်းဆောင်ရည် စောင့်ကြည့်ခြင်းနှင့် အဆင့်မြှင့်တင်ခြင်း

### အခန်း ၃ အတွက် ပြင်ဆင်မှုများ: Open-Source Models

1. **Hugging Face ကို ရှာဖွေပါ**: အကောင့်တစ်ခု ဖန်တီးပြီး model catalog ကို browse လုပ်ပါ
2. **Model Mondays ကို ပြန်လည်သုံးသပ်ပါ**: [Model Mondays series](https://aka.ms/model-mondays) ကို ကြည့်ပါ
3. **Custom Models ကို စီစဉ်ပါ**: သင့် use cases များအတွက် အထူးပြုမော်ဒယ်များ ဘယ်လိုအကျိုးရှိမည်ကို စဉ်းစားပါ

### ထပ်ဆောင်း အရင်းအမြစ်များ

- [Azure AI Foundry Documentation](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Foundry Local GitHub Repository](https://github.com/microsoft/Foundry-Local)
- [Advanced Prompt Engineering Guide](https://platform.openai.com/docs/guides/prompt-engineering)
- [Business Process Automation Best Practices](https://docs.microsoft.com/en-us/power-automate/)

သင်သည် ယခုအခါ local inference ၏ စွမ်းရည်နှင့် cloud-scale စွမ်းရည်များကို ပေါင်းစည်းထားသော အဆင့်မြင့် AI ဖြေရှင်းချက်များ ဖန်တီးရန် အသင့်ဖြစ်ပြီး လုပ်ငန်းအဆင့် AI အက်ပလီကေးရှင်းများအတွက် အခြေခံကို တည်ဆောက်ထားပါပြီ။
