...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T02:21:36+00:00",
  "source_file": "Module08/02.AzureAIFoundryIntegration.md",
  "language_code": "my"
}
-->
# အခန်း ၂: OpenAI SDK ကို Azure AI Foundry နှင့် ပေါင်းစည်းခြင်း

## အကျဉ်းချုပ်

Foundry Local အခြေခံပညာကို အခြေခံပြီး ဒီအခန်းမှာ Microsoft Foundry Local နဲ့ Azure OpenAI နှစ်ခုလုံးကို ပေါင်းစည်းနိုင်တဲ့ အဆင့်မြင့် OpenAI SDK ပုံစံများကို လေ့လာပါမယ်။ သင့်ရဲ့ AI အက်ပလီကေးရှင်းတွေကို လိုအပ်တဲ့အခါမှာ Cloud မှာ အဆင့်မြှင့်နိုင်ပြီး Privacy နဲ့ Development အတွက် Local မှာ အလွယ်တကူ လုပ်ဆောင်နိုင်အောင် တည်ဆောက်ပေးမယ်။

## သင်ယူရမည့် ရည်မှန်းချက်များ

ဒီအခန်းပြီးဆုံးချိန်မှာ သင်:
- Foundry Local နဲ့ Azure OpenAI နှစ်ခုလုံးအတွက် အဆင့်မြင့် OpenAI SDK ပေါင်းစည်းမှုကို ကျွမ်းကျင်စွာ လုပ်နိုင်မယ်
- အသုံးပြုသူအတွေ့အကြုံကို မြှင့်တင်ပေးမယ့် Streaming Responses ကို အကောင်အထည်ဖော်နိုင်မယ်
- Multi-provider ကို ပံ့ပိုးပေးနိုင်တဲ့ Client Factory Patterns ကို တည်ဆောက်နိုင်မယ်
- Context ကို ထိန်းသိမ်းထားတဲ့ Conversation Management Systems ကို တည်ဆောက်နိုင်မယ်
- Performance Benchmarking နဲ့ Health Monitoring ကို အကောင်အထည်ဖော်နိုင်မယ်
- Error Handling မှန်ကန်တဲ့ Production-ready Applications ကို Deploy လုပ်နိုင်မယ်

## ကြိုတင်လိုအပ်ချက်များ

- အခန်း ၁: Foundry Local ကို စတင်အသုံးပြုခြင်းကို ပြီးစီးထားရမယ်
- Foundry Local ကို အလုပ်လုပ်နေတဲ့ Models နဲ့တင်ထားရမယ်
- Python 3.8 သို့မဟုတ် အထက်ရှိ Virtual Environment အစွမ်းသတ္တိရှိရမယ်
- OpenAI Python SDK (`pip install openai foundry-local-sdk`) ကို တင်ထားရမယ်
- Azure OpenAI Service ပါဝင်တဲ့ Azure Account (Cloud Scenario အတွက် Optional)
- Python async/await Patterns အခြေခံကို နားလည်ထားရမယ်

## အပိုင်း ၁: OpenAI SDK Client Factory Pattern

### Multi-Provider Architecture ကို နားလည်ခြင်း

Foundry Local နဲ့ Azure OpenAI နှစ်ခုလုံးအတွက် အလုပ်လုပ်နိုင်တဲ့ Flexible Client Creation Pattern တစ်ခုကို တည်ဆောက်ခြင်း:
...
## အပိုင်း ၂: Streaming Responses နဲ့ အချိန်နှင့်တပြေးညီ အပြန်အလှန်လုပ်ဆောင်မှု

### Streaming Chat Completions ကို အကောင်အထည်ဖော်ခြင်း

Streaming က အသုံးပြုသူအတွေ့အကြုံကို Response တွေကို တစ်စတစ်စ ပြသပေးခြင်းအားဖြင့် ပိုမိုကောင်းမွန်စေပါတယ်:
...
## အပိုင်း ၃: Performance Benchmarking နဲ့ Analysis

### Response Time ကို တိုင်းတာခြင်း

Configurations များအလိုက် Performance ကို တိုင်းတာပြီး နှိုင်းယှဉ်ပါ:
...
### Temperature နဲ့ Parameter Testing
...
## အပိုင်း ၄: Service Health Monitoring နဲ့ Diagnostics
...
## အပိုင်း ၅: Environment Variables နဲ့ Configuration Management

### Environment Variable Reference

Provider နှစ်ခုလုံးအတွက် Configuration Reference အပြည့်အစုံ:
...
## အပိုင်း ၆: လက်တွေ့ လေ့ကျင့်ခန်းများ

### လေ့ကျင့်ခန်း ၁: Multi-Provider SDK Integration

Provider တွေကို အလွယ်တကူ ပြောင်းလဲနိုင်တဲ့ အပြည့်အစုံ Application တစ်ခုကို တည်ဆောက်ပါ:
...
### လေ့ကျင့်ခန်း ၂: Advanced Conversation Management
...
### လေ့ကျင့်ခန်း ၃: Production-Ready Health Monitoring
...
## အပိုင်း ၇: အကျဉ်းချုပ်နဲ့ နောက်တစ်ဆင့်များ

### အခန်းတွင် ရရှိထားသော အကျိုးကျေးဇူးများ

ဒီအခန်းမှာ သင် ကျွမ်းကျင်ထားတာတွေက:
- ✅ **OpenAI SDK Integration**: Foundry Local နဲ့ Azure OpenAI နှစ်ခုလုံးအတွက် အဆင့်မြင့်ပုံစံများ
- ✅ **Streaming Responses**: အသုံးပြုသူအတွေ့အကြုံကို မြှင့်တင်ပေးတဲ့ Real-time Chat Completions
- ✅ **Multi-Provider Support**: Local နဲ့ Cloud AI Services အကြား Seamless Switching
- ✅ **Conversation Management**: Context-aware Multi-turn Conversations
- ✅ **Performance Monitoring**: Production Deployments အတွက် Benchmarking နဲ့ Health Checking
- ✅ **Production Patterns**: Error Handling နဲ့ Configuration Management
...
### Best Practices အကျဉ်းချုပ်

1. **🔄 Always Implement Fallbacks**: Azure → Foundry Local → Error handling
2. **🌊 Use Streaming for Long Responses**: Better perceived performance
3. **🛡️ Implement Comprehensive Error Handling**: User-friendly error messages
4. **📈 Monitor Performance**: Track response times and success rates
5. **⚙️ Environment-Based Configuration**: Easy switching between dev/staging/prod
6. **🔒 Secure Credential Management**: Never hardcode API keys
...
### Session 3 အတွက် ပြင်ဆင်ခြင်း: Open-Source Models

1. **Explore Model Catalog**: Foundry Local မှာ ရရှိနိုင်တဲ့ Models တွေကို ပြန်လည်သုံးသပ်ပါ
2. **Understand Model Formats**: ONNX, Quantization နဲ့ Optimization အကြောင်းကို လေ့လာပါ
3. **Consider Custom Models**: Domain-specific Model လိုအပ်ချက်တွေကို စဉ်းစားပါ
...
- **[OpenAI Python SDK Documentation](https://github.com/openai/openai-python)**: Official SDK reference
- **[Azure OpenAI Documentation](https://learn.microsoft.com/azure/ai-services/openai/)**: Azure OpenAI service guide
- **[Foundry Local SDK Reference](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Local inference documentation
- **[Streaming Completions Guide](https://learn.microsoft.com/azure/ai-foundry/foundry-local/how-to/integrate-with-inference-sdks)**: Advanced streaming patterns
- **[Sample 01: Quick Chat via OpenAI SDK](samples/01/README.md)**: Basic integration patterns
- **[Sample 02: Advanced SDK Integration](samples/02/README.md)**: This session's hands-on examples
- **[Sample 04: Chainlit Application](samples/04/README.md)**: Web UI development
- **[Sample 05: Multi-Agent Systems](samples/05/README.md)**: Advanced orchestration patterns

သင်ဟာ Local နဲ့ Cloud AI အစွမ်းသတ္တိတွေကို ပေါင်းစည်းပြီး အဆင့်မြင့် AI Applications တွေကို တည်ဆောက်နိုင်ဖို့ အဆင်သင့်ဖြစ်နေပါပြီ။ Use Case တစ်ခုချင်းစီအတွက် Provider ကို ရွေးချယ်နိုင်တဲ့ Flexible Development Patterns တွေကို ထိန်းသိမ်းထားနိုင်ပါတယ်။
