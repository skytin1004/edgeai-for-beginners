...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T23:14:08+00:00",
...
- **Foundry Local**: Installeret og kørende ([Installationsguide](https://learn.microsoft.com/azure/ai-foundry/foundry-local/))
...
- **Browser**: Moderne webbrowser med WebGPU-understøttelse (Chrome/Edge)
...
|--------|-----------------|---------------------|
| **Forsinkelse** | 🚀 50-200ms (ingen netværk) | ⏱️ 200-2000ms (netværksafhængig) |
| **Privatliv** | 🔒 Data forlader aldrig enheden | ⚠️ Data sendes til skyen |
| **Omkostninger** | 💰 Gratis efter hardware | 💸 Betal per token |
...
| `BASE_URL` | Foundry Local endpoint | Automatisk opdaget | `http://localhost:51211` |
...
### Oversigt over Notebook-understøttelse
...
### Trin 1: Tjek WebGPU-understøttelse

**Browserkrav:**
- Chrome/Edge 113+ med WebGPU aktiveret
- Tjek: `chrome://gpu` → bekræft "WebGPU"-status
- Programmeringskontrol: `if (!('gpu' in navigator)) { /* no WebGPU */ }`
...
- ✅ **Chainlit Framework**: Moderne UI og streaming-understøttelse til chatapplikationer
...
- **[Open WebUI Integrationsguide](https://github.com/microsoft/foundry-local/blob/main/docs/tutorials/chat-application-with-open-web-ui.md)**: Officiel tutorial
