...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-24T23:38:23+00:00",
  "source_file": "Module08/samples/10/README.md",
  "language_code": "da"
}
-->
# Foundry Local som værktøjsintegration

En omfattende ramme for integration af Microsoft Foundry Local som kaldbare værktøjer i større applikationer, i overensstemmelse med Microsofts officielle mønstre for værktøjsbaseret AI-integration.

## Oversigt

Dette eksempel viser, hvordan Foundry Local-modeller kan eksponeres som genanvendelige værktøjer, der kan integreres i eksisterende applikationer, arbejdsgange og udviklingsmiljøer. Det fremhæver Microsofts anbefalede mønstre for værktøjsintegration og funktionskald.

## Centrale begreber

### 🔧 **Værktøjs-først arkitektur**
- Foundry Local-modeller som kaldbare funktioner
- Standardiserede værktøjsgrænseflader og skemaer
- Problemfri integration med eksisterende kodebaser
- Type-sikre værktøjsdefinitioner og validering

### ⚡ **Mønstre for funktionskald**
- Microsoft Foundry Local-implementering af funktionskald
- OpenAI-kompatible værktøjsdefinitioner
- Automatisk parametervalidering og konvertering
- Fejlhåndtering og responsformatering

### 🔌 **Integrationsrammer**
- **LangChain Integration**: Indbygget LangChain-værktøjsstøtte
- **Semantic Kernel**: Microsoft Semantic Kernel-funktioner
- **REST API**: HTTP-baserede værktøjsendepunkter
- **CLI-værktøjer**: Integration via kommandolinje
- **Jupyter Notebooks**: Interaktive udviklingsværktøjer

### 🎯 **Anvendelsesmønstre**
- Værktøjer til kodeanalyse og -generering
- Indholdsbehandling og opsummering
...
- **Node.js**: v18+ (til JavaScript-integrationer)
- **Hukommelse**: 12GB+ anbefales
- **Lagring**: 10GB+ til modeller og værktøjer
...
### 1. Grundlæggende værktøjsoprettelse
```python
...
1. **Mønstre for værktøjsintegration**
   - Design af funktionsbaserede og klassebaserede værktøjer
   - Microsoft Foundry Local-integrationsmønstre
   - Skemavalidering og type-sikkerhed
   - Fejlhåndtering og genopretning

2. **Rammeintegration**
   - Udvikling af LangChain-værktøjer
   - Integration af Semantic Kernel-funktioner
   - REST API-rammeintegration
   - Udvikling af CLI-applikationer

3. **Produktionshensyn**
   - Strategier for performanceoptimering
   - Cache og ressourcehåndtering
   - Overvågning og synlighed
   - Sikkerhed og validering

4. **Avancerede værktøjsmønstre**
   - Værktøjssammensætning og kædning
   - Kontekstbevidst behandling
   - Batch- og streamingoperationer
   - Udvikling af brugerdefinerede integrationer

## Næste skridt

- **Integrationsprojekter**: Byg brugerdefinerede integrationer med dine foretrukne rammer
- **Værktøjsudvikling**: Opret specialiserede værktøjer til dit domæne
- **Performanceoptimering**: Optimer til dine specifikke anvendelsestilfælde
- **Produktionsudrulning**: Skaler værktøjer til virksomhedsanvendelse

## Bidrag

Se hovedrepositoryets retningslinjer for instruktioner om bidrag.
