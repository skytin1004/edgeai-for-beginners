...
Et avanceret multi-agent system drevet af Microsoft Foundry Local, der demonstrerer intelligent agentkoordination, specialiseret opgavefordeling og samarbejdsmønstre for problemløsning.

## Oversigt

Denne prøve viser, hvordan man bygger sofistikerede AI-agent systemer ved hjælp af Foundry Local, og implementerer Microsofts officielle mønstre for funktionskald, agentorkestrering og samarbejdende AI-arbejdsgange.
...
- **Problem Solver**: Kompleks ræsonnement, beslutningstagning

### ⚡ **Avanceret Funktionskald**
- Microsoft Foundry Local mønstre for funktionskald
- Type-sikre værktøjsdefinitioner
- Automatisk parametervalidering
- Fejlhåndtering og genopretning
- Værktøjskædning og sammensætning

### 🎯 **Smart Opgaverouting**
- Intentionsklassificering og analyse
- Matchning af agentkapacitet
- Belastningsbalancering og optimering
- Håndtering af fallback og redundans
...
### 1. Grundlæggende Multi-Agent Arbejdsgang
```python
...
### Eksempel 3: Problemløsningssession
```python
...
- **Prøve 10**: Foundry Local som Værktøjsintegration
...
Denne prøve følger samme licens som Microsoft Foundry Local projektet.
