...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-22T20:25:11+00:00",
...
Med udgangspunkt i din Foundry Local-viden fokuserer denne session på at skabe avancerede AI-løsninger gennem avanceret prompt engineering, problemfri dataintegration og automatisering af opgaver. Du lærer at forbinde lokal udvikling med Azure AI Foundry-funktioner og skabe virksomhedsklare applikationer, der udnytter det bedste fra begge verdener.

## Læringsmål

Ved afslutningen af denne session vil du:
- Mestre avancerede teknikker inden for prompt engineering for konsistente og pålidelige AI-svar
- Implementere robuste dataintegrationsmønstre til virkelige applikationer
- Skabe handlingsorienterede AI-opgaver, der skaber forretningsværdi
- Etablere problemfri forbindelse mellem Foundry Local og Azure AI Foundry
- Opbygge workflows til performanceovervågning og optimering
- Udrulle produktionsklare AI-løsninger med korrekt fejlhåndtering og skalering

## Forudsætninger

- Gennemført Session 1: Kom godt i gang med Foundry Local
- Aktiv Foundry Local-installation med kørende modeller
- Azure-konto (gratis niveau er tilstrækkeligt til læring)
- Grundlæggende forståelse af REST API'er og JSON

## Del 1: Avanceret Prompt Engineering

### Forståelse af Prompt Arkitektur

Effektiv prompt engineering er fundamentet for pålidelige AI-applikationer. Foundry Local tilbyder forbedrede muligheder for prompting:
...
### Implementering af Prompt Strategier
...
### Praktiske Eksempler på Prompt Engineering
...
### Eksempel på Dataintegration i Virkeligheden
...
## Del 3: Handlingsorienterede AI-opgaver

### Rammeværk for Opgaveautomatisering
...
### Eksempler på Automatisering af Forretningsprocesser
...
## Del 4: Integration med Azure AI Foundry
...
## Del 5: Performanceovervågning og Optimering

### Omfattende Overvågningssystem
...
### Øvelse 1: Avanceret Kundeservicebot
...
### Øvelse 2: Automatiseret Markedsanalyse
...
## Del 7: Næste Skridt og Forhåndsvisning af Session 3

### Sessionens Resultater

I denne session har du mestret:
- ✅ Avancerede teknikker inden for prompt engineering for konsistent AI-adfærd
- ✅ Robuste dataintegrationsmønstre til virkelige applikationer
- ✅ Automatiseret opgaveoprettelse til optimering af forretningsprocesser
- ✅ Integration med Azure AI Foundry og hybrid udrulningsstrategier
- ✅ Omfattende performanceovervågning og optimering

### Forberedelse til Session 3: Open-Source Modeller

1. **Udforsk Hugging Face**: Opret en konto og gennemse modelkataloget
2. **Gennemgå Model Mondays**: Tjek den seneste [Model Mondays-serie](https://aka.ms/model-mondays)
3. **Planlæg Specialtilpassede Modeller**: Overvej, hvilke specialiserede modeller der vil gavne dine anvendelsesscenarier
...
- [Avanceret Prompt Engineering Guide](https://platform.openai.com/docs/guides/prompt-engineering)
- [Best Practices for Automatisering af Forretningsprocesser](https://docs.microsoft.com/en-us/power-automate/)

Du er nu klar til at bygge avancerede AI-løsninger, der kombinerer kraften fra lokal inferens med cloud-skala kapaciteter, og lægge fundamentet for AI-applikationer i virksomhedsklasse.
