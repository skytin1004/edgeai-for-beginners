...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-08T11:50:19+00:00",
...
| [📚 01](../../Module01) | [Основи EdgeAI](./Module01/README.md) | Порівняння хмари та Edge AI | Основи EdgeAI • Реальні кейси • Посібник з реалізації • Розгортання на краю | Початковий | 3-4 год |
...
### 🎓 **Практичний семінар: Навчальний шлях**

Комплексні матеріали практичного семінару з реалізаціями, готовими до виробництва:

- **[Посібник семінару](./Workshop/Readme.md)** - Повні цілі навчання, результати та навігація по ресурсам
...
- **Посібники сесій** - Детальні посібники у форматі markdown для кожної сесії семінару
...
- Інтелектуальний маршрутизатор моделей із вибором на основі завдань
...
### 🎯 Основні компетенції
- **Архітектура Edge AI**: Проектування систем AI з локальним пріоритетом та інтеграцією з хмарою
...
### 🏗️ Практичні проекти
- **Додатки Foundry Local Chat**: Нативний додаток для Windows 11 із перемиканням моделей
- **Системи мультиагентів**: Координатор зі спеціалізованими агентами для складних робочих процесів  
- **RAG-додатки**: Локальна обробка документів із пошуком векторами
- **Маршрутизатори моделей**: Інтелектуальний вибір між моделями на основі аналізу завдань  
- **Фреймворки API**: Готові до виробництва клієнти зі стрімінгом і моніторингом стану  
...
0. **📖 Вступ** ([Introduction.md](./introduction.md)): Основи EdgeAI + контекст індустрії + навчальна структура  
...
**Сектори індустрії**: Виробництво 4.0 • Технології охорони здоров'я • Автономні системи • FinTech • Споживча електроніка  

**Проекти для портфоліо**: Системи з багатьма агентами • Виробничі RAG-додатки • Кросплатформне розгортання • Оптимізація продуктивності  
...
📖 **[Доступний навчальний посібник](STUDY_GUIDE.md)**: Структурований 20-годинний навчальний шлях із рекомендаціями щодо розподілу часу та інструментами самооцінки.  
...
- [Генеративний AI для початківців за допомогою JavaScript](https://github.com/microsoft/generative-ai-with-javascript?WT.mc_id=academic-105485-koreyst)  
