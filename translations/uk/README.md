...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-18T21:20:10+00:00",
...
Цей курс проведе вас від основних концепцій до готових до виробництва реалізацій, охоплюючи:
...
Edge AI означає виконання алгоритмів AI і мовних моделей локально на апаратному забезпеченні — близько до місця генерації даних — без залежності від хмарних ресурсів для інференції. Це зменшує затримку, покращує конфіденційність і дозволяє приймати рішення в реальному часі.
...
- **Суверенітет даних**: Збереження чутливих даних локально, покращуючи безпеку та відповідність

### Малі мовні моделі (SLM)

SLM, такі як Phi-4, Mistral-7B і Gemma, є оптимізованими версіями великих LLM — навченими або дистильованими для:
...
- [**Розділ 1: Основи EdgeAI**](./Module01/01.EdgeAIFundamentals.md)
  ...
  - Виклики та обмеження обчислень на краю
  - Ключові технології: квантування моделей, оптимізація стиснення, малі мовні моделі (SLM)
...
- [**Розділ 2: Реальні кейси**](./Module01/02.RealWorldCaseStudies.md)
  ...
  - Кейси використання AI в Japan Airlines
...
- [**Розділ 4: Апаратні платформи для розгортання Edge AI**](./Module01/04.EdgeDeployment.md)
  ...
  - NVIDIA Jetson та платформи обчислень на краю
  - Платформи Windows AI для ПК з прискоренням NPU
...
- [**Розділ 1: Основи сімейства моделей Microsoft Phi**](./Module02/01.PhiFamily.md)
  ...
  - Спеціалізовані можливості (логічне мислення, мультимодальність, розгортання на краю)

- [**Розділ 2: Основи сімейства моделей Qwen**](./Module02/02.QwenFamily.md)
  - Відкритий код (Qwen 1.0 до Qwen3) – доступний через Hugging Face
  - Розширена архітектура логічного мислення з можливостями режиму мислення
  - Масштабовані варіанти розгортання (0.5B-235B параметрів)

- [**Розділ 3: Основи сімейства моделей Gemma**](./Module02/03.GemmaFamily.md)
  - Інновації, орієнтовані на дослідження (Gemma 3 & 3n)
  - Мультимодальна досконалість
  - Архітектура, орієнтована на мобільні пристрої

- [**Розділ 4: Основи сімейства моделей BitNET**](./Module02/04.BitNETFamily.md)
...
- [**Розділ 5: Основи моделі Microsoft Mu**](./Module02/05.mumodel.md)
  - Архітектура, орієнтована на пристрої, вбудована в Windows 11
  - Інтеграція з налаштуваннями Windows 11
  - Офлайн-операція з збереженням конфіденційності

- [**Розділ 6: Основи Phi-Silica**](./Module02/06.phisilica.md)
  - Архітектура, оптимізована для NPU, вбудована в ПК Windows 11 Copilot+
...
**Тема**: Повний цикл розгортання SLM, від теорії до виробничого середовища
...
- [**Розділ 1: Розширене навчання SLM**](./Module03/01.SLMAdvancedLearning.md)
  ...
  - Розширені техніки оптимізації (методи квантування, BitNET 1-бітове квантування)
...
- [**Розділ 3: Контейнеризоване хмарне розгортання**](./Module03/03.DeployingSLMinCloud.md)
  ...
  - Оптимізована реалізація ONNX Runtime для краю

---

### [Модуль 04: Конвертація формату моделі та квантування](./Module04/README.md)
**Тема**: Повний набір інструментів оптимізації моделі для розгортання на краю на різних платформах
...
- [**Розділ 1: Основи конвертації формату моделі та квантування**](./Module04/01.Introduce.md)
  ...
  - Переваги формату GGUF та ONNX і випадки використання
...
- [**Розділ 2: Посібник з реалізації Llama.cpp**](./Module04/02.Llamacpp.md)
  ...
  - Конверсія у формат GGUF та рівні квантування (Q2_K до Q8_0)
  - Апаратне прискорення (CUDA, Metal, OpenCL, Vulkan)
  - Інтеграція з Python та розгортання REST API

- [**Розділ 3: Набір оптимізації Microsoft Olive**](./Module04/03.MicrosoftOlive.md)
  - Оптимізація моделей з урахуванням апаратного забезпечення з понад 40 вбудованими компонентами
  - Автоматична оптимізація з динамічним і статичним квантуванням
  - Інтеграція в корпоративні робочі процеси Azure ML
  - Підтримка популярних моделей (Llama, Phi, вибрані моделі Qwen, Gemma)

- [**Розділ 4: Набір оптимізації OpenVINO Toolkit**](./Module04/04.openvino.md)
...
- [**Розділ 5: Глибокий аналіз фреймворку Apple MLX**](./Module04/05.AppleMLX.md)
  - Єдина архітектура пам’яті для Apple Silicon
  - Підтримка LLaMA, Mistral, Phi-3, вибраних моделей Qwen
  - Тонке налаштування LoRA та кастомізація моделей
  - Інтеграція з Hugging Face із квантуванням 4-біт/8-біт
...
- [**Розділ 6: Синтез робочого процесу розробки Edge AI**](./Module04/06.workflow-synthesis.md)
  ...
  - Стратегії майбутнього розвитку для нових апаратних засобів і архітектур моделей
...
- [**Розділ 1: Вступ до SLMOps**](./Module05/01.IntroduceSLMOps.md)
  ...
  - Виклики реального впровадження та рішення

- [**Розділ 2: Дистиляція моделі - від теорії до практики**](./Module05/02.SLMOps-Distillation.md)
...
### [Модуль 06: Агентні системи SLM - AI-агенти та виклик функцій](./Module06/README.md)
**Тема**: Реалізація агентних систем SLM від основ до розширеного виклику функцій та інтеграції протоколу контексту моделі (MCP)
...
- [**Розділ 1: AI-агенти та основи малих мовних моделей**](./Module06/01.IntroduceAgent.md)
  ...
  - Основи SLM та стратегії оптимізації (GGUF, квантування, edge-фреймворки)
  - Аналіз компромісів SLM проти LLM (зниження витрат на 10-30×, ефективність завдань 70-80%)
...
- [**Розділ 2: Виклик функцій у малих мовних моделях**](./Module06/02.FunctionCalling.md)
  - Реалізація системного робочого процесу (виявлення намірів, JSON-вивід, зовнішнє виконання)
...
- [**Розділ 3: Інтеграція протоколу контексту моделі (MCP)**](./Module06/03.IntroduceMCP.md)
...
- [**EdgeAI на NVIDIA Jetson Orin Nano**](./Module07/README.md#1-edgeai-in-nvidia-jetson-orin-nano)
  - AI-продуктивність 67 TOPS у форм-факторі розміром із кредитну картку
...
- [**EdgeAI у мобільних додатках із .NET MAUI та ONNX Runtime GenAI**](./Module07/README.md#2-edgeai-in-mobile-applications-with-net-maui-and-onnx-runtime-genai)
  - Кросплатформовий мобільний AI із єдиною кодовою базою на C#
...
- [**EdgeAI в Azure із двигуном малих мовних моделей**](./Module07/README.md#3-edgeai-in-azure-with-small-language-models-engine)
  ...
  - Інтеграція Azure AI services із ONNX Runtime
...
- [**EdgeAI із Windows ML**](./Module07/README.md#4-edgeai-with-windows-ml)
  ...
  - Єдиний фреймворк для різноманітної екосистеми апаратного забезпечення Windows

- [**EdgeAI із локальними додатками Foundry**](./Module07/README.md#5-edgeai-with-foundry-local-applications)
  - Реалізація RAG із фокусом на конфіденційність із локальними ресурсами
  - Інтеграція мовної моделі Phi-3 із семантичним пошуком (лише моделі Phi)
  - Підтримка локальних векторних баз даних (SQLite, Qdrant)
  - Можливості суверенітету даних та роботи в офлайн-режимі

## Цілі навчання курсу

Завершивши цей комплексний курс EdgeAI, ви здобудете експертизу в проектуванні, реалізації та розгортанні готових до виробництва рішень EdgeAI. Наша структурована програма забезпечує освоєння як теоретичних основ, так і практичних навичок реалізації.

### Технічні компетенції

**Базові знання**
- Розуміння фундаментальних відмінностей між архітектурами AI на основі хмари та edge
- Оволодіння принципами квантування, стиснення та оптимізації моделей для середовищ із обмеженими ресурсами
...
- Проектування масштабованих архітектур EdgeAI для корпоративних застосувань
...
- Оцінка можливостей EdgeAI та визначення відповідних варіантів використання для бізнес-застосувань
...
**Архітектура системи**
- Проектування комплексних рішень EdgeAI, які інтегруються з існуючою інфраструктурою
- Планування гібридних архітектур хмара-edge для оптимальної продуктивності та ефективності витрат
...
- Розуміння фундаментальних відмінностей між архітектурами AI на основі хмари та edge
- Оволодіння основними техніками оптимізації для розгортання на edge
...
- Оволодіння стратегічними навичками прийняття рішень на основі обмежень обчислень та вимог до продуктивності
- Усвідомлення компромісів гнучкості розгортання
- Набуття перспективних знань про ефективну архітектуру AI

### Результати навчання модуля 03:
- Стратегічні навички вибору моделей
- Оволодіння техніками оптимізації
- Майстерність гнучкості розгортання
- Навички конфігурації готових до виробництва рішень
...
- Оволодіння оптимізацією апаратного забезпечення Intel за допомогою OpenVINO та NNCF
- Навички вибору оптимізації з урахуванням апаратного забезпечення на різних платформах
- Навички розгортання у виробництві для кросплатформових середовищ edge-комп’ютингу
- Стратегічний вибір фреймворків та синтез робочих процесів для оптимальних рішень Edge AI

### Результати навчання модуля 05:
- Оволодіння парадигмою SLMOps та принципами операцій
- Реалізація дистиляції моделей для передачі знань та оптимізації ефективності
- Застосування технік тонкого налаштування для кастомізації моделей під конкретні домени
- Розгортання готових до виробництва рішень SLM із стратегіями моніторингу та обслуговування

### Результати навчання модуля 06:
- Розуміння основних концепцій AI-агентів та архітектури малих мовних моделей
- Оволодіння реалізацією виклику функцій на різних платформах та фреймворках
- Інтеграція протоколу контексту моделі (MCP) для стандартизованої взаємодії із зовнішніми інструментами
- Побудова складних агентних систем із мінімальними вимогами до людського втручання

### Результати навчання модуля 07:
- Оволодіння AI Toolkit для Visual Studio Code для комплексних робочих процесів розробки Edge AI
- Набуття експертизи у платформі Windows AI Foundry та стратегі
Цей курс ставить вас на передову впровадження технологій штучного інтелекту, де інтелектуальні можливості безперешкодно інтегруються в пристрої та системи, які забезпечують сучасне життя.
...
- **Прогресивне навчання**: Поступовий перехід від базових концепцій до складного впровадження
- **Інтеграція теорії та практики**: Кожен модуль містить як теоретичні основи, так і практичні операції
- **Реальні кейси**: Засновані на реальних прикладах від Microsoft, Alibaba, Google та інших
- **Практичні завдання**: Завершені конфігураційні файли, процедури тестування API та скрипти для впровадження
- **Оцінка продуктивності**: Детальні порівняння швидкості виконання, використання пам’яті та вимог до ресурсів
- **Рівень підприємства**: Практики безпеки, рамки відповідності та стратегії захисту даних
...
3. Вивчіть **Module03**, щоб опанувати практичні навички впровадження
4. Продовжіть з **Module04** для оптимізації моделей, конвертації форматів та синтезу фреймворків
5. Завершіть **Module05**, щоб освоїти SLMOps для готових до виробництва впроваджень
6. Досліджуйте **Module06**, щоб зрозуміти агентні системи SLM та можливості виклику функцій
7. Завершіть **Module07**, щоб отримати практичний досвід з AI Toolkit та різноманітними прикладами впровадження EdgeAI

Кожен модуль розроблений як самодостатній, але послідовне навчання забезпечить найкращі результати.
...
- **Ідеї для міні-проектів**: Практичні застосування для закріплення знань
...
**Майбутнє EdgeAI полягає у постійному вдосконаленні архітектур моделей, технік квантування та стратегій впровадження, які надають пріоритет ефективності та спеціалізації над універсальними можливостями. Організації, які приймуть цю зміну парадигми, будуть добре підготовлені до використання трансформаційного потенціалу штучного інтелекту, зберігаючи контроль над своїми даними та операціями.**
