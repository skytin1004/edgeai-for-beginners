...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T02:28:31+00:00",
...
Ласкаво просимо до **EdgeAI для початківців** – вашої всебічної подорожі у світ Edge штучного інтелекту. Цей курс об'єднує потужні можливості AI з практичним впровадженням на пристроях, дозволяючи використовувати потенціал AI безпосередньо там, де генерується дані та приймаються рішення.
...
SLM, такі як Phi-4, Mistral-7B і Gemma, є оптимізованими версіями більших LLM, які були навчені або дистильовані для:
...
| [💻 07](../../Module07) | [Реалізація на платформах](./Module07/README.md) | Зразки для різних платформ | Інструментарій AI • Foundry Local • Розробка для Windows | Високий | 3-4 год |
...
- [03: Відкриття моделей та тестування продуктивності](./Module08/samples/03/README.md)  
...
- [08: Додаток для чату Windows 11](./Module08/samples/08/README.md)  
...
### 🏗️ Практичні проекти
- **Додатки Foundry Local Chat**: Нативний додаток для Windows 11 з перемиканням моделей  
...
## Вплив на кар'єру
**Технічні ролі**: Архітектор рішень EdgeAI • Інженер ML (Edge) • Розробник IoT AI • Розробник Mobile AI

**Сектори промисловості**: Виробництво 4.0 • Технології охорони здоров’я • Автономні системи • FinTech • Споживча електроніка

**Портфоліо проєктів**: Системи з багатьма агентами • Продуктивні RAG-додатки • Кросплатформенне розгортання • Оптимізація продуктивності
...
✅ **Фокус на продуктивність**: 85% покращення швидкості, 75% зменшення розміру  
✅ **Багатоплатформеність**: Windows, мобільні пристрої, вбудовані системи, гібридні хмарно-периферійні рішення  
✅ **Готовність до виробництва**: Моніторинг, масштабування, безпека, рамки відповідності

📖 **[Доступний навчальний посібник](STUDY_GUIDE.md)**: Структурований 20-годинний навчальний план із рекомендаціями щодо розподілу часу та інструментами для самооцінки.

---

**EdgeAI представляє майбутнє розгортання AI**: локально-орієнтоване, конфіденційне та ефективне. Опановуйте ці навички, щоб створювати наступне покоління інтелектуальних додатків.
