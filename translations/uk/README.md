...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-26T10:13:16+00:00",
...
SLM, такі як Phi-4, Mistral-7B і Gemma, є оптимізованими версіями великих мовних моделей, які були навчені або дистильовані для:
...
- **Додатки RAG**: Локальна обробка документів з пошуком вектора  
- **Маршрутизатори моделей**: Інтелектуальний вибір між моделями на основі аналізу завдань  
- **Фреймворки API**: Готові до виробництва клієнти зі стрімінгом та моніторингом стану  
...
**Технічні ролі**: Архітектор рішень EdgeAI • Інженер машинного навчання (Edge) • Розробник IoT AI • Розробник мобільного AI  

**Сектори індустрії**: Виробництво 4.0 • Технології охорони здоров'я • Автономні системи • FinTech • Споживча електроніка  

**Портфоліо проєктів**: Системи з багатьма агентами • RAG-додатки для виробництва • Кросплатформенне розгортання • Оптимізація продуктивності  
...
**EdgeAI — це майбутнє розгортання штучного інтелекту**: локальне, збереження конфіденційності та ефективне. Опануйте ці навички, щоб створювати наступне покоління інтелектуальних додатків.
...
- [Штучний інтелект для початківців](https://aka.ms/ai-beginners?WT.mc_id=academic-105485-koreyst)  
