...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-10-01T01:54:16+00:00",
...
- Зрозуміти кеш моделей і шаблони локального зберігання
- Навчитися швидко тестувати та порівнювати різні моделі
- Встановити практичні робочі процеси для вибору моделей і тестування продуктивності
- Дослідити зростаючу екосистему моделей, доступних через Foundry Local

## Попередні вимоги

- Завершена Сесія 1: Початок роботи з Foundry Local
- Встановлений і доступний CLI Foundry Local
- Достатньо місця для зберігання моделей (розмір моделей може варіюватися від 1 ГБ до 20 ГБ+)
- Базове розуміння типів моделей і їх застосування

## Огляд

Ця сесія досліджує, як інтегрувати моделі з відкритим кодом у Foundry Local.

## Частина 6: Практичне завдання

### Завдання: Відкриття та порівняння моделей
...
## Частина 7: Вирішення проблем і найкращі практики
...
- Оновіть оперативну пам'ять, якщо часто виникають обмеження
...
4. **Консистентне тестування**: Використовуйте однакові запити для справедливого порівняння
...
- **Попередні вимоги**: Впевнене перемикання між моделями та базове тестування продуктивності
...
✅ **Моніторинг продуктивності**: Базове використання ресурсів і вимірювання часу відповіді  
...
Тепер у вас є практичні навички для відкриття, тестування та вибору відповідних моделей для ваших AI-застосувань за допомогою простого CLI-підходу Foundry Local: вибір моделей спільноти, інтеграція контенту Hugging Face і використання стратегій "принеси свою модель" (BYOM). Ви також відкриєте для себе серію Model Mondays для безперервного навчання та відкриття моделей.
...
CLI Foundry надає прості команди для відкриття та управління моделями:
...
**Середні моделі:**
- `qwen2.5-7b`: Відмінне логічне мислення та довший контекст
- `deepseek-r1-7b`: Оптимізована для генерації коду

**Великі моделі:**
- `llama-3.2`: Остання модель з відкритим кодом від Meta
- `qwen2.5-14b`: Рівень підприємства для логічного мислення

## Частина 2: Швидке тестування та порівняння моделей

### Підхід Зразка 03: Простий список і тестування
...
Після запуску моделі протестуйте її за допомогою консистентних запитів:
...
## Частина 3: Управління кешем і зберіганням моделей

### Розуміння кешу моделей

Foundry Local автоматично управляє завантаженням і кешуванням моделей:
...
### Розгляди щодо зберігання моделей
...
- Слідкуйте за використанням пам'яті (моделі залишаються завантаженими в ОЗП)
- Моніторинг використання ЦП під час виконання запитів
...
- Розширений варіант: `qwen2.5-7b` (довший контекст)

**Для генерації коду:**
- Рекомендовано: `deepseek-r1-7b`
- Альтернатива: `qwen2.5-7b` (також добре для коду)

**Для складного логічного мислення:**
- Найкраще: `qwen2.5-7b` або `qwen2.5-14b`
- Бюджетний варіант: `phi-4`

### Керівництво щодо апаратних вимог
...
- 32 ГБ+ ОЗП для комфортного перемикання між моделями
- SSD для швидшого завантаження моделей
- Сучасний ЦП з хорошою продуктивністю на одному ядрі
...
Для кожної моделі протестуйте її за допомогою консистентних запитів і оцініть вручну:
...
- Підготуйтеся до Сесії 4: порівняння LLMs vs SLMs, локального vs хмарного використання, та практичних демонстрацій
