...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T02:30:15+00:00",
...
- **Розробляти AI-агентів**: Створювати інтелектуальних агентів із можливостями обґрунтування та оркестрації
...
**Приклад**: [Оркестрація кількох агентів](./samples/05/README.md) • [Складна система кількох агентів](./samples/09/README.md)
...
**Фокус**: Модульні AI-рішення, масштабування для підприємств та шаблони виробництва
...
**Фокус**: Чиста інтеграція REST API без залежностей від SDK для максимального контролю
...
**Фокус**: Координація агентів, спеціалізоване делегування завдань та спільні AI робочі процеси
...
**Приклад**: [Складна система кількох агентів](./samples/09/README.md)
...
- **Інтегрувати моделі**: Працювати з різноманітними сімействами моделей від Microsoft, Hugging Face та спільноти
- **Створювати додатки**: Розробляти готові до виробництва AI-додатки з розширеними функціями та оптимізаціями
- **Розробляти агентів**: Реалізовувати складних AI-агентів із обґрунтуванням, логікою та інтеграцією інструментів

### Стратегічне розуміння
- **Рішення щодо архітектури**: Приймати обґрунтовані рішення між локальним та хмарним розгортанням
- **Оптимізація продуктивності**: Оптимізувати продуктивність виконання моделей на різних апаратних конфігураціях
...
- **Розробка для майбутнього**: Створювати додатки, готові до нових AI-технологій та шаблонів

## Початок роботи

1. **Налаштування середовища**: Переконайтеся, що у вас Windows 11 з рекомендованим апаратним забезпеченням (див. Попередні вимоги)
...
- [ ] Реалізувати складну систему кількох агентів (Приклад 09)
...
@@CODE
Цей модуль представляє передові досягнення в розробці Edge AI, поєднуючи корпоративні інструменти Microsoft із гнучкістю та інноваціями відкритого програмного забезпечення. Опановуючи Foundry Local через всі 10 детальних прикладів, ви станете лідером у розробці AI-додатків.
...
Для інтеграції Azure OpenAI (Сесія 2) перегляньте README-файли окремих прикладів для необхідних змінних середовища та налаштувань версії API.
