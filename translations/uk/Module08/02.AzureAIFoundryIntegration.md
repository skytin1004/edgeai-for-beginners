...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T01:17:16+00:00",
...
Спираючись на ваші знання з Foundry Local, ця сесія зосереджена на створенні складних AI-рішень через вдосконалене проектування запитів, безшовну інтеграцію даних та автоматизацію завдань. Ви навчитеся поєднувати локальну розробку з можливостями Azure AI Foundry, створюючи готові до використання в бізнесі додатки, які об'єднують найкраще з обох світів.

## Цілі навчання

До кінця цієї сесії ви зможете:
- Опановувати вдосконалені техніки проектування запитів для отримання стабільних і надійних відповідей AI
- Реалізовувати надійні шаблони інтеграції даних для реальних застосувань
- Створювати дієві AI-завдання, які приносять бізнес-цінність
- Налагоджувати безшовне з'єднання між Foundry Local та Azure AI Foundry
- Будувати робочі процеси моніторингу продуктивності та оптимізації
- Розгортати AI-рішення, готові до використання в продакшені, з належною обробкою помилок і масштабуванням

## Попередні вимоги

- Завершена Сесія 1: Початок роботи з Foundry Local
- Активна установка Foundry Local з працюючими моделями
- Обліковий запис Azure (достатньо безкоштовного рівня для навчання)
- Базове розуміння REST API та JSON

## Частина 1: Вдосконалене проектування запитів

### Розуміння архітектури запитів

Ефективне проектування запитів є основою надійних AI-додатків. Foundry Local пропонує розширені можливості для створення запитів:
...
### Практичні приклади проектування запитів
...
## Частина 2: Шаблони інтеграції даних

### Конектори даних Foundry Local
...
### Приклад інтеграції даних у реальному світі
...
## Частина 3: Дієві AI-завдання

### Фреймворк автоматизації завдань
...
## Частина 4: Інтеграція з Azure AI Foundry
...
## Частина 5: Моніторинг продуктивності та оптимізація
...
### Вправа 1: Вдосконалений бот для обслуговування клієнтів
...
### Вправа 2: Автоматизоване дослідження ринку
...
## Частина 7: Наступні кроки та попередній перегляд Сесії 3

### Досягнення сесії

У цій сесії ви опанували:
- ✅ Вдосконалені техніки проектування запитів для стабільної поведінки AI
- ✅ Надійні шаблони інтеграції даних для реальних застосувань
- ✅ Автоматизоване створення завдань для оптимізації бізнес-процесів
- ✅ Інтеграцію з Azure AI Foundry та гібридні стратегії розгортання
- ✅ Комплексний моніторинг продуктивності та оптимізацію

### Підготовка до Сесії 3: Моделі з відкритим кодом

1. **Досліджуйте Hugging Face**: Створіть обліковий запис і перегляньте каталог моделей
2. **Ознайомтеся з Model Mondays**: Перегляньте останню серію [Model Mondays](https://aka.ms/model-mondays)
3. **Плануйте власні моделі**: Розгляньте, які спеціалізовані моделі можуть бути корисними для ваших випадків використання

### Додаткові ресурси

- [Документація Azure AI Foundry](https://learn.microsoft.com/en-us/azure/ai-foundry/)
- [Репозиторій Foundry Local на GitHub](https://github.com/microsoft/Foundry-Local)
- [Посібник з вдосконаленого проектування запитів](https://platform.openai.com/docs/guides/prompt-engineering)
- [Найкращі практики автоматизації бізнес-процесів](https://docs.microsoft.com/en-us/power-automate/)

Тепер ви готові створювати складні AI-рішення, які поєднують потужність локального інференсу з можливостями хмарного масштабу, закладаючи основу для AI-додатків корпоративного рівня.
