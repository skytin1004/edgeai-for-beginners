...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T00:41:20+00:00",
...
Microsoft Olive yra galingas ir lengvai naudojamas įrankis, skirtas modelių optimizavimui, atsižvelgiant į aparatūros ypatybes. Jis supaprastina mašininio mokymosi modelių optimizavimo procesą, kad jie būtų pritaikyti įvairioms aparatūros platformoms. Nesvarbu, ar taikote procesoriams, grafikos plokštėms, ar specializuotiems AI akceleratoriams, Olive padeda pasiekti optimalų našumą išlaikant modelio tikslumą.

## Kas yra Microsoft Olive?

Olive yra lengvai naudojamas įrankis, skirtas modelių optimizavimui, kuris apjungia pažangiausias technologijas modelių suspaudimo, optimizavimo ir kompiliavimo srityse. Jis veikia kartu su ONNX Runtime kaip pilnas sprendimas inferencijos optimizavimui.

### Pagrindinės savybės

- **Optimizavimas pagal aparatūrą**: Automatiškai parenka geriausius optimizavimo metodus pagal jūsų tikslinę aparatūrą
...
- **Daugiaplatforminis palaikymas**: Veikia su PyTorch, Hugging Face modeliais ir ONNX
- **Populiarių modelių palaikymas**: Olive gali automatiškai optimizuoti populiarias modelių architektūras, tokias kaip Llama, Phi, Qwen, Gemma ir kt.
...
- **Kryžminė platformų diegimo galimybė**: Optimizuoti modeliai veikia skirtingose aparatūrose ir operacinėse sistemose
...
### Pasirinktinės priklausomybės

Olive siūlo įvairias pasirinktines priklausomybes papildomoms funkcijoms:
...
Optimizavimo procesas apima: modelio gavimą iš vietinio talpyklos, ONNX grafų užfiksavimą ir svorių saugojimą ONNX duomenų faile, ONNX grafų optimizavimą ir modelio kvantizaciją į int4 naudojant RTN metodą.
...
### 1 žingsnis: Modelio atsisiuntimas (pasirinktinai)
...
### 2 žingsnis: Qwen3 modelio optimizavimas
...
### 3 žingsnis: Optimizuoto modelio testavimas

Sukurkite paprastą Python skriptą, kad išbandytumėte optimizuotą modelį:
...
### 2. Aparatūros apsvarstymai
- Suderinkite optimizavimo tikslą su diegimo aparatūra
- Naudokite GPU optimizavimą, jei turite CUDA suderinamą aparatūrą
...
- Palyginkite našumo metrikas (vėlavimas, pralaidumas, tikslumas)
...
- **VS Code plėtinys**: AI Toolkit for VS Code apžvalga — https://learn.microsoft.com/azure/ai-toolkit/overview
- **Tinklaraščio įrašai**: Microsoft Open Source Blog — https://opensource.microsoft.com/blog/

### Susiję įrankiai
- **ONNX Runtime**: Aukštos kokybės inferencijos variklis — https://onnxruntime.ai/
- **Hugging Face Transformers**: Daugelio suderinamų modelių šaltinis — https://huggingface.co/docs/transformers/index
- **Azure Machine Learning**: Optimizavimo procesai debesyje — https://learn.microsoft.com/azure/machine-learning/
