...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T02:41:00+00:00",
...
- Sukurti praktinius darbo procesus modelių pasirinkimui ir vertinimui
- Tyrinėti augančią modelių ekosistemą per Foundry Local
...
- Pagrindinis modelių tipų ir jų panaudojimo supratimas
...
## 7 dalis: Trikčių šalinimas ir geriausios praktikos
...
**Lėtas našumas:**
- Įsitikinkite, kad modelis pilnai įkeltas (patikrinkite išsamų išvestį)
...
4. **Testuokite nuosekliai**: Naudokite tuos pačius užklausimus sąžiningiems palyginimams
...
- **Rekomenduojama**: Turėti 2-3 mėgstamus modelius, atrinktus iš šios sesijos
...
- **[03 pavyzdys: Modelių atradimas](samples/03/README.md)**: Praktinis scenarijaus pavyzdys

### Pagrindinės išvados

✅ **Modelių atradimas**: Naudokite `foundry model list`, kad peržiūrėtumėte galimus modelius  
✅ **Greitas testavimas**: Naudokite `list_and_bench.cmd` greitam vertinimui  
✅ **Našumo stebėjimas**: Pagrindinis išteklių naudojimo ir atsakymo laiko matavimas  
✅ **Modelių pasirinkimas**: Praktinės gairės modelių pasirinkimui pagal poreikius  
✅ **Talpyklos valdymas**: Suprasti saugojimo ir valymo procedūras  
...
- Taikyti modelių pasirinkimo strategijas pagal tikslumą, vėlavimą ir išteklių poreikius
...
**Vidutiniai modeliai:**
- `qwen2.5-7b-instruct`: Puikus samprotavimas ir ilgesnis kontekstas
- `deepseek-r1-distill-qwen-7b`: Optimizuotas kodo generavimui

**Dideli modeliai:**
- `llama-3.2`: Naujausias Meta atvirojo kodo modelis
- `qwen2.5-14b-instruct`: Įmonės lygio samprotavimas

## 2 dalis: Greitas modelių testavimas ir palyginimas

### 03 pavyzdžio metodas: Paprastas sąrašas ir vertinimas

Remiantis mūsų 03 pavyzdžio metodu, pateikiamas minimalus darbo procesas:
...
Kai modelis veikia, testuokite jį su nuosekliais užklausimais:
...
**Saugojimo geriausios praktikos:**
...
## 4 dalis: Praktinės modelių pasirinkimo gairės

### Modelių pasirinkimas pagal panaudojimą

**Bendram pokalbiui ir klausimams-atsakymams:**
- Pradėkite nuo: `phi-4-mini` (greitas, efektyvus)
- Atnaujinkite į: `phi-4` (geresnis samprotavimas)
- Pažangus pasirinkimas: `qwen2.5-7b-instruct` (ilgesnis kontekstas)

**Kodo generavimui:**
- Rekomenduojama: `deepseek-r1-distill-qwen-7b`
- Alternatyva: `qwen2.5-7b-instruct` (taip pat geras kodo generavimui)

**Sudėtingam samprotavimui:**
- Geriausias: `qwen2.5-7b-instruct` arba `qwen2.5-14b-instruct`
...
- NPU palaikymas (Windows 11 Copilot+ kompiuteriai) pagreitinimui
...
## 5 dalis: Paprastas modelių vertinimas

### Pagrindinis našumo testavimas

Pateikiamas paprastas būdas palyginti modelių našumą:
...
Kiekvienam modeliui testuokite su nuosekliais užklausimais ir vertinkite rankiniu būdu:

**Testavimo užklausimai:**
1. "Paaiškinkite kvantinį skaičiavimą paprastais terminais."
2. "Parašykite Python funkciją, kuri rūšiuoja sąrašą."
