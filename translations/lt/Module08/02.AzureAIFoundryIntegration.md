...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-23T01:17:29+00:00",
...
Remdamiesi Foundry Local pagrindais, šioje sesijoje gilinsitės į pažangius AI sprendimus, pasitelkdami sudėtingą užklausų kūrimą, sklandžią duomenų integraciją ir veiksmingą užduočių automatizavimą. Išmoksite sujungti vietinį kūrimą su Azure AI Foundry galimybėmis, kurdami įmonės lygio programas, kurios išnaudoja abiejų pasaulių privalumus.

## Mokymosi tikslai

Šios sesijos pabaigoje jūs:
- Įvaldysite pažangius užklausų kūrimo metodus, užtikrinančius nuoseklius ir patikimus AI atsakymus
- Įgyvendinsite tvirtus duomenų integracijos modelius realioms programoms
- Kursite veiksmingas AI užduotis, kurios suteikia verslo vertę
- Užtikrinsite sklandų ryšį tarp Foundry Local ir Azure AI Foundry
- Kursite našumo stebėjimo ir optimizavimo darbo eigas
- Diegsite gamybai paruoštus AI sprendimus su tinkamu klaidų valdymu ir mastelio didinimu

## Reikalavimai

- Baigta 1 sesija: Darbo pradžia su Foundry Local
- Aktyvi Foundry Local instaliacija su veikiančiais modeliais
- Azure paskyra (mokymuisi pakanka nemokamo plano)
- Pagrindinės REST API ir JSON žinios

## 1 dalis: Pažangus užklausų kūrimas

### Užklausų architektūros supratimas

Efektyvus užklausų kūrimas yra patikimų AI programų pagrindas. Foundry Local siūlo patobulintas užklausų kūrimo galimybes:
...
### Užklausų strategijų įgyvendinimas
...
### Praktiniai užklausų kūrimo pavyzdžiai
...
## 2 dalis: Duomenų integracijos modeliai

### Foundry Local duomenų jungtys
...
### Realios duomenų integracijos pavyzdys
...
## 3 dalis: Veiksmingos AI užduotys

### Užduočių automatizavimo sistema
...
### Verslo procesų automatizavimo pavyzdžiai
...
## 4 dalis: Azure AI Foundry integracija
...
## 5 dalis: Našumo stebėjimas ir optimizavimas
...
### Užduotis 1: Pažangus klientų aptarnavimo botas
...
### Užduotis 2: Automatinė rinkos tyrimų sistema
...
## 7 dalis: Kiti žingsniai ir 3 sesijos apžvalga

### Sesijos pasiekimai

Šioje sesijoje jūs įvaldėte:
- ✅ Pažangius užklausų kūrimo metodus, užtikrinančius nuoseklų AI elgesį
- ✅ Tvirtus duomenų integracijos modelius realioms programoms
- ✅ Automatizuotų užduočių kūrimą verslo procesų optimizavimui
- ✅ Azure AI Foundry integraciją ir hibridinio diegimo strategijas
- ✅ Išsamų našumo stebėjimą ir optimizavimą

### Pasiruošimas 3 sesijai: Atvirojo kodo modeliai

1. **Naršykite Hugging Face**: Susikurkite paskyrą ir peržiūrėkite modelių katalogą
2. **Peržiūrėkite Model Mondays**: Susipažinkite su naujausia [Model Mondays serija](https://aka.ms/model-mondays)
3. **Planuokite pritaikytus modelius**: Pagalvokite, kokie specializuoti modeliai galėtų būti naudingi jūsų naudojimo atvejams
...
- [Pažangus užklausų kūrimo vadovas](https://platform.openai.com/docs/guides/prompt-engineering)
- [Geriausios verslo procesų automatizavimo praktikos](https://docs.microsoft.com/en-us/power-automate/)

Dabar esate pasiruošę kurti pažangius AI sprendimus, kurie sujungia vietinio apdorojimo galią su debesų mastelio galimybėmis, sudarydami pagrindą įmonės lygio AI programoms.
