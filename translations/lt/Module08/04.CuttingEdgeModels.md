...
CO_OP_TRANSLATOR_METADATA:
{
  ...
  "translation_date": "2025-09-25T02:41:54+00:00",
...
Šioje sesijoje mokysitės kurti produkcijai paruoštas pokalbių programas, naudodami Chainlit ir Microsoft Foundry Local. Sužinosite, kaip sukurti modernias interneto sąsajas AI pokalbiams, įgyvendinti srautinį atsakymų pateikimą ir diegti patikimas pokalbių programas su tinkamu klaidų valdymu bei vartotojo patirties dizainu.
...
- Įgyvendinti srautinį atsakymų pateikimą, siekiant pagerinti vartotojo patirtį
...
- `cl.Message().stream_token()`: Realus laiko srautas
...
| **Privatumas** | 🔒 Duomenys niekada nepalieka įrenginio | ⚠️ Duomenys siunčiami į debesį |
| **Kaina** | 💰 Nemokama po įrangos įsigijimo | 💸 Mokestis už kiekvieną žodį |
| **Offline** | ✅ Veikia be interneto | ❌ Reikalingas internetas |
| **Modelio dydis** | ⚠️ Ribotas pagal įrangą | ✅ Prieiga prie didžiausių modelių |
| **Mastelis** | ⚠️ Priklauso nuo įrangos | ✅ Neribotas mastelis |
...
## 4 dalis: Jupyter užrašų knygelių kūrimas ir naudojimas

### Užrašų knygelių palaikymo apžvalga

Pavyzdys 04 apima išsamią Jupyter užrašų knygelę (`chainlit_app.ipynb`), kurioje pateikiama:

- **📚 Mokomoji medžiaga**: Žingsnis po žingsnio mokymosi medžiaga
- **🔬 Interaktyvus tyrinėjimas**: Kodo langelių vykdymas ir eksperimentavimas
- **📊 Vizualiniai demonstravimai**: Diagramos, schemos ir rezultatų vizualizacija
- **🛠️ Kūrimo įrankiai**: Testavimo ir derinimo galimybės

### Savo užrašų knygelių kūrimas
...
#### 2 žingsnis: Naujos užrašų knygelės kūrimas
...
### Užrašų knygelės struktūros geriausios praktikos

#### Langelių organizavimas
...
- Patikrinimas: `chrome://gpu` → patvirtinkite "WebGPU" būseną
...
4 sesijoje aptarėme produkcijai paruoštų Chainlit programų kūrimą pokalbių AI. Jūs išmokote:
...
- ✅ **Produkcijos šablonai**: Klaidų valdymas, stebėjimas ir mastelio didinimas

Pavyzdys 04 demonstruoja geriausias praktikas, kaip kurti patikimas pokalbių sąsajas, kurios naudoja vietinius AI modelius per Microsoft Foundry Local, tuo pačiu užtikrinant puikią vartotojo patirtį.

## Nuorodos

- **[Pavyzdys 04: Chainlit programa](samples/04/README.md)**: Pilna programa su dokumentacija
- **[Chainlit mokomoji užrašų knygelė](samples/04/chainlit_app.ipynb)**: Interaktyvi mokymosi medžiaga
- **[Foundry Local dokumentacija](https://learn.microsoft.com/azure/ai-foundry/foundry-local/)**: Pilna platformos dokumentacija
- **[Chainlit dokumentacija](https://docs.chainlit.io/)**: Oficialus sistemos dokumentas
